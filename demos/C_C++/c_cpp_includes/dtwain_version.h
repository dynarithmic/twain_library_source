...
#define DTWAIN_MINOR_VERSION           9
#define DTWAIN_PATCHLEVEL_VERSION      3

#define DTWAIN_TEXTRESOURCE_MIN_MAJOR_VERSION           5
#define DTWAIN_TEXTRESOURCE_MIN_MINOR_VERSION           9
#define DTWAIN_TEXTRESOURCE_MIN_PATCHLEVEL_VERSION      3

#define DTWAIN_STRINGER_2_(x) #x
#define DTWAIN_STRINGER_(x) DTWAIN_STRINGER_2_(x)

#define DTWAIN_BUILDNUMBER_VERSION 10
