        ...
        class pdf_options
        {
            ...
            public:
                class pdf_encryption_options
                {
                    ...
                    public:
                       pdf_encryption_options() : m_useStrong(true), m_useEncryption(false), m_useAESEncryption(false), 
                                                  m_useAES256Encryption(false), m_bAutoGenPassword(false), m_permissions(0) {}
                       ...
                       pdf_encryption_options& use_AES256_encryption(bool bSet) { m_useAES256Encryption = bSet; return *this; }
                       ...
                       bool is_use_AES256_encryption() const { return m_useAES256Encryption; }
