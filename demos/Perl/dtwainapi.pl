...
use constant DTWAIN_SVG => 13000;
use constant DTWAIN_SVGZ => 13001;
...
use constant DTWAIN_NODELETEDIBS => 1024;
...
use constant DTWAIN_ARRAYSHORTINT16 => 160;
use constant DTWAIN_ARRAYSHORTUINT16 => 170;
...
use constant DTWAIN_CAPSETCONSTRAINT => 12;
...
use constant DTWAIN_FAILURE3 => 0xFFFFFFFF;
...
use constant DTWAIN_TN_DEVICEEVENTFAILED => 1101;
...
use constant DTWAIN_TN_SOURCEDETAILS => 1304;
use constant DTWAIN_TN_QUERYACQUIREPAGES => 1305;
use constant DTWAIN_TN_ACQUIREPAGESSTOPPING => 1306;
use constant DTWAIN_TN_ACQUIREPAGESSTOPPED => 1307;
use constant DTWAIN_TN_QUERYUPDATEDIBORIG => 1308;
use constant DTWAIN_TN_QUERYUPDATEDIBRESAMPLED => 1309;
use constant DTWAIN_TN_PENDINGXFERSRETRIEVED => 1310;
...
use constant DTWAIN_ERR_NULL_WINDOW_HANDLE => (-501);
use constant DTWAIN_ERR_ALLOCATION_FAILURE => (-502);
use constant DTWAIN_ERR_INVALID_DLLHANDLE => (-503);
use constant DTWAIN_ERR_INVALID_SOURCE_HANDLE => (-504);
use constant DTWAIN_ERR_TWAINDSM_NOT_FOUND => (-505);
use constant DTWAIN_ERR_INVALID_TWAINDSM_DLL => (-506);
use constant DTWAIN_ERR_INVALID_SESSION_HANDLE => (-507);
use constant DTWAIN_ERR_INVALID_TWAIN_MANAGER => (-508);
use constant DTWAIN_ERR_TWAINDSM_LOAD_ERROR => (-509);
use constant DTWAIN_ERR_SOURCE_OPEN_ERROR => (-510);
use constant DTWAIN_ERR_SOURCE_CLOSE_ERROR => (-511);
use constant DTWAIN_ERR_SOURCE_REQUIRED_OPEN => (-512);
use constant DTWAIN_ERR_XYRESOLUTION_MATCH => (-527);
use constant DTWAIN_ERR_INVALID_FILENAME => (-528);
use constant DTWAIN_ERR_TRIPLET_NOTEXECUTED => (-532);
...
use constant DTWAIN_ERR_DTWAINDLL_LOADERROR => (-1089);
use constant DTWAIN_ERR_DTWAINDLL_VERSION => (-1090);
use constant DTWAIN_ERR_ACTIVE_TWAINSESSION => (-1091);
use constant DTWAIN_ERR_DSMVERSION_NOTSUPPORTED => (-1092);
use constant DTWAIN_ERR_TWENUMERATOR_NOTUSED => (-1093);
...
use constant DTWAIN_ERR_INVALID_PDFTEXTELEMENT => (-2505);
use constant DTWAIN_ERR_SETCAP_FAILED => (-2506);
use constant DTWAIN_ERR_CAP_INVALIDSTATE => (-2507);
use constant DTWAIN_ERR_GETCAP_FAILED => (-2508);
...
use constant DTWAIN_DLG_CENTER_CURRENT_MONITOR => 32768;
use constant DTWAIN_DLG_CONSOLEASPARENT => 65536;
...
use constant DTWAIN_PDFTEXT_COPYTEXTELEMENT => 0x00000080;
...
use constant DTWAIN_PDFTEXT_NOROTATION => 0x10000000;
use constant DTWAIN_PDFTEXT_NOSKEWING => 0x20000000;
use constant DTWAIN_PDFTEXT_NOSCALINGXY => 0x40000000;
...
use constant DTWAIN_PDFTEXTTRANSFORM_SRK => 0;
use constant DTWAIN_PDFTEXTTRANSFORM_SKR => 1;
use constant DTWAIN_PDFTEXTTRANSFORM_KSR => 2;
use constant DTWAIN_PDFTEXTTRANSFORM_KRS => 3;
use constant DTWAIN_PDFTEXTTRANSFORM_RSK => 4;
use constant DTWAIN_PDFTEXTTRANSFORM_RKS => 5;
use constant DTWAIN_PDFTEXTTRANFORM_LAST => DTWAIN_PDFTEXTTRANSFORM_RKS;
...
use constant DTWAIN_CONSTANT_CAPCODE_NOMNEMONIC => 82;
use constant DTWAIN_CONSTANT_DTWAINCONT_TWAINCONT => 83;
use constant DTWAIN_CONSTANT_ERROR_NAMES => 84;
...
my $DTWAIN_AcquireAudioFile = new Win32::API($dtwain_dllName, 'DTWAIN_AcquireAudioFile', 'PPiiIIP', 'I');
my $DTWAIN_AcquireAudioFileA = new Win32::API($dtwain_dllName, 'DTWAIN_AcquireAudioFileA', 'PPiiIIP', 'I');
my $DTWAIN_AcquireAudioFileW = new Win32::API($dtwain_dllName, 'DTWAIN_AcquireAudioFileW', 'PPiiIIP', 'I');
my $DTWAIN_AcquireAudioNative = new Win32::API($dtwain_dllName, 'DTWAIN_AcquireAudioNative', 'PiIIP', 'P');
my $DTWAIN_AcquireAudioNativeEx = new Win32::API($dtwain_dllName, 'DTWAIN_AcquireAudioNativeEx', 'PiIIPP', 'I');
my $DTWAIN_AcquireBuffered = new Win32::API($dtwain_dllName, 'DTWAIN_AcquireBuffered', 'PiiIIP', 'P');
my $DTWAIN_AcquireBufferedEx = new Win32::API($dtwain_dllName, 'DTWAIN_AcquireBufferedEx', 'PiiIIPP', 'I');
my $DTWAIN_AcquireFile = new Win32::API($dtwain_dllName, 'DTWAIN_AcquireFile', 'PPiiiiIIP', 'I');
my $DTWAIN_AcquireFileA = new Win32::API($dtwain_dllName, 'DTWAIN_AcquireFileA', 'PPiiiiIIP', 'I');
my $DTWAIN_AcquireFileEx = new Win32::API($dtwain_dllName, 'DTWAIN_AcquireFileEx', 'PPiiiiIIP', 'I');
my $DTWAIN_AcquireFileW = new Win32::API($dtwain_dllName, 'DTWAIN_AcquireFileW', 'PPiiiiIIP', 'I');
my $DTWAIN_AcquireNative = new Win32::API($dtwain_dllName, 'DTWAIN_AcquireNative', 'PiiIIP', 'P');
my $DTWAIN_AcquireNativeEx = new Win32::API($dtwain_dllName, 'DTWAIN_AcquireNativeEx', 'PiiIIPP', 'I');
my $DTWAIN_AcquireToClipboard = new Win32::API($dtwain_dllName, 'DTWAIN_AcquireToClipboard', 'PiiiIIIP', 'P');
my $DTWAIN_AddPDFText = new Win32::API($dtwain_dllName, 'DTWAIN_AddPDFText', 'PPiiPDiiDDDDI', 'I');
my $DTWAIN_AddPDFTextA = new Win32::API($dtwain_dllName, 'DTWAIN_AddPDFTextA', 'PPiiPDiiDDDDI', 'I');
my $DTWAIN_AddPDFTextElement = new Win32::API($dtwain_dllName, 'DTWAIN_AddPDFTextElement', 'PP', 'I');
my $DTWAIN_AddPDFTextString = new Win32::API($dtwain_dllName, 'DTWAIN_AddPDFTextString', 'PPiiPPiiPPPPI', 'I');
my $DTWAIN_AddPDFTextStringA = new Win32::API($dtwain_dllName, 'DTWAIN_AddPDFTextStringA', 'PPiiPPiiPPPPI', 'I');
my $DTWAIN_AddPDFTextStringW = new Win32::API($dtwain_dllName, 'DTWAIN_AddPDFTextStringW', 'PPiiPPiiPPPPI', 'I');
my $DTWAIN_AddPDFTextW = new Win32::API($dtwain_dllName, 'DTWAIN_AddPDFTextW', 'PPiiPDiiDDDDI', 'I');
...
my $DTWAIN_ArrayANSIStringToFloat = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayANSIStringToFloat', 'P', 'P');
my $DTWAIN_ArrayAdd = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayAdd', 'PP', 'I');
my $DTWAIN_ArrayAddANSIString = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayAddANSIString', 'PP', 'I');
my $DTWAIN_ArrayAddANSIStringN = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayAddANSIStringN', 'PPi', 'I');
my $DTWAIN_ArrayAddFloat = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayAddFloat', 'PD', 'I');
my $DTWAIN_ArrayAddFloatN = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayAddFloatN', 'PDi', 'I');
my $DTWAIN_ArrayAddFloatString = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayAddFloatString', 'PP', 'I');
my $DTWAIN_ArrayAddFloatStringA = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayAddFloatStringA', 'PP', 'I');
my $DTWAIN_ArrayAddFloatStringN = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayAddFloatStringN', 'PPi', 'I');
my $DTWAIN_ArrayAddFloatStringNA = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayAddFloatStringNA', 'PPi', 'I');
my $DTWAIN_ArrayAddFloatStringNW = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayAddFloatStringNW', 'PPi', 'I');
my $DTWAIN_ArrayAddFloatStringW = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayAddFloatStringW', 'PP', 'I');
my $DTWAIN_ArrayAddFrame = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayAddFrame', 'PP', 'I');
my $DTWAIN_ArrayAddFrameN = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayAddFrameN', 'PPi', 'I');
my $DTWAIN_ArrayAddLong = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayAddLong', 'Pi', 'I');
my $DTWAIN_ArrayAddLong64 = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayAddLong64', 'Pq', 'I');
my $DTWAIN_ArrayAddLong64N = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayAddLong64N', 'Pqi', 'I');
my $DTWAIN_ArrayAddLongN = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayAddLongN', 'Pii', 'I');
my $DTWAIN_ArrayAddN = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayAddN', 'PPi', 'I');
my $DTWAIN_ArrayAddString = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayAddString', 'PP', 'I');
my $DTWAIN_ArrayAddStringA = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayAddStringA', 'PP', 'I');
my $DTWAIN_ArrayAddStringN = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayAddStringN', 'PPi', 'I');
my $DTWAIN_ArrayAddStringNA = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayAddStringNA', 'PPi', 'I');
my $DTWAIN_ArrayAddStringNW = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayAddStringNW', 'PPi', 'I');
my $DTWAIN_ArrayAddStringW = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayAddStringW', 'PP', 'I');
my $DTWAIN_ArrayAddWideString = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayAddWideString', 'PP', 'I');
my $DTWAIN_ArrayAddWideStringN = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayAddWideStringN', 'PPi', 'I');
my $DTWAIN_ArrayConvertFix32ToFloat = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayConvertFix32ToFloat', 'P', 'P');
my $DTWAIN_ArrayConvertFloatToFix32 = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayConvertFloatToFix32', 'P', 'P');
my $DTWAIN_ArrayCopy = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayCopy', 'PP', 'I');
my $DTWAIN_ArrayCreate = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayCreate', 'ii', 'P');
my $DTWAIN_ArrayCreateCopy = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayCreateCopy', 'P', 'P');
my $DTWAIN_ArrayCreateFromANSIStrings = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayCreateFromANSIStrings', 'Pi', 'P');
my $DTWAIN_ArrayCreateFromCap = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayCreateFromCap', 'Pii', 'P');
my $DTWAIN_ArrayCreateFromFloats = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayCreateFromFloats', 'Pi', 'P');
...
my $DTWAIN_ArrayFindANSIString = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayFindANSIString', 'PP', 'i');
my $DTWAIN_ArrayFindFloat = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayFindFloat', 'PDD', 'i');
my $DTWAIN_ArrayFindFloatString = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayFindFloatString', 'PPP', 'i');
my $DTWAIN_ArrayFindFloatStringA = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayFindFloatStringA', 'PPP', 'i');
my $DTWAIN_ArrayFindFloatStringW = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayFindFloatStringW', 'PPP', 'i');
my $DTWAIN_ArrayFindLong = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayFindLong', 'Pi', 'i');
my $DTWAIN_ArrayFindLong64 = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayFindLong64', 'Pq', 'i');
my $DTWAIN_ArrayFindString = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayFindString', 'PP', 'i');
my $DTWAIN_ArrayFindStringA = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayFindStringA', 'PP', 'i');
my $DTWAIN_ArrayFindStringW = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayFindStringW', 'PP', 'i');
my $DTWAIN_ArrayFindWideString = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayFindWideString', 'PP', 'i');
my $DTWAIN_ArrayFix32GetAt = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayFix32GetAt', 'PIPP', 'I');
my $DTWAIN_ArrayFix32SetAt = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayFix32SetAt', 'PIII', 'I');
my $DTWAIN_ArrayFloatToANSIString = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayFloatToANSIString', 'P', 'P');
my $DTWAIN_ArrayFloatToString = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayFloatToString', 'P', 'P');
my $DTWAIN_ArrayFloatToWideString = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayFloatToWideString', 'P', 'P');
my $DTWAIN_ArrayGetAt = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayGetAt', 'PiP', 'I');
my $DTWAIN_ArrayGetAtANSIString = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayGetAtANSIString', 'PiP', 'I');
my $DTWAIN_ArrayGetAtANSIStringPtr = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayGetAtANSIStringPtr', 'Pi', 'P');
my $DTWAIN_ArrayGetAtFloat = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayGetAtFloat', 'PiP', 'I');
my $DTWAIN_ArrayGetAtFloatEx = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayGetAtFloatEx', 'Pi', 'D');
my $DTWAIN_ArrayGetAtFloatString = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayGetAtFloatString', 'PiP', 'I');
my $DTWAIN_ArrayGetAtFloatStringA = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayGetAtFloatStringA', 'PiP', 'I');
my $DTWAIN_ArrayGetAtFloatStringW = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayGetAtFloatStringW', 'PiP', 'I');
my $DTWAIN_ArrayGetAtFrame = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayGetAtFrame', 'PiPPPP', 'I');
my $DTWAIN_ArrayGetAtFrameEx = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayGetAtFrameEx', 'PiP', 'I');
my $DTWAIN_ArrayGetAtFrameString = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayGetAtFrameString', 'PiPPPP', 'I');
my $DTWAIN_ArrayGetAtFrameStringA = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayGetAtFrameStringA', 'PiPPPP', 'I');
my $DTWAIN_ArrayGetAtFrameStringW = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayGetAtFrameStringW', 'PiPPPP', 'I');
my $DTWAIN_ArrayGetAtLong = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayGetAtLong', 'PiP', 'I');
my $DTWAIN_ArrayGetAtLong64 = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayGetAtLong64', 'PiP', 'I');
my $DTWAIN_ArrayGetAtLong64Ex = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayGetAtLong64Ex', 'Pi', 'q');
my $DTWAIN_ArrayGetAtLongEx = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayGetAtLongEx', 'Pi', 'i');
my $DTWAIN_ArrayGetAtSource = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayGetAtSource', 'PiP', 'I');
my $DTWAIN_ArrayGetAtSourceEx = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayGetAtSourceEx', 'Pi', 'P');
my $DTWAIN_ArrayGetAtString = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayGetAtString', 'PiP', 'I');
my $DTWAIN_ArrayGetAtStringA = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayGetAtStringA', 'PiP', 'I');
my $DTWAIN_ArrayGetAtStringPtr = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayGetAtStringPtr', 'Pi', 'P');
my $DTWAIN_ArrayGetAtStringW = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayGetAtStringW', 'PiP', 'I');
my $DTWAIN_ArrayGetAtWideString = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayGetAtWideString', 'PiP', 'I');
my $DTWAIN_ArrayGetAtWideStringPtr = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayGetAtWideStringPtr', 'Pi', 'P');
my $DTWAIN_ArrayGetBuffer = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayGetBuffer', 'Pi', 'P');
my $DTWAIN_ArrayGetCapValues = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayGetCapValues', 'Pii', 'P');
my $DTWAIN_ArrayGetCapValuesEx = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayGetCapValuesEx', 'Piii', 'P');
my $DTWAIN_ArrayGetCapValuesEx2 = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayGetCapValuesEx2', 'Piiii', 'P');
my $DTWAIN_ArrayGetCount = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayGetCount', 'P', 'i');
my $DTWAIN_ArrayGetMaxStringLength = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayGetMaxStringLength', 'P', 'i');
my $DTWAIN_ArrayGetSourceAt = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayGetSourceAt', 'PiP', 'I');
my $DTWAIN_ArrayGetStringLength = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayGetStringLength', 'Pi', 'i');
my $DTWAIN_ArrayGetType = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayGetType', 'P', 'i');
my $DTWAIN_ArrayInsertAt = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayInsertAt', 'PiP', 'I');
my $DTWAIN_ArrayInsertAtANSIString = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayInsertAtANSIString', 'PiP', 'I');
my $DTWAIN_ArrayInsertAtANSIStringN = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayInsertAtANSIStringN', 'PiPi', 'I');
my $DTWAIN_ArrayInsertAtFloat = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayInsertAtFloat', 'PiD', 'I');
my $DTWAIN_ArrayInsertAtFloatN = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayInsertAtFloatN', 'PiDi', 'I');
my $DTWAIN_ArrayInsertAtFloatString = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayInsertAtFloatString', 'PiP', 'I');
my $DTWAIN_ArrayInsertAtFloatStringA = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayInsertAtFloatStringA', 'PiP', 'I');
my $DTWAIN_ArrayInsertAtFloatStringN = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayInsertAtFloatStringN', 'PiPi', 'I');
my $DTWAIN_ArrayInsertAtFloatStringNA = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayInsertAtFloatStringNA', 'PiPi', 'I');
my $DTWAIN_ArrayInsertAtFloatStringNW = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayInsertAtFloatStringNW', 'PiPi', 'I');
my $DTWAIN_ArrayInsertAtFloatStringW = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayInsertAtFloatStringW', 'PiP', 'I');
my $DTWAIN_ArrayInsertAtFrame = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayInsertAtFrame', 'PiP', 'I');
my $DTWAIN_ArrayInsertAtFrameN = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayInsertAtFrameN', 'PiPi', 'I');
my $DTWAIN_ArrayInsertAtLong = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayInsertAtLong', 'Pii', 'I');
my $DTWAIN_ArrayInsertAtLong64 = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayInsertAtLong64', 'Piq', 'I');
my $DTWAIN_ArrayInsertAtLong64N = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayInsertAtLong64N', 'Piqi', 'I');
my $DTWAIN_ArrayInsertAtLongN = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayInsertAtLongN', 'Piii', 'I');
my $DTWAIN_ArrayInsertAtN = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayInsertAtN', 'PiPi', 'I');
my $DTWAIN_ArrayInsertAtString = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayInsertAtString', 'PiP', 'I');
my $DTWAIN_ArrayInsertAtStringA = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayInsertAtStringA', 'PiP', 'I');
my $DTWAIN_ArrayInsertAtStringN = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayInsertAtStringN', 'PiPi', 'I');
my $DTWAIN_ArrayInsertAtStringNA = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayInsertAtStringNA', 'PiPi', 'I');
my $DTWAIN_ArrayInsertAtStringNW = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayInsertAtStringNW', 'PiPi', 'I');
my $DTWAIN_ArrayInsertAtStringW = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayInsertAtStringW', 'PiP', 'I');
my $DTWAIN_ArrayInsertAtWideString = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayInsertAtWideString', 'PiP', 'I');
my $DTWAIN_ArrayInsertAtWideStringN = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayInsertAtWideStringN', 'PiPi', 'I');
my $DTWAIN_ArrayIsValid = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayIsValid', 'P', 'I');
my $DTWAIN_ArrayRemoveAll = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayRemoveAll', 'P', 'I');
my $DTWAIN_ArrayRemoveAt = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayRemoveAt', 'Pi', 'I');
my $DTWAIN_ArrayRemoveAtN = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayRemoveAtN', 'Pii', 'I');
my $DTWAIN_ArrayResize = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayResize', 'Pi', 'I');
my $DTWAIN_ArraySetAt = new Win32::API($dtwain_dllName, 'DTWAIN_ArraySetAt', 'PiP', 'I');
my $DTWAIN_ArraySetAtANSIString = new Win32::API($dtwain_dllName, 'DTWAIN_ArraySetAtANSIString', 'PiP', 'I');
my $DTWAIN_ArraySetAtFloat = new Win32::API($dtwain_dllName, 'DTWAIN_ArraySetAtFloat', 'PiD', 'I');
my $DTWAIN_ArraySetAtFloatString = new Win32::API($dtwain_dllName, 'DTWAIN_ArraySetAtFloatString', 'PiP', 'I');
my $DTWAIN_ArraySetAtFloatStringA = new Win32::API($dtwain_dllName, 'DTWAIN_ArraySetAtFloatStringA', 'PiP', 'I');
my $DTWAIN_ArraySetAtFloatStringW = new Win32::API($dtwain_dllName, 'DTWAIN_ArraySetAtFloatStringW', 'PiP', 'I');
my $DTWAIN_ArraySetAtFrame = new Win32::API($dtwain_dllName, 'DTWAIN_ArraySetAtFrame', 'PiDDDD', 'I');
my $DTWAIN_ArraySetAtFrameEx = new Win32::API($dtwain_dllName, 'DTWAIN_ArraySetAtFrameEx', 'PiP', 'I');
my $DTWAIN_ArraySetAtFrameString = new Win32::API($dtwain_dllName, 'DTWAIN_ArraySetAtFrameString', 'PiPPPP', 'I');
my $DTWAIN_ArraySetAtFrameStringA = new Win32::API($dtwain_dllName, 'DTWAIN_ArraySetAtFrameStringA', 'PiPPPP', 'I');
my $DTWAIN_ArraySetAtFrameStringW = new Win32::API($dtwain_dllName, 'DTWAIN_ArraySetAtFrameStringW', 'PiPPPP', 'I');
my $DTWAIN_ArraySetAtLong = new Win32::API($dtwain_dllName, 'DTWAIN_ArraySetAtLong', 'Pii', 'I');
my $DTWAIN_ArraySetAtLong64 = new Win32::API($dtwain_dllName, 'DTWAIN_ArraySetAtLong64', 'Piq', 'I');
my $DTWAIN_ArraySetAtString = new Win32::API($dtwain_dllName, 'DTWAIN_ArraySetAtString', 'PiP', 'I');
my $DTWAIN_ArraySetAtStringA = new Win32::API($dtwain_dllName, 'DTWAIN_ArraySetAtStringA', 'PiP', 'I');
my $DTWAIN_ArraySetAtStringW = new Win32::API($dtwain_dllName, 'DTWAIN_ArraySetAtStringW', 'PiP', 'I');
my $DTWAIN_ArraySetAtWideString = new Win32::API($dtwain_dllName, 'DTWAIN_ArraySetAtWideString', 'PiP', 'I');
my $DTWAIN_ArrayStringToFloat = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayStringToFloat', 'P', 'P');
my $DTWAIN_ArrayWideStringToFloat = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayWideStringToFloat', 'P', 'P');
...
my $DTWAIN_ClearPDFTextElements = new Win32::API($dtwain_dllName, 'DTWAIN_ClearPDFTextElements', 'P', 'I');
my $DTWAIN_ClearPage = new Win32::API($dtwain_dllName, 'DTWAIN_ClearPage', 'P', 'I');
my $DTWAIN_CloseSource = new Win32::API($dtwain_dllName, 'DTWAIN_CloseSource', 'P', 'I');
my $DTWAIN_CloseSourceUI = new Win32::API($dtwain_dllName, 'DTWAIN_CloseSourceUI', 'P', 'I');
...
my $DTWAIN_CreateAcquisitionArray = new Win32::API($dtwain_dllName, 'DTWAIN_CreateAcquisitionArray', '', 'P');
my $DTWAIN_CreatePDFTextElement = new Win32::API($dtwain_dllName, 'DTWAIN_CreatePDFTextElement', '', 'P');
my $DTWAIN_CreatePDFTextElementCopy = new Win32::API($dtwain_dllName, 'DTWAIN_CreatePDFTextElementCopy', 'P', 'P');
my $DTWAIN_DeleteDIB = new Win32::API($dtwain_dllName, 'DTWAIN_DeleteDIB', 'P', 'I');
my $DTWAIN_DestroyAcquisitionArray = new Win32::API($dtwain_dllName, 'DTWAIN_DestroyAcquisitionArray', 'PI', 'I');
my $DTWAIN_DestroyPDFTextElement = new Win32::API($dtwain_dllName, 'DTWAIN_DestroyPDFTextElement', 'P', 'I');
my $DTWAIN_DisableAppWindow = new Win32::API($dtwain_dllName, 'DTWAIN_DisableAppWindow', 'PI', 'I');
my $DTWAIN_EnableAutoBorderDetect = new Win32::API($dtwain_dllName, 'DTWAIN_EnableAutoBorderDetect', 'PI', 'I');
my $DTWAIN_EnableAutoBright = new Win32::API($dtwain_dllName, 'DTWAIN_EnableAutoBright', 'PI', 'I');
my $DTWAIN_EnableAutoDeskew = new Win32::API($dtwain_dllName, 'DTWAIN_EnableAutoDeskew', 'PI', 'I');
my $DTWAIN_EnableAutoFeed = new Win32::API($dtwain_dllName, 'DTWAIN_EnableAutoFeed', 'PI', 'I');
my $DTWAIN_EnableAutoRotate = new Win32::API($dtwain_dllName, 'DTWAIN_EnableAutoRotate', 'PI', 'I');
my $DTWAIN_EnableAutoScan = new Win32::API($dtwain_dllName, 'DTWAIN_EnableAutoScan', 'PI', 'I');
my $DTWAIN_EnableAutomaticSenseMedium = new Win32::API($dtwain_dllName, 'DTWAIN_EnableAutomaticSenseMedium', 'PI', 'I');
my $DTWAIN_EnableBarcodeDetection = new Win32::API($dtwain_dllName, 'DTWAIN_EnableBarcodeDetection', 'PI', 'I');
my $DTWAIN_EnableDuplex = new Win32::API($dtwain_dllName, 'DTWAIN_EnableDuplex', 'PI', 'I');
my $DTWAIN_EnableFeeder = new Win32::API($dtwain_dllName, 'DTWAIN_EnableFeeder', 'PI', 'I');
my $DTWAIN_EnableGetMessageLoop = new Win32::API($dtwain_dllName, 'DTWAIN_EnableGetMessageLoop', 'PI', 'I');
my $DTWAIN_EnableGetMessageLoopDetection = new Win32::API($dtwain_dllName, 'DTWAIN_EnableGetMessageLoopDetection', 'I', 'I');
my $DTWAIN_EnableIndicator = new Win32::API($dtwain_dllName, 'DTWAIN_EnableIndicator', 'PI', 'I');
my $DTWAIN_EnableJobFileHandling = new Win32::API($dtwain_dllName, 'DTWAIN_EnableJobFileHandling', 'PI', 'I');
my $DTWAIN_EnableLamp = new Win32::API($dtwain_dllName, 'DTWAIN_EnableLamp', 'PI', 'I');
my $DTWAIN_EnableMsgNotify = new Win32::API($dtwain_dllName, 'DTWAIN_EnableMsgNotify', 'I', 'I');
my $DTWAIN_EnablePatchcodeDetection = new Win32::API($dtwain_dllName, 'DTWAIN_EnablePatchcodeDetection', 'PI', 'I');
my $DTWAIN_EnablePeekMessageLoop = new Win32::API($dtwain_dllName, 'DTWAIN_EnablePeekMessageLoop', 'PI', 'I');
my $DTWAIN_EnablePrinter = new Win32::API($dtwain_dllName, 'DTWAIN_EnablePrinter', 'PI', 'I');
my $DTWAIN_EnableThumbnail = new Win32::API($dtwain_dllName, 'DTWAIN_EnableThumbnail', 'PI', 'I');
my $DTWAIN_EnableTripletsNotify = new Win32::API($dtwain_dllName, 'DTWAIN_EnableTripletsNotify', 'I', 'I');
my $DTWAIN_EndThread = new Win32::API($dtwain_dllName, 'DTWAIN_EndThread', 'P', 'I');
my $DTWAIN_EndTwainSession = new Win32::API($dtwain_dllName, 'DTWAIN_EndTwainSession', '', 'I');
my $DTWAIN_EnumAlarmVolumes = new Win32::API($dtwain_dllName, 'DTWAIN_EnumAlarmVolumes', 'PPI', 'I');
my $DTWAIN_EnumAlarmVolumesEx = new Win32::API($dtwain_dllName, 'DTWAIN_EnumAlarmVolumesEx', 'PI', 'P');
my $DTWAIN_EnumAlarms = new Win32::API($dtwain_dllName, 'DTWAIN_EnumAlarms', 'PP', 'I');
my $DTWAIN_EnumAlarmsEx = new Win32::API($dtwain_dllName, 'DTWAIN_EnumAlarmsEx', 'P', 'P');
my $DTWAIN_EnumAudioXferMechs = new Win32::API($dtwain_dllName, 'DTWAIN_EnumAudioXferMechs', 'PP', 'I');
my $DTWAIN_EnumAudioXferMechsEx = new Win32::API($dtwain_dllName, 'DTWAIN_EnumAudioXferMechsEx', 'P', 'P');
my $DTWAIN_EnumAutoFeedValues = new Win32::API($dtwain_dllName, 'DTWAIN_EnumAutoFeedValues', 'PP', 'I');
my $DTWAIN_EnumAutoFeedValuesEx = new Win32::API($dtwain_dllName, 'DTWAIN_EnumAutoFeedValuesEx', 'P', 'P');
my $DTWAIN_EnumAutomaticCaptures = new Win32::API($dtwain_dllName, 'DTWAIN_EnumAutomaticCaptures', 'PPI', 'I');
my $DTWAIN_EnumAutomaticCapturesEx = new Win32::API($dtwain_dllName, 'DTWAIN_EnumAutomaticCapturesEx', 'PI', 'P');
my $DTWAIN_EnumAutomaticSenseMedium = new Win32::API($dtwain_dllName, 'DTWAIN_EnumAutomaticSenseMedium', 'PP', 'I');
my $DTWAIN_EnumAutomaticSenseMediumEx = new Win32::API($dtwain_dllName, 'DTWAIN_EnumAutomaticSenseMediumEx', 'P', 'P');
my $DTWAIN_EnumBarcodeCodes = new Win32::API($dtwain_dllName, 'DTWAIN_EnumBarcodeCodes', 'PP', 'I');
my $DTWAIN_EnumBarcodeCodesEx = new Win32::API($dtwain_dllName, 'DTWAIN_EnumBarcodeCodesEx', 'P', 'P');
my $DTWAIN_EnumBarcodeMaxPriorities = new Win32::API($dtwain_dllName, 'DTWAIN_EnumBarcodeMaxPriorities', 'PP', 'I');
my $DTWAIN_EnumBarcodeMaxPrioritiesEx = new Win32::API($dtwain_dllName, 'DTWAIN_EnumBarcodeMaxPrioritiesEx', 'P', 'P');
my $DTWAIN_EnumBarcodeMaxRetries = new Win32::API($dtwain_dllName, 'DTWAIN_EnumBarcodeMaxRetries', 'PP', 'I');
my $DTWAIN_EnumBarcodeMaxRetriesEx = new Win32::API($dtwain_dllName, 'DTWAIN_EnumBarcodeMaxRetriesEx', 'P', 'P');
my $DTWAIN_EnumBarcodePriorities = new Win32::API($dtwain_dllName, 'DTWAIN_EnumBarcodePriorities', 'PP', 'I');
my $DTWAIN_EnumBarcodePrioritiesEx = new Win32::API($dtwain_dllName, 'DTWAIN_EnumBarcodePrioritiesEx', 'P', 'P');
my $DTWAIN_EnumBarcodeSearchModes = new Win32::API($dtwain_dllName, 'DTWAIN_EnumBarcodeSearchModes', 'PP', 'I');
my $DTWAIN_EnumBarcodeSearchModesEx = new Win32::API($dtwain_dllName, 'DTWAIN_EnumBarcodeSearchModesEx', 'P', 'P');
my $DTWAIN_EnumBarcodeTimeOutValues = new Win32::API($dtwain_dllName, 'DTWAIN_EnumBarcodeTimeOutValues', 'PP', 'I');
my $DTWAIN_EnumBarcodeTimeOutValuesEx = new Win32::API($dtwain_dllName, 'DTWAIN_EnumBarcodeTimeOutValuesEx', 'P', 'P');
my $DTWAIN_EnumBitDepths = new Win32::API($dtwain_dllName, 'DTWAIN_EnumBitDepths', 'PP', 'I');
my $DTWAIN_EnumBitDepthsEx = new Win32::API($dtwain_dllName, 'DTWAIN_EnumBitDepthsEx', 'P', 'P');
my $DTWAIN_EnumBitDepthsEx2 = new Win32::API($dtwain_dllName, 'DTWAIN_EnumBitDepthsEx2', 'Pi', 'P');
my $DTWAIN_EnumBottomCameras = new Win32::API($dtwain_dllName, 'DTWAIN_EnumBottomCameras', 'PP', 'I');
my $DTWAIN_EnumBottomCamerasEx = new Win32::API($dtwain_dllName, 'DTWAIN_EnumBottomCamerasEx', 'P', 'P');
my $DTWAIN_EnumBrightnessValues = new Win32::API($dtwain_dllName, 'DTWAIN_EnumBrightnessValues', 'PPI', 'i');
my $DTWAIN_EnumBrightnessValuesEx = new Win32::API($dtwain_dllName, 'DTWAIN_EnumBrightnessValuesEx', 'PI', 'P');
my $DTWAIN_EnumCameras = new Win32::API($dtwain_dllName, 'DTWAIN_EnumCameras', 'PP', 'I');
my $DTWAIN_EnumCamerasEx = new Win32::API($dtwain_dllName, 'DTWAIN_EnumCamerasEx', 'P', 'P');
my $DTWAIN_EnumCamerasEx2 = new Win32::API($dtwain_dllName, 'DTWAIN_EnumCamerasEx2', 'Pi', 'P');
my $DTWAIN_EnumCapLabels = new Win32::API($dtwain_dllName, 'DTWAIN_EnumCapLabels', 'i', 'P');
my $DTWAIN_EnumCompressionTypes = new Win32::API($dtwain_dllName, 'DTWAIN_EnumCompressionTypes', 'PP', 'I');
my $DTWAIN_EnumCompressionTypesEx = new Win32::API($dtwain_dllName, 'DTWAIN_EnumCompressionTypesEx', 'P', 'P');
my $DTWAIN_EnumCompressionTypesEx2 = new Win32::API($dtwain_dllName, 'DTWAIN_EnumCompressionTypesEx2', 'PiI', 'P');
my $DTWAIN_EnumContrastValues = new Win32::API($dtwain_dllName, 'DTWAIN_EnumContrastValues', 'PPI', 'i');
my $DTWAIN_EnumContrastValuesEx = new Win32::API($dtwain_dllName, 'DTWAIN_EnumContrastValuesEx', 'PI', 'P');
my $DTWAIN_EnumCustomCaps = new Win32::API($dtwain_dllName, 'DTWAIN_EnumCustomCaps', 'PP', 'I');
my $DTWAIN_EnumCustomCapsEx = new Win32::API($dtwain_dllName, 'DTWAIN_EnumCustomCapsEx', 'P', 'P');
my $DTWAIN_EnumDoubleFeedDetectLengths = new Win32::API($dtwain_dllName, 'DTWAIN_EnumDoubleFeedDetectLengths', 'PPI', 'i');
my $DTWAIN_EnumDoubleFeedDetectLengthsEx = new Win32::API($dtwain_dllName, 'DTWAIN_EnumDoubleFeedDetectLengthsEx', 'PI', 'P');
my $DTWAIN_EnumDoubleFeedDetectValues = new Win32::API($dtwain_dllName, 'DTWAIN_EnumDoubleFeedDetectValues', 'PP', 'i');
my $DTWAIN_EnumDoubleFeedDetectValuesEx = new Win32::API($dtwain_dllName, 'DTWAIN_EnumDoubleFeedDetectValuesEx', 'P', 'P');
my $DTWAIN_EnumExtImageInfoTypes = new Win32::API($dtwain_dllName, 'DTWAIN_EnumExtImageInfoTypes', 'PP', 'I');
my $DTWAIN_EnumExtImageInfoTypesEx = new Win32::API($dtwain_dllName, 'DTWAIN_EnumExtImageInfoTypesEx', 'P', 'P');
my $DTWAIN_EnumExtendedCaps = new Win32::API($dtwain_dllName, 'DTWAIN_EnumExtendedCaps', 'PP', 'I');
my $DTWAIN_EnumExtendedCapsEx = new Win32::API($dtwain_dllName, 'DTWAIN_EnumExtendedCapsEx', 'P', 'P');
my $DTWAIN_EnumExtendedCapsEx2 = new Win32::API($dtwain_dllName, 'DTWAIN_EnumExtendedCapsEx2', 'P', 'P');
my $DTWAIN_EnumFileTypeBitsPerPixel = new Win32::API($dtwain_dllName, 'DTWAIN_EnumFileTypeBitsPerPixel', 'iP', 'I');
my $DTWAIN_EnumFileXferFormats = new Win32::API($dtwain_dllName, 'DTWAIN_EnumFileXferFormats', 'PP', 'I');
my $DTWAIN_EnumFileXferFormatsEx = new Win32::API($dtwain_dllName, 'DTWAIN_EnumFileXferFormatsEx', 'P', 'P');
my $DTWAIN_EnumHalftones = new Win32::API($dtwain_dllName, 'DTWAIN_EnumHalftones', 'PP', 'I');
my $DTWAIN_EnumHalftonesEx = new Win32::API($dtwain_dllName, 'DTWAIN_EnumHalftonesEx', 'P', 'P');
my $DTWAIN_EnumHighlightValues = new Win32::API($dtwain_dllName, 'DTWAIN_EnumHighlightValues', 'PPI', 'i');
my $DTWAIN_EnumHighlightValuesEx = new Win32::API($dtwain_dllName, 'DTWAIN_EnumHighlightValuesEx', 'PI', 'P');
my $DTWAIN_EnumJobControls = new Win32::API($dtwain_dllName, 'DTWAIN_EnumJobControls', 'PP', 'I');
my $DTWAIN_EnumJobControlsEx = new Win32::API($dtwain_dllName, 'DTWAIN_EnumJobControlsEx', 'P', 'P');
my $DTWAIN_EnumLightPaths = new Win32::API($dtwain_dllName, 'DTWAIN_EnumLightPaths', 'PP', 'I');
my $DTWAIN_EnumLightPathsEx = new Win32::API($dtwain_dllName, 'DTWAIN_EnumLightPathsEx', 'P', 'P');
my $DTWAIN_EnumLightSources = new Win32::API($dtwain_dllName, 'DTWAIN_EnumLightSources', 'PP', 'I');
my $DTWAIN_EnumLightSourcesEx = new Win32::API($dtwain_dllName, 'DTWAIN_EnumLightSourcesEx', 'P', 'P');
my $DTWAIN_EnumMaxBuffers = new Win32::API($dtwain_dllName, 'DTWAIN_EnumMaxBuffers', 'PPI', 'I');
my $DTWAIN_EnumMaxBuffersEx = new Win32::API($dtwain_dllName, 'DTWAIN_EnumMaxBuffersEx', 'PI', 'P');
my $DTWAIN_EnumNoiseFilters = new Win32::API($dtwain_dllName, 'DTWAIN_EnumNoiseFilters', 'PP', 'I');
my $DTWAIN_EnumNoiseFiltersEx = new Win32::API($dtwain_dllName, 'DTWAIN_EnumNoiseFiltersEx', 'P', 'P');
my $DTWAIN_EnumOCRInterfaces = new Win32::API($dtwain_dllName, 'DTWAIN_EnumOCRInterfaces', 'P', 'I');
my $DTWAIN_EnumOCRInterfacesEx = new Win32::API($dtwain_dllName, 'DTWAIN_EnumOCRInterfacesEx', '', 'P');
my $DTWAIN_EnumOCRSupportedCaps = new Win32::API($dtwain_dllName, 'DTWAIN_EnumOCRSupportedCaps', 'PP', 'I');
my $DTWAIN_EnumOrientations = new Win32::API($dtwain_dllName, 'DTWAIN_EnumOrientations', 'PP', 'I');
my $DTWAIN_EnumOrientationsEx = new Win32::API($dtwain_dllName, 'DTWAIN_EnumOrientationsEx', 'P', 'P');
my $DTWAIN_EnumOverscanValues = new Win32::API($dtwain_dllName, 'DTWAIN_EnumOverscanValues', 'PP', 'I');
my $DTWAIN_EnumOverscanValuesEx = new Win32::API($dtwain_dllName, 'DTWAIN_EnumOverscanValuesEx', 'P', 'P');
my $DTWAIN_EnumPaperSizes = new Win32::API($dtwain_dllName, 'DTWAIN_EnumPaperSizes', 'PP', 'I');
my $DTWAIN_EnumPaperSizesEx = new Win32::API($dtwain_dllName, 'DTWAIN_EnumPaperSizesEx', 'P', 'P');
my $DTWAIN_EnumPatchcodeCodes = new Win32::API($dtwain_dllName, 'DTWAIN_EnumPatchcodeCodes', 'PP', 'I');
my $DTWAIN_EnumPatchcodeCodesEx = new Win32::API($dtwain_dllName, 'DTWAIN_EnumPatchcodeCodesEx', 'P', 'P');
my $DTWAIN_EnumPatchcodeMaxPriorities = new Win32::API($dtwain_dllName, 'DTWAIN_EnumPatchcodeMaxPriorities', 'PP', 'I');
my $DTWAIN_EnumPatchcodeMaxPrioritiesEx = new Win32::API($dtwain_dllName, 'DTWAIN_EnumPatchcodeMaxPrioritiesEx', 'P', 'P');
my $DTWAIN_EnumPatchcodeMaxRetries = new Win32::API($dtwain_dllName, 'DTWAIN_EnumPatchcodeMaxRetries', 'PP', 'I');
my $DTWAIN_EnumPatchcodeMaxRetriesEx = new Win32::API($dtwain_dllName, 'DTWAIN_EnumPatchcodeMaxRetriesEx', 'P', 'P');
my $DTWAIN_EnumPatchcodePriorities = new Win32::API($dtwain_dllName, 'DTWAIN_EnumPatchcodePriorities', 'PP', 'I');
my $DTWAIN_EnumPatchcodePrioritiesEx = new Win32::API($dtwain_dllName, 'DTWAIN_EnumPatchcodePrioritiesEx', 'P', 'P');
my $DTWAIN_EnumPatchcodeSearchModes = new Win32::API($dtwain_dllName, 'DTWAIN_EnumPatchcodeSearchModes', 'PP', 'I');
my $DTWAIN_EnumPatchcodeSearchModesEx = new Win32::API($dtwain_dllName, 'DTWAIN_EnumPatchcodeSearchModesEx', 'P', 'P');
my $DTWAIN_EnumPatchcodeTimeOutValues = new Win32::API($dtwain_dllName, 'DTWAIN_EnumPatchcodeTimeOutValues', 'PP', 'I');
my $DTWAIN_EnumPatchcodeTimeOutValuesEx = new Win32::API($dtwain_dllName, 'DTWAIN_EnumPatchcodeTimeOutValuesEx', 'P', 'P');
my $DTWAIN_EnumPixelTypes = new Win32::API($dtwain_dllName, 'DTWAIN_EnumPixelTypes', 'PP', 'I');
my $DTWAIN_EnumPixelTypesEx = new Win32::API($dtwain_dllName, 'DTWAIN_EnumPixelTypesEx', 'P', 'P');
my $DTWAIN_EnumPrinterStringModes = new Win32::API($dtwain_dllName, 'DTWAIN_EnumPrinterStringModes', 'PP', 'I');
my $DTWAIN_EnumPrinterStringModesEx = new Win32::API($dtwain_dllName, 'DTWAIN_EnumPrinterStringModesEx', 'P', 'P');
my $DTWAIN_EnumResolutionValues = new Win32::API($dtwain_dllName, 'DTWAIN_EnumResolutionValues', 'PPI', 'i');
my $DTWAIN_EnumResolutionValuesEx = new Win32::API($dtwain_dllName, 'DTWAIN_EnumResolutionValuesEx', 'PI', 'P');
my $DTWAIN_EnumShadowValues = new Win32::API($dtwain_dllName, 'DTWAIN_EnumShadowValues', 'PPI', 'i');
my $DTWAIN_EnumShadowValuesEx = new Win32::API($dtwain_dllName, 'DTWAIN_EnumShadowValuesEx', 'PI', 'P');
my $DTWAIN_EnumSourceUnits = new Win32::API($dtwain_dllName, 'DTWAIN_EnumSourceUnits', 'PP', 'I');
my $DTWAIN_EnumSourceUnitsEx = new Win32::API($dtwain_dllName, 'DTWAIN_EnumSourceUnitsEx', 'P', 'P');
my $DTWAIN_EnumSourceValues = new Win32::API($dtwain_dllName, 'DTWAIN_EnumSourceValues', 'PPPI', 'I');
my $DTWAIN_EnumSourceValuesA = new Win32::API($dtwain_dllName, 'DTWAIN_EnumSourceValuesA', 'PPPI', 'I');
my $DTWAIN_EnumSourceValuesW = new Win32::API($dtwain_dllName, 'DTWAIN_EnumSourceValuesW', 'PPPI', 'I');
my $DTWAIN_EnumSources = new Win32::API($dtwain_dllName, 'DTWAIN_EnumSources', 'P', 'I');
my $DTWAIN_EnumSourcesEx = new Win32::API($dtwain_dllName, 'DTWAIN_EnumSourcesEx', '', 'P');
my $DTWAIN_EnumSupportedCaps = new Win32::API($dtwain_dllName, 'DTWAIN_EnumSupportedCaps', 'PP', 'I');
my $DTWAIN_EnumSupportedCapsEx = new Win32::API($dtwain_dllName, 'DTWAIN_EnumSupportedCapsEx', 'P', 'P');
my $DTWAIN_EnumSupportedCapsEx2 = new Win32::API($dtwain_dllName, 'DTWAIN_EnumSupportedCapsEx2', 'P', 'P');
my $DTWAIN_EnumSupportedExtImageInfo = new Win32::API($dtwain_dllName, 'DTWAIN_EnumSupportedExtImageInfo', 'PP', 'I');
my $DTWAIN_EnumSupportedExtImageInfoEx = new Win32::API($dtwain_dllName, 'DTWAIN_EnumSupportedExtImageInfoEx', 'P', 'P');
my $DTWAIN_EnumSupportedFileTypes = new Win32::API($dtwain_dllName, 'DTWAIN_EnumSupportedFileTypes', '', 'P');
my $DTWAIN_EnumSupportedMultiPageFileTypes = new Win32::API($dtwain_dllName, 'DTWAIN_EnumSupportedMultiPageFileTypes', '', 'P');
my $DTWAIN_EnumSupportedSinglePageFileTypes = new Win32::API($dtwain_dllName, 'DTWAIN_EnumSupportedSinglePageFileTypes', '', 'P');
my $DTWAIN_EnumThresholdValues = new Win32::API($dtwain_dllName, 'DTWAIN_EnumThresholdValues', 'PPI', 'i');
my $DTWAIN_EnumThresholdValuesEx = new Win32::API($dtwain_dllName, 'DTWAIN_EnumThresholdValuesEx', 'PI', 'P');
my $DTWAIN_EnumTopCameras = new Win32::API($dtwain_dllName, 'DTWAIN_EnumTopCameras', 'PP', 'I');
my $DTWAIN_EnumTopCamerasEx = new Win32::API($dtwain_dllName, 'DTWAIN_EnumTopCamerasEx', 'P', 'P');
my $DTWAIN_EnumTwainPrinters = new Win32::API($dtwain_dllName, 'DTWAIN_EnumTwainPrinters', 'PP', 'I');
my $DTWAIN_EnumTwainPrintersEx = new Win32::API($dtwain_dllName, 'DTWAIN_EnumTwainPrintersEx', 'P', 'P');
my $DTWAIN_EnumXResolutionValues = new Win32::API($dtwain_dllName, 'DTWAIN_EnumXResolutionValues', 'PPI', 'i');
my $DTWAIN_EnumXResolutionValuesEx = new Win32::API($dtwain_dllName, 'DTWAIN_EnumXResolutionValuesEx', 'PI', 'P');
my $DTWAIN_EnumYResolutionValues = new Win32::API($dtwain_dllName, 'DTWAIN_EnumYResolutionValues', 'PPI', 'i');
my $DTWAIN_EnumYResolutionValuesEx = new Win32::API($dtwain_dllName, 'DTWAIN_EnumYResolutionValuesEx', 'PI', 'P');
...
my $DTWAIN_FeedPage = new Win32::API($dtwain_dllName, 'DTWAIN_FeedPage', 'P', 'I');
my $DTWAIN_FlipBitmap = new Win32::API($dtwain_dllName, 'DTWAIN_FlipBitmap', 'P', 'I');
my $DTWAIN_FlushAcquiredPages = new Win32::API($dtwain_dllName, 'DTWAIN_FlushAcquiredPages', 'P', 'I');
...
my $DTWAIN_FreeExtImageInfo = new Win32::API($dtwain_dllName, 'DTWAIN_FreeExtImageInfo', 'P', 'I');
...
my $DTWAIN_GetAPIHandleStatus = new Win32::API($dtwain_dllName, 'DTWAIN_GetAPIHandleStatus', 'P', 'i');
my $DTWAIN_GetAcquireArea = new Win32::API($dtwain_dllName, 'DTWAIN_GetAcquireArea', 'PiP', 'I');
my $DTWAIN_GetAcquireArea2 = new Win32::API($dtwain_dllName, 'DTWAIN_GetAcquireArea2', 'PPPPPP', 'I');
my $DTWAIN_GetAcquireArea2String = new Win32::API($dtwain_dllName, 'DTWAIN_GetAcquireArea2String', 'PPPPPP', 'I');
my $DTWAIN_GetAcquireArea2StringA = new Win32::API($dtwain_dllName, 'DTWAIN_GetAcquireArea2StringA', 'PPPPPP', 'I');
my $DTWAIN_GetAcquireArea2StringW = new Win32::API($dtwain_dllName, 'DTWAIN_GetAcquireArea2StringW', 'PPPPPP', 'I');
my $DTWAIN_GetAcquireAreaEx = new Win32::API($dtwain_dllName, 'DTWAIN_GetAcquireAreaEx', 'Pi', 'P');
my $DTWAIN_GetAcquireMetrics = new Win32::API($dtwain_dllName, 'DTWAIN_GetAcquireMetrics', 'PPP', 'I');
my $DTWAIN_GetAcquireStripBuffer = new Win32::API($dtwain_dllName, 'DTWAIN_GetAcquireStripBuffer', 'P', 'P');
my $DTWAIN_GetAcquireStripData = new Win32::API($dtwain_dllName, 'DTWAIN_GetAcquireStripData', 'PPPPPPPP', 'I');
my $DTWAIN_GetAcquireStripSizes = new Win32::API($dtwain_dllName, 'DTWAIN_GetAcquireStripSizes', 'PPPP', 'I');
my $DTWAIN_GetAcquiredImage = new Win32::API($dtwain_dllName, 'DTWAIN_GetAcquiredImage', 'Pii', 'P');
my $DTWAIN_GetAcquiredImageArray = new Win32::API($dtwain_dllName, 'DTWAIN_GetAcquiredImageArray', 'Pi', 'P');
my $DTWAIN_GetAcquisitionArray = new Win32::API($dtwain_dllName, 'DTWAIN_GetAcquisitionArray', 'P', 'P');
...
my $DTWAIN_GetAlarmVolume = new Win32::API($dtwain_dllName, 'DTWAIN_GetAlarmVolume', 'PP', 'I');
my $DTWAIN_GetAllSessionInfo = new Win32::API($dtwain_dllName, 'DTWAIN_GetAllSessionInfo', 'Pii', 'i');
my $DTWAIN_GetAllSessionInfoA = new Win32::API($dtwain_dllName, 'DTWAIN_GetAllSessionInfoA', 'Pii', 'i');
my $DTWAIN_GetAllSessionInfoW = new Win32::API($dtwain_dllName, 'DTWAIN_GetAllSessionInfoW', 'Pii', 'i');
my $DTWAIN_GetAllSourceDibs = new Win32::API($dtwain_dllName, 'DTWAIN_GetAllSourceDibs', 'P', 'P');
my $DTWAIN_GetAllSourceInfo = new Win32::API($dtwain_dllName, 'DTWAIN_GetAllSourceInfo', 'PPii', 'i');
my $DTWAIN_GetAllSourceInfoA = new Win32::API($dtwain_dllName, 'DTWAIN_GetAllSourceInfoA', 'PPii', 'i');
my $DTWAIN_GetAllSourceInfoW = new Win32::API($dtwain_dllName, 'DTWAIN_GetAllSourceInfoW', 'PPii', 'i');
...
my $DTWAIN_GetAuthor = new Win32::API($dtwain_dllName, 'DTWAIN_GetAuthor', 'PP', 'I');
my $DTWAIN_GetAuthorA = new Win32::API($dtwain_dllName, 'DTWAIN_GetAuthorA', 'PP', 'I');
my $DTWAIN_GetAuthorW = new Win32::API($dtwain_dllName, 'DTWAIN_GetAuthorW', 'PP', 'I');
my $DTWAIN_GetBarcodeMaxPriorities = new Win32::API($dtwain_dllName, 'DTWAIN_GetBarcodeMaxPriorities', 'PPI', 'I');
my $DTWAIN_GetBarcodeMaxRetries = new Win32::API($dtwain_dllName, 'DTWAIN_GetBarcodeMaxRetries', 'PPI', 'I');
my $DTWAIN_GetBarcodePriorities = new Win32::API($dtwain_dllName, 'DTWAIN_GetBarcodePriorities', 'PP', 'I');
my $DTWAIN_GetBarcodeSearchMode = new Win32::API($dtwain_dllName, 'DTWAIN_GetBarcodeSearchMode', 'PPI', 'I');
my $DTWAIN_GetBarcodeTimeOut = new Win32::API($dtwain_dllName, 'DTWAIN_GetBarcodeTimeOut', 'PPI', 'I');
my $DTWAIN_GetBatteryMinutes = new Win32::API($dtwain_dllName, 'DTWAIN_GetBatteryMinutes', 'PP', 'I');
my $DTWAIN_GetBatteryPercent = new Win32::API($dtwain_dllName, 'DTWAIN_GetBatteryPercent', 'PP', 'I');
my $DTWAIN_GetBitDepth = new Win32::API($dtwain_dllName, 'DTWAIN_GetBitDepth', 'PPI', 'I');
my $DTWAIN_GetBitDepthEx = new Win32::API($dtwain_dllName, 'DTWAIN_GetBitDepthEx', 'PI', 'i');
my $DTWAIN_GetBlankPageAutoDetection = new Win32::API($dtwain_dllName, 'DTWAIN_GetBlankPageAutoDetection', 'P', 'i');
my $DTWAIN_GetBrightness = new Win32::API($dtwain_dllName, 'DTWAIN_GetBrightness', 'PP', 'I');
my $DTWAIN_GetBrightnessEx = new Win32::API($dtwain_dllName, 'DTWAIN_GetBrightnessEx', 'P', 'D');
my $DTWAIN_GetBrightnessString = new Win32::API($dtwain_dllName, 'DTWAIN_GetBrightnessString', 'PP', 'I');
my $DTWAIN_GetBrightnessStringA = new Win32::API($dtwain_dllName, 'DTWAIN_GetBrightnessStringA', 'PP', 'I');
my $DTWAIN_GetBrightnessStringW = new Win32::API($dtwain_dllName, 'DTWAIN_GetBrightnessStringW', 'PP', 'I');
my $DTWAIN_GetBufferedTransferInfo = new Win32::API($dtwain_dllName, 'DTWAIN_GetBufferedTransferInfo', 'PPPPPPPPPP', 'P');
...
my $DTWAIN_GetCapArrayType = new Win32::API($dtwain_dllName, 'DTWAIN_GetCapArrayType', 'Pi', 'i');
my $DTWAIN_GetCapContainer = new Win32::API($dtwain_dllName, 'DTWAIN_GetCapContainer', 'Pii', 'i');
my $DTWAIN_GetCapContainerEx = new Win32::API($dtwain_dllName, 'DTWAIN_GetCapContainerEx', 'iIP', 'i');
my $DTWAIN_GetCapContainerEx2 = new Win32::API($dtwain_dllName, 'DTWAIN_GetCapContainerEx2', 'iI', 'P');
my $DTWAIN_GetCapDataType = new Win32::API($dtwain_dllName, 'DTWAIN_GetCapDataType', 'Pi', 'i');
...
my $DTWAIN_GetCapHelp = new Win32::API($dtwain_dllName, 'DTWAIN_GetCapHelp', 'iPi', 'i');
my $DTWAIN_GetCapHelpA = new Win32::API($dtwain_dllName, 'DTWAIN_GetCapHelpA', 'iPi', 'i');
my $DTWAIN_GetCapHelpW = new Win32::API($dtwain_dllName, 'DTWAIN_GetCapHelpW', 'iPi', 'i');
my $DTWAIN_GetCapLabel = new Win32::API($dtwain_dllName, 'DTWAIN_GetCapLabel', 'iPi', 'i');
my $DTWAIN_GetCapLabelA = new Win32::API($dtwain_dllName, 'DTWAIN_GetCapLabelA', 'iPi', 'i');
my $DTWAIN_GetCapLabelW = new Win32::API($dtwain_dllName, 'DTWAIN_GetCapLabelW', 'iPi', 'i');
my $DTWAIN_GetCapOperations = new Win32::API($dtwain_dllName, 'DTWAIN_GetCapOperations', 'PiP', 'I');
my $DTWAIN_GetCapOperationsEx = new Win32::API($dtwain_dllName, 'DTWAIN_GetCapOperationsEx', 'Pi', 'i');
my $DTWAIN_GetCapValues = new Win32::API($dtwain_dllName, 'DTWAIN_GetCapValues', 'PiiP', 'I');
my $DTWAIN_GetCapValuesEx = new Win32::API($dtwain_dllName, 'DTWAIN_GetCapValuesEx', 'PiiiP', 'I');
my $DTWAIN_GetCapValuesEx2 = new Win32::API($dtwain_dllName, 'DTWAIN_GetCapValuesEx2', 'PiiiiP', 'I');
my $DTWAIN_GetCaption = new Win32::API($dtwain_dllName, 'DTWAIN_GetCaption', 'PP', 'I');
my $DTWAIN_GetCaptionA = new Win32::API($dtwain_dllName, 'DTWAIN_GetCaptionA', 'PP', 'I');
my $DTWAIN_GetCaptionW = new Win32::API($dtwain_dllName, 'DTWAIN_GetCaptionW', 'PP', 'I');
my $DTWAIN_GetCompressionSize = new Win32::API($dtwain_dllName, 'DTWAIN_GetCompressionSize', 'PP', 'I');
my $DTWAIN_GetCompressionType = new Win32::API($dtwain_dllName, 'DTWAIN_GetCompressionType', 'PPI', 'I');
my $DTWAIN_GetCompressionTypeEx = new Win32::API($dtwain_dllName, 'DTWAIN_GetCompressionTypeEx', 'PI', 'i');
...
my $DTWAIN_GetConstantFromTwainName = new Win32::API($dtwain_dllName, 'DTWAIN_GetConstantFromTwainName', 'P', 'i');
my $DTWAIN_GetConstantFromTwainNameA = new Win32::API($dtwain_dllName, 'DTWAIN_GetConstantFromTwainNameA', 'P', 'i');
my $DTWAIN_GetConstantFromTwainNameW = new Win32::API($dtwain_dllName, 'DTWAIN_GetConstantFromTwainNameW', 'P', 'i');
my $DTWAIN_GetContrast = new Win32::API($dtwain_dllName, 'DTWAIN_GetContrast', 'PP', 'I');
my $DTWAIN_GetContrastEx = new Win32::API($dtwain_dllName, 'DTWAIN_GetContrastEx', 'P', 'D');
my $DTWAIN_GetContrastString = new Win32::API($dtwain_dllName, 'DTWAIN_GetContrastString', 'PP', 'I');
my $DTWAIN_GetContrastStringA = new Win32::API($dtwain_dllName, 'DTWAIN_GetContrastStringA', 'PP', 'I');
my $DTWAIN_GetContrastStringW = new Win32::API($dtwain_dllName, 'DTWAIN_GetContrastStringW', 'PP', 'I');
my $DTWAIN_GetCountry = new Win32::API($dtwain_dllName, 'DTWAIN_GetCountry', '', 'i');
my $DTWAIN_GetCurrentAcquiredImage = new Win32::API($dtwain_dllName, 'DTWAIN_GetCurrentAcquiredImage', 'P', 'P');
my $DTWAIN_GetCurrentCustomResourceName = new Win32::API($dtwain_dllName, 'DTWAIN_GetCurrentCustomResourceName', 'Pi', 'i');
my $DTWAIN_GetCurrentCustomResourceNameA = new Win32::API($dtwain_dllName, 'DTWAIN_GetCurrentCustomResourceNameA', 'Pi', 'i');
my $DTWAIN_GetCurrentCustomResourceNameW = new Win32::API($dtwain_dllName, 'DTWAIN_GetCurrentCustomResourceNameW', 'Pi', 'i');
my $DTWAIN_GetCurrentFileName = new Win32::API($dtwain_dllName, 'DTWAIN_GetCurrentFileName', 'PPi', 'i');
my $DTWAIN_GetCurrentFileNameA = new Win32::API($dtwain_dllName, 'DTWAIN_GetCurrentFileNameA', 'PPi', 'i');
my $DTWAIN_GetCurrentFileNameW = new Win32::API($dtwain_dllName, 'DTWAIN_GetCurrentFileNameW', 'PPi', 'i');
my $DTWAIN_GetCurrentPageNum = new Win32::API($dtwain_dllName, 'DTWAIN_GetCurrentPageNum', 'P', 'i');
my $DTWAIN_GetCurrentRetryCount = new Win32::API($dtwain_dllName, 'DTWAIN_GetCurrentRetryCount', 'P', 'i');
my $DTWAIN_GetCurrentTwainTriplet = new Win32::API($dtwain_dllName, 'DTWAIN_GetCurrentTwainTriplet', 'PPPPPP', 'I');
my $DTWAIN_GetCustomDSData = new Win32::API($dtwain_dllName, 'DTWAIN_GetCustomDSData', 'PPIPi', 'P');
...
my $DTWAIN_GetDSMSearchOrderEx = new Win32::API($dtwain_dllName, 'DTWAIN_GetDSMSearchOrderEx', 'PP', 'i');
my $DTWAIN_GetDSMSearchOrderExA = new Win32::API($dtwain_dllName, 'DTWAIN_GetDSMSearchOrderExA', 'PP', 'i');
my $DTWAIN_GetDSMSearchOrderExW = new Win32::API($dtwain_dllName, 'DTWAIN_GetDSMSearchOrderExW', 'PP', 'i');
my $DTWAIN_GetDTWAINHandle = new Win32::API($dtwain_dllName, 'DTWAIN_GetDTWAINHandle', '', 'P');
my $DTWAIN_GetDeviceEvent = new Win32::API($dtwain_dllName, 'DTWAIN_GetDeviceEvent', 'PP', 'I');
my $DTWAIN_GetDeviceEventEx = new Win32::API($dtwain_dllName, 'DTWAIN_GetDeviceEventEx', 'PPP', 'I');
my $DTWAIN_GetDeviceEventInfo = new Win32::API($dtwain_dllName, 'DTWAIN_GetDeviceEventInfo', 'PiP', 'I');
my $DTWAIN_GetDeviceNotifications = new Win32::API($dtwain_dllName, 'DTWAIN_GetDeviceNotifications', 'PP', 'I');
my $DTWAIN_GetDeviceTimeDate = new Win32::API($dtwain_dllName, 'DTWAIN_GetDeviceTimeDate', 'PP', 'I');
my $DTWAIN_GetDeviceTimeDateA = new Win32::API($dtwain_dllName, 'DTWAIN_GetDeviceTimeDateA', 'PP', 'I');
my $DTWAIN_GetDeviceTimeDateW = new Win32::API($dtwain_dllName, 'DTWAIN_GetDeviceTimeDateW', 'PP', 'I');
my $DTWAIN_GetDoubleFeedDetectLength = new Win32::API($dtwain_dllName, 'DTWAIN_GetDoubleFeedDetectLength', 'PPI', 'I');
my $DTWAIN_GetDoubleFeedDetectValues = new Win32::API($dtwain_dllName, 'DTWAIN_GetDoubleFeedDetectValues', 'PP', 'I');
my $DTWAIN_GetDuplexType = new Win32::API($dtwain_dllName, 'DTWAIN_GetDuplexType', 'PP', 'I');
my $DTWAIN_GetDuplexTypeEx = new Win32::API($dtwain_dllName, 'DTWAIN_GetDuplexTypeEx', 'P', 'i');
...
my $DTWAIN_GetExtImageInfo = new Win32::API($dtwain_dllName, 'DTWAIN_GetExtImageInfo', 'P', 'I');
my $DTWAIN_GetExtImageInfoData = new Win32::API($dtwain_dllName, 'DTWAIN_GetExtImageInfoData', 'PiP', 'I');
my $DTWAIN_GetExtImageInfoDataEx = new Win32::API($dtwain_dllName, 'DTWAIN_GetExtImageInfoDataEx', 'Pi', 'P');
my $DTWAIN_GetExtImageInfoItem = new Win32::API($dtwain_dllName, 'DTWAIN_GetExtImageInfoItem', 'PiPPP', 'I');
my $DTWAIN_GetExtImageInfoItemEx = new Win32::API($dtwain_dllName, 'DTWAIN_GetExtImageInfoItemEx', 'PiPPPP', 'I');
...
my $DTWAIN_GetFeederAlignment = new Win32::API($dtwain_dllName, 'DTWAIN_GetFeederAlignment', 'PP', 'I');
my $DTWAIN_GetFeederFuncs = new Win32::API($dtwain_dllName, 'DTWAIN_GetFeederFuncs', 'P', 'i');
my $DTWAIN_GetFeederOrder = new Win32::API($dtwain_dllName, 'DTWAIN_GetFeederOrder', 'PP', 'I');
my $DTWAIN_GetFeederWaitTime = new Win32::API($dtwain_dllName, 'DTWAIN_GetFeederWaitTime', 'P', 'i');
my $DTWAIN_GetFileCompressionType = new Win32::API($dtwain_dllName, 'DTWAIN_GetFileCompressionType', 'P', 'i');
my $DTWAIN_GetFileSavePageCount = new Win32::API($dtwain_dllName, 'DTWAIN_GetFileSavePageCount', 'P', 'i');
...
my $DTWAIN_GetHalftone = new Win32::API($dtwain_dllName, 'DTWAIN_GetHalftone', 'PPi', 'I');
my $DTWAIN_GetHalftoneA = new Win32::API($dtwain_dllName, 'DTWAIN_GetHalftoneA', 'PPi', 'I');
my $DTWAIN_GetHalftoneW = new Win32::API($dtwain_dllName, 'DTWAIN_GetHalftoneW', 'PPi', 'I');
my $DTWAIN_GetHighlight = new Win32::API($dtwain_dllName, 'DTWAIN_GetHighlight', 'PP', 'I');
my $DTWAIN_GetHighlightString = new Win32::API($dtwain_dllName, 'DTWAIN_GetHighlightString', 'PP', 'I');
my $DTWAIN_GetHighlightStringA = new Win32::API($dtwain_dllName, 'DTWAIN_GetHighlightStringA', 'PP', 'I');
my $DTWAIN_GetHighlightStringW = new Win32::API($dtwain_dllName, 'DTWAIN_GetHighlightStringW', 'PP', 'I');
my $DTWAIN_GetImageInfo = new Win32::API($dtwain_dllName, 'DTWAIN_GetImageInfo', 'PPPPPPPPPPP', 'I');
...
my $DTWAIN_GetJpegXRValues = new Win32::API($dtwain_dllName, 'DTWAIN_GetJpegXRValues', 'PPP', 'I');
my $DTWAIN_GetLanguage = new Win32::API($dtwain_dllName, 'DTWAIN_GetLanguage', '', 'i');
my $DTWAIN_GetLastCapEnumIndices = new Win32::API($dtwain_dllName, 'DTWAIN_GetLastCapEnumIndices', 'PPP', 'I');
my $DTWAIN_GetLastError = new Win32::API($dtwain_dllName, 'DTWAIN_GetLastError', '', 'i');
my $DTWAIN_GetLastTwainError = new Win32::API($dtwain_dllName, 'DTWAIN_GetLastTwainError', 'PP', 'I');
...
my $DTWAIN_GetLightPath = new Win32::API($dtwain_dllName, 'DTWAIN_GetLightPath', 'PP', 'I');
my $DTWAIN_GetLightPathEx = new Win32::API($dtwain_dllName, 'DTWAIN_GetLightPathEx', 'P', 'I');
my $DTWAIN_GetLightSource = new Win32::API($dtwain_dllName, 'DTWAIN_GetLightSource', 'PP', 'I');
my $DTWAIN_GetLightSources = new Win32::API($dtwain_dllName, 'DTWAIN_GetLightSources', 'PP', 'I');
my $DTWAIN_GetLightSourcesEx = new Win32::API($dtwain_dllName, 'DTWAIN_GetLightSourcesEx', 'P', 'P');
...
my $DTWAIN_GetMajorMinorVersion = new Win32::API($dtwain_dllName, 'DTWAIN_GetMajorMinorVersion', 'PP', 'I');
...
my $DTWAIN_GetNoiseFilter = new Win32::API($dtwain_dllName, 'DTWAIN_GetNoiseFilter', 'PP', 'I');
my $DTWAIN_GetNumAcquiredImages = new Win32::API($dtwain_dllName, 'DTWAIN_GetNumAcquiredImages', 'Pi', 'i');
my $DTWAIN_GetNumAcquisitions = new Win32::API($dtwain_dllName, 'DTWAIN_GetNumAcquisitions', 'P', 'i');
...
my $DTWAIN_GetOCRTextInfoFloat = new Win32::API($dtwain_dllName, 'DTWAIN_GetOCRTextInfoFloat', 'PiiP', 'I');
my $DTWAIN_GetOCRTextInfoFloatEx = new Win32::API($dtwain_dllName, 'DTWAIN_GetOCRTextInfoFloatEx', 'PiPi', 'I');
my $DTWAIN_GetOCRTextInfoHandle = new Win32::API($dtwain_dllName, 'DTWAIN_GetOCRTextInfoHandle', 'Pi', 'P');
my $DTWAIN_GetOCRTextInfoLong = new Win32::API($dtwain_dllName, 'DTWAIN_GetOCRTextInfoLong', 'PiiP', 'I');
my $DTWAIN_GetOCRTextInfoLongEx = new Win32::API($dtwain_dllName, 'DTWAIN_GetOCRTextInfoLongEx', 'PiPi', 'I');
...
my $DTWAIN_GetOrientation = new Win32::API($dtwain_dllName, 'DTWAIN_GetOrientation', 'PPI', 'I');
my $DTWAIN_GetOrientationEx = new Win32::API($dtwain_dllName, 'DTWAIN_GetOrientationEx', 'PI', 'i');
my $DTWAIN_GetOverscan = new Win32::API($dtwain_dllName, 'DTWAIN_GetOverscan', 'PPI', 'I');
...
my $DTWAIN_GetPaperSize = new Win32::API($dtwain_dllName, 'DTWAIN_GetPaperSize', 'PPI', 'I');
...
my $DTWAIN_GetPatchcodeMaxPriorities = new Win32::API($dtwain_dllName, 'DTWAIN_GetPatchcodeMaxPriorities', 'PPI', 'I');
my $DTWAIN_GetPatchcodeMaxRetries = new Win32::API($dtwain_dllName, 'DTWAIN_GetPatchcodeMaxRetries', 'PPI', 'I');
my $DTWAIN_GetPatchcodePriorities = new Win32::API($dtwain_dllName, 'DTWAIN_GetPatchcodePriorities', 'PP', 'I');
my $DTWAIN_GetPatchcodeSearchMode = new Win32::API($dtwain_dllName, 'DTWAIN_GetPatchcodeSearchMode', 'PPI', 'I');
my $DTWAIN_GetPatchcodeTimeOut = new Win32::API($dtwain_dllName, 'DTWAIN_GetPatchcodeTimeOut', 'PPI', 'I');
my $DTWAIN_GetPendingXferCount = new Win32::API($dtwain_dllName, 'DTWAIN_GetPendingXferCount', 'P', 'i');
my $DTWAIN_GetPixelFlavor = new Win32::API($dtwain_dllName, 'DTWAIN_GetPixelFlavor', 'PP', 'I');
my $DTWAIN_GetPixelType = new Win32::API($dtwain_dllName, 'DTWAIN_GetPixelType', 'PPPI', 'I');
my $DTWAIN_GetPrinter = new Win32::API($dtwain_dllName, 'DTWAIN_GetPrinter', 'PPI', 'I');
my $DTWAIN_GetPrinterEx = new Win32::API($dtwain_dllName, 'DTWAIN_GetPrinterEx', 'PI', 'i');
my $DTWAIN_GetPrinterStartNumber = new Win32::API($dtwain_dllName, 'DTWAIN_GetPrinterStartNumber', 'PP', 'I');
my $DTWAIN_GetPrinterStartNumberEx = new Win32::API($dtwain_dllName, 'DTWAIN_GetPrinterStartNumberEx', 'P', 'I');
my $DTWAIN_GetPrinterStringMode = new Win32::API($dtwain_dllName, 'DTWAIN_GetPrinterStringMode', 'PPI', 'I');
my $DTWAIN_GetPrinterStringModeEx = new Win32::API($dtwain_dllName, 'DTWAIN_GetPrinterStringModeEx', 'PI', 'i');
my $DTWAIN_GetPrinterStrings = new Win32::API($dtwain_dllName, 'DTWAIN_GetPrinterStrings', 'PP', 'I');
my $DTWAIN_GetPrinterStringsEx = new Win32::API($dtwain_dllName, 'DTWAIN_GetPrinterStringsEx', 'P', 'P');
my $DTWAIN_GetPrinterSuffixString = new Win32::API($dtwain_dllName, 'DTWAIN_GetPrinterSuffixString', 'PPi', 'I');
my $DTWAIN_GetPrinterSuffixStringA = new Win32::API($dtwain_dllName, 'DTWAIN_GetPrinterSuffixStringA', 'PPi', 'I');
my $DTWAIN_GetPrinterSuffixStringW = new Win32::API($dtwain_dllName, 'DTWAIN_GetPrinterSuffixStringW', 'PPi', 'I');
my $DTWAIN_GetRegisteredMsg = new Win32::API($dtwain_dllName, 'DTWAIN_GetRegisteredMsg', '', 'i');
my $DTWAIN_GetResolution = new Win32::API($dtwain_dllName, 'DTWAIN_GetResolution', 'PP', 'I');
my $DTWAIN_GetResolutionEx = new Win32::API($dtwain_dllName, 'DTWAIN_GetResolutionEx', 'P', 'D');
my $DTWAIN_GetResolutionString = new Win32::API($dtwain_dllName, 'DTWAIN_GetResolutionString', 'PP', 'I');
my $DTWAIN_GetResolutionStringA = new Win32::API($dtwain_dllName, 'DTWAIN_GetResolutionStringA', 'PP', 'I');
my $DTWAIN_GetResolutionStringW = new Win32::API($dtwain_dllName, 'DTWAIN_GetResolutionStringW', 'PP', 'I');
...
my $DTWAIN_GetRotation = new Win32::API($dtwain_dllName, 'DTWAIN_GetRotation', 'PP', 'I');
my $DTWAIN_GetRotationEx = new Win32::API($dtwain_dllName, 'DTWAIN_GetRotationEx', 'P', 'D');
my $DTWAIN_GetRotationString = new Win32::API($dtwain_dllName, 'DTWAIN_GetRotationString', 'PP', 'I');
my $DTWAIN_GetRotationStringA = new Win32::API($dtwain_dllName, 'DTWAIN_GetRotationStringA', 'PP', 'I');
my $DTWAIN_GetRotationStringW = new Win32::API($dtwain_dllName, 'DTWAIN_GetRotationStringW', 'PP', 'I');
my $DTWAIN_GetSaveFileName = new Win32::API($dtwain_dllName, 'DTWAIN_GetSaveFileName', 'PPi', 'i');
my $DTWAIN_GetSaveFileNameA = new Win32::API($dtwain_dllName, 'DTWAIN_GetSaveFileNameA', 'PPi', 'i');
my $DTWAIN_GetSaveFileNameW = new Win32::API($dtwain_dllName, 'DTWAIN_GetSaveFileNameW', 'PPi', 'i');
my $DTWAIN_GetSaveFileType = new Win32::API($dtwain_dllName, 'DTWAIN_GetSaveFileType', 'P', 'i');
...
my $DTWAIN_GetShadow = new Win32::API($dtwain_dllName, 'DTWAIN_GetShadow', 'PP', 'I');
my $DTWAIN_GetShadowString = new Win32::API($dtwain_dllName, 'DTWAIN_GetShadowString', 'PP', 'I');
my $DTWAIN_GetShadowStringA = new Win32::API($dtwain_dllName, 'DTWAIN_GetShadowStringA', 'PP', 'I');
my $DTWAIN_GetShadowStringW = new Win32::API($dtwain_dllName, 'DTWAIN_GetShadowStringW', 'PP', 'I');
...
my $DTWAIN_GetSourceAcquisitions = new Win32::API($dtwain_dllName, 'DTWAIN_GetSourceAcquisitions', 'P', 'P');
...
my $DTWAIN_GetSourceID = new Win32::API($dtwain_dllName, 'DTWAIN_GetSourceID', 'P', 'P');
my $DTWAIN_GetSourceIDEx = new Win32::API($dtwain_dllName, 'DTWAIN_GetSourceIDEx', 'PP', 'P');
my $DTWAIN_GetSourceManufacturer = new Win32::API($dtwain_dllName, 'DTWAIN_GetSourceManufacturer', 'PPi', 'i');
my $DTWAIN_GetSourceManufacturerA = new Win32::API($dtwain_dllName, 'DTWAIN_GetSourceManufacturerA', 'PPi', 'i');
my $DTWAIN_GetSourceManufacturerW = new Win32::API($dtwain_dllName, 'DTWAIN_GetSourceManufacturerW', 'PPi', 'i');
my $DTWAIN_GetSourceProductFamily = new Win32::API($dtwain_dllName, 'DTWAIN_GetSourceProductFamily', 'PPi', 'i');
my $DTWAIN_GetSourceProductFamilyA = new Win32::API($dtwain_dllName, 'DTWAIN_GetSourceProductFamilyA', 'PPi', 'i');
my $DTWAIN_GetSourceProductFamilyW = new Win32::API($dtwain_dllName, 'DTWAIN_GetSourceProductFamilyW', 'PPi', 'i');
my $DTWAIN_GetSourceProductName = new Win32::API($dtwain_dllName, 'DTWAIN_GetSourceProductName', 'PPi', 'i');
my $DTWAIN_GetSourceProductNameA = new Win32::API($dtwain_dllName, 'DTWAIN_GetSourceProductNameA', 'PPi', 'i');
my $DTWAIN_GetSourceProductNameW = new Win32::API($dtwain_dllName, 'DTWAIN_GetSourceProductNameW', 'PPi', 'i');
my $DTWAIN_GetSourceUnit = new Win32::API($dtwain_dllName, 'DTWAIN_GetSourceUnit', 'PP', 'I');
my $DTWAIN_GetSourceUnitEx = new Win32::API($dtwain_dllName, 'DTWAIN_GetSourceUnitEx', 'P', 'i');
my $DTWAIN_GetSourceVersionInfo = new Win32::API($dtwain_dllName, 'DTWAIN_GetSourceVersionInfo', 'PPi', 'i');
my $DTWAIN_GetSourceVersionInfoA = new Win32::API($dtwain_dllName, 'DTWAIN_GetSourceVersionInfoA', 'PPi', 'i');
my $DTWAIN_GetSourceVersionInfoW = new Win32::API($dtwain_dllName, 'DTWAIN_GetSourceVersionInfoW', 'PPi', 'i');
my $DTWAIN_GetSourceVersionNumber = new Win32::API($dtwain_dllName, 'DTWAIN_GetSourceVersionNumber', 'PPP', 'I');
...
my $DTWAIN_GetThreshold = new Win32::API($dtwain_dllName, 'DTWAIN_GetThreshold', 'PP', 'I');
my $DTWAIN_GetThresholdString = new Win32::API($dtwain_dllName, 'DTWAIN_GetThresholdString', 'PP', 'I');
my $DTWAIN_GetThresholdStringA = new Win32::API($dtwain_dllName, 'DTWAIN_GetThresholdStringA', 'PP', 'I');
my $DTWAIN_GetThresholdStringW = new Win32::API($dtwain_dllName, 'DTWAIN_GetThresholdStringW', 'PP', 'I');
my $DTWAIN_GetTimeDate = new Win32::API($dtwain_dllName, 'DTWAIN_GetTimeDate', 'PP', 'I');
my $DTWAIN_GetTimeDateA = new Win32::API($dtwain_dllName, 'DTWAIN_GetTimeDateA', 'PP', 'I');
my $DTWAIN_GetTimeDateW = new Win32::API($dtwain_dllName, 'DTWAIN_GetTimeDateW', 'PP', 'I');
...
my $DTWAIN_GetTwainHwnd = new Win32::API($dtwain_dllName, 'DTWAIN_GetTwainHwnd', '', 'P');
...
my $DTWAIN_GetTwainNameFromConstantEx = new Win32::API($dtwain_dllName, 'DTWAIN_GetTwainNameFromConstantEx', 'iiPi', 'i');
my $DTWAIN_GetTwainNameFromConstantExA = new Win32::API($dtwain_dllName, 'DTWAIN_GetTwainNameFromConstantExA', 'iiPi', 'i');
my $DTWAIN_GetTwainNameFromConstantExW = new Win32::API($dtwain_dllName, 'DTWAIN_GetTwainNameFromConstantExW', 'iiPi', 'i');
...
my $DTWAIN_GetXResolution = new Win32::API($dtwain_dllName, 'DTWAIN_GetXResolution', 'PP', 'I');
my $DTWAIN_GetXResolutionString = new Win32::API($dtwain_dllName, 'DTWAIN_GetXResolutionString', 'PP', 'I');
my $DTWAIN_GetXResolutionStringA = new Win32::API($dtwain_dllName, 'DTWAIN_GetXResolutionStringA', 'PP', 'I');
my $DTWAIN_GetXResolutionStringW = new Win32::API($dtwain_dllName, 'DTWAIN_GetXResolutionStringW', 'PP', 'I');
my $DTWAIN_GetYResolution = new Win32::API($dtwain_dllName, 'DTWAIN_GetYResolution', 'PP', 'I');
my $DTWAIN_GetYResolutionString = new Win32::API($dtwain_dllName, 'DTWAIN_GetYResolutionString', 'PP', 'I');
my $DTWAIN_GetYResolutionStringA = new Win32::API($dtwain_dllName, 'DTWAIN_GetYResolutionStringA', 'PP', 'I');
my $DTWAIN_GetYResolutionStringW = new Win32::API($dtwain_dllName, 'DTWAIN_GetYResolutionStringW', 'PP', 'I');
my $DTWAIN_InitExtImageInfo = new Win32::API($dtwain_dllName, 'DTWAIN_InitExtImageInfo', 'P', 'I');
...
my $DTWAIN_IsAudioXferSupported = new Win32::API($dtwain_dllName, 'DTWAIN_IsAudioXferSupported', 'Pi', 'I');
my $DTWAIN_IsAutoBorderDetectEnabled = new Win32::API($dtwain_dllName, 'DTWAIN_IsAutoBorderDetectEnabled', 'P', 'I');
my $DTWAIN_IsAutoBorderDetectSupported = new Win32::API($dtwain_dllName, 'DTWAIN_IsAutoBorderDetectSupported', 'P', 'I');
my $DTWAIN_IsAutoBrightEnabled = new Win32::API($dtwain_dllName, 'DTWAIN_IsAutoBrightEnabled', 'P', 'I');
my $DTWAIN_IsAutoBrightSupported = new Win32::API($dtwain_dllName, 'DTWAIN_IsAutoBrightSupported', 'P', 'I');
my $DTWAIN_IsAutoDeskewEnabled = new Win32::API($dtwain_dllName, 'DTWAIN_IsAutoDeskewEnabled', 'P', 'I');
my $DTWAIN_IsAutoDeskewSupported = new Win32::API($dtwain_dllName, 'DTWAIN_IsAutoDeskewSupported', 'P', 'I');
my $DTWAIN_IsAutoFeedEnabled = new Win32::API($dtwain_dllName, 'DTWAIN_IsAutoFeedEnabled', 'P', 'I');
my $DTWAIN_IsAutoFeedSupported = new Win32::API($dtwain_dllName, 'DTWAIN_IsAutoFeedSupported', 'P', 'I');
my $DTWAIN_IsAutoRotateEnabled = new Win32::API($dtwain_dllName, 'DTWAIN_IsAutoRotateEnabled', 'P', 'I');
my $DTWAIN_IsAutoRotateSupported = new Win32::API($dtwain_dllName, 'DTWAIN_IsAutoRotateSupported', 'P', 'I');
my $DTWAIN_IsAutoScanEnabled = new Win32::API($dtwain_dllName, 'DTWAIN_IsAutoScanEnabled', 'P', 'I');
my $DTWAIN_IsAutomaticSenseMediumEnabled = new Win32::API($dtwain_dllName, 'DTWAIN_IsAutomaticSenseMediumEnabled', 'P', 'I');
my $DTWAIN_IsAutomaticSenseMediumSupported = new Win32::API($dtwain_dllName, 'DTWAIN_IsAutomaticSenseMediumSupported', 'P', 'I');
my $DTWAIN_IsBarcodeCapsSupported = new Win32::API($dtwain_dllName, 'DTWAIN_IsBarcodeCapsSupported', 'P', 'I');
my $DTWAIN_IsBarcodeDetectionEnabled = new Win32::API($dtwain_dllName, 'DTWAIN_IsBarcodeDetectionEnabled', 'P', 'I');
my $DTWAIN_IsBarcodeSupported = new Win32::API($dtwain_dllName, 'DTWAIN_IsBarcodeSupported', 'Pi', 'I');
my $DTWAIN_IsBlankPageDetectionOn = new Win32::API($dtwain_dllName, 'DTWAIN_IsBlankPageDetectionOn', 'P', 'I');
my $DTWAIN_IsBufferedTileModeOn = new Win32::API($dtwain_dllName, 'DTWAIN_IsBufferedTileModeOn', 'P', 'I');
my $DTWAIN_IsBufferedTileModeSupported = new Win32::API($dtwain_dllName, 'DTWAIN_IsBufferedTileModeSupported', 'P', 'I');
my $DTWAIN_IsCapSupported = new Win32::API($dtwain_dllName, 'DTWAIN_IsCapSupported', 'Pi', 'I');
my $DTWAIN_IsCompressionSupported = new Win32::API($dtwain_dllName, 'DTWAIN_IsCompressionSupported', 'Pi', 'I');
my $DTWAIN_IsCustomDSDataSupported = new Win32::API($dtwain_dllName, 'DTWAIN_IsCustomDSDataSupported', 'P', 'I');
...
my $DTWAIN_IsDeviceEventSupported = new Win32::API($dtwain_dllName, 'DTWAIN_IsDeviceEventSupported', 'P', 'I');
my $DTWAIN_IsDeviceOnLine = new Win32::API($dtwain_dllName, 'DTWAIN_IsDeviceOnLine', 'P', 'I');
my $DTWAIN_IsDoubleFeedDetectLengthSupported = new Win32::API($dtwain_dllName, 'DTWAIN_IsDoubleFeedDetectLengthSupported', 'PD', 'I');
my $DTWAIN_IsDoubleFeedDetectSupported = new Win32::API($dtwain_dllName, 'DTWAIN_IsDoubleFeedDetectSupported', 'Pi', 'I');
my $DTWAIN_IsDuplexEnabled = new Win32::API($dtwain_dllName, 'DTWAIN_IsDuplexEnabled', 'P', 'I');
my $DTWAIN_IsDuplexSupported = new Win32::API($dtwain_dllName, 'DTWAIN_IsDuplexSupported', 'P', 'I');
my $DTWAIN_IsExtImageInfoSupported = new Win32::API($dtwain_dllName, 'DTWAIN_IsExtImageInfoSupported', 'P', 'I');
my $DTWAIN_IsFeederEnabled = new Win32::API($dtwain_dllName, 'DTWAIN_IsFeederEnabled', 'P', 'I');
my $DTWAIN_IsFeederLoaded = new Win32::API($dtwain_dllName, 'DTWAIN_IsFeederLoaded', 'P', 'I');
my $DTWAIN_IsFeederSensitive = new Win32::API($dtwain_dllName, 'DTWAIN_IsFeederSensitive', 'P', 'I');
my $DTWAIN_IsFeederSupported = new Win32::API($dtwain_dllName, 'DTWAIN_IsFeederSupported', 'P', 'I');
my $DTWAIN_IsFileSystemSupported = new Win32::API($dtwain_dllName, 'DTWAIN_IsFileSystemSupported', 'P', 'I');
my $DTWAIN_IsFileXferSupported = new Win32::API($dtwain_dllName, 'DTWAIN_IsFileXferSupported', 'Pi', 'I');
my $DTWAIN_IsGetMessageLoopDetectionOn = new Win32::API($dtwain_dllName, 'DTWAIN_IsGetMessageLoopDetectionOn', '', 'I');
my $DTWAIN_IsGetMessageLoopEnabled = new Win32::API($dtwain_dllName, 'DTWAIN_IsGetMessageLoopEnabled', 'P', 'I');
my $DTWAIN_IsIAFieldALastPageSupported = new Win32::API($dtwain_dllName, 'DTWAIN_IsIAFieldALastPageSupported', 'P', 'I');
my $DTWAIN_IsIAFieldALevelSupported = new Win32::API($dtwain_dllName, 'DTWAIN_IsIAFieldALevelSupported', 'P', 'I');
my $DTWAIN_IsIAFieldAPrintFormatSupported = new Win32::API($dtwain_dllName, 'DTWAIN_IsIAFieldAPrintFormatSupported', 'P', 'I');
my $DTWAIN_IsIAFieldAValueSupported = new Win32::API($dtwain_dllName, 'DTWAIN_IsIAFieldAValueSupported', 'P', 'I');
my $DTWAIN_IsIAFieldBLastPageSupported = new Win32::API($dtwain_dllName, 'DTWAIN_IsIAFieldBLastPageSupported', 'P', 'I');
my $DTWAIN_IsIAFieldBLevelSupported = new Win32::API($dtwain_dllName, 'DTWAIN_IsIAFieldBLevelSupported', 'P', 'I');
my $DTWAIN_IsIAFieldBPrintFormatSupported = new Win32::API($dtwain_dllName, 'DTWAIN_IsIAFieldBPrintFormatSupported', 'P', 'I');
my $DTWAIN_IsIAFieldBValueSupported = new Win32::API($dtwain_dllName, 'DTWAIN_IsIAFieldBValueSupported', 'P', 'I');
my $DTWAIN_IsIAFieldCLastPageSupported = new Win32::API($dtwain_dllName, 'DTWAIN_IsIAFieldCLastPageSupported', 'P', 'I');
my $DTWAIN_IsIAFieldCLevelSupported = new Win32::API($dtwain_dllName, 'DTWAIN_IsIAFieldCLevelSupported', 'P', 'I');
my $DTWAIN_IsIAFieldCPrintFormatSupported = new Win32::API($dtwain_dllName, 'DTWAIN_IsIAFieldCPrintFormatSupported', 'P', 'I');
my $DTWAIN_IsIAFieldCValueSupported = new Win32::API($dtwain_dllName, 'DTWAIN_IsIAFieldCValueSupported', 'P', 'I');
my $DTWAIN_IsIAFieldDLastPageSupported = new Win32::API($dtwain_dllName, 'DTWAIN_IsIAFieldDLastPageSupported', 'P', 'I');
my $DTWAIN_IsIAFieldDLevelSupported = new Win32::API($dtwain_dllName, 'DTWAIN_IsIAFieldDLevelSupported', 'P', 'I');
my $DTWAIN_IsIAFieldDPrintFormatSupported = new Win32::API($dtwain_dllName, 'DTWAIN_IsIAFieldDPrintFormatSupported', 'P', 'I');
my $DTWAIN_IsIAFieldDValueSupported = new Win32::API($dtwain_dllName, 'DTWAIN_IsIAFieldDValueSupported', 'P', 'I');
my $DTWAIN_IsIAFieldELastPageSupported = new Win32::API($dtwain_dllName, 'DTWAIN_IsIAFieldELastPageSupported', 'P', 'I');
my $DTWAIN_IsIAFieldELevelSupported = new Win32::API($dtwain_dllName, 'DTWAIN_IsIAFieldELevelSupported', 'P', 'I');
my $DTWAIN_IsIAFieldEPrintFormatSupported = new Win32::API($dtwain_dllName, 'DTWAIN_IsIAFieldEPrintFormatSupported', 'P', 'I');
my $DTWAIN_IsIAFieldEValueSupported = new Win32::API($dtwain_dllName, 'DTWAIN_IsIAFieldEValueSupported', 'P', 'I');
my $DTWAIN_IsImageAddressingSupported = new Win32::API($dtwain_dllName, 'DTWAIN_IsImageAddressingSupported', 'P', 'I');
my $DTWAIN_IsIndicatorEnabled = new Win32::API($dtwain_dllName, 'DTWAIN_IsIndicatorEnabled', 'P', 'I');
my $DTWAIN_IsIndicatorSupported = new Win32::API($dtwain_dllName, 'DTWAIN_IsIndicatorSupported', 'P', 'I');
my $DTWAIN_IsInitialized = new Win32::API($dtwain_dllName, 'DTWAIN_IsInitialized', '', 'I');
my $DTWAIN_IsJobControlSupported = new Win32::API($dtwain_dllName, 'DTWAIN_IsJobControlSupported', 'Pi', 'I');
my $DTWAIN_IsLampEnabled = new Win32::API($dtwain_dllName, 'DTWAIN_IsLampEnabled', 'P', 'I');
my $DTWAIN_IsLampSupported = new Win32::API($dtwain_dllName, 'DTWAIN_IsLampSupported', 'P', 'I');
my $DTWAIN_IsLightPathSupported = new Win32::API($dtwain_dllName, 'DTWAIN_IsLightPathSupported', 'P', 'I');
my $DTWAIN_IsLightSourceSupported = new Win32::API($dtwain_dllName, 'DTWAIN_IsLightSourceSupported', 'P', 'I');
my $DTWAIN_IsMaxBuffersSupported = new Win32::API($dtwain_dllName, 'DTWAIN_IsMaxBuffersSupported', 'Pi', 'I');
my $DTWAIN_IsMemFileXferSupported = new Win32::API($dtwain_dllName, 'DTWAIN_IsMemFileXferSupported', 'P', 'I');
...
my $DTWAIN_IsOrientationSupported = new Win32::API($dtwain_dllName, 'DTWAIN_IsOrientationSupported', 'Pi', 'I');
my $DTWAIN_IsOverscanSupported = new Win32::API($dtwain_dllName, 'DTWAIN_IsOverscanSupported', 'Pi', 'I');
my $DTWAIN_IsPaperDetectable = new Win32::API($dtwain_dllName, 'DTWAIN_IsPaperDetectable', 'P', 'I');
my $DTWAIN_IsPaperSizeSupported = new Win32::API($dtwain_dllName, 'DTWAIN_IsPaperSizeSupported', 'Pi', 'I');
my $DTWAIN_IsPatchcodeCapsSupported = new Win32::API($dtwain_dllName, 'DTWAIN_IsPatchcodeCapsSupported', 'P', 'I');
my $DTWAIN_IsPatchcodeDetectionEnabled = new Win32::API($dtwain_dllName, 'DTWAIN_IsPatchcodeDetectionEnabled', 'P', 'I');
my $DTWAIN_IsPatchcodeSupported = new Win32::API($dtwain_dllName, 'DTWAIN_IsPatchcodeSupported', 'Pi', 'I');
my $DTWAIN_IsPeekMessageLoopEnabled = new Win32::API($dtwain_dllName, 'DTWAIN_IsPeekMessageLoopEnabled', 'P', 'I');
my $DTWAIN_IsPixelTypeSupported = new Win32::API($dtwain_dllName, 'DTWAIN_IsPixelTypeSupported', 'Pi', 'I');
my $DTWAIN_IsPrinterEnabled = new Win32::API($dtwain_dllName, 'DTWAIN_IsPrinterEnabled', 'Pi', 'I');
my $DTWAIN_IsPrinterSupported = new Win32::API($dtwain_dllName, 'DTWAIN_IsPrinterSupported', 'P', 'I');
my $DTWAIN_IsRotationSupported = new Win32::API($dtwain_dllName, 'DTWAIN_IsRotationSupported', 'P', 'I');
my $DTWAIN_IsSessionEnabled = new Win32::API($dtwain_dllName, 'DTWAIN_IsSessionEnabled', '', 'I');
my $DTWAIN_IsSkipImageInfoError = new Win32::API($dtwain_dllName, 'DTWAIN_IsSkipImageInfoError', 'P', 'I');
my $DTWAIN_IsSourceAcquiring = new Win32::API($dtwain_dllName, 'DTWAIN_IsSourceAcquiring', 'P', 'I');
my $DTWAIN_IsSourceAcquiringEx = new Win32::API($dtwain_dllName, 'DTWAIN_IsSourceAcquiringEx', 'PI', 'I');
my $DTWAIN_IsSourceInUIOnlyMode = new Win32::API($dtwain_dllName, 'DTWAIN_IsSourceInUIOnlyMode', 'P', 'I');
my $DTWAIN_IsSourceOpen = new Win32::API($dtwain_dllName, 'DTWAIN_IsSourceOpen', 'P', 'I');
my $DTWAIN_IsSourceSelected = new Win32::API($dtwain_dllName, 'DTWAIN_IsSourceSelected', 'P', 'I');
my $DTWAIN_IsSourceValid = new Win32::API($dtwain_dllName, 'DTWAIN_IsSourceValid', 'P', 'I');
my $DTWAIN_IsThumbnailEnabled = new Win32::API($dtwain_dllName, 'DTWAIN_IsThumbnailEnabled', 'P', 'I');
my $DTWAIN_IsThumbnailSupported = new Win32::API($dtwain_dllName, 'DTWAIN_IsThumbnailSupported', 'P', 'I');
...
my $DTWAIN_IsUIControllable = new Win32::API($dtwain_dllName, 'DTWAIN_IsUIControllable', 'P', 'I');
my $DTWAIN_IsUIEnabled = new Win32::API($dtwain_dllName, 'DTWAIN_IsUIEnabled', 'P', 'I');
my $DTWAIN_IsUIOnlySupported = new Win32::API($dtwain_dllName, 'DTWAIN_IsUIOnlySupported', 'P', 'I');
...
my $DTWAIN_OpenSource = new Win32::API($dtwain_dllName, 'DTWAIN_OpenSource', 'P', 'I');
...
my $DTWAIN_RangeCreateFromCap = new Win32::API($dtwain_dllName, 'DTWAIN_RangeCreateFromCap', 'Pi', 'P');
...
my $DTWAIN_RangeExpandEx = new Win32::API($dtwain_dllName, 'DTWAIN_RangeExpandEx', 'P', 'P');
...
my $DTWAIN_RangeGetNearestValueFloat = new Win32::API($dtwain_dllName, 'DTWAIN_RangeGetNearestValueFloat', 'PDPi', 'I');
my $DTWAIN_RangeGetNearestValueFloatString = new Win32::API($dtwain_dllName, 'DTWAIN_RangeGetNearestValueFloatString', 'PPPi', 'I');
my $DTWAIN_RangeGetNearestValueFloatStringA = new Win32::API($dtwain_dllName, 'DTWAIN_RangeGetNearestValueFloatStringA', 'PPPi', 'I');
my $DTWAIN_RangeGetNearestValueFloatStringW = new Win32::API($dtwain_dllName, 'DTWAIN_RangeGetNearestValueFloatStringW', 'PPPi', 'I');
my $DTWAIN_RangeGetNearestValueLong = new Win32::API($dtwain_dllName, 'DTWAIN_RangeGetNearestValueLong', 'PiPi', 'I');
...
my $DTWAIN_RemovePDFTextElement = new Win32::API($dtwain_dllName, 'DTWAIN_RemovePDFTextElement', 'PP', 'I');
my $DTWAIN_ResetPDFTextElement = new Win32::API($dtwain_dllName, 'DTWAIN_ResetPDFTextElement', 'P', 'I');
my $DTWAIN_RewindPage = new Win32::API($dtwain_dllName, 'DTWAIN_RewindPage', 'P', 'I');
my $DTWAIN_RotateImage = new Win32::API($dtwain_dllName, 'DTWAIN_RotateImage', 'PD', 'P');
my $DTWAIN_RotateImageString = new Win32::API($dtwain_dllName, 'DTWAIN_RotateImageString', 'PP', 'P');
my $DTWAIN_RotateImageStringA = new Win32::API($dtwain_dllName, 'DTWAIN_RotateImageStringA', 'PP', 'P');
my $DTWAIN_RotateImageStringW = new Win32::API($dtwain_dllName, 'DTWAIN_RotateImageStringW', 'PP', 'P');
my $DTWAIN_SelectDefaultOCREngine = new Win32::API($dtwain_dllName, 'DTWAIN_SelectDefaultOCREngine', '', 'P');
my $DTWAIN_SelectDefaultSource = new Win32::API($dtwain_dllName, 'DTWAIN_SelectDefaultSource', '', 'P');
my $DTWAIN_SelectDefaultSourceWithOpen = new Win32::API($dtwain_dllName, 'DTWAIN_SelectDefaultSourceWithOpen', 'I', 'P');
my $DTWAIN_SelectOCREngine = new Win32::API($dtwain_dllName, 'DTWAIN_SelectOCREngine', '', 'P');
my $DTWAIN_SelectOCREngine2 = new Win32::API($dtwain_dllName, 'DTWAIN_SelectOCREngine2', 'PPiii', 'P');
my $DTWAIN_SelectOCREngine2A = new Win32::API($dtwain_dllName, 'DTWAIN_SelectOCREngine2A', 'PPiii', 'P');
my $DTWAIN_SelectOCREngine2Ex = new Win32::API($dtwain_dllName, 'DTWAIN_SelectOCREngine2Ex', 'PPiiPPPi', 'P');
my $DTWAIN_SelectOCREngine2ExA = new Win32::API($dtwain_dllName, 'DTWAIN_SelectOCREngine2ExA', 'PPiiPPPi', 'P');
my $DTWAIN_SelectOCREngine2ExW = new Win32::API($dtwain_dllName, 'DTWAIN_SelectOCREngine2ExW', 'PPiiPPPi', 'P');
my $DTWAIN_SelectOCREngine2W = new Win32::API($dtwain_dllName, 'DTWAIN_SelectOCREngine2W', 'PPiii', 'P');
...
my $DTWAIN_SelectSource = new Win32::API($dtwain_dllName, 'DTWAIN_SelectSource', '', 'P');
my $DTWAIN_SelectSource2 = new Win32::API($dtwain_dllName, 'DTWAIN_SelectSource2', 'PPiii', 'P');
my $DTWAIN_SelectSource2A = new Win32::API($dtwain_dllName, 'DTWAIN_SelectSource2A', 'PPiii', 'P');
my $DTWAIN_SelectSource2Ex = new Win32::API($dtwain_dllName, 'DTWAIN_SelectSource2Ex', 'PPiiPPPi', 'P');
my $DTWAIN_SelectSource2ExA = new Win32::API($dtwain_dllName, 'DTWAIN_SelectSource2ExA', 'PPiiPPPi', 'P');
my $DTWAIN_SelectSource2ExW = new Win32::API($dtwain_dllName, 'DTWAIN_SelectSource2ExW', 'PPiiPPPi', 'P');
my $DTWAIN_SelectSource2W = new Win32::API($dtwain_dllName, 'DTWAIN_SelectSource2W', 'PPiii', 'P');
my $DTWAIN_SelectSourceByName = new Win32::API($dtwain_dllName, 'DTWAIN_SelectSourceByName', 'P', 'P');
my $DTWAIN_SelectSourceByNameA = new Win32::API($dtwain_dllName, 'DTWAIN_SelectSourceByNameA', 'P', 'P');
my $DTWAIN_SelectSourceByNameW = new Win32::API($dtwain_dllName, 'DTWAIN_SelectSourceByNameW', 'P', 'P');
my $DTWAIN_SelectSourceByNameWithOpen = new Win32::API($dtwain_dllName, 'DTWAIN_SelectSourceByNameWithOpen', 'PI', 'P');
my $DTWAIN_SelectSourceByNameWithOpenA = new Win32::API($dtwain_dllName, 'DTWAIN_SelectSourceByNameWithOpenA', 'PI', 'P');
my $DTWAIN_SelectSourceByNameWithOpenW = new Win32::API($dtwain_dllName, 'DTWAIN_SelectSourceByNameWithOpenW', 'PI', 'P');
my $DTWAIN_SelectSourceWithOpen = new Win32::API($dtwain_dllName, 'DTWAIN_SelectSourceWithOpen', 'I', 'P');
my $DTWAIN_SetAcquireArea = new Win32::API($dtwain_dllName, 'DTWAIN_SetAcquireArea', 'PiPP', 'I');
my $DTWAIN_SetAcquireArea2 = new Win32::API($dtwain_dllName, 'DTWAIN_SetAcquireArea2', 'PDDDDii', 'I');
my $DTWAIN_SetAcquireArea2String = new Win32::API($dtwain_dllName, 'DTWAIN_SetAcquireArea2String', 'PPPPPii', 'I');
my $DTWAIN_SetAcquireArea2StringA = new Win32::API($dtwain_dllName, 'DTWAIN_SetAcquireArea2StringA', 'PPPPPii', 'I');
my $DTWAIN_SetAcquireArea2StringW = new Win32::API($dtwain_dllName, 'DTWAIN_SetAcquireArea2StringW', 'PPPPPii', 'I');
my $DTWAIN_SetAcquireImageNegative = new Win32::API($dtwain_dllName, 'DTWAIN_SetAcquireImageNegative', 'PI', 'I');
my $DTWAIN_SetAcquireImageScale = new Win32::API($dtwain_dllName, 'DTWAIN_SetAcquireImageScale', 'PDD', 'I');
my $DTWAIN_SetAcquireImageScaleString = new Win32::API($dtwain_dllName, 'DTWAIN_SetAcquireImageScaleString', 'PPP', 'I');
my $DTWAIN_SetAcquireImageScaleStringA = new Win32::API($dtwain_dllName, 'DTWAIN_SetAcquireImageScaleStringA', 'PPP', 'I');
my $DTWAIN_SetAcquireImageScaleStringW = new Win32::API($dtwain_dllName, 'DTWAIN_SetAcquireImageScaleStringW', 'PPP', 'I');
my $DTWAIN_SetAcquireStripBuffer = new Win32::API($dtwain_dllName, 'DTWAIN_SetAcquireStripBuffer', 'PP', 'I');
my $DTWAIN_SetAcquireStripSize = new Win32::API($dtwain_dllName, 'DTWAIN_SetAcquireStripSize', 'PI', 'I');
my $DTWAIN_SetAlarmVolume = new Win32::API($dtwain_dllName, 'DTWAIN_SetAlarmVolume', 'Pi', 'I');
my $DTWAIN_SetAlarms = new Win32::API($dtwain_dllName, 'DTWAIN_SetAlarms', 'PP', 'I');
my $DTWAIN_SetAllCapsToDefault = new Win32::API($dtwain_dllName, 'DTWAIN_SetAllCapsToDefault', 'P', 'I');
...
my $DTWAIN_SetAuthor = new Win32::API($dtwain_dllName, 'DTWAIN_SetAuthor', 'PP', 'I');
my $DTWAIN_SetAuthorA = new Win32::API($dtwain_dllName, 'DTWAIN_SetAuthorA', 'PP', 'I');
my $DTWAIN_SetAuthorW = new Win32::API($dtwain_dllName, 'DTWAIN_SetAuthorW', 'PP', 'I');
my $DTWAIN_SetAvailablePrinters = new Win32::API($dtwain_dllName, 'DTWAIN_SetAvailablePrinters', 'Pi', 'I');
my $DTWAIN_SetAvailablePrintersArray = new Win32::API($dtwain_dllName, 'DTWAIN_SetAvailablePrintersArray', 'PP', 'I');
my $DTWAIN_SetBarcodeMaxPriorities = new Win32::API($dtwain_dllName, 'DTWAIN_SetBarcodeMaxPriorities', 'PI', 'I');
my $DTWAIN_SetBarcodeMaxRetries = new Win32::API($dtwain_dllName, 'DTWAIN_SetBarcodeMaxRetries', 'PI', 'I');
my $DTWAIN_SetBarcodePriorities = new Win32::API($dtwain_dllName, 'DTWAIN_SetBarcodePriorities', 'PP', 'I');
my $DTWAIN_SetBarcodeSearchMode = new Win32::API($dtwain_dllName, 'DTWAIN_SetBarcodeSearchMode', 'Pi', 'I');
my $DTWAIN_SetBarcodeTimeOut = new Win32::API($dtwain_dllName, 'DTWAIN_SetBarcodeTimeOut', 'PI', 'I');
my $DTWAIN_SetBitDepth = new Win32::API($dtwain_dllName, 'DTWAIN_SetBitDepth', 'PiI', 'I');
my $DTWAIN_SetBlankPageDetection = new Win32::API($dtwain_dllName, 'DTWAIN_SetBlankPageDetection', 'PDiI', 'I');
my $DTWAIN_SetBlankPageDetectionEx = new Win32::API($dtwain_dllName, 'DTWAIN_SetBlankPageDetectionEx', 'PDiiI', 'I');
my $DTWAIN_SetBlankPageDetectionExString = new Win32::API($dtwain_dllName, 'DTWAIN_SetBlankPageDetectionExString', 'PPiiI', 'I');
my $DTWAIN_SetBlankPageDetectionExStringA = new Win32::API($dtwain_dllName, 'DTWAIN_SetBlankPageDetectionExStringA', 'PPiiI', 'I');
my $DTWAIN_SetBlankPageDetectionExStringW = new Win32::API($dtwain_dllName, 'DTWAIN_SetBlankPageDetectionExStringW', 'PPiiI', 'I');
my $DTWAIN_SetBlankPageDetectionString = new Win32::API($dtwain_dllName, 'DTWAIN_SetBlankPageDetectionString', 'PPiI', 'I');
my $DTWAIN_SetBlankPageDetectionStringA = new Win32::API($dtwain_dllName, 'DTWAIN_SetBlankPageDetectionStringA', 'PPiI', 'I');
my $DTWAIN_SetBlankPageDetectionStringW = new Win32::API($dtwain_dllName, 'DTWAIN_SetBlankPageDetectionStringW', 'PPiI', 'I');
my $DTWAIN_SetBrightness = new Win32::API($dtwain_dllName, 'DTWAIN_SetBrightness', 'PD', 'I');
my $DTWAIN_SetBrightnessString = new Win32::API($dtwain_dllName, 'DTWAIN_SetBrightnessString', 'PP', 'I');
my $DTWAIN_SetBrightnessStringA = new Win32::API($dtwain_dllName, 'DTWAIN_SetBrightnessStringA', 'PP', 'I');
my $DTWAIN_SetBrightnessStringW = new Win32::API($dtwain_dllName, 'DTWAIN_SetBrightnessStringW', 'PP', 'I');
my $DTWAIN_SetBufferedTileMode = new Win32::API($dtwain_dllName, 'DTWAIN_SetBufferedTileMode', 'PI', 'I');
...
my $DTWAIN_SetCamera = new Win32::API($dtwain_dllName, 'DTWAIN_SetCamera', 'PP', 'I');
my $DTWAIN_SetCameraA = new Win32::API($dtwain_dllName, 'DTWAIN_SetCameraA', 'PP', 'I');
my $DTWAIN_SetCameraW = new Win32::API($dtwain_dllName, 'DTWAIN_SetCameraW', 'PP', 'I');
my $DTWAIN_SetCapValues = new Win32::API($dtwain_dllName, 'DTWAIN_SetCapValues', 'PiiP', 'I');
my $DTWAIN_SetCapValuesEx = new Win32::API($dtwain_dllName, 'DTWAIN_SetCapValuesEx', 'PiiiP', 'I');
my $DTWAIN_SetCapValuesEx2 = new Win32::API($dtwain_dllName, 'DTWAIN_SetCapValuesEx2', 'PiiiiP', 'I');
my $DTWAIN_SetCaption = new Win32::API($dtwain_dllName, 'DTWAIN_SetCaption', 'PP', 'I');
my $DTWAIN_SetCaptionA = new Win32::API($dtwain_dllName, 'DTWAIN_SetCaptionA', 'PP', 'I');
my $DTWAIN_SetCaptionW = new Win32::API($dtwain_dllName, 'DTWAIN_SetCaptionW', 'PP', 'I');
my $DTWAIN_SetCompressionType = new Win32::API($dtwain_dllName, 'DTWAIN_SetCompressionType', 'PiI', 'I');
my $DTWAIN_SetContrast = new Win32::API($dtwain_dllName, 'DTWAIN_SetContrast', 'PD', 'I');
my $DTWAIN_SetContrastString = new Win32::API($dtwain_dllName, 'DTWAIN_SetContrastString', 'PP', 'I');
my $DTWAIN_SetContrastStringA = new Win32::API($dtwain_dllName, 'DTWAIN_SetContrastStringA', 'PP', 'I');
my $DTWAIN_SetContrastStringW = new Win32::API($dtwain_dllName, 'DTWAIN_SetContrastStringW', 'PP', 'I');
my $DTWAIN_SetCountry = new Win32::API($dtwain_dllName, 'DTWAIN_SetCountry', 'i', 'I');
my $DTWAIN_SetCurrentRetryCount = new Win32::API($dtwain_dllName, 'DTWAIN_SetCurrentRetryCount', 'Pi', 'I');
my $DTWAIN_SetCustomDSData = new Win32::API($dtwain_dllName, 'DTWAIN_SetCustomDSData', 'PPPIi', 'I');
...
my $DTWAIN_SetDefaultSource = new Win32::API($dtwain_dllName, 'DTWAIN_SetDefaultSource', 'P', 'I');
my $DTWAIN_SetDeviceNotifications = new Win32::API($dtwain_dllName, 'DTWAIN_SetDeviceNotifications', 'Pi', 'I');
my $DTWAIN_SetDeviceTimeDate = new Win32::API($dtwain_dllName, 'DTWAIN_SetDeviceTimeDate', 'PP', 'I');
my $DTWAIN_SetDeviceTimeDateA = new Win32::API($dtwain_dllName, 'DTWAIN_SetDeviceTimeDateA', 'PP', 'I');
my $DTWAIN_SetDeviceTimeDateW = new Win32::API($dtwain_dllName, 'DTWAIN_SetDeviceTimeDateW', 'PP', 'I');
my $DTWAIN_SetDoubleFeedDetectLength = new Win32::API($dtwain_dllName, 'DTWAIN_SetDoubleFeedDetectLength', 'PD', 'I');
my $DTWAIN_SetDoubleFeedDetectLengthString = new Win32::API($dtwain_dllName, 'DTWAIN_SetDoubleFeedDetectLengthString', 'PP', 'I');
my $DTWAIN_SetDoubleFeedDetectLengthStringA = new Win32::API($dtwain_dllName, 'DTWAIN_SetDoubleFeedDetectLengthStringA', 'PP', 'I');
my $DTWAIN_SetDoubleFeedDetectLengthStringW = new Win32::API($dtwain_dllName, 'DTWAIN_SetDoubleFeedDetectLengthStringW', 'PP', 'I');
my $DTWAIN_SetDoubleFeedDetectValues = new Win32::API($dtwain_dllName, 'DTWAIN_SetDoubleFeedDetectValues', 'PP', 'I');
my $DTWAIN_SetDoublePageCountOnDuplex = new Win32::API($dtwain_dllName, 'DTWAIN_SetDoublePageCountOnDuplex', 'PI', 'I');
my $DTWAIN_SetEOJDetectValue = new Win32::API($dtwain_dllName, 'DTWAIN_SetEOJDetectValue', 'Pi', 'I');
...
my $DTWAIN_SetFeederAlignment = new Win32::API($dtwain_dllName, 'DTWAIN_SetFeederAlignment', 'Pi', 'I');
my $DTWAIN_SetFeederOrder = new Win32::API($dtwain_dllName, 'DTWAIN_SetFeederOrder', 'Pi', 'I');
my $DTWAIN_SetFeederWaitTime = new Win32::API($dtwain_dllName, 'DTWAIN_SetFeederWaitTime', 'Pii', 'I');
my $DTWAIN_SetFileAutoIncrement = new Win32::API($dtwain_dllName, 'DTWAIN_SetFileAutoIncrement', 'PiII', 'I');
my $DTWAIN_SetFileCompressionType = new Win32::API($dtwain_dllName, 'DTWAIN_SetFileCompressionType', 'PiI', 'I');
my $DTWAIN_SetFileSavePos = new Win32::API($dtwain_dllName, 'DTWAIN_SetFileSavePos', 'PPiii', 'I');
my $DTWAIN_SetFileSavePosA = new Win32::API($dtwain_dllName, 'DTWAIN_SetFileSavePosA', 'PPiii', 'I');
my $DTWAIN_SetFileSavePosW = new Win32::API($dtwain_dllName, 'DTWAIN_SetFileSavePosW', 'PPiii', 'I');
my $DTWAIN_SetFileXferFormat = new Win32::API($dtwain_dllName, 'DTWAIN_SetFileXferFormat', 'PiI', 'I');
my $DTWAIN_SetHalftone = new Win32::API($dtwain_dllName, 'DTWAIN_SetHalftone', 'PP', 'I');
my $DTWAIN_SetHalftoneA = new Win32::API($dtwain_dllName, 'DTWAIN_SetHalftoneA', 'PP', 'I');
my $DTWAIN_SetHalftoneW = new Win32::API($dtwain_dllName, 'DTWAIN_SetHalftoneW', 'PP', 'I');
my $DTWAIN_SetHighlight = new Win32::API($dtwain_dllName, 'DTWAIN_SetHighlight', 'PD', 'I');
my $DTWAIN_SetHighlightString = new Win32::API($dtwain_dllName, 'DTWAIN_SetHighlightString', 'PP', 'I');
my $DTWAIN_SetHighlightStringA = new Win32::API($dtwain_dllName, 'DTWAIN_SetHighlightStringA', 'PP', 'I');
my $DTWAIN_SetHighlightStringW = new Win32::API($dtwain_dllName, 'DTWAIN_SetHighlightStringW', 'PP', 'I');
my $DTWAIN_SetJobControl = new Win32::API($dtwain_dllName, 'DTWAIN_SetJobControl', 'PiI', 'I');
my $DTWAIN_SetJpegValues = new Win32::API($dtwain_dllName, 'DTWAIN_SetJpegValues', 'Pii', 'I');
my $DTWAIN_SetJpegXRValues = new Win32::API($dtwain_dllName, 'DTWAIN_SetJpegXRValues', 'Pii', 'I');
...
my $DTWAIN_SetLightPath = new Win32::API($dtwain_dllName, 'DTWAIN_SetLightPath', 'Pi', 'I');
my $DTWAIN_SetLightPathEx = new Win32::API($dtwain_dllName, 'DTWAIN_SetLightPathEx', 'PP', 'I');
my $DTWAIN_SetLightSource = new Win32::API($dtwain_dllName, 'DTWAIN_SetLightSource', 'Pi', 'I');
my $DTWAIN_SetLightSources = new Win32::API($dtwain_dllName, 'DTWAIN_SetLightSources', 'PP', 'I');
my $DTWAIN_SetLogSaveThreshold = new Win32::API($dtwain_dllName, 'DTWAIN_SetLogSaveThreshold', 'q', 'I');
...
my $DTWAIN_SetMajorMinorVersion = new Win32::API($dtwain_dllName, 'DTWAIN_SetMajorMinorVersion', 'II', 'I');
my $DTWAIN_SetManualDuplexMode = new Win32::API($dtwain_dllName, 'DTWAIN_SetManualDuplexMode', 'PiI', 'I');
my $DTWAIN_SetMaxAcquisitions = new Win32::API($dtwain_dllName, 'DTWAIN_SetMaxAcquisitions', 'Pi', 'I');
my $DTWAIN_SetMaxBuffers = new Win32::API($dtwain_dllName, 'DTWAIN_SetMaxBuffers', 'PI', 'I');
my $DTWAIN_SetMaxRetryAttempts = new Win32::API($dtwain_dllName, 'DTWAIN_SetMaxRetryAttempts', 'Pi', 'I');
my $DTWAIN_SetMultipageScanMode = new Win32::API($dtwain_dllName, 'DTWAIN_SetMultipageScanMode', 'Pi', 'I');
my $DTWAIN_SetNoiseFilter = new Win32::API($dtwain_dllName, 'DTWAIN_SetNoiseFilter', 'Pi', 'I');
my $DTWAIN_SetOCRCapValues = new Win32::API($dtwain_dllName, 'DTWAIN_SetOCRCapValues', 'PiiP', 'I');
my $DTWAIN_SetOrientation = new Win32::API($dtwain_dllName, 'DTWAIN_SetOrientation', 'PiI', 'I');
my $DTWAIN_SetOverscan = new Win32::API($dtwain_dllName, 'DTWAIN_SetOverscan', 'PiI', 'I');
my $DTWAIN_SetPDFAESEncryption = new Win32::API($dtwain_dllName, 'DTWAIN_SetPDFAESEncryption', 'PiI', 'I');
my $DTWAIN_SetPDFASCIICompression = new Win32::API($dtwain_dllName, 'DTWAIN_SetPDFASCIICompression', 'PI', 'I');
my $DTWAIN_SetPDFAuthor = new Win32::API($dtwain_dllName, 'DTWAIN_SetPDFAuthor', 'PP', 'I');
my $DTWAIN_SetPDFAuthorA = new Win32::API($dtwain_dllName, 'DTWAIN_SetPDFAuthorA', 'PP', 'I');
my $DTWAIN_SetPDFAuthorW = new Win32::API($dtwain_dllName, 'DTWAIN_SetPDFAuthorW', 'PP', 'I');
my $DTWAIN_SetPDFCompression = new Win32::API($dtwain_dllName, 'DTWAIN_SetPDFCompression', 'PI', 'I');
my $DTWAIN_SetPDFCreator = new Win32::API($dtwain_dllName, 'DTWAIN_SetPDFCreator', 'PP', 'I');
my $DTWAIN_SetPDFCreatorA = new Win32::API($dtwain_dllName, 'DTWAIN_SetPDFCreatorA', 'PP', 'I');
my $DTWAIN_SetPDFCreatorW = new Win32::API($dtwain_dllName, 'DTWAIN_SetPDFCreatorW', 'PP', 'I');
my $DTWAIN_SetPDFEncryption = new Win32::API($dtwain_dllName, 'DTWAIN_SetPDFEncryption', 'PIPPII', 'I');
my $DTWAIN_SetPDFEncryptionA = new Win32::API($dtwain_dllName, 'DTWAIN_SetPDFEncryptionA', 'PIPPII', 'I');
my $DTWAIN_SetPDFEncryptionW = new Win32::API($dtwain_dllName, 'DTWAIN_SetPDFEncryptionW', 'PIPPII', 'I');
my $DTWAIN_SetPDFJpegQuality = new Win32::API($dtwain_dllName, 'DTWAIN_SetPDFJpegQuality', 'Pi', 'I');
my $DTWAIN_SetPDFKeywords = new Win32::API($dtwain_dllName, 'DTWAIN_SetPDFKeywords', 'PP', 'I');
my $DTWAIN_SetPDFKeywordsA = new Win32::API($dtwain_dllName, 'DTWAIN_SetPDFKeywordsA', 'PP', 'I');
my $DTWAIN_SetPDFKeywordsW = new Win32::API($dtwain_dllName, 'DTWAIN_SetPDFKeywordsW', 'PP', 'I');
my $DTWAIN_SetPDFOCRConversion = new Win32::API($dtwain_dllName, 'DTWAIN_SetPDFOCRConversion', 'Piiiii', 'i');
my $DTWAIN_SetPDFOCRMode = new Win32::API($dtwain_dllName, 'DTWAIN_SetPDFOCRMode', 'PI', 'I');
my $DTWAIN_SetPDFOrientation = new Win32::API($dtwain_dllName, 'DTWAIN_SetPDFOrientation', 'Pi', 'I');
my $DTWAIN_SetPDFPageScale = new Win32::API($dtwain_dllName, 'DTWAIN_SetPDFPageScale', 'PiDD', 'I');
my $DTWAIN_SetPDFPageScaleString = new Win32::API($dtwain_dllName, 'DTWAIN_SetPDFPageScaleString', 'PiPP', 'I');
my $DTWAIN_SetPDFPageScaleStringA = new Win32::API($dtwain_dllName, 'DTWAIN_SetPDFPageScaleStringA', 'PiPP', 'I');
my $DTWAIN_SetPDFPageScaleStringW = new Win32::API($dtwain_dllName, 'DTWAIN_SetPDFPageScaleStringW', 'PiPP', 'I');
my $DTWAIN_SetPDFPageSize = new Win32::API($dtwain_dllName, 'DTWAIN_SetPDFPageSize', 'PiDD', 'I');
my $DTWAIN_SetPDFPageSizeString = new Win32::API($dtwain_dllName, 'DTWAIN_SetPDFPageSizeString', 'PiPP', 'I');
my $DTWAIN_SetPDFPageSizeStringA = new Win32::API($dtwain_dllName, 'DTWAIN_SetPDFPageSizeStringA', 'PiPP', 'I');
my $DTWAIN_SetPDFPageSizeStringW = new Win32::API($dtwain_dllName, 'DTWAIN_SetPDFPageSizeStringW', 'PiPP', 'I');
my $DTWAIN_SetPDFPolarity = new Win32::API($dtwain_dllName, 'DTWAIN_SetPDFPolarity', 'Pi', 'I');
my $DTWAIN_SetPDFProducer = new Win32::API($dtwain_dllName, 'DTWAIN_SetPDFProducer', 'PP', 'I');
my $DTWAIN_SetPDFProducerA = new Win32::API($dtwain_dllName, 'DTWAIN_SetPDFProducerA', 'PP', 'I');
my $DTWAIN_SetPDFProducerW = new Win32::API($dtwain_dllName, 'DTWAIN_SetPDFProducerW', 'PP', 'I');
my $DTWAIN_SetPDFSubject = new Win32::API($dtwain_dllName, 'DTWAIN_SetPDFSubject', 'PP', 'I');
my $DTWAIN_SetPDFSubjectA = new Win32::API($dtwain_dllName, 'DTWAIN_SetPDFSubjectA', 'PP', 'I');
my $DTWAIN_SetPDFSubjectW = new Win32::API($dtwain_dllName, 'DTWAIN_SetPDFSubjectW', 'PP', 'I');
my $DTWAIN_SetPDFTextElementFloat = new Win32::API($dtwain_dllName, 'DTWAIN_SetPDFTextElementFloat', 'PDDi', 'I');
my $DTWAIN_SetPDFTextElementFloatString = new Win32::API($dtwain_dllName, 'DTWAIN_SetPDFTextElementFloatString', 'PPPi', 'I');
my $DTWAIN_SetPDFTextElementFloatStringA = new Win32::API($dtwain_dllName, 'DTWAIN_SetPDFTextElementFloatStringA', 'PPPi', 'I');
my $DTWAIN_SetPDFTextElementFloatStringW = new Win32::API($dtwain_dllName, 'DTWAIN_SetPDFTextElementFloatStringW', 'PPPi', 'I');
...
my $DTWAIN_SetPDFTitle = new Win32::API($dtwain_dllName, 'DTWAIN_SetPDFTitle', 'PP', 'I');
my $DTWAIN_SetPDFTitleA = new Win32::API($dtwain_dllName, 'DTWAIN_SetPDFTitleA', 'PP', 'I');
my $DTWAIN_SetPDFTitleW = new Win32::API($dtwain_dllName, 'DTWAIN_SetPDFTitleW', 'PP', 'I');
my $DTWAIN_SetPaperSize = new Win32::API($dtwain_dllName, 'DTWAIN_SetPaperSize', 'PiI', 'I');
my $DTWAIN_SetPatchcodeMaxPriorities = new Win32::API($dtwain_dllName, 'DTWAIN_SetPatchcodeMaxPriorities', 'PI', 'I');
my $DTWAIN_SetPatchcodeMaxRetries = new Win32::API($dtwain_dllName, 'DTWAIN_SetPatchcodeMaxRetries', 'PI', 'I');
my $DTWAIN_SetPatchcodePriorities = new Win32::API($dtwain_dllName, 'DTWAIN_SetPatchcodePriorities', 'PP', 'I');
my $DTWAIN_SetPatchcodeSearchMode = new Win32::API($dtwain_dllName, 'DTWAIN_SetPatchcodeSearchMode', 'Pi', 'I');
my $DTWAIN_SetPatchcodeTimeOut = new Win32::API($dtwain_dllName, 'DTWAIN_SetPatchcodeTimeOut', 'PI', 'I');
my $DTWAIN_SetPixelFlavor = new Win32::API($dtwain_dllName, 'DTWAIN_SetPixelFlavor', 'Pi', 'I');
my $DTWAIN_SetPixelType = new Win32::API($dtwain_dllName, 'DTWAIN_SetPixelType', 'PiiI', 'I');
my $DTWAIN_SetPostScriptTitle = new Win32::API($dtwain_dllName, 'DTWAIN_SetPostScriptTitle', 'PP', 'I');
my $DTWAIN_SetPostScriptTitleA = new Win32::API($dtwain_dllName, 'DTWAIN_SetPostScriptTitleA', 'PP', 'I');
my $DTWAIN_SetPostScriptTitleW = new Win32::API($dtwain_dllName, 'DTWAIN_SetPostScriptTitleW', 'PP', 'I');
my $DTWAIN_SetPostScriptType = new Win32::API($dtwain_dllName, 'DTWAIN_SetPostScriptType', 'Pi', 'I');
my $DTWAIN_SetPrinter = new Win32::API($dtwain_dllName, 'DTWAIN_SetPrinter', 'PiI', 'I');
my $DTWAIN_SetPrinterEx = new Win32::API($dtwain_dllName, 'DTWAIN_SetPrinterEx', 'PiI', 'I');
my $DTWAIN_SetPrinterStartNumber = new Win32::API($dtwain_dllName, 'DTWAIN_SetPrinterStartNumber', 'PI', 'I');
my $DTWAIN_SetPrinterStringMode = new Win32::API($dtwain_dllName, 'DTWAIN_SetPrinterStringMode', 'PiI', 'I');
my $DTWAIN_SetPrinterStrings = new Win32::API($dtwain_dllName, 'DTWAIN_SetPrinterStrings', 'PPP', 'I');
my $DTWAIN_SetPrinterSuffixString = new Win32::API($dtwain_dllName, 'DTWAIN_SetPrinterSuffixString', 'PP', 'I');
my $DTWAIN_SetPrinterSuffixStringA = new Win32::API($dtwain_dllName, 'DTWAIN_SetPrinterSuffixStringA', 'PP', 'I');
my $DTWAIN_SetPrinterSuffixStringW = new Win32::API($dtwain_dllName, 'DTWAIN_SetPrinterSuffixStringW', 'PP', 'I');
my $DTWAIN_SetResolution = new Win32::API($dtwain_dllName, 'DTWAIN_SetResolution', 'PD', 'I');
my $DTWAIN_SetResolutionString = new Win32::API($dtwain_dllName, 'DTWAIN_SetResolutionString', 'PP', 'I');
my $DTWAIN_SetResolutionStringA = new Win32::API($dtwain_dllName, 'DTWAIN_SetResolutionStringA', 'PP', 'I');
my $DTWAIN_SetResolutionStringW = new Win32::API($dtwain_dllName, 'DTWAIN_SetResolutionStringW', 'PP', 'I');
...
my $DTWAIN_SetRotation = new Win32::API($dtwain_dllName, 'DTWAIN_SetRotation', 'PD', 'I');
my $DTWAIN_SetRotationString = new Win32::API($dtwain_dllName, 'DTWAIN_SetRotationString', 'PP', 'I');
my $DTWAIN_SetRotationStringA = new Win32::API($dtwain_dllName, 'DTWAIN_SetRotationStringA', 'PP', 'I');
my $DTWAIN_SetRotationStringW = new Win32::API($dtwain_dllName, 'DTWAIN_SetRotationStringW', 'PP', 'I');
my $DTWAIN_SetSaveFileName = new Win32::API($dtwain_dllName, 'DTWAIN_SetSaveFileName', 'PP', 'I');
my $DTWAIN_SetSaveFileNameA = new Win32::API($dtwain_dllName, 'DTWAIN_SetSaveFileNameA', 'PP', 'I');
my $DTWAIN_SetSaveFileNameW = new Win32::API($dtwain_dllName, 'DTWAIN_SetSaveFileNameW', 'PP', 'I');
my $DTWAIN_SetSaveFileType = new Win32::API($dtwain_dllName, 'DTWAIN_SetSaveFileType', 'Pi', 'I');
my $DTWAIN_SetShadow = new Win32::API($dtwain_dllName, 'DTWAIN_SetShadow', 'PD', 'I');
my $DTWAIN_SetShadowString = new Win32::API($dtwain_dllName, 'DTWAIN_SetShadowString', 'PP', 'I');
my $DTWAIN_SetShadowStringA = new Win32::API($dtwain_dllName, 'DTWAIN_SetShadowStringA', 'PP', 'I');
my $DTWAIN_SetShadowStringW = new Win32::API($dtwain_dllName, 'DTWAIN_SetShadowStringW', 'PP', 'I');
my $DTWAIN_SetSourceUnit = new Win32::API($dtwain_dllName, 'DTWAIN_SetSourceUnit', 'Pi', 'I');
my $DTWAIN_SetTIFFCompressType = new Win32::API($dtwain_dllName, 'DTWAIN_SetTIFFCompressType', 'Pi', 'I');
my $DTWAIN_SetTIFFInvert = new Win32::API($dtwain_dllName, 'DTWAIN_SetTIFFInvert', 'Pi', 'I');
...
my $DTWAIN_SetThreshold = new Win32::API($dtwain_dllName, 'DTWAIN_SetThreshold', 'PDI', 'I');
my $DTWAIN_SetThresholdString = new Win32::API($dtwain_dllName, 'DTWAIN_SetThresholdString', 'PPI', 'I');
my $DTWAIN_SetThresholdStringA = new Win32::API($dtwain_dllName, 'DTWAIN_SetThresholdStringA', 'PPI', 'I');
my $DTWAIN_SetThresholdStringW = new Win32::API($dtwain_dllName, 'DTWAIN_SetThresholdStringW', 'PPI', 'I');
...
my $DTWAIN_SetXResolution = new Win32::API($dtwain_dllName, 'DTWAIN_SetXResolution', 'PD', 'I');
my $DTWAIN_SetXResolutionString = new Win32::API($dtwain_dllName, 'DTWAIN_SetXResolutionString', 'PP', 'I');
my $DTWAIN_SetXResolutionStringA = new Win32::API($dtwain_dllName, 'DTWAIN_SetXResolutionStringA', 'PP', 'I');
my $DTWAIN_SetXResolutionStringW = new Win32::API($dtwain_dllName, 'DTWAIN_SetXResolutionStringW', 'PP', 'I');
my $DTWAIN_SetYResolution = new Win32::API($dtwain_dllName, 'DTWAIN_SetYResolution', 'PD', 'I');
my $DTWAIN_SetYResolutionString = new Win32::API($dtwain_dllName, 'DTWAIN_SetYResolutionString', 'PP', 'I');
my $DTWAIN_SetYResolutionStringA = new Win32::API($dtwain_dllName, 'DTWAIN_SetYResolutionStringA', 'PP', 'I');
my $DTWAIN_SetYResolutionStringW = new Win32::API($dtwain_dllName, 'DTWAIN_SetYResolutionStringW', 'PP', 'I');
my $DTWAIN_ShowUIOnly = new Win32::API($dtwain_dllName, 'DTWAIN_ShowUIOnly', 'P', 'I');
my $DTWAIN_ShutdownOCREngine = new Win32::API($dtwain_dllName, 'DTWAIN_ShutdownOCREngine', 'P', 'I');
my $DTWAIN_SkipImageInfoError = new Win32::API($dtwain_dllName, 'DTWAIN_SkipImageInfoError', 'PI', 'I');
my $DTWAIN_StartThread = new Win32::API($dtwain_dllName, 'DTWAIN_StartThread', 'P', 'I');
my $DTWAIN_StartTwainSession = new Win32::API($dtwain_dllName, 'DTWAIN_StartTwainSession', 'PP', 'I');
my $DTWAIN_StartTwainSessionA = new Win32::API($dtwain_dllName, 'DTWAIN_StartTwainSessionA', 'PP', 'I');
my $DTWAIN_StartTwainSessionW = new Win32::API($dtwain_dllName, 'DTWAIN_StartTwainSessionW', 'PP', 'I');
my $DTWAIN_SysDestroy = new Win32::API($dtwain_dllName, 'DTWAIN_SysDestroy', '', 'I');
my $DTWAIN_SysInitialize = new Win32::API($dtwain_dllName, 'DTWAIN_SysInitialize', '', 'P');
...
my $DTWAIN_UpdateCurrentAcquiredImage = new Win32::API($dtwain_dllName, 'DTWAIN_UpdateCurrentAcquiredImage', 'PP', 'I');
