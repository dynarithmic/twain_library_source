...
my $DTWAIN_AddExtImageInfoQuery = new Win32::API($dtwain_dllName, 'DTWAIN_AddExtImageInfoQuery', 'Pi', 'I');
...
my $DTWAIN_AddPDFTextEx = new Win32::API($dtwain_dllName, 'DTWAIN_AddPDFTextEx', 'PPiiPDiiDDDDDDDDDi', 'I');
my $DTWAIN_AddPDFTextExA = new Win32::API($dtwain_dllName, 'DTWAIN_AddPDFTextExA', 'PPiiPDiiDDDDDDDDDi', 'I');
my $DTWAIN_AddPDFTextExW = new Win32::API($dtwain_dllName, 'DTWAIN_AddPDFTextExW', 'PPiiPDiiDDDDDDDDDi', 'I');
...
my $DTWAIN_ArrayInit = new Win32::API($dtwain_dllName, 'DTWAIN_ArrayInit', '', 'P');
...
my $DTWAIN_SysInitializeEx = new Win32::API($dtwain_dllName, 'DTWAIN_SysInitializeEx', 'P', 'P');
my $DTWAIN_SysInitializeEx2 = new Win32::API($dtwain_dllName, 'DTWAIN_SysInitializeEx2', 'PPP', 'P');
my $DTWAIN_SysInitializeEx2A = new Win32::API($dtwain_dllName, 'DTWAIN_SysInitializeEx2A', 'PPP', 'P');
my $DTWAIN_SysInitializeEx2W = new Win32::API($dtwain_dllName, 'DTWAIN_SysInitializeEx2W', 'PPP', 'P');
my $DTWAIN_SysInitializeExA = new Win32::API($dtwain_dllName, 'DTWAIN_SysInitializeExA', 'P', 'P');
my $DTWAIN_SysInitializeExW = new Win32::API($dtwain_dllName, 'DTWAIN_SysInitializeExW', 'P', 'P');
my $DTWAIN_SysInitializeLib = new Win32::API($dtwain_dllName, 'DTWAIN_SysInitializeLib', 'P', 'P');
my $DTWAIN_SysInitializeLibEx = new Win32::API($dtwain_dllName, 'DTWAIN_SysInitializeLibEx', 'PP', 'P');
my $DTWAIN_SysInitializeLibEx2 = new Win32::API($dtwain_dllName, 'DTWAIN_SysInitializeLibEx2', 'PPPP', 'P');
my $DTWAIN_SysInitializeLibEx2A = new Win32::API($dtwain_dllName, 'DTWAIN_SysInitializeLibEx2A', 'PPPP', 'P');
my $DTWAIN_SysInitializeLibEx2W = new Win32::API($dtwain_dllName, 'DTWAIN_SysInitializeLibEx2W', 'PPPP', 'P');
