...
Class DTWAINAPI
    ...
    Public Declare Function DTWAIN_AcquireAudioNative Lib "dtwain32d.dll" (Source As System.IntPtr, nMaxAudioClips As Integer, bShowUI As Integer, bCloseSource As Integer, ByRef pStatus As Integer) As System.IntPtr
    Public Declare Function DTWAIN_AcquireAudioNativeEx Lib "dtwain32d.dll" (Source As System.IntPtr, nMaxAudioClips As Integer, bShowUI As Integer, bCloseSource As Integer, Acquisitions As System.IntPtr, ByRef pStatus As Integer) As Integer
    Public Declare Function DTWAIN_AcquireBuffered Lib "dtwain32d.dll" (Source As System.IntPtr, PixelType As Integer, nMaxPages As Integer, bShowUI As Integer, bCloseSource As Integer, ByRef pStatus As Integer) As System.IntPtr
    Public Declare Function DTWAIN_AcquireBufferedEx Lib "dtwain32d.dll" (Source As System.IntPtr, PixelType As Integer, nMaxPages As Integer, bShowUI As Integer, bCloseSource As Integer, Acquisitions As System.IntPtr, ByRef pStatus As Integer) As Integer
    ...
    Public Declare Function DTWAIN_AcquireFileEx Lib "dtwain32d.dll" (Source As System.IntPtr, aFileNames As System.IntPtr, lFileType As Integer, lFileFlags As Integer, PixelType As Integer, lMaxPages As Integer, bShowUI As Integer, bCloseSource As Integer, ByRef pStatus As Integer) As Integer
    Public Declare Function DTWAIN_AcquireNative Lib "dtwain32d.dll" (Source As System.IntPtr, PixelType As Integer, nMaxPages As Integer, bShowUI As Integer, bCloseSource As Integer, ByRef pStatus As Integer) As System.IntPtr
    Public Declare Function DTWAIN_AcquireNativeEx Lib "dtwain32d.dll" (Source As System.IntPtr, PixelType As Integer, nMaxPages As Integer, bShowUI As Integer, bCloseSource As Integer, Acquisitions As System.IntPtr, ByRef pStatus As Integer) As Integer
    Public Declare Function DTWAIN_AcquireToClipboard Lib "dtwain32d.dll" (Source As System.IntPtr, PixelType As Integer, nMaxPages As Integer, nTransferMode As Integer, bDiscardDibs As Integer, bShowUI As Integer, bCloseSource As Integer, ByRef pStatus As Integer) As System.IntPtr
    Public Declare Function DTWAIN_AddExtImageInfoQuery Lib "dtwain32d.dll" (Source As System.IntPtr, ExtImageInfo As Integer) As Integer
    ...
    Public Declare Function DTWAIN_AddPDFTextElement Lib "dtwain32d.dll" (Source As System.IntPtr, TextElement As System.IntPtr) As Integer
    ...
    Public Declare Function DTWAIN_AllocateMemory Lib "dtwain32d.dll" (memSize As UInteger) As System.IntPtr
    Public Declare Function DTWAIN_AllocateMemory64 Lib "dtwain32d.dll" (memSize As System.UInt64) As System.IntPtr
    Public Declare Function DTWAIN_AllocateMemoryEx Lib "dtwain32d.dll" (memSize As UInteger) As System.IntPtr
    Public Declare Function DTWAIN_AppHandlesExceptions Lib "dtwain32d.dll" (bSet As Integer) As Integer
    Public Declare Function DTWAIN_ArrayANSIStringToFloat Lib "dtwain32d.dll" (StringArray As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_ArrayAdd Lib "dtwain32d.dll" (pArray As System.IntPtr, pVariant As System.IntPtr) As Integer
    ...
    Public Declare Function DTWAIN_ArrayAddFloat Lib "dtwain32d.dll" (pArray As System.IntPtr, Val As System.Double) As Integer
    Public Declare Function DTWAIN_ArrayAddFloatN Lib "dtwain32d.dll" (pArray As System.IntPtr, Val As System.Double, num As Integer) As Integer
    ...
    Public Declare Function DTWAIN_ArrayAddFrame Lib "dtwain32d.dll" (pArray As System.IntPtr, frame As System.IntPtr) As Integer
    Public Declare Function DTWAIN_ArrayAddFrameN Lib "dtwain32d.dll" (pArray As System.IntPtr, frame As System.IntPtr, num As Integer) As Integer
    Public Declare Function DTWAIN_ArrayAddLong Lib "dtwain32d.dll" (pArray As System.IntPtr, Val As Integer) As Integer
    Public Declare Function DTWAIN_ArrayAddLong64 Lib "dtwain32d.dll" (pArray As System.IntPtr, Val As System.Int64) As Integer
    Public Declare Function DTWAIN_ArrayAddLong64N Lib "dtwain32d.dll" (pArray As System.IntPtr, Val As System.Int64, num As Integer) As Integer
    Public Declare Function DTWAIN_ArrayAddLongN Lib "dtwain32d.dll" (pArray As System.IntPtr, Val As Integer, num As Integer) As Integer
    Public Declare Function DTWAIN_ArrayAddN Lib "dtwain32d.dll" (pArray As System.IntPtr, pVariant As System.IntPtr, num As Integer) As Integer
    ...
    Public Declare Function DTWAIN_ArrayConvertFix32ToFloat Lib "dtwain32d.dll" (Fix32Array As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_ArrayConvertFloatToFix32 Lib "dtwain32d.dll" (FloatArray As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_ArrayCopy Lib "dtwain32d.dll" (Source As System.IntPtr, Dest As System.IntPtr) As Integer
    Public Declare Function DTWAIN_ArrayCreate Lib "dtwain32d.dll" (nEnumType As Integer, nInitialSize As Integer) As System.IntPtr
    Public Declare Function DTWAIN_ArrayCreateCopy Lib "dtwain32d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_ArrayCreateFromANSIStrings Lib "dtwain32d.dll" (<[In], MarshalAs(UnmanagedType.LPArray, ArraySubType:=UnmanagedType.LPStr)> pCArray() As String, nSize As Integer) As System.IntPtr
    Public Declare Function DTWAIN_ArrayCreateFromCap Lib "dtwain32d.dll" (Source As System.IntPtr, lCapType As Integer, lSize As Integer) As System.IntPtr
    Public Declare Function DTWAIN_ArrayCreateFromFloats Lib "dtwain32d.dll" (<[In]> pCArray() As System.Double, nSize As Integer) As System.IntPtr
    Public Declare Function DTWAIN_ArrayCreateFromLong64s Lib "dtwain32d.dll" (<[In]> pCArray() As System.Int64, nSize As Integer) As System.IntPtr
    Public Declare Function DTWAIN_ArrayCreateFromLongs Lib "dtwain32d.dll" (<[In]> pCArray() As Integer, nSize As Integer) As System.IntPtr
    Public Declare Function DTWAIN_ArrayCreateFromStrings Lib "dtwain32d.dll" (<[In], MarshalAs(UnmanagedType.LPArray, ArraySubType:=UnmanagedType.LPTStr)> pCArray() As String, nSize As Integer) As System.IntPtr
    Public Declare Function DTWAIN_ArrayCreateFromType Lib "dtwain32d.dll" (Source As System.IntPtr, lType As Integer, lSize As Integer) As System.IntPtr
    Public Declare Function DTWAIN_ArrayCreateFromWideStrings Lib "dtwain32d.dll" (<[In], MarshalAs(UnmanagedType.LPArray, ArraySubType:=UnmanagedType.LPWStr)> pCArray() As String, nSize As Integer) As System.IntPtr
    Public Declare Function DTWAIN_ArrayDestroy Lib "dtwain32d.dll" (pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_ArrayDestroyAll Lib "dtwain32d.dll" () As Integer
    ...
    Public Declare Function DTWAIN_ArrayFindLong Lib "dtwain32d.dll" (pArray As System.IntPtr, Val As Integer) As Integer
    Public Declare Function DTWAIN_ArrayFindLong64 Lib "dtwain32d.dll" (pArray As System.IntPtr, Val As System.Int64) As Integer
    ...
    Public Declare Function DTWAIN_ArrayFix32GetAt Lib "dtwain32d.dll" (aFix32 As System.IntPtr, lPos As Integer, ByRef Whole As Integer, ByRef Frac As Integer) As Integer
    Public Declare Function DTWAIN_ArrayFix32SetAt Lib "dtwain32d.dll" (aFix32 As System.IntPtr, lPos As Integer, Whole As Integer, Frac As Integer) As Integer
    Public Declare Function DTWAIN_ArrayFloatToANSIString Lib "dtwain32d.dll" (FloatArray As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_ArrayFloatToString Lib "dtwain32d.dll" (FloatArray As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_ArrayFloatToWideString Lib "dtwain32d.dll" (FloatArray As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_ArrayGetAt Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer, pVariant As System.IntPtr) As Integer
    ...
    Public Declare Function DTWAIN_ArrayGetAtANSIStringPtr Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer) As System.IntPtr
    Public Declare Function DTWAIN_ArrayGetAtFloat Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer, ByRef pVal As System.Double) As Integer
    Public Declare Function DTWAIN_ArrayGetAtFloatEx Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer) As System.Double
    ...
    Public Declare Function DTWAIN_ArrayGetAtFrame Lib "dtwain32d.dll" (FrameArray As System.IntPtr, nWhere As Integer, ByRef pleft As System.Double, ByRef ptop As System.Double, ByRef pright As System.Double, ByRef pbottom As System.Double) As Integer
    Public Declare Function DTWAIN_ArrayGetAtFrameEx Lib "dtwain32d.dll" (FrameArray As System.IntPtr, nWhere As Integer, Frame As System.IntPtr) As Integer
    ...
    Public Declare Function DTWAIN_ArrayGetAtLong Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer, ByRef pVal As Integer) As Integer
    Public Declare Function DTWAIN_ArrayGetAtLong64 Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer, ByRef pVal As System.Int64) As Integer
    Public Declare Function DTWAIN_ArrayGetAtLong64Ex Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer) As System.Int64
    Public Declare Function DTWAIN_ArrayGetAtLongEx Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer) As Integer
    Public Declare Function DTWAIN_ArrayGetAtSource Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer, ByRef ppSource As System.IntPtr) As Integer
    Public Declare Function DTWAIN_ArrayGetAtSourceEx Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer) As System.IntPtr
    ...
    Public Declare Function DTWAIN_ArrayGetAtStringPtr Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer) As System.IntPtr
    ...
    Public Declare Function DTWAIN_ArrayGetAtWideStringPtr Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer) As System.IntPtr
    Public Declare Function DTWAIN_ArrayGetBuffer Lib "dtwain32d.dll" (pArray As System.IntPtr, nPos As Integer) As System.IntPtr
    Public Declare Function DTWAIN_ArrayGetCapValues Lib "dtwain32d.dll" (Source As System.IntPtr, lCap As Integer, lGetType As Integer) As System.IntPtr
    Public Declare Function DTWAIN_ArrayGetCapValuesEx Lib "dtwain32d.dll" (Source As System.IntPtr, lCap As Integer, lGetType As Integer, lContainerType As Integer) As System.IntPtr
    Public Declare Function DTWAIN_ArrayGetCapValuesEx2 Lib "dtwain32d.dll" (Source As System.IntPtr, lCap As Integer, lGetType As Integer, lContainerType As Integer, nDataType As Integer) As System.IntPtr
    Public Declare Function DTWAIN_ArrayGetCount Lib "dtwain32d.dll" (pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_ArrayGetMaxStringLength Lib "dtwain32d.dll" (a As System.IntPtr) As Integer
    Public Declare Function DTWAIN_ArrayGetSourceAt Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer, ByRef ppSource As System.IntPtr) As Integer
    Public Declare Function DTWAIN_ArrayGetStringLength Lib "dtwain32d.dll" (a As System.IntPtr, nWhichString As Integer) As Integer
    Public Declare Function DTWAIN_ArrayGetType Lib "dtwain32d.dll" (pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_ArrayInit Lib "dtwain32d.dll" () As System.IntPtr
    Public Declare Function DTWAIN_ArrayInsertAt Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer, pVariant As System.IntPtr) As Integer
    ...
    Public Declare Function DTWAIN_ArrayInsertAtFloat Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer, pVal As System.Double) As Integer
    Public Declare Function DTWAIN_ArrayInsertAtFloatN Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer, Val As System.Double, num As Integer) As Integer
    ...
    Public Declare Function DTWAIN_ArrayInsertAtFrame Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer, frame As System.IntPtr) As Integer
    Public Declare Function DTWAIN_ArrayInsertAtFrameN Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer, frame As System.IntPtr, num As Integer) As Integer
    Public Declare Function DTWAIN_ArrayInsertAtLong Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer, pVal As Integer) As Integer
    Public Declare Function DTWAIN_ArrayInsertAtLong64 Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer, Val As System.Int64) As Integer
    Public Declare Function DTWAIN_ArrayInsertAtLong64N Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer, Val As System.Int64, num As Integer) As Integer
    Public Declare Function DTWAIN_ArrayInsertAtLongN Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer, pVal As Integer, num As Integer) As Integer
    Public Declare Function DTWAIN_ArrayInsertAtN Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer, pVariant As System.IntPtr, num As Integer) As Integer
    ...
    Public Declare Function DTWAIN_ArrayResize Lib "dtwain32d.dll" (pArray As System.IntPtr, NewSize As Integer) As Integer
    Public Declare Function DTWAIN_ArraySetAt Lib "dtwain32d.dll" (pArray As System.IntPtr, lPos As Integer, pVariant As System.IntPtr) As Integer
    ...
    Public Declare Function DTWAIN_ArraySetAtFloat Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer, pVal As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_ArraySetAtFrame Lib "dtwain32d.dll" (FrameArray As System.IntPtr, nWhere As Integer, left As System.Double, top As System.Double, right As System.Double, bottom As System.Double) As Integer
    Public Declare Function DTWAIN_ArraySetAtFrameEx Lib "dtwain32d.dll" (FrameArray As System.IntPtr, nWhere As Integer, Frame As System.IntPtr) As Integer
    ...
    Public Declare Function DTWAIN_ArraySetAtLong Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer, pVal As Integer) As Integer
    Public Declare Function DTWAIN_ArraySetAtLong64 Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer, Val As System.Int64) As Integer
    ...
    Public Declare Function DTWAIN_ArrayStringToFloat Lib "dtwain32d.dll" (StringArray As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_ArrayWideStringToFloat Lib "dtwain32d.dll" (StringArray As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_CallCallback Lib "dtwain32d.dll" (wParam As Integer, lParam As Integer, UserData As Integer) As Integer
    Public Declare Function DTWAIN_CallCallback64 Lib "dtwain32d.dll" (wParam As Integer, lParam As Integer, UserData As System.Int64) As Integer
    Public Declare Function DTWAIN_CallDSMProc Lib "dtwain32d.dll" (AppID As System.IntPtr, SourceId As System.IntPtr, lDG As Integer, lDAT As Integer, lMSG As Integer, pData As System.IntPtr) As Integer
    Public Declare Function DTWAIN_CheckDLLVersion Lib "dtwain32d.dll" (lMajor As Integer, lMinor As Integer, lPatchLevel As Integer, lBuildNumber As Integer, MatchType As Integer) As Integer
    Public Declare Function DTWAIN_CheckHandles Lib "dtwain32d.dll" (bCheck As Integer) As Integer
    Public Declare Function DTWAIN_ClearBuffers Lib "dtwain32d.dll" (Source As System.IntPtr, ClearBuffer As Integer) As Integer
    Public Declare Function DTWAIN_ClearErrorBuffer Lib "dtwain32d.dll" () As Integer
    Public Declare Function DTWAIN_ClearPDFTextElements Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_ClearPage Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_CloseSource Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_CloseSourceUI Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_ConvertDIBToBitmap Lib "dtwain32d.dll" (hDib As System.IntPtr, hPalette As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_ConvertDIBToFullBitmap Lib "dtwain32d.dll" (hDib As System.IntPtr, isBMP As Integer) As System.IntPtr
    ...
    Public Declare Function DTWAIN_CreateAcquisitionArray Lib "dtwain32d.dll" () As System.IntPtr
    Public Declare Function DTWAIN_CreatePDFTextElement Lib "dtwain32d.dll" () As System.IntPtr
    Public Declare Function DTWAIN_CreatePDFTextElementCopy Lib "dtwain32d.dll" (TextElement As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_DeleteDIB Lib "dtwain32d.dll" (hDib As System.IntPtr) As Integer
    Public Declare Function DTWAIN_DestroyAcquisitionArray Lib "dtwain32d.dll" (aAcq As System.IntPtr, bDestroyData As Integer) As Integer
    Public Declare Function DTWAIN_DestroyPDFTextElement Lib "dtwain32d.dll" (TextElement As System.IntPtr) As Integer
    Public Declare Function DTWAIN_DisableAppWindow Lib "dtwain32d.dll" (hWnd As System.IntPtr, bDisable As Integer) As Integer
    Public Declare Function DTWAIN_EnableAutoBorderDetect Lib "dtwain32d.dll" (Source As System.IntPtr, bEnable As Integer) As Integer
    Public Declare Function DTWAIN_EnableAutoBright Lib "dtwain32d.dll" (Source As System.IntPtr, bSet As Integer) As Integer
    Public Declare Function DTWAIN_EnableAutoDeskew Lib "dtwain32d.dll" (Source As System.IntPtr, bEnable As Integer) As Integer
    Public Declare Function DTWAIN_EnableAutoFeed Lib "dtwain32d.dll" (Source As System.IntPtr, bSet As Integer) As Integer
    Public Declare Function DTWAIN_EnableAutoRotate Lib "dtwain32d.dll" (Source As System.IntPtr, bSet As Integer) As Integer
    Public Declare Function DTWAIN_EnableAutoScan Lib "dtwain32d.dll" (Source As System.IntPtr, bEnable As Integer) As Integer
    Public Declare Function DTWAIN_EnableAutomaticSenseMedium Lib "dtwain32d.dll" (Source As System.IntPtr, bSet As Integer) As Integer
    ...
    Public Declare Function DTWAIN_EnableLamp Lib "dtwain32d.dll" (Source As System.IntPtr, bEnable As Integer) As Integer
    Public Declare Function DTWAIN_EnableMsgNotify Lib "dtwain32d.dll" (bSet As Integer) As Integer
    Public Declare Function DTWAIN_EnablePatchcodeDetection Lib "dtwain32d.dll" (Source As System.IntPtr, bEnable As Integer) As Integer
    Public Declare Function DTWAIN_EnablePeekMessageLoop Lib "dtwain32d.dll" (Source As System.IntPtr, bSet As Integer) As Integer
    Public Declare Function DTWAIN_EnablePrinter Lib "dtwain32d.dll" (Source As System.IntPtr, bEnable As Integer) As Integer
    Public Declare Function DTWAIN_EnableThumbnail Lib "dtwain32d.dll" (Source As System.IntPtr, bEnable As Integer) As Integer
    Public Declare Function DTWAIN_EnableTripletsNotify Lib "dtwain32d.dll" (bSet As Integer) As Integer
    Public Declare Function DTWAIN_EndThread Lib "dtwain32d.dll" (DLLHandle As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EndTwainSession Lib "dtwain32d.dll" () As Integer
    Public Declare Function DTWAIN_EnumAlarmVolumes Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr, expandIfRange As Integer) As Integer
    Public Declare Function DTWAIN_EnumAlarmVolumesEx Lib "dtwain32d.dll" (Source As System.IntPtr, expandIfRange As Integer) As System.IntPtr
    Public Declare Function DTWAIN_EnumAlarms Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumAlarmsEx Lib "dtwain32d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumAudioXferMechs Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumAudioXferMechsEx Lib "dtwain32d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumAutoFeedValues Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumAutoFeedValuesEx Lib "dtwain32d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumAutomaticCaptures Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr, bExpandIfRange As Integer) As Integer
    Public Declare Function DTWAIN_EnumAutomaticCapturesEx Lib "dtwain32d.dll" (Source As System.IntPtr, bExpandIfRange As Integer) As System.IntPtr
    ...
    Public Declare Function DTWAIN_EnumBarcodeCodes Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef PCodes As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumBarcodeCodesEx Lib "dtwain32d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumBarcodeMaxPriorities Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumBarcodeMaxPrioritiesEx Lib "dtwain32d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumBarcodeMaxRetries Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumBarcodeMaxRetriesEx Lib "dtwain32d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumBarcodePriorities Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumBarcodePrioritiesEx Lib "dtwain32d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumBarcodeSearchModes Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumBarcodeSearchModesEx Lib "dtwain32d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumBarcodeTimeOutValues Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumBarcodeTimeOutValuesEx Lib "dtwain32d.dll" (Source As System.IntPtr) As System.IntPtr
    ...
    Public Declare Function DTWAIN_EnumCapLabels Lib "dtwain32d.dll" (lCapability As Integer) As System.IntPtr
    ...
    Public Declare Function DTWAIN_EnumDoubleFeedDetectValuesEx Lib "dtwain32d.dll" (Source As System.IntPtr) As System.IntPtr
    ...
    Public Declare Function DTWAIN_EnumFileXferFormatsEx Lib "dtwain32d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumHalftones Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumHalftonesEx Lib "dtwain32d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumHighlightValues Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr, bExpandIfRange As Integer) As Integer
    Public Declare Function DTWAIN_EnumHighlightValuesEx Lib "dtwain32d.dll" (Source As System.IntPtr, bExpandIfRange As Integer) As System.IntPtr
    Public Declare Function DTWAIN_EnumJobControls Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumJobControlsEx Lib "dtwain32d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumLightPaths Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef LightPath As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumLightPathsEx Lib "dtwain32d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumLightSources Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef LightSources As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumLightSourcesEx Lib "dtwain32d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumMaxBuffers Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef pMaxBufs As System.IntPtr, bExpandRange As Integer) As Integer
    Public Declare Function DTWAIN_EnumMaxBuffersEx Lib "dtwain32d.dll" (Source As System.IntPtr, bExpandRange As Integer) As System.IntPtr
    Public Declare Function DTWAIN_EnumNoiseFilters Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumNoiseFiltersEx Lib "dtwain32d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumOCRInterfaces Lib "dtwain32d.dll" (ByRef OCRInterfaces As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumOCRInterfacesEx Lib "dtwain32d.dll" () As System.IntPtr
    Public Declare Function DTWAIN_EnumOCRSupportedCaps Lib "dtwain32d.dll" (Engine As System.IntPtr, ByRef SupportedCaps As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumOrientations Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumOrientationsEx Lib "dtwain32d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumOverscanValues Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumOverscanValuesEx Lib "dtwain32d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumPaperSizes Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumPaperSizesEx Lib "dtwain32d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumPatchcodeCodes Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef PCodes As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumPatchcodeCodesEx Lib "dtwain32d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumPatchcodeMaxPriorities Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumPatchcodeMaxPrioritiesEx Lib "dtwain32d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumPatchcodeMaxRetries Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumPatchcodeMaxRetriesEx Lib "dtwain32d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumPatchcodePriorities Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumPatchcodePrioritiesEx Lib "dtwain32d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumPatchcodeSearchModes Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumPatchcodeSearchModesEx Lib "dtwain32d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumPatchcodeTimeOutValues Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumPatchcodeTimeOutValuesEx Lib "dtwain32d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumPixelTypes Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumPixelTypesEx Lib "dtwain32d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumPrinterStringModes Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumPrinterStringModesEx Lib "dtwain32d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumResolutionValues Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr, bExpandIfRange As Integer) As Integer
    Public Declare Function DTWAIN_EnumResolutionValuesEx Lib "dtwain32d.dll" (Source As System.IntPtr, bExpandIfRange As Integer) As System.IntPtr
    Public Declare Function DTWAIN_EnumShadowValues Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr, bExpandIfRange As Integer) As Integer
    Public Declare Function DTWAIN_EnumShadowValuesEx Lib "dtwain32d.dll" (Source As System.IntPtr, bExpandIfRange As Integer) As System.IntPtr
    Public Declare Function DTWAIN_EnumSourceUnits Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef lpArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumSourceUnitsEx Lib "dtwain32d.dll" (Source As System.IntPtr) As System.IntPtr
    ...
    Public Declare Function DTWAIN_EnumSources Lib "dtwain32d.dll" (ByRef lpArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumSourcesEx Lib "dtwain32d.dll" () As System.IntPtr
    Public Declare Function DTWAIN_EnumSupportedCaps Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumSupportedCapsEx Lib "dtwain32d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumSupportedCapsEx2 Lib "dtwain32d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumSupportedExtImageInfo Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumSupportedExtImageInfoEx Lib "dtwain32d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumSupportedFileTypes Lib "dtwain32d.dll" () As System.IntPtr
    Public Declare Function DTWAIN_EnumSupportedMultiPageFileTypes Lib "dtwain32d.dll" () As System.IntPtr
    Public Declare Function DTWAIN_EnumSupportedSinglePageFileTypes Lib "dtwain32d.dll" () As System.IntPtr
    Public Declare Function DTWAIN_EnumThresholdValues Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr, bExpandIfRange As Integer) As Integer
    Public Declare Function DTWAIN_EnumThresholdValuesEx Lib "dtwain32d.dll" (Source As System.IntPtr, bExpandIfRange As Integer) As System.IntPtr
    Public Declare Function DTWAIN_EnumTopCameras Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef Cameras As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumTopCamerasEx Lib "dtwain32d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumTwainPrinters Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef lpAvailPrinters As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumTwainPrintersEx Lib "dtwain32d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumXResolutionValues Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr, bExpandIfRange As Integer) As Integer
    Public Declare Function DTWAIN_EnumXResolutionValuesEx Lib "dtwain32d.dll" (Source As System.IntPtr, bExpandIfRange As Integer) As System.IntPtr
    Public Declare Function DTWAIN_EnumYResolutionValues Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr, bExpandIfRange As Integer) As Integer
    Public Declare Function DTWAIN_EnumYResolutionValuesEx Lib "dtwain32d.dll" (Source As System.IntPtr, bExpandIfRange As Integer) As System.IntPtr
    ...
    Public Declare Function DTWAIN_FrameGetAll Lib "dtwain32d.dll" (Frame As System.IntPtr, ByRef Left As System.Double, ByRef Top As System.Double, ByRef Right As System.Double, ByRef Bottom As System.Double) As Integer
    Public Declare Ansi Function DTWAIN_FrameGetAllString Lib "dtwain32d.dll" (Frame As System.IntPtr, <MarshalAs(UnmanagedType.LPStr)> Left As StringBuilder, <MarshalAs(UnmanagedType.LPStr)> Top As StringBuilder, <MarshalAs(UnmanagedType.LPStr)> Right As StringBuilder, <MarshalAs(UnmanagedType.LPStr)> Bottom As StringBuilder) As Integer
    Public Declare Function DTWAIN_FrameGetValue Lib "dtwain32d.dll" (Frame As System.IntPtr, nWhich As Integer, ByRef Value As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_FrameIsValid Lib "dtwain32d.dll" (Frame As System.IntPtr) As Integer
    Public Declare Function DTWAIN_FrameSetAll Lib "dtwain32d.dll" (Frame As System.IntPtr, Left As System.Double, Top As System.Double, Right As System.Double, Bottom As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_FrameSetValue Lib "dtwain32d.dll" (Frame As System.IntPtr, nWhich As Integer, Value As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_FreeExtImageInfo Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_FreeMemory Lib "dtwain32d.dll" (h As System.IntPtr) As Integer
    Public Declare Function DTWAIN_FreeMemoryEx Lib "dtwain32d.dll" (h As System.IntPtr) As Integer
    Public Declare Function DTWAIN_GetAPIHandleStatus Lib "dtwain32d.dll" (pHandle As System.IntPtr) As Integer
    Public Declare Function DTWAIN_GetAcquireArea Lib "dtwain32d.dll" (Source As System.IntPtr, lGetType As Integer, ByRef FloatEnum As System.IntPtr) As Integer
    Public Declare Function DTWAIN_GetAcquireArea2 Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef left As System.Double, ByRef top As System.Double, ByRef right As System.Double, ByRef bottom As System.Double, ByRef lpUnit As Integer) As Integer
    ...
    Public Declare Function DTWAIN_GetAcquireAreaEx Lib "dtwain32d.dll" (Source As System.IntPtr, lGetType As Integer) As System.IntPtr
    Public Declare Function DTWAIN_GetAcquireMetrics Lib "dtwain32d.dll" (source As System.IntPtr, ByRef ImageCount As Integer, ByRef SheetCount As Integer) As Integer
    Public Declare Function DTWAIN_GetAcquireStripBuffer Lib "dtwain32d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_GetAcquireStripData Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef lpCompression As Integer, ByRef lpBytesPerRow As UInteger, ByRef lpColumns As UInteger, ByRef lpRows As UInteger, ByRef XOffset As UInteger, ByRef YOffset As UInteger, ByRef lpBytesWritten As UInteger) As Integer
    ...
    Public Declare Ansi Function DTWAIN_GetAllSessionInfo Lib "dtwain32d.dll" (<MarshalAs(UnmanagedType.LPTStr)> lpszOut As StringBuilder, indentFactor As Integer, nMaxLen As Integer) As Integer
    Public Declare Function DTWAIN_GetAllSourceDibs Lib "dtwain32d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Ansi Function DTWAIN_GetAllSourceInfo Lib "dtwain32d.dll" (Source As System.IntPtr, <MarshalAs(UnmanagedType.LPStr)> lpszOut As StringBuilder, indentFactor As Integer, nSize As Integer) As Integer
    ...
    Public Declare Function DTWAIN_GetBarcodeMaxPriorities Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef pMaxPriorities As UInteger, bCurrent As Integer) As Integer
    Public Declare Function DTWAIN_GetBarcodeMaxRetries Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef pMaxRetries As UInteger, bCurrent As Integer) As Integer
    Public Declare Function DTWAIN_GetBarcodePriorities Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef SearchPriorities As System.IntPtr) As Integer
    Public Declare Function DTWAIN_GetBarcodeSearchMode Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef pSearchMode As Integer, bCurrent As Integer) As Integer
    Public Declare Function DTWAIN_GetBarcodeTimeOut Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef pTimeOut As UInteger, bCurrent As Integer) As Integer
    Public Declare Function DTWAIN_GetBatteryMinutes Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef lpMinutes As Integer) As Integer
    Public Declare Function DTWAIN_GetBatteryPercent Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef lpPercent As Integer) As Integer
    Public Declare Function DTWAIN_GetBitDepth Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef BitDepth As Integer, bCurrent As Integer) As Integer
    Public Declare Function DTWAIN_GetBitDepthEx Lib "dtwain32d.dll" (Source As System.IntPtr, bCurrent As Integer) As Integer
    Public Declare Function DTWAIN_GetBlankPageAutoDetection Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_GetBrightness Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef Brightness As System.Double) As Integer
    Public Declare Function DTWAIN_GetBrightnessEx Lib "dtwain32d.dll" (Source As System.IntPtr) As System.Double
    ...
    Public Declare Function DTWAIN_GetBufferedTransferInfo Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef Compression As UInteger, ByRef BytesPerRow As UInteger, ByRef Columns As UInteger, ByRef Rows As UInteger, ByRef XOffset As UInteger, ByRef YOffset As UInteger, ByRef Flags As UInteger, ByRef BytesWritten As UInteger, ByRef MemoryLength As UInteger) As System.IntPtr
    Public Declare Function DTWAIN_GetCallback Lib "dtwain32d.dll" () As DTwainCallback
    Public Declare Function DTWAIN_GetCallback64 Lib "dtwain32d.dll" () As DTwainCallback64
    Public Declare Function DTWAIN_GetCapArrayType Lib "dtwain32d.dll" (Source As System.IntPtr, nCap As Integer) As Integer
    Public Declare Function DTWAIN_GetCapContainer Lib "dtwain32d.dll" (Source As System.IntPtr, nCap As Integer, lCapType As Integer) As Integer
    Public Declare Function DTWAIN_GetCapContainerEx Lib "dtwain32d.dll" (nCap As Integer, bSetContainer As Integer, ByRef ConTypes As System.IntPtr) As Integer
    Public Declare Function DTWAIN_GetCapContainerEx2 Lib "dtwain32d.dll" (nCap As Integer, bSetContainer As Integer) As System.IntPtr
    Public Declare Function DTWAIN_GetCapDataType Lib "dtwain32d.dll" (Source As System.IntPtr, nCap As Integer) As Integer
    Public Declare Ansi Function DTWAIN_GetCapFromName Lib "dtwain32d.dll" (szName As String) As Integer
    Public Declare Ansi Function DTWAIN_GetCapHelp Lib "dtwain32d.dll" (lCapability As Integer, <MarshalAs(UnmanagedType.LPStr)> lpszOut As StringBuilder, nSize As Integer) As Integer
    Public Declare Ansi Function DTWAIN_GetCapLabel Lib "dtwain32d.dll" (lCapability As Integer, <MarshalAs(UnmanagedType.LPStr)> lpszOut As StringBuilder, nSize As Integer) As Integer
    Public Declare Function DTWAIN_GetCapOperations Lib "dtwain32d.dll" (Source As System.IntPtr, lCapability As Integer, ByRef lpOps As Integer) As Integer
    Public Declare Function DTWAIN_GetCapOperationsEx Lib "dtwain32d.dll" (Source As System.IntPtr, lCapability As Integer) As Integer
    Public Declare Function DTWAIN_GetCapValues Lib "dtwain32d.dll" (Source As System.IntPtr, lCap As Integer, lGetType As Integer, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_GetCapValuesEx Lib "dtwain32d.dll" (Source As System.IntPtr, lCap As Integer, lGetType As Integer, lContainerType As Integer, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_GetCapValuesEx2 Lib "dtwain32d.dll" (Source As System.IntPtr, lCap As Integer, lGetType As Integer, lContainerType As Integer, nDataType As Integer, ByRef pArray As System.IntPtr) As Integer
    ...
    Public Declare Function DTWAIN_GetCompressionSize Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef lBytes As UInteger) As Integer
    Public Declare Function DTWAIN_GetCompressionType Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef lpCompression As Integer, bCurrent As Integer) As Integer
    Public Declare Function DTWAIN_GetCompressionTypeEx Lib "dtwain32d.dll" (Source As System.IntPtr, bCurrent As Integer) As Integer
    ...
    Public Declare Function DTWAIN_GetContrast Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef Contrast As System.Double) As Integer
    Public Declare Function DTWAIN_GetContrastEx Lib "dtwain32d.dll" (Source As System.IntPtr) As System.Double
    ...
    Public Declare Function DTWAIN_GetCountry Lib "dtwain32d.dll" () As Integer
    Public Declare Function DTWAIN_GetCurrentAcquiredImage Lib "dtwain32d.dll" (Source As System.IntPtr) As System.IntPtr
    ...
    Public Declare Function DTWAIN_GetCurrentPageNum Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_GetCurrentRetryCount Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_GetCurrentTwainTriplet Lib "dtwain32d.dll" (ByRef pAppID As TW_IDENTITY, ByRef pSourceID As TW_IDENTITY, ByRef lpDG As Integer, ByRef lpDAT As Integer, ByRef lpMsg As Integer, ByRef lpMemRef As System.Int64) As Integer
    Public Declare Function DTWAIN_GetCustomDSData Lib "dtwain32d.dll" (Source As System.IntPtr, Data As Byte(), dSize As UInteger, ByRef pActualSize As UInteger, nFlags As Integer) As System.IntPtr
    ...
    Public Declare Function DTWAIN_GetDSMSearchOrder Lib "dtwain32d.dll" () As Integer
    Public Declare Ansi Function DTWAIN_GetDSMSearchOrderEx Lib "dtwain32d.dll" (<MarshalAs(UnmanagedType.LPStr)> SearchOrder As StringBuilder, <MarshalAs(UnmanagedType.LPStr)> UserDirectory As StringBuilder) As Integer
    Public Declare Function DTWAIN_GetDTWAINHandle Lib "dtwain32d.dll" () As System.IntPtr
    Public Declare Function DTWAIN_GetDeviceEvent Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef lpEvent As UInteger) As Integer
    Public Declare Function DTWAIN_GetDeviceEventEx Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef lpEvent As UInteger, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_GetDeviceEventInfo Lib "dtwain32d.dll" (Source As System.IntPtr, nWhichInfo As Integer, pValue As System.IntPtr) As Integer
    Public Declare Function DTWAIN_GetDeviceNotifications Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef DevEvents As Integer) As Integer
    ...
    Public Declare Function DTWAIN_GetDoubleFeedDetectLength Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef Value As System.Double, bCurrent As Integer) As Integer
    Public Declare Function DTWAIN_GetDoubleFeedDetectValues Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_GetDuplexType Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef lpDupType As Integer) As Integer
    Public Declare Function DTWAIN_GetDuplexTypeEx Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_GetErrorBuffer Lib "dtwain32d.dll" (ByRef ArrayBuffer As System.IntPtr) As Integer
    Public Declare Function DTWAIN_GetErrorBufferThreshold Lib "dtwain32d.dll" () As UInteger
    Public Declare Function DTWAIN_GetErrorCallback Lib "dtwain32d.dll" () As DTwainErrorProc
    Public Declare Function DTWAIN_GetErrorCallback64 Lib "dtwain32d.dll" () As DTwainErrorProc64
    ...
    Public Declare Function DTWAIN_GetExtImageInfo Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_GetExtImageInfoData Lib "dtwain32d.dll" (Source As System.IntPtr, nWhich As Integer, ByRef Data As System.IntPtr) As Integer
    Public Declare Function DTWAIN_GetExtImageInfoDataEx Lib "dtwain32d.dll" (Source As System.IntPtr, nWhich As Integer) As System.IntPtr
    Public Declare Function DTWAIN_GetExtImageInfoItem Lib "dtwain32d.dll" (Source As System.IntPtr, nWhich As Integer, ByRef InfoID As Integer, ByRef NumItems As Integer, ByRef Type As Integer) As Integer
    Public Declare Function DTWAIN_GetExtImageInfoItemEx Lib "dtwain32d.dll" (Source As System.IntPtr, nWhich As Integer, ByRef InfoID As Integer, ByRef NumItems As Integer, ByRef Type As Integer, ByRef ReturnCode As Integer) As Integer
    ...
    Public Declare Function DTWAIN_GetFeederAlignment Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef lpAlignment As Integer) As Integer
    Public Declare Function DTWAIN_GetFeederFuncs Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_GetFeederOrder Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef lpOrder As Integer) As Integer
    Public Declare Function DTWAIN_GetFeederWaitTime Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_GetFileCompressionType Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_GetFileSavePageCount Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    ...
    Public Declare Function DTWAIN_GetHighlight Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef Highlight As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_GetJobControl Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef pJobControl As Integer, bCurrent As Integer) As Integer
    Public Declare Function DTWAIN_GetJobControlEx Lib "dtwain32d.dll" (Source As System.IntPtr, bGetCurrent As Integer) As Integer
    Public Declare Function DTWAIN_GetJpegValues Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef pQuality As Integer, ByRef Progressive As Integer) As Integer
    Public Declare Function DTWAIN_GetJpegXRValues Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef pQuality As Integer, ByRef Progressive As Integer) As Integer
    Public Declare Function DTWAIN_GetLanguage Lib "dtwain32d.dll" () As Integer
    Public Declare Function DTWAIN_GetLastError Lib "dtwain32d.dll" () As Integer
    ...
    Public Declare Function DTWAIN_GetLightPath Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef lpLightPath As Integer) As Integer
    Public Declare Function DTWAIN_GetLightPathEx Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_GetLightSource Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef LightSource As Integer) As Integer
    Public Declare Function DTWAIN_GetLightSources Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef LightSources As System.IntPtr) As Integer
    Public Declare Function DTWAIN_GetLightSourcesEx Lib "dtwain32d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_GetLoggerCallback Lib "dtwain32d.dll" () As DTwainLoggerProc
    Public Declare Function DTWAIN_GetMajorMinorVersion Lib "dtwain32d.dll" (ByRef nMajor As UInteger, ByRef nMinor As UInteger) As Integer
    Public Declare Function DTWAIN_GetManualDuplexCount Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef pSide1 As Integer, ByRef pSide2 As Integer) As Integer
    Public Declare Function DTWAIN_GetMaxAcquisitions Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_GetMaxBuffers Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef pMaxBuf As UInteger) As Integer
    Public Declare Function DTWAIN_GetMaxBuffersEx Lib "dtwain32d.dll" (Source As System.IntPtr) As UInteger
    Public Declare Function DTWAIN_GetMaxPagesToAcquire Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_GetMaxRetryAttempts Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    ...
    Public Declare Function DTWAIN_GetNoiseFilter Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef lpNoiseFilter As Integer) As Integer
    Public Declare Function DTWAIN_GetNumAcquiredImages Lib "dtwain32d.dll" (aAcq As System.IntPtr, nWhich As Integer) As Integer
    Public Declare Function DTWAIN_GetNumAcquisitions Lib "dtwain32d.dll" (aAcq As System.IntPtr) As Integer
    Public Declare Function DTWAIN_GetOCRCapValues Lib "dtwain32d.dll" (Engine As System.IntPtr, OCRCapValue As Integer, TypeOfGet As Integer, ByRef CapValues As System.IntPtr) As Integer
    ...
    Public Declare Function DTWAIN_GetOCRLastError Lib "dtwain32d.dll" (Engine As System.IntPtr) As Integer
    Public Declare Function DTWAIN_GetOCRMajorMinorVersion Lib "dtwain32d.dll" (Engine As System.IntPtr, ByRef lpMajor As Integer, ByRef lpMinor As Integer) As Integer
    ...
    Public Declare Function DTWAIN_GetOCRTextInfoFloat Lib "dtwain32d.dll" (OCRTextInfo As System.IntPtr, nCharPos As Integer, nWhichItem As Integer, ByRef pInfo As System.Double) As Integer
    Public Declare Function DTWAIN_GetOCRTextInfoFloatEx Lib "dtwain32d.dll" (OCRTextInfo As System.IntPtr, nWhichItem As Integer, ByRef pInfo As System.Double, bufSize As Integer) As Integer
    Public Declare Function DTWAIN_GetOCRTextInfoHandle Lib "dtwain32d.dll" (Engine As System.IntPtr, nPageNo As Integer) As System.IntPtr
    Public Declare Function DTWAIN_GetOCRTextInfoLong Lib "dtwain32d.dll" (OCRTextInfo As System.IntPtr, nCharPos As Integer, nWhichItem As Integer, ByRef pInfo As Integer) As Integer
    Public Declare Function DTWAIN_GetOCRTextInfoLongEx Lib "dtwain32d.dll" (OCRTextInfo As System.IntPtr, nWhichItem As Integer, ByRef pInfo As Integer, bufSize As Integer) As Integer
    ...
    Public Declare Function DTWAIN_GetOrientation Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef lpOrient As Integer, bCurrent As Integer) As Integer
    Public Declare Function DTWAIN_GetOrientationEx Lib "dtwain32d.dll" (Source As System.IntPtr, bCurrent As Integer) As Integer
    Public Declare Function DTWAIN_GetOverscan Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef lpOverscan As Integer, bCurrent As Integer) As Integer
    Public Declare Function DTWAIN_GetPDFTextElementFloat Lib "dtwain32d.dll" (TextElement As System.IntPtr, ByRef val1 As System.Double, ByRef val2 As System.Double, Flags As Integer) As Integer
    Public Declare Function DTWAIN_GetPDFTextElementLong Lib "dtwain32d.dll" (TextElement As System.IntPtr, ByRef val1 As Integer, ByRef val2 As Integer, Flags As Integer) As Integer
    ...
    Public Declare Function DTWAIN_GetPaperSize Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef lpPaperSize As Integer, bCurrent As Integer) As Integer
    ...
    Public Declare Function DTWAIN_GetPatchcodeMaxPriorities Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef pMaxPriorities As UInteger, bCurrent As Integer) As Integer
    Public Declare Function DTWAIN_GetPatchcodeMaxRetries Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef pMaxRetries As UInteger, bCurrent As Integer) As Integer
    Public Declare Function DTWAIN_GetPatchcodePriorities Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef SearchPriorities As System.IntPtr) As Integer
    Public Declare Function DTWAIN_GetPatchcodeSearchMode Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef pSearchMode As Integer, bCurrent As Integer) As Integer
    Public Declare Function DTWAIN_GetPatchcodeTimeOut Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef pTimeOut As UInteger, bCurrent As Integer) As Integer
    Public Declare Function DTWAIN_GetPixelFlavor Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef lpPixelFlavor As Integer) As Integer
    Public Declare Function DTWAIN_GetPixelType Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef PixelType As Integer, ByRef BitDepth As Integer, bCurrent As Integer) As Integer
    Public Declare Function DTWAIN_GetPrinter Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef lpPrinter As Integer, bCurrent As Integer) As Integer
    Public Declare Function DTWAIN_GetPrinterEx Lib "dtwain32d.dll" (Source As System.IntPtr, bCurrent As Integer) As Integer
    Public Declare Function DTWAIN_GetPrinterStartNumber Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef nStart As UInteger) As Integer
    Public Declare Function DTWAIN_GetPrinterStartNumberEx Lib "dtwain32d.dll" (Source As System.IntPtr) As UInteger
    Public Declare Function DTWAIN_GetPrinterStringMode Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef PrinterMode As Integer, bCurrent As Integer) As Integer
    Public Declare Function DTWAIN_GetPrinterStringModeEx Lib "dtwain32d.dll" (Source As System.IntPtr, bCurrent As Integer) As Integer
    Public Declare Function DTWAIN_GetPrinterStrings Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef ArrayString As System.IntPtr) As Integer
    Public Declare Function DTWAIN_GetPrinterStringsEx Lib "dtwain32d.dll" (Source As System.IntPtr) As System.IntPtr
    ...
    Public Declare Function DTWAIN_GetRegisteredMsg Lib "dtwain32d.dll" () As Integer
    Public Declare Function DTWAIN_GetResolution Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef Resolution As System.Double) As Integer
    Public Declare Function DTWAIN_GetResolutionEx Lib "dtwain32d.dll" (Source As System.IntPtr) As System.Double
    ...
    Public Declare Function DTWAIN_GetRotation Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef Rotation As System.Double) As Integer
    Public Declare Function DTWAIN_GetRotationEx Lib "dtwain32d.dll" (Source As System.IntPtr) As System.Double
    ...
    Public Declare Function DTWAIN_GetShadow Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef Shadow As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_GetSourceAcquisitions Lib "dtwain32d.dll" (Source As System.IntPtr) As System.IntPtr
    ...
    Public Declare Function DTWAIN_GetSourceID Lib "dtwain32d.dll" (Source As System.IntPtr) As System.IntPtr
    ...
    Public Declare Function DTWAIN_GetSourceUnit Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef lpUnit As Integer) As Integer
    Public Declare Function DTWAIN_GetSourceUnitEx Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    ...
    Public Declare Function DTWAIN_GetSourceVersionNumber Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef pMajor As Integer, ByRef pMinor As Integer) As Integer
    Public Declare Function DTWAIN_GetStaticLibVersion Lib "dtwain32d.dll" () As Integer
    ...
    Public Declare Function DTWAIN_GetThreshold Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef Threshold As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_GetTwainAppID Lib "dtwain32d.dll" () As System.IntPtr
    Public Declare Function DTWAIN_GetTwainAvailability Lib "dtwain32d.dll" () As Integer
    ...
    Public Declare Function DTWAIN_GetTwainHwnd Lib "dtwain32d.dll" () As System.IntPtr
    ...
    Public Declare Function DTWAIN_GetVersionEx2 Lib "dtwain32d.dll" (ByRef lMajor As Integer, ByRef lMinor As Integer, ByRef lVersionType As Integer, ByRef lPatchLevel As Integer, ByRef lBuildNumber As Integer) As Integer
    ...
    Public Declare Function DTWAIN_GetXResolution Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef Resolution As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_GetYResolution Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef Resolution As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_InitExtImageInfo Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Ansi Function DTWAIN_InitImageFileAppend Lib "dtwain32d.dll" (szFile As String, fType As Integer) As Integer
    Public Declare Function DTWAIN_InitOCRInterface Lib "dtwain32d.dll" () As Integer
    Public Declare Function DTWAIN_IsAcquiring Lib "dtwain32d.dll" () As Integer
    Public Declare Function DTWAIN_IsAudioXferSupported Lib "dtwain32d.dll" (Source As System.IntPtr, supportVal As Integer) As Integer
    Public Declare Function DTWAIN_IsAutoBorderDetectEnabled Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsAutoBorderDetectSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsAutoBrightEnabled Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsAutoBrightSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsAutoDeskewEnabled Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsAutoDeskewSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsAutoFeedEnabled Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsAutoFeedSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsAutoRotateEnabled Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsAutoRotateSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsAutoScanEnabled Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsAutomaticSenseMediumEnabled Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsAutomaticSenseMediumSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsBarcodeCapsSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsBarcodeDetectionEnabled Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsBarcodeSupported Lib "dtwain32d.dll" (Source As System.IntPtr, BarCode As Integer) As Integer
    Public Declare Function DTWAIN_IsBlankPageDetectionOn Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsBufferedTileModeOn Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsBufferedTileModeSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsCapSupported Lib "dtwain32d.dll" (Source As System.IntPtr, lCapability As Integer) As Integer
    Public Declare Function DTWAIN_IsCompressionSupported Lib "dtwain32d.dll" (Source As System.IntPtr, Compression As Integer) As Integer
    Public Declare Function DTWAIN_IsCustomDSDataSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsDIBBlank Lib "dtwain32d.dll" (hDib As System.IntPtr, threshold As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_IsDeviceEventSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsDeviceOnLine Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsDoubleFeedDetectLengthSupported Lib "dtwain32d.dll" (Source As System.IntPtr, value As System.Double) As Integer
    Public Declare Function DTWAIN_IsDoubleFeedDetectSupported Lib "dtwain32d.dll" (Source As System.IntPtr, SupportVal As Integer) As Integer
    Public Declare Function DTWAIN_IsDoublePageCountOnDuplex Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsDuplexEnabled Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsDuplexSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsExtImageInfoSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsFeederEnabled Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsFeederLoaded Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsFeederSensitive Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsFeederSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    ...
    Public Declare Function DTWAIN_IsIAFieldAValueSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsIAFieldBLastPageSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsIAFieldBLevelSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsIAFieldBPrintFormatSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsIAFieldBValueSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsIAFieldCLastPageSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsIAFieldCLevelSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsIAFieldCPrintFormatSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsIAFieldCValueSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsIAFieldDLastPageSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsIAFieldDLevelSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsIAFieldDPrintFormatSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsIAFieldDValueSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsIAFieldELastPageSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsIAFieldELevelSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsIAFieldEPrintFormatSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsIAFieldEValueSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsImageAddressingSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsIndicatorEnabled Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsIndicatorSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsInitialized Lib "dtwain32d.dll" () As Integer
    Public Declare Function DTWAIN_IsJobControlSupported Lib "dtwain32d.dll" (Source As System.IntPtr, JobControl As Integer) As Integer
    Public Declare Function DTWAIN_IsLampEnabled Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsLampSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsLightPathSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsLightSourceSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsMaxBuffersSupported Lib "dtwain32d.dll" (Source As System.IntPtr, MaxBuf As Integer) As Integer
    Public Declare Function DTWAIN_IsMemFileXferSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsMsgNotifyEnabled Lib "dtwain32d.dll" () As Integer
    Public Declare Function DTWAIN_IsNotifyTripletsEnabled Lib "dtwain32d.dll" () As Integer
    Public Declare Function DTWAIN_IsOCREngineActivated Lib "dtwain32d.dll" (OCREngine As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsOpenSourcesOnSelect Lib "dtwain32d.dll" () As Integer
    Public Declare Function DTWAIN_IsOrientationSupported Lib "dtwain32d.dll" (Source As System.IntPtr, Orientation As Integer) As Integer
    Public Declare Function DTWAIN_IsOverscanSupported Lib "dtwain32d.dll" (Source As System.IntPtr, SupportValue As Integer) As Integer
    Public Declare Function DTWAIN_IsPaperDetectable Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsPaperSizeSupported Lib "dtwain32d.dll" (Source As System.IntPtr, PaperSize As Integer) As Integer
    Public Declare Function DTWAIN_IsPatchcodeCapsSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsPatchcodeDetectionEnabled Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsPatchcodeSupported Lib "dtwain32d.dll" (Source As System.IntPtr, PatchCode As Integer) As Integer
    Public Declare Function DTWAIN_IsPeekMessageLoopEnabled Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsPixelTypeSupported Lib "dtwain32d.dll" (Source As System.IntPtr, PixelType As Integer) As Integer
    Public Declare Function DTWAIN_IsPrinterEnabled Lib "dtwain32d.dll" (Source As System.IntPtr, Printer As Integer) As Integer
    Public Declare Function DTWAIN_IsPrinterSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsRotationSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsSessionEnabled Lib "dtwain32d.dll" () As Integer
    Public Declare Function DTWAIN_IsSkipImageInfoError Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsSourceAcquiring Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsSourceAcquiringEx Lib "dtwain32d.dll" (Source As System.IntPtr, bUIOnly As Integer) As Integer
    Public Declare Function DTWAIN_IsSourceInUIOnlyMode Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsSourceOpen Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsSourceSelected Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsSourceValid Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsThumbnailEnabled Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsThumbnailSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsTwainAvailable Lib "dtwain32d.dll" () As Integer
    ...
    Public Declare Function DTWAIN_IsTwainMsg Lib "dtwain32d.dll" (ByRef pMsg As WinMsg) As Integer
    Public Declare Function DTWAIN_IsUIControllable Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsUIEnabled Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsUIOnlySupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    ...
    Public Declare Function DTWAIN_LoadLanguageResource Lib "dtwain32d.dll" (nLanguage As Integer) As Integer
    Public Declare Function DTWAIN_LockMemory Lib "dtwain32d.dll" (h As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_LockMemoryEx Lib "dtwain32d.dll" (h As System.IntPtr) As System.IntPtr
    Public Declare Ansi Function DTWAIN_LogMessage Lib "dtwain32d.dll" (message As String) As Integer
    Public Declare Function DTWAIN_MakeRGB Lib "dtwain32d.dll" (red As Integer, green As Integer, blue As Integer) As Integer
    Public Declare Function DTWAIN_OpenSource Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_OpenSourcesOnSelect Lib "dtwain32d.dll" (bSet As Integer) As Integer
    Public Declare Function DTWAIN_RangeCreate Lib "dtwain32d.dll" (nEnumType As Integer) As System.IntPtr
    Public Declare Function DTWAIN_RangeCreateFromCap Lib "dtwain32d.dll" (Source As System.IntPtr, lCapType As Integer) As System.IntPtr
    Public Declare Function DTWAIN_RangeDestroy Lib "dtwain32d.dll" (pSource As System.IntPtr) As Integer
    Public Declare Function DTWAIN_RangeExpand Lib "dtwain32d.dll" (pSource As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_RangeExpandEx Lib "dtwain32d.dll" (Range As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_RangeGetAll Lib "dtwain32d.dll" (pArray As System.IntPtr, pVariantLow As System.IntPtr, pVariantUp As System.IntPtr, pVariantStep As System.IntPtr, pVariantDefault As System.IntPtr, pVariantCurrent As System.IntPtr) As Integer
    Public Declare Function DTWAIN_RangeGetAllFloat Lib "dtwain32d.dll" (pArray As System.IntPtr, ByRef pVariantLow As System.Double, ByRef pVariantUp As System.Double, ByRef pVariantStep As System.Double, ByRef pVariantDefault As System.Double, ByRef pVariantCurrent As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_RangeGetAllLong Lib "dtwain32d.dll" (pArray As System.IntPtr, ByRef pVariantLow As Integer, ByRef pVariantUp As Integer, ByRef pVariantStep As Integer, ByRef pVariantDefault As Integer, ByRef pVariantCurrent As Integer) As Integer
    Public Declare Function DTWAIN_RangeGetCount Lib "dtwain32d.dll" (pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_RangeGetExpValue Lib "dtwain32d.dll" (pArray As System.IntPtr, lPos As Integer, pVariant As System.IntPtr) As Integer
    Public Declare Function DTWAIN_RangeGetExpValueFloat Lib "dtwain32d.dll" (pArray As System.IntPtr, lPos As Integer, ByRef pVal As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_RangeGetExpValueLong Lib "dtwain32d.dll" (pArray As System.IntPtr, lPos As Integer, ByRef pVal As Integer) As Integer
    Public Declare Function DTWAIN_RangeGetNearestValue Lib "dtwain32d.dll" (pArray As System.IntPtr, pVariantIn As System.IntPtr, pVariantOut As System.IntPtr, RoundType As Integer) As Integer
    Public Declare Function DTWAIN_RangeGetNearestValueFloat Lib "dtwain32d.dll" (pArray As System.IntPtr, dIn As System.Double, ByRef pOut As System.Double, RoundType As Integer) As Integer
    ...
    Public Declare Function DTWAIN_RangeGetNearestValueLong Lib "dtwain32d.dll" (pArray As System.IntPtr, lIn As Integer, ByRef pOut As Integer, RoundType As Integer) As Integer
    Public Declare Function DTWAIN_RangeGetPos Lib "dtwain32d.dll" (pArray As System.IntPtr, pVariant As System.IntPtr, ByRef pPos As Integer) As Integer
    Public Declare Function DTWAIN_RangeGetPosFloat Lib "dtwain32d.dll" (pArray As System.IntPtr, Val As System.Double, ByRef pPos As Integer) As Integer
    ...
    Public Declare Function DTWAIN_RangeGetPosLong Lib "dtwain32d.dll" (pArray As System.IntPtr, Value As Integer, ByRef pPos As Integer) As Integer
    Public Declare Function DTWAIN_RangeGetValue Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhich As Integer, pVariant As System.IntPtr) As Integer
    Public Declare Function DTWAIN_RangeGetValueFloat Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhich As Integer, ByRef pVal As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_RangeGetValueLong Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhich As Integer, ByRef pVal As Integer) As Integer
    Public Declare Function DTWAIN_RangeIsValid Lib "dtwain32d.dll" (Range As System.IntPtr, ByRef pStatus As Integer) As Integer
    Public Declare Function DTWAIN_RangeSetAll Lib "dtwain32d.dll" (pArray As System.IntPtr, pVariantLow As System.IntPtr, pVariantUp As System.IntPtr, pVariantStep As System.IntPtr, pVariantDefault As System.IntPtr, pVariantCurrent As System.IntPtr) As Integer
    Public Declare Function DTWAIN_RangeSetAllFloat Lib "dtwain32d.dll" (pArray As System.IntPtr, dLow As System.Double, dUp As System.Double, dStep As System.Double, dDefault As System.Double, dCurrent As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_RangeSetAllLong Lib "dtwain32d.dll" (pArray As System.IntPtr, lLow As Integer, lUp As Integer, lStep As Integer, lDefault As Integer, lCurrent As Integer) As Integer
    Public Declare Function DTWAIN_RangeSetValue Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhich As Integer, pVal As System.IntPtr) As Integer
    Public Declare Function DTWAIN_RangeSetValueFloat Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhich As Integer, Val As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_RangeSetValueLong Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhich As Integer, Val As Integer) As Integer
    Public Declare Function DTWAIN_RemovePDFTextElement Lib "dtwain32d.dll" (Source As System.IntPtr, TextElement As System.IntPtr) As Integer
    Public Declare Function DTWAIN_ResetPDFTextElement Lib "dtwain32d.dll" (TextElement As System.IntPtr) As Integer
    Public Declare Function DTWAIN_RewindPage Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_RotateImage Lib "dtwain32d.dll" (hDib As System.IntPtr, rotationAngle As System.Double) As System.IntPtr
    Public Declare Ansi Function DTWAIN_RotateImageString Lib "dtwain32d.dll" (hDib As System.IntPtr, rotationAngle As String) As System.IntPtr
    Public Declare Function DTWAIN_SelectDefaultOCREngine Lib "dtwain32d.dll" () As System.IntPtr
    Public Declare Function DTWAIN_SelectDefaultSource Lib "dtwain32d.dll" () As System.IntPtr
    Public Declare Function DTWAIN_SelectDefaultSourceWithOpen Lib "dtwain32d.dll" (bOpen As Integer) As System.IntPtr
    Public Declare Function DTWAIN_SelectOCREngine Lib "dtwain32d.dll" () As System.IntPtr
    ...
    Public Declare Function DTWAIN_SelectSource Lib "dtwain32d.dll" () As System.IntPtr
    ...
    Public Declare Function DTWAIN_SelectSourceWithOpen Lib "dtwain32d.dll" (bOpen As Integer) As System.IntPtr
    Public Declare Function DTWAIN_SetAcquireArea Lib "dtwain32d.dll" (Source As System.IntPtr, lSetType As Integer, FloatEnum As System.IntPtr, ActualEnum As System.IntPtr) As Integer
    Public Declare Function DTWAIN_SetAcquireArea2 Lib "dtwain32d.dll" (Source As System.IntPtr, left As System.Double, top As System.Double, right As System.Double, bottom As System.Double, lUnit As Integer, Flags As Integer) As Integer
    ...
    Public Declare Function DTWAIN_SetAcquireImageNegative Lib "dtwain32d.dll" (Source As System.IntPtr, IsNegative As Integer) As Integer
    Public Declare Function DTWAIN_SetAcquireImageScale Lib "dtwain32d.dll" (Source As System.IntPtr, xscale As System.Double, yscale As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_SetAcquireStripBuffer Lib "dtwain32d.dll" (Source As System.IntPtr, hMem As System.IntPtr) As Integer
    Public Declare Function DTWAIN_SetAcquireStripSize Lib "dtwain32d.dll" (Source As System.IntPtr, StripSize As UInteger) As Integer
    Public Declare Function DTWAIN_SetAlarmVolume Lib "dtwain32d.dll" (Source As System.IntPtr, Volume As Integer) As Integer
    Public Declare Function DTWAIN_SetAlarms Lib "dtwain32d.dll" (Source As System.IntPtr, Alarms As System.IntPtr) As Integer
    Public Declare Function DTWAIN_SetAllCapsToDefault Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    ...
    Public Declare Function DTWAIN_SetAvailablePrinters Lib "dtwain32d.dll" (Source As System.IntPtr, lpAvailPrinters As Integer) As Integer
    Public Declare Function DTWAIN_SetAvailablePrintersArray Lib "dtwain32d.dll" (Source As System.IntPtr, AvailPrinters As System.IntPtr) As Integer
    Public Declare Function DTWAIN_SetBarcodeMaxPriorities Lib "dtwain32d.dll" (Source As System.IntPtr, nMaxPriorities As UInteger) As Integer
    Public Declare Function DTWAIN_SetBarcodeMaxRetries Lib "dtwain32d.dll" (Source As System.IntPtr, nMaxRetries As UInteger) As Integer
    Public Declare Function DTWAIN_SetBarcodePriorities Lib "dtwain32d.dll" (Source As System.IntPtr, SearchPriorities As System.IntPtr) As Integer
    Public Declare Function DTWAIN_SetBarcodeSearchMode Lib "dtwain32d.dll" (Source As System.IntPtr, nSearchMode As Integer) As Integer
    Public Declare Function DTWAIN_SetBarcodeTimeOut Lib "dtwain32d.dll" (Source As System.IntPtr, TimeOutValue As UInteger) As Integer
    Public Declare Function DTWAIN_SetBitDepth Lib "dtwain32d.dll" (Source As System.IntPtr, BitDepth As Integer, bSetCurrent As Integer) As Integer
    Public Declare Function DTWAIN_SetBlankPageDetection Lib "dtwain32d.dll" (Source As System.IntPtr, threshold As System.Double, discard_option As Integer, bSet As Integer) As Integer
    Public Declare Function DTWAIN_SetBlankPageDetectionEx Lib "dtwain32d.dll" (Source As System.IntPtr, threshold As System.Double, autodetect As Integer, detectOpts As Integer, bSet As Integer) As Integer
    ...
    Public Declare Function DTWAIN_SetBrightness Lib "dtwain32d.dll" (Source As System.IntPtr, Brightness As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_SetBufferedTileMode Lib "dtwain32d.dll" (Source As System.IntPtr, bTileMode As Integer) As Integer
    Public Declare Function DTWAIN_SetCallback Lib "dtwain32d.dll" (Fn As DTwainCallback, UserData As Integer) As DTwainCallback
    Public Declare Function DTWAIN_SetCallback64 Lib "dtwain32d.dll" (Fn As DTwainCallback64, UserData As System.Int64) As DTwainCallback64
    Public Declare Ansi Function DTWAIN_SetCamera Lib "dtwain32d.dll" (Source As System.IntPtr, szCamera As String) As Integer
    Public Declare Function DTWAIN_SetCapValues Lib "dtwain32d.dll" (Source As System.IntPtr, lCap As Integer, lSetType As Integer, pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_SetCapValuesEx Lib "dtwain32d.dll" (Source As System.IntPtr, lCap As Integer, lSetType As Integer, lContainerType As Integer, pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_SetCapValuesEx2 Lib "dtwain32d.dll" (Source As System.IntPtr, lCap As Integer, lSetType As Integer, lContainerType As Integer, nDataType As Integer, pArray As System.IntPtr) As Integer
    Public Declare Ansi Function DTWAIN_SetCaption Lib "dtwain32d.dll" (Source As System.IntPtr, Caption As String) As Integer
    Public Declare Function DTWAIN_SetCompressionType Lib "dtwain32d.dll" (Source As System.IntPtr, lCompression As Integer, bSetCurrent As Integer) As Integer
    Public Declare Function DTWAIN_SetContrast Lib "dtwain32d.dll" (Source As System.IntPtr, Contrast As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_SetCountry Lib "dtwain32d.dll" (nCountry As Integer) As Integer
    Public Declare Function DTWAIN_SetCurrentRetryCount Lib "dtwain32d.dll" (Source As System.IntPtr, nCount As Integer) As Integer
    Public Declare Function DTWAIN_SetCustomDSData Lib "dtwain32d.dll" (Source As System.IntPtr, hData As System.IntPtr, <MarshalAs(UnmanagedType.LPArray, ArraySubType:=UnmanagedType.U8, SizeParamIndex:=3)> Data As Byte(), dSize As UInteger, nFlags As Integer) As Integer
    Public Declare Function DTWAIN_SetDSMSearchOrder Lib "dtwain32d.dll" (SearchPath As Integer) As Integer
    ...
    Public Declare Function DTWAIN_SetDefaultSource Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_SetDeviceNotifications Lib "dtwain32d.dll" (Source As System.IntPtr, DevEvents As Integer) As Integer
    ...
    Public Declare Function DTWAIN_SetDoubleFeedDetectLength Lib "dtwain32d.dll" (Source As System.IntPtr, Value As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_SetDoubleFeedDetectValues Lib "dtwain32d.dll" (Source As System.IntPtr, prray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_SetDoublePageCountOnDuplex Lib "dtwain32d.dll" (Source As System.IntPtr, bDoubleCount As Integer) As Integer
    Public Declare Function DTWAIN_SetEOJDetectValue Lib "dtwain32d.dll" (Source As System.IntPtr, nValue As Integer) As Integer
    Public Declare Function DTWAIN_SetErrorBufferThreshold Lib "dtwain32d.dll" (nErrors As UInteger) As Integer
    Public Declare Function DTWAIN_SetErrorCallback Lib "dtwain32d.dll" (proc As DTwainErrorProc, UserData As Integer) As Integer
    Public Declare Function DTWAIN_SetErrorCallback64 Lib "dtwain32d.dll" (proc As DTwainErrorProc64, UserData64 As System.Int64) As Integer
    Public Declare Function DTWAIN_SetFeederAlignment Lib "dtwain32d.dll" (Source As System.IntPtr, lpAlignment As Integer) As Integer
    Public Declare Function DTWAIN_SetFeederOrder Lib "dtwain32d.dll" (Source As System.IntPtr, lOrder As Integer) As Integer
    Public Declare Function DTWAIN_SetFeederWaitTime Lib "dtwain32d.dll" (Source As System.IntPtr, waitTime As Integer, flags As Integer) As Integer
    Public Declare Function DTWAIN_SetFileAutoIncrement Lib "dtwain32d.dll" (Source As System.IntPtr, Increment As Integer, bResetOnAcquire As Integer, bSet As Integer) As Integer
    Public Declare Function DTWAIN_SetFileCompressionType Lib "dtwain32d.dll" (Source As System.IntPtr, lCompression As Integer, bIsCustom As Integer) As Integer
    ...
    Public Declare Function DTWAIN_SetFileXferFormat Lib "dtwain32d.dll" (Source As System.IntPtr, lFileType As Integer, bSetCurrent As Integer) As Integer
    ...
    Public Declare Function DTWAIN_SetHighlight Lib "dtwain32d.dll" (Source As System.IntPtr, Highlight As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_SetJobControl Lib "dtwain32d.dll" (Source As System.IntPtr, JobControl As Integer, bSetCurrent As Integer) As Integer
    Public Declare Function DTWAIN_SetJpegValues Lib "dtwain32d.dll" (Source As System.IntPtr, Quality As Integer, Progressive As Integer) As Integer
    Public Declare Function DTWAIN_SetJpegXRValues Lib "dtwain32d.dll" (Source As System.IntPtr, Quality As Integer, Progressive As Integer) As Integer
    Public Declare Function DTWAIN_SetLanguage Lib "dtwain32d.dll" (nLanguage As Integer) As Integer
    Public Declare Function DTWAIN_SetLastError Lib "dtwain32d.dll" (nError As Integer) As Integer
    Public Declare Function DTWAIN_SetLightPath Lib "dtwain32d.dll" (Source As System.IntPtr, LightPath As Integer) As Integer
    Public Declare Function DTWAIN_SetLightPathEx Lib "dtwain32d.dll" (Source As System.IntPtr, LightPaths As System.IntPtr) As Integer
    Public Declare Function DTWAIN_SetLightSource Lib "dtwain32d.dll" (Source As System.IntPtr, LightSource As Integer) As Integer
    Public Declare Function DTWAIN_SetLightSources Lib "dtwain32d.dll" (Source As System.IntPtr, LightSources As System.IntPtr) As Integer
    Public Declare Function DTWAIN_SetLogSaveThreshold Lib "dtwain32d.dll" (lineCount As System.Int64) As Integer
    Public Declare Function DTWAIN_SetLoggerCallback Lib "dtwain32d.dll" (logProc As DTwainLoggerProc, UserData As System.Int64) As Integer
    Public Declare Function DTWAIN_SetMajorMinorVersion Lib "dtwain32d.dll" (nMajor As UInteger, nMinor As UInteger) As Integer
    Public Declare Function DTWAIN_SetManualDuplexMode Lib "dtwain32d.dll" (Source As System.IntPtr, Flags As Integer, bSet As Integer) As Integer
    Public Declare Function DTWAIN_SetMaxAcquisitions Lib "dtwain32d.dll" (Source As System.IntPtr, MaxAcquires As Integer) As Integer
    Public Declare Function DTWAIN_SetMaxBuffers Lib "dtwain32d.dll" (Source As System.IntPtr, MaxBuf As UInteger) As Integer
    Public Declare Function DTWAIN_SetMaxRetryAttempts Lib "dtwain32d.dll" (Source As System.IntPtr, nAttempts As Integer) As Integer
    Public Declare Function DTWAIN_SetMultipageScanMode Lib "dtwain32d.dll" (Source As System.IntPtr, ScanType As Integer) As Integer
    Public Declare Function DTWAIN_SetNoiseFilter Lib "dtwain32d.dll" (Source As System.IntPtr, NoiseFilter As Integer) As Integer
    Public Declare Function DTWAIN_SetOCRCapValues Lib "dtwain32d.dll" (Engine As System.IntPtr, OCRCapValue As Integer, SetType As Integer, CapValues As System.IntPtr) As Integer
    Public Declare Function DTWAIN_SetOrientation Lib "dtwain32d.dll" (Source As System.IntPtr, Orient As Integer, bSetCurrent As Integer) As Integer
    Public Declare Function DTWAIN_SetOverscan Lib "dtwain32d.dll" (Source As System.IntPtr, Value As Integer, bSetCurrent As Integer) As Integer
    Public Declare Function DTWAIN_SetPDFAESEncryption Lib "dtwain32d.dll" (Source As System.IntPtr, nWhichEncryption As Integer, bUseAES As Integer) As Integer
    Public Declare Function DTWAIN_SetPDFASCIICompression Lib "dtwain32d.dll" (Source As System.IntPtr, bSet As Integer) As Integer
    Public Declare Ansi Function DTWAIN_SetPDFAuthor Lib "dtwain32d.dll" (Source As System.IntPtr, lpAuthor As String) As Integer
    Public Declare Function DTWAIN_SetPDFCompression Lib "dtwain32d.dll" (Source As System.IntPtr, bCompression As Integer) As Integer
    ...
    Public Declare Function DTWAIN_SetPDFJpegQuality Lib "dtwain32d.dll" (Source As System.IntPtr, Quality As Integer) As Integer
    ...
    Public Declare Function DTWAIN_SetPDFOCRConversion Lib "dtwain32d.dll" (Engine As System.IntPtr, PageType As Integer, FileType As Integer, PixelType As Integer, BitDepth As Integer, Options As Integer) As Integer
    Public Declare Function DTWAIN_SetPDFOCRMode Lib "dtwain32d.dll" (Source As System.IntPtr, bSet As Integer) As Integer
    Public Declare Function DTWAIN_SetPDFOrientation Lib "dtwain32d.dll" (Source As System.IntPtr, lPOrientation As Integer) As Integer
    Public Declare Function DTWAIN_SetPDFPageScale Lib "dtwain32d.dll" (Source As System.IntPtr, nOptions As Integer, xScale As System.Double, yScale As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_SetPDFPageSize Lib "dtwain32d.dll" (Source As System.IntPtr, PageSize As Integer, CustomWidth As System.Double, CustomHeight As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_SetPDFPolarity Lib "dtwain32d.dll" (Source As System.IntPtr, Polarity As Integer) As Integer
    ...
    Public Declare Function DTWAIN_SetPDFTextElementFloat Lib "dtwain32d.dll" (TextElement As System.IntPtr, val1 As System.Double, val2 As System.Double, Flags As Integer) As Integer
    ...
    Public Declare Function DTWAIN_SetPDFTextElementLong Lib "dtwain32d.dll" (TextElement As System.IntPtr, val1 As Integer, val2 As Integer, Flags As Integer) As Integer
    ...
    Public Declare Function DTWAIN_SetPaperSize Lib "dtwain32d.dll" (Source As System.IntPtr, PaperSize As Integer, bSetCurrent As Integer) As Integer
    Public Declare Function DTWAIN_SetPatchcodeMaxPriorities Lib "dtwain32d.dll" (Source As System.IntPtr, nMaxSearchRetries As UInteger) As Integer
    Public Declare Function DTWAIN_SetPatchcodeMaxRetries Lib "dtwain32d.dll" (Source As System.IntPtr, nMaxRetries As UInteger) As Integer
    Public Declare Function DTWAIN_SetPatchcodePriorities Lib "dtwain32d.dll" (Source As System.IntPtr, SearchPriorities As System.IntPtr) As Integer
    Public Declare Function DTWAIN_SetPatchcodeSearchMode Lib "dtwain32d.dll" (Source As System.IntPtr, nSearchMode As Integer) As Integer
    Public Declare Function DTWAIN_SetPatchcodeTimeOut Lib "dtwain32d.dll" (Source As System.IntPtr, TimeOutValue As UInteger) As Integer
    Public Declare Function DTWAIN_SetPixelFlavor Lib "dtwain32d.dll" (Source As System.IntPtr, PixelFlavor As Integer) As Integer
    Public Declare Function DTWAIN_SetPixelType Lib "dtwain32d.dll" (Source As System.IntPtr, PixelType As Integer, BitDepth As Integer, bSetCurrent As Integer) As Integer
    ...
    Public Declare Function DTWAIN_SetPostScriptType Lib "dtwain32d.dll" (Source As System.IntPtr, PSType As Integer) As Integer
    Public Declare Function DTWAIN_SetPrinter Lib "dtwain32d.dll" (Source As System.IntPtr, Printer As Integer, bCurrent As Integer) As Integer
    Public Declare Function DTWAIN_SetPrinterEx Lib "dtwain32d.dll" (Source As System.IntPtr, Printer As Integer, bCurrent As Integer) As Integer
    Public Declare Function DTWAIN_SetPrinterStartNumber Lib "dtwain32d.dll" (Source As System.IntPtr, nStart As UInteger) As Integer
    Public Declare Function DTWAIN_SetPrinterStringMode Lib "dtwain32d.dll" (Source As System.IntPtr, PrinterMode As Integer, bSetCurrent As Integer) As Integer
    Public Declare Function DTWAIN_SetPrinterStrings Lib "dtwain32d.dll" (Source As System.IntPtr, ArrayString As System.IntPtr, ByRef pNumStrings As Integer) As Integer
    ...
    Public Declare Function DTWAIN_SetQueryCapSupport Lib "dtwain32d.dll" (bSet As Integer) As Integer
    Public Declare Function DTWAIN_SetResolution Lib "dtwain32d.dll" (Source As System.IntPtr, Resolution As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_SetRotation Lib "dtwain32d.dll" (Source As System.IntPtr, Rotation As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_SetShadow Lib "dtwain32d.dll" (Source As System.IntPtr, Shadow As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_SetSourceUnit Lib "dtwain32d.dll" (Source As System.IntPtr, Unit As Integer) As Integer
    Public Declare Function DTWAIN_SetTIFFCompressType Lib "dtwain32d.dll" (Source As System.IntPtr, Setting As Integer) As Integer
    Public Declare Function DTWAIN_SetTIFFInvert Lib "dtwain32d.dll" (Source As System.IntPtr, Setting As Integer) As Integer
    ...
    Public Declare Function DTWAIN_SetThreshold Lib "dtwain32d.dll" (Source As System.IntPtr, Threshold As System.Double, bSetBithDepthReduction As Integer) As Integer
    ...
    Public Declare Function DTWAIN_SetYResolution Lib "dtwain32d.dll" (Source As System.IntPtr, yResolution As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_ShowUIOnly Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_ShutdownOCREngine Lib "dtwain32d.dll" (OCREngine As System.IntPtr) As Integer
    Public Declare Function DTWAIN_SkipImageInfoError Lib "dtwain32d.dll" (Source As System.IntPtr, bSkip As Integer) As Integer
    Public Declare Function DTWAIN_StartThread Lib "dtwain32d.dll" (DLLHandle As System.IntPtr) As Integer
    ...
    Public Declare Function DTWAIN_SysInitializeLib Lib "dtwain32d.dll" (hInstance As System.IntPtr) As System.IntPtr
