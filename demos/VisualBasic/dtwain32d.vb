...
Class DTWAINAPI
    ...
    Declare Ansi Function DTWAIN_AcquireAudioFile Lib "dtwain32d.dll" (Source As System.IntPtr, lpszFile As String, lFileFlags As Integer, lMaxClips As Integer, bShowUI As Integer, bCloseSource As Integer, ByRef pStatus As Integer) As Integer
    Declare Ansi Function DTWAIN_AcquireAudioFileA Lib "dtwain32d.dll" (Source As System.IntPtr, lpszFile As String, lFileFlags As Integer, lNumClips As Integer, bShowUI As Integer, bCloseSource As Integer, ByRef pStatus As Integer) As Integer
    Declare Unicode Function DTWAIN_AcquireAudioFileW Lib "dtwain32d.dll" (Source As System.IntPtr, lpszFile As String, lFileFlags As Integer, lNumClips As Integer, bShowUI As Integer, bCloseSource As Integer, ByRef pStatus As Integer) As Integer
    ...
    Declare Ansi Function DTWAIN_AcquireFile Lib "dtwain32d.dll" (Source As System.IntPtr, lpszFile As String, lFileType As Integer, lFileFlags As Integer, PixelType As Integer, lMaxPages As Integer, bShowUI As Integer, bCloseSource As Integer, ByRef pStatus As Integer) As Integer
    Declare Ansi Function DTWAIN_AcquireFileA Lib "dtwain32d.dll" (Source As System.IntPtr, lpszFile As String, lFileType As Integer, lFileFlags As Integer, PixelType As Integer, lMaxPages As Integer, bShowUI As Integer, bCloseSource As Integer, ByRef pStatus As Integer) As Integer
    ...
    Declare Unicode Function DTWAIN_AcquireFileW Lib "dtwain32d.dll" (Source As System.IntPtr, lpszFile As String, lFileType As Integer, lFileFlags As Integer, PixelType As Integer, lMaxPages As Integer, bShowUI As Integer, bCloseSource As Integer, ByRef pStatus As Integer) As Integer
    ...
    Declare Ansi Function DTWAIN_AddFileToAppend Lib "dtwain32d.dll" (szFile As String) As Integer
    Declare Ansi Function DTWAIN_AddFileToAppendA Lib "dtwain32d.dll" (szFile As String) As Integer
    Declare Unicode Function DTWAIN_AddFileToAppendW Lib "dtwain32d.dll" (szFile As String) As Integer
    Declare Ansi Function DTWAIN_AddPDFText Lib "dtwain32d.dll" (Source As System.IntPtr, szText As String, xPos As Integer, yPos As Integer, fontName As String, fontSize As System.Double, colorRGB As Integer, renderMode As Integer, scaling As System.Double, charSpacing As System.Double, wordSpacing As System.Double, strokeWidth As Integer, Flags As UInteger) As Integer
    ...
    Declare Auto Function DTWAIN_AddPDFTextEx Lib "dtwain32d.dll" (Source As System.IntPtr, TextElement As System.IntPtr, Flags As UInteger) As Integer
    Declare Unicode Function DTWAIN_AddPDFTextW Lib "dtwain32d.dll" (Source As System.IntPtr, szText As String, xPos As Integer, yPos As Integer, fontName As String, fontSize As System.Double, colorRGB As Integer, renderMode As Integer, scaling As System.Double, charSpacing As System.Double, wordSpacing As System.Double, strokeWidth As Integer, Flags As UInteger) As Integer
    Declare Auto Function DTWAIN_AllocateMemory Lib "dtwain32d.dll" (memSize As UInteger) As System.IntPtr
    Declare Auto Function DTWAIN_AllocateMemory64 Lib "dtwain32d.dll" (memSize As System.UInt64) As System.IntPtr
    Declare Auto Function DTWAIN_AllocateMemoryEx Lib "dtwain32d.dll" (memSize As UInteger) As System.IntPtr
    Declare Auto Function DTWAIN_AppHandlesExceptions Lib "dtwain32d.dll" (bSet As Integer) As Integer
    Declare Auto Function DTWAIN_ArrayANSIStringToFloat Lib "dtwain32d.dll" (StringArray As System.IntPtr) As System.IntPtr
    Declare Auto Function DTWAIN_ArrayAdd Lib "dtwain32d.dll" (pArray As System.IntPtr, pVariant As System.IntPtr) As Integer
    Declare Ansi Function DTWAIN_ArrayAddANSIString Lib "dtwain32d.dll" (pArray As System.IntPtr, Val As String) As Integer
    Declare Ansi Function DTWAIN_ArrayAddANSIStringN Lib "dtwain32d.dll" (pArray As System.IntPtr, Val As String, num As Integer) As Integer
    Declare Auto Function DTWAIN_ArrayAddFloat Lib "dtwain32d.dll" (pArray As System.IntPtr, Val As System.Double) As Integer
    Declare Auto Function DTWAIN_ArrayAddFloatN Lib "dtwain32d.dll" (pArray As System.IntPtr, Val As System.Double, num As Integer) As Integer
    Declare Ansi Function DTWAIN_ArrayAddFloatString Lib "dtwain32d.dll" (pArray As System.IntPtr, Val As String) As Integer
    Declare Ansi Function DTWAIN_ArrayAddFloatStringA Lib "dtwain32d.dll" (pArray As System.IntPtr, Val As String) As Integer
    Declare Ansi Function DTWAIN_ArrayAddFloatStringN Lib "dtwain32d.dll" (pArray As System.IntPtr, Val As String, num As Integer) As Integer
    Declare Ansi Function DTWAIN_ArrayAddFloatStringNA Lib "dtwain32d.dll" (pArray As System.IntPtr, Val As String, num As Integer) As Integer
    Declare Unicode Function DTWAIN_ArrayAddFloatStringNW Lib "dtwain32d.dll" (pArray As System.IntPtr, Val As String, num As Integer) As Integer
    Declare Unicode Function DTWAIN_ArrayAddFloatStringW Lib "dtwain32d.dll" (pArray As System.IntPtr, Val As String) As Integer
    Declare Auto Function DTWAIN_ArrayAddFrame Lib "dtwain32d.dll" (pArray As System.IntPtr, frame As System.IntPtr) As Integer
    Declare Auto Function DTWAIN_ArrayAddFrameN Lib "dtwain32d.dll" (pArray As System.IntPtr, frame As System.IntPtr, num As Integer) As Integer
    Declare Auto Function DTWAIN_ArrayAddLong Lib "dtwain32d.dll" (pArray As System.IntPtr, Val As Integer) As Integer
    Declare Auto Function DTWAIN_ArrayAddLong64 Lib "dtwain32d.dll" (pArray As System.IntPtr, Val As System.Int64) As Integer
    Declare Auto Function DTWAIN_ArrayAddLong64N Lib "dtwain32d.dll" (pArray As System.IntPtr, Val As System.Int64, num As Integer) As Integer
    ...
    Declare Ansi Function DTWAIN_ArrayAddString Lib "dtwain32d.dll" (pArray As System.IntPtr, Val As String) As Integer
    Declare Ansi Function DTWAIN_ArrayAddStringA Lib "dtwain32d.dll" (pArray As System.IntPtr, Val As String) As Integer
    Declare Ansi Function DTWAIN_ArrayAddStringN Lib "dtwain32d.dll" (pArray As System.IntPtr, Val As String, num As Integer) As Integer
    Declare Ansi Function DTWAIN_ArrayAddStringNA Lib "dtwain32d.dll" (pArray As System.IntPtr, Val As String, num As Integer) As Integer
    Declare Unicode Function DTWAIN_ArrayAddStringNW Lib "dtwain32d.dll" (pArray As System.IntPtr, Val As String, num As Integer) As Integer
    Declare Unicode Function DTWAIN_ArrayAddStringW Lib "dtwain32d.dll" (pArray As System.IntPtr, Val As String) As Integer
    Declare Unicode Function DTWAIN_ArrayAddWideString Lib "dtwain32d.dll" (pArray As System.IntPtr, Val As String) As Integer
    Declare Unicode Function DTWAIN_ArrayAddWideStringN Lib "dtwain32d.dll" (pArray As System.IntPtr, Val As String, num As Integer) As Integer
    ...
    Declare Auto Function DTWAIN_ArrayCreateFromLong64s Lib "dtwain32d.dll" (ByRef pCArray As System.Int64, nSize As Integer) As System.IntPtr
    ...
    Declare Auto Function DTWAIN_ArrayCreateFromReals Lib "dtwain32d.dll" (ByRef pCArray As System.Double, nSize As Integer) As System.IntPtr
    ...
    Declare Ansi Function DTWAIN_ArrayFindANSIString Lib "dtwain32d.dll" (pArray As System.IntPtr, pString As String) As Integer
    Declare Auto Function DTWAIN_ArrayFindFloat Lib "dtwain32d.dll" (pArray As System.IntPtr, Val As System.Double, Tolerance As System.Double) As Integer
    Declare Ansi Function DTWAIN_ArrayFindFloatString Lib "dtwain32d.dll" (pArray As System.IntPtr, Val As String, Tolerance As String) As Integer
    Declare Ansi Function DTWAIN_ArrayFindFloatStringA Lib "dtwain32d.dll" (pArray As System.IntPtr, Val As String, Tolerance As String) As Integer
    Declare Unicode Function DTWAIN_ArrayFindFloatStringW Lib "dtwain32d.dll" (pArray As System.IntPtr, Val As String, Tolerance As String) As Integer
    Declare Auto Function DTWAIN_ArrayFindLong Lib "dtwain32d.dll" (pArray As System.IntPtr, Val As Integer) As Integer
    Declare Auto Function DTWAIN_ArrayFindLong64 Lib "dtwain32d.dll" (pArray As System.IntPtr, Val As System.Int64) As Integer
    Declare Ansi Function DTWAIN_ArrayFindString Lib "dtwain32d.dll" (pArray As System.IntPtr, pString As String) As Integer
    Declare Ansi Function DTWAIN_ArrayFindStringA Lib "dtwain32d.dll" (pArray As System.IntPtr, pString As String) As Integer
    Declare Unicode Function DTWAIN_ArrayFindStringW Lib "dtwain32d.dll" (pArray As System.IntPtr, pString As String) As Integer
    Declare Unicode Function DTWAIN_ArrayFindWideString Lib "dtwain32d.dll" (pArray As System.IntPtr, pString As String) As Integer
    Declare Auto Function DTWAIN_ArrayFix32GetAt Lib "dtwain32d.dll" (aFix32 As System.IntPtr, lPos As Integer, ByRef Whole As Integer, ByRef Frac As Integer) As Integer
    Declare Auto Function DTWAIN_ArrayFix32SetAt Lib "dtwain32d.dll" (aFix32 As System.IntPtr, lPos As Integer, Whole As Integer, Frac As Integer) As Integer
    Declare Auto Function DTWAIN_ArrayFloatToANSIString Lib "dtwain32d.dll" (FloatArray As System.IntPtr) As System.IntPtr
    Declare Auto Function DTWAIN_ArrayFloatToString Lib "dtwain32d.dll" (FloatArray As System.IntPtr) As System.IntPtr
    Declare Auto Function DTWAIN_ArrayFloatToWideString Lib "dtwain32d.dll" (FloatArray As System.IntPtr) As System.IntPtr
    ...
    Declare Ansi Function DTWAIN_ArrayGetAtANSIString Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer, <MarshalAs(UnmanagedType.LPStr)> pStr As StringBuilder) As Integer
    Declare Auto Function DTWAIN_ArrayGetAtFloat Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer, ByRef pVal As System.Double) As Integer
    Declare Ansi Function DTWAIN_ArrayGetAtFloatString Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer, <MarshalAs(UnmanagedType.LPStr)> Val As StringBuilder) As Integer
    Declare Ansi Function DTWAIN_ArrayGetAtFloatStringA Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer, <MarshalAs(UnmanagedType.LPStr)> Val As StringBuilder) As Integer
    Declare Unicode Function DTWAIN_ArrayGetAtFloatStringW Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer, <MarshalAs(UnmanagedType.LPWStr)> Val As StringBuilder) As Integer
    Declare Auto Function DTWAIN_ArrayGetAtFrame Lib "dtwain32d.dll" (FrameArray As System.IntPtr, nWhere As Integer, ByRef pleft As System.Double, ByRef ptop As System.Double, ByRef pright As System.Double, ByRef pbottom As System.Double) As Integer
    Declare Auto Function DTWAIN_ArrayGetAtFrameEx Lib "dtwain32d.dll" (FrameArray As System.IntPtr, nWhere As Integer, Frame As System.IntPtr) As Integer
    Declare Ansi Function DTWAIN_ArrayGetAtFrameString Lib "dtwain32d.dll" (FrameArray As System.IntPtr, nWhere As Integer, <MarshalAs(UnmanagedType.LPStr)> left As StringBuilder, <MarshalAs(UnmanagedType.LPStr)> top As StringBuilder, <MarshalAs(UnmanagedType.LPStr)> right As StringBuilder, <MarshalAs(UnmanagedType.LPStr)> bottom As StringBuilder) As Integer
    Declare Ansi Function DTWAIN_ArrayGetAtFrameStringA Lib "dtwain32d.dll" (FrameArray As System.IntPtr, nWhere As Integer, <MarshalAs(UnmanagedType.LPStr)> left As StringBuilder, <MarshalAs(UnmanagedType.LPStr)> top As StringBuilder, <MarshalAs(UnmanagedType.LPStr)> right As StringBuilder, <MarshalAs(UnmanagedType.LPStr)> bottom As StringBuilder) As Integer
    Declare Unicode Function DTWAIN_ArrayGetAtFrameStringW Lib "dtwain32d.dll" (FrameArray As System.IntPtr, nWhere As Integer, <MarshalAs(UnmanagedType.LPWStr)> left As StringBuilder, <MarshalAs(UnmanagedType.LPWStr)> top As StringBuilder, <MarshalAs(UnmanagedType.LPWStr)> right As StringBuilder, <MarshalAs(UnmanagedType.LPWStr)> bottom As StringBuilder) As Integer
    ...
    Declare Auto Function DTWAIN_ArrayGetAtLong64 Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer, ByRef pVal As System.Int64) As Integer
    ...
    Declare Ansi Function DTWAIN_ArrayGetAtString Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer, <MarshalAs(UnmanagedType.LPStr)> pStr As StringBuilder) As Integer
    Declare Ansi Function DTWAIN_ArrayGetAtStringA Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer, <MarshalAs(UnmanagedType.LPStr)> pStr As StringBuilder) As Integer
    ...
    Declare Unicode Function DTWAIN_ArrayGetAtWideString Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer, <MarshalAs(UnmanagedType.LPWStr)> pStr As StringBuilder) As Integer
    ...
    Declare Ansi Function DTWAIN_ArrayInsertAtANSIString Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer, pVal As String) As Integer
    Declare Ansi Function DTWAIN_ArrayInsertAtANSIStringN Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer, Val As String, num As Integer) As Integer
    Declare Auto Function DTWAIN_ArrayInsertAtFloat Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer, pVal As System.Double) As Integer
    Declare Auto Function DTWAIN_ArrayInsertAtFloatN Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer, Val As System.Double, num As Integer) As Integer
    Declare Ansi Function DTWAIN_ArrayInsertAtFloatString Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer, Val As String) As Integer
    Declare Ansi Function DTWAIN_ArrayInsertAtFloatStringA Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer, Val As String) As Integer
    Declare Ansi Function DTWAIN_ArrayInsertAtFloatStringN Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer, Val As String, num As Integer) As Integer
    Declare Ansi Function DTWAIN_ArrayInsertAtFloatStringNA Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer, Val As String, num As Integer) As Integer
    Declare Unicode Function DTWAIN_ArrayInsertAtFloatStringNW Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer, Val As String, num As Integer) As Integer
    Declare Unicode Function DTWAIN_ArrayInsertAtFloatStringW Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer, Val As String) As Integer
    Declare Auto Function DTWAIN_ArrayInsertAtFrame Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer, frame As System.IntPtr) As Integer
    Declare Auto Function DTWAIN_ArrayInsertAtFrameN Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer, frame As System.IntPtr, num As Integer) As Integer
    ...
    Declare Auto Function DTWAIN_ArrayInsertAtLong64 Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer, Val As System.Int64) As Integer
    Declare Auto Function DTWAIN_ArrayInsertAtLong64N Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer, Val As System.Int64, num As Integer) As Integer
    ...
    Declare Ansi Function DTWAIN_ArrayInsertAtString Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer, pVal As String) As Integer
    Declare Ansi Function DTWAIN_ArrayInsertAtStringA Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer, pVal As String) As Integer
    Declare Ansi Function DTWAIN_ArrayInsertAtStringN Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer, Val As String, num As Integer) As Integer
    Declare Ansi Function DTWAIN_ArrayInsertAtStringNA Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer, Val As String, num As Integer) As Integer
    Declare Unicode Function DTWAIN_ArrayInsertAtStringNW Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer, Val As String, num As Integer) As Integer
    Declare Unicode Function DTWAIN_ArrayInsertAtStringW Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer, pVal As String) As Integer
    Declare Unicode Function DTWAIN_ArrayInsertAtWideString Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer, pVal As String) As Integer
    Declare Unicode Function DTWAIN_ArrayInsertAtWideStringN Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer, Val As String, num As Integer) As Integer
    ...
    Declare Ansi Function DTWAIN_ArraySetAtANSIString Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer, pStr As String) As Integer
    Declare Auto Function DTWAIN_ArraySetAtFloat Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer, pVal As System.Double) As Integer
    Declare Ansi Function DTWAIN_ArraySetAtFloatString Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer, Val As String) As Integer
    Declare Ansi Function DTWAIN_ArraySetAtFloatStringA Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer, Val As String) As Integer
    Declare Unicode Function DTWAIN_ArraySetAtFloatStringW Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer, Val As String) As Integer
    Declare Auto Function DTWAIN_ArraySetAtFrame Lib "dtwain32d.dll" (FrameArray As System.IntPtr, nWhere As Integer, left As System.Double, top As System.Double, right As System.Double, bottom As System.Double) As Integer
    Declare Auto Function DTWAIN_ArraySetAtFrameEx Lib "dtwain32d.dll" (FrameArray As System.IntPtr, nWhere As Integer, Frame As System.IntPtr) As Integer
    Declare Ansi Function DTWAIN_ArraySetAtFrameString Lib "dtwain32d.dll" (FrameArray As System.IntPtr, nWhere As Integer, left As String, top As String, right As String, bottom As String) As Integer
    Declare Ansi Function DTWAIN_ArraySetAtFrameStringA Lib "dtwain32d.dll" (FrameArray As System.IntPtr, nWhere As Integer, left As String, top As String, right As String, bottom As String) As Integer
    Declare Unicode Function DTWAIN_ArraySetAtFrameStringW Lib "dtwain32d.dll" (FrameArray As System.IntPtr, nWhere As Integer, left As String, top As String, right As String, bottom As String) As Integer
    ...
    Declare Auto Function DTWAIN_ArraySetAtLong64 Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer, Val As System.Int64) As Integer
    Declare Ansi Function DTWAIN_ArraySetAtString Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer, pStr As String) As Integer
    Declare Ansi Function DTWAIN_ArraySetAtStringA Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer, pStr As String) As Integer
    Declare Unicode Function DTWAIN_ArraySetAtStringW Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer, pStr As String) As Integer
    Declare Unicode Function DTWAIN_ArraySetAtWideString Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhere As Integer, pStr As String) As Integer
    Declare Auto Function DTWAIN_ArrayStringToFloat Lib "dtwain32d.dll" (StringArray As System.IntPtr) As System.IntPtr
    Declare Auto Function DTWAIN_ArrayWideStringToFloat Lib "dtwain32d.dll" (StringArray As System.IntPtr) As System.IntPtr
    Declare Auto Function DTWAIN_CallCallback Lib "dtwain32d.dll" (wParam As Integer, lParam As Integer, UserData As Integer) As Integer
    Declare Auto Function DTWAIN_CallCallback64 Lib "dtwain32d.dll" (wParam As Integer, lParam As Integer, UserData As System.Int64) As Integer
    ...
    Declare Auto Function DTWAIN_ConvertDIBToFullBitmap Lib "dtwain32d.dll" (hDib As System.IntPtr, isBMP As Integer) As System.IntPtr
    Declare Ansi Function DTWAIN_ConvertToAPIString Lib "dtwain32d.dll" (lpOrigString As String) As System.IntPtr
    Declare Ansi Function DTWAIN_ConvertToAPIStringA Lib "dtwain32d.dll" (lpOrigString As String) As System.IntPtr
    Declare Ansi Function DTWAIN_ConvertToAPIStringEx Lib "dtwain32d.dll" (lpOrigString As String, <MarshalAs(UnmanagedType.LPStr)> lpOutString As StringBuilder, nSize As Integer) As Integer
    Declare Ansi Function DTWAIN_ConvertToAPIStringExA Lib "dtwain32d.dll" (lpOrigString As String, <MarshalAs(UnmanagedType.LPStr)> lpOutString As StringBuilder, nSize As Integer) As Integer
    Declare Unicode Function DTWAIN_ConvertToAPIStringExW Lib "dtwain32d.dll" (lpOrigString As String, <MarshalAs(UnmanagedType.LPWStr)> lpOutString As StringBuilder, nSize As Integer) As Integer
    Declare Unicode Function DTWAIN_ConvertToAPIStringW Lib "dtwain32d.dll" (lpOrigString As String) As System.IntPtr
    ...
    Declare Auto Function DTWAIN_DeleteDIB Lib "dtwain32d.dll" (hDib As System.IntPtr) As Integer
    ...
    Declare Auto Function DTWAIN_EnablePeekMessageLoop Lib "dtwain32d.dll" (Source As System.IntPtr, bSet As Integer) As Integer
    ...
    Declare Auto Function DTWAIN_EnableTripletsNotify Lib "dtwain32d.dll" (bSet As Integer) As Integer
    ...
    Declare Auto Function DTWAIN_EnumBottomCamerasEx Lib "dtwain32d.dll" (Source As System.IntPtr) As System.IntPtr
    ...
    Declare Auto Function DTWAIN_EnumCamerasEx Lib "dtwain32d.dll" (Source As System.IntPtr, nWhichCamera As Integer, ByRef Cameras As System.IntPtr) As Integer
    Declare Auto Function DTWAIN_EnumCamerasEx2 Lib "dtwain32d.dll" (Source As System.IntPtr) As System.IntPtr
    Declare Auto Function DTWAIN_EnumCamerasEx3 Lib "dtwain32d.dll" (Source As System.IntPtr, nWhichCamera As Integer) As System.IntPtr
    ...
    Declare Auto Function DTWAIN_EnumCompressionTypesEx2 Lib "dtwain32d.dll" (Source As System.IntPtr, lFileType As Integer, bUseBufferedMode As Integer) As System.IntPtr
    ...
    Declare Auto Function DTWAIN_EnumExtImageInfoTypesEx Lib "dtwain32d.dll" (Source As System.IntPtr) As System.IntPtr
    ...
    Declare Auto Function DTWAIN_EnumFileTypeBitsPerPixel Lib "dtwain32d.dll" (FileType As Integer, ByRef Array As System.IntPtr) As Integer
    ...
    Declare Auto Function DTWAIN_EnumPixelTypesEx Lib "dtwain32d.dll" (Source As System.IntPtr) As System.IntPtr
    ...
    Declare Ansi Function DTWAIN_EnumSourceValues Lib "dtwain32d.dll" (Source As System.IntPtr, capName As String, ByRef values As System.IntPtr, bExpandIfRange As Integer) As Integer
    Declare Ansi Function DTWAIN_EnumSourceValuesA Lib "dtwain32d.dll" (Source As System.IntPtr, capName As String, ByRef values As System.IntPtr, bExpandIfRange As Integer) As Integer
    Declare Unicode Function DTWAIN_EnumSourceValuesW Lib "dtwain32d.dll" (Source As System.IntPtr, capName As String, ByRef values As System.IntPtr, bExpandIfRange As Integer) As Integer
    ...
    Declare Auto Function DTWAIN_EnumSupportedExtImageInfoEx Lib "dtwain32d.dll" (Source As System.IntPtr) As System.IntPtr
    Declare Auto Function DTWAIN_EnumSupportedFileTypes Lib "dtwain32d.dll" () As System.IntPtr
    ...
    Declare Auto Function DTWAIN_EnumTopCamerasEx Lib "dtwain32d.dll" (Source As System.IntPtr) As System.IntPtr
    ...
    Declare Auto Function DTWAIN_EnumXResolutionValues Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr, bExpandIfRange As Integer) As Integer
    Declare Auto Function DTWAIN_EnumXResolutionValuesEx Lib "dtwain32d.dll" (Source As System.IntPtr, bExpandIfRange As Integer) As System.IntPtr
    Declare Auto Function DTWAIN_EnumYResolutionValues Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr, bExpandIfRange As Integer) As Integer
    Declare Auto Function DTWAIN_EnumYResolutionValuesEx Lib "dtwain32d.dll" (Source As System.IntPtr, bExpandIfRange As Integer) As System.IntPtr
    Declare Ansi Function DTWAIN_ExecuteOCR Lib "dtwain32d.dll" (Engine As System.IntPtr, szFileName As String, nStartPage As Integer, nEndPage As Integer) As Integer
    Declare Ansi Function DTWAIN_ExecuteOCRA Lib "dtwain32d.dll" (Engine As System.IntPtr, szFileName As String, nStartPage As Integer, nEndPage As Integer) As Integer
    Declare Unicode Function DTWAIN_ExecuteOCRW Lib "dtwain32d.dll" (Engine As System.IntPtr, szFileName As String, nStartPage As Integer, nEndPage As Integer) As Integer
    ...
    Declare Auto Function DTWAIN_FrameCreate Lib "dtwain32d.dll" (Left As System.Double, Top As System.Double, Right As System.Double, Bottom As System.Double) As System.IntPtr
    Declare Ansi Function DTWAIN_FrameCreateString Lib "dtwain32d.dll" (Left As String, Top As String, Right As String, Bottom As String) As System.IntPtr
    Declare Ansi Function DTWAIN_FrameCreateStringA Lib "dtwain32d.dll" (Left As String, Top As String, Right As String, Bottom As String) As System.IntPtr
    Declare Unicode Function DTWAIN_FrameCreateStringW Lib "dtwain32d.dll" (Left As String, Top As String, Right As String, Bottom As String) As System.IntPtr
    Declare Auto Function DTWAIN_FrameDestroy Lib "dtwain32d.dll" (Frame As System.IntPtr) As Integer
    Declare Auto Function DTWAIN_FrameGetAll Lib "dtwain32d.dll" (Frame As System.IntPtr, ByRef Left As System.Double, ByRef Top As System.Double, ByRef Right As System.Double, ByRef Bottom As System.Double) As Integer
    Declare Ansi Function DTWAIN_FrameGetAllString Lib "dtwain32d.dll" (Frame As System.IntPtr, <MarshalAs(UnmanagedType.LPStr)> Left As StringBuilder, <MarshalAs(UnmanagedType.LPStr)> Top As StringBuilder, <MarshalAs(UnmanagedType.LPStr)> Right As StringBuilder, <MarshalAs(UnmanagedType.LPStr)> Bottom As StringBuilder) As Integer
    ...
    Declare Auto Function DTWAIN_FrameGetValue Lib "dtwain32d.dll" (Frame As System.IntPtr, nWhich As Integer, ByRef Value As System.Double) As Integer
    Declare Ansi Function DTWAIN_FrameGetValueString Lib "dtwain32d.dll" (Frame As System.IntPtr, nWhich As Integer, <MarshalAs(UnmanagedType.LPStr)> Value As StringBuilder) As Integer
    Declare Ansi Function DTWAIN_FrameGetValueStringA Lib "dtwain32d.dll" (Frame As System.IntPtr, nWhich As Integer, <MarshalAs(UnmanagedType.LPStr)> Value As StringBuilder) As Integer
    ...
    Declare Auto Function DTWAIN_FrameSetAll Lib "dtwain32d.dll" (Frame As System.IntPtr, Left As System.Double, Top As System.Double, Right As System.Double, Bottom As System.Double) As Integer
    Declare Ansi Function DTWAIN_FrameSetAllString Lib "dtwain32d.dll" (Frame As System.IntPtr, Left As String, Top As String, Right As String, Bottom As String) As Integer
    Declare Ansi Function DTWAIN_FrameSetAllStringA Lib "dtwain32d.dll" (Frame As System.IntPtr, Left As String, Top As String, Right As String, Bottom As String) As Integer
    Declare Unicode Function DTWAIN_FrameSetAllStringW Lib "dtwain32d.dll" (Frame As System.IntPtr, Left As String, Top As String, Right As String, Bottom As String) As Integer
    Declare Auto Function DTWAIN_FrameSetValue Lib "dtwain32d.dll" (Frame As System.IntPtr, nWhich As Integer, Value As System.Double) As Integer
    Declare Ansi Function DTWAIN_FrameSetValueString Lib "dtwain32d.dll" (Frame As System.IntPtr, nWhich As Integer, Value As String) As Integer
    Declare Ansi Function DTWAIN_FrameSetValueStringA Lib "dtwain32d.dll" (Frame As System.IntPtr, nWhich As Integer, Value As String) As Integer
    Declare Unicode Function DTWAIN_FrameSetValueStringW Lib "dtwain32d.dll" (Frame As System.IntPtr, nWhich As Integer, Value As String) As Integer
    ...
    Declare Auto Function DTWAIN_GetAPIHandleStatus Lib "dtwain32d.dll" (pHandle As System.IntPtr) As Integer
    ...
    Declare Auto Function DTWAIN_GetAcquireArea2 Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef left As System.Double, ByRef top As System.Double, ByRef right As System.Double, ByRef bottom As System.Double, ByRef lpUnit As Integer) As Integer
    ...
    Declare Auto Function DTWAIN_GetAcquireAreaEx Lib "dtwain32d.dll" (Source As System.IntPtr, lGetType As Integer) As System.IntPtr
    ...
    Declare Ansi Function DTWAIN_GetActiveDSMPath Lib "dtwain32d.dll" (<MarshalAs(UnmanagedType.LPStr)> lpszBuffer As StringBuilder, nMaxLen As Integer) As Integer
    Declare Ansi Function DTWAIN_GetActiveDSMPathA Lib "dtwain32d.dll" (<MarshalAs(UnmanagedType.LPStr)> lpszBuffer As StringBuilder, nMaxLen As Integer) As Integer
    Declare Unicode Function DTWAIN_GetActiveDSMPathW Lib "dtwain32d.dll" (<MarshalAs(UnmanagedType.LPWStr)> lpszBuffer As StringBuilder, nMaxLen As Integer) As Integer
    Declare Ansi Function DTWAIN_GetActiveDSMVersionInfo Lib "dtwain32d.dll" (<MarshalAs(UnmanagedType.LPStr)> szDLLInfo As StringBuilder, nMaxLen As Integer) As Integer
    Declare Ansi Function DTWAIN_GetActiveDSMVersionInfoA Lib "dtwain32d.dll" (<MarshalAs(UnmanagedType.LPStr)> lpszBuffer As StringBuilder, nMaxLen As Integer) As Integer
    Declare Unicode Function DTWAIN_GetActiveDSMVersionInfoW Lib "dtwain32d.dll" (<MarshalAs(UnmanagedType.LPWStr)> lpszBuffer As StringBuilder, nMaxLen As Integer) As Integer
    ...
    Declare Auto Function DTWAIN_GetAllSourceDibs Lib "dtwain32d.dll" (Source As System.IntPtr) As System.IntPtr
    Declare Ansi Function DTWAIN_GetAppInfo Lib "dtwain32d.dll" (<MarshalAs(UnmanagedType.LPStr)> szVerStr As StringBuilder, <MarshalAs(UnmanagedType.LPStr)> szManu As StringBuilder, <MarshalAs(UnmanagedType.LPStr)> szProdFam As StringBuilder, <MarshalAs(UnmanagedType.LPStr)> szProdName As StringBuilder) As Integer
    Declare Ansi Function DTWAIN_GetAppInfoA Lib "dtwain32d.dll" (<MarshalAs(UnmanagedType.LPStr)> szVerStr As StringBuilder, <MarshalAs(UnmanagedType.LPStr)> szManu As StringBuilder, <MarshalAs(UnmanagedType.LPStr)> szProdFam As StringBuilder, <MarshalAs(UnmanagedType.LPStr)> szProdName As StringBuilder) As Integer
    ...
    Declare Ansi Function DTWAIN_GetAuthor Lib "dtwain32d.dll" (Source As System.IntPtr, <MarshalAs(UnmanagedType.LPStr)> szAuthor As StringBuilder) As Integer
    Declare Ansi Function DTWAIN_GetAuthorA Lib "dtwain32d.dll" (Source As System.IntPtr, <MarshalAs(UnmanagedType.LPStr)> szAuthor As StringBuilder) As Integer
    ...
    Declare Auto Function DTWAIN_GetBrightness Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef Brightness As System.Double) As Integer
    Declare Ansi Function DTWAIN_GetBrightnessString Lib "dtwain32d.dll" (Source As System.IntPtr, <MarshalAs(UnmanagedType.LPStr)> Brightness As StringBuilder) As Integer
    Declare Ansi Function DTWAIN_GetBrightnessStringA Lib "dtwain32d.dll" (Source As System.IntPtr, <MarshalAs(UnmanagedType.LPStr)> Contrast As StringBuilder) As Integer
    ...
    Declare Auto Function DTWAIN_GetCapContainerEx2 Lib "dtwain32d.dll" (nCap As Integer, bSetContainer As Integer) As System.IntPtr
    Declare Auto Function DTWAIN_GetCapDataType Lib "dtwain32d.dll" (Source As System.IntPtr, nCap As Integer) As Integer
    Declare Ansi Function DTWAIN_GetCapFromName Lib "dtwain32d.dll" (szName As String) As Integer
    Declare Ansi Function DTWAIN_GetCapFromNameA Lib "dtwain32d.dll" (szName As String) As Integer
    Declare Unicode Function DTWAIN_GetCapFromNameW Lib "dtwain32d.dll" (szName As String) As Integer
    ...
    Declare Ansi Function DTWAIN_GetCaption Lib "dtwain32d.dll" (Source As System.IntPtr, <MarshalAs(UnmanagedType.LPStr)> Caption As StringBuilder) As Integer
    Declare Ansi Function DTWAIN_GetCaptionA Lib "dtwain32d.dll" (Source As System.IntPtr, <MarshalAs(UnmanagedType.LPStr)> Caption As StringBuilder) As Integer
    ...
    Declare Ansi Function DTWAIN_GetConditionCodeString Lib "dtwain32d.dll" (lError As Integer, <MarshalAs(UnmanagedType.LPStr)> lpszBuffer As StringBuilder, nMaxLen As Integer) As Integer
    Declare Ansi Function DTWAIN_GetConditionCodeStringA Lib "dtwain32d.dll" (lError As Integer, <MarshalAs(UnmanagedType.LPStr)> lpszBuffer As StringBuilder, nMaxLen As Integer) As Integer
    ...
    Declare Auto Function DTWAIN_GetContrast Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef Contrast As System.Double) As Integer
    Declare Ansi Function DTWAIN_GetContrastString Lib "dtwain32d.dll" (Source As System.IntPtr, <MarshalAs(UnmanagedType.LPStr)> Contrast As StringBuilder) As Integer
    Declare Ansi Function DTWAIN_GetContrastStringA Lib "dtwain32d.dll" (Source As System.IntPtr, <MarshalAs(UnmanagedType.LPStr)> Contrast As StringBuilder) As Integer
    ...
    Declare Ansi Function DTWAIN_GetCurrentFileName Lib "dtwain32d.dll" (Source As System.IntPtr, <MarshalAs(UnmanagedType.LPStr)> szName As StringBuilder, MaxLen As Integer) As Integer
    Declare Ansi Function DTWAIN_GetCurrentFileNameA Lib "dtwain32d.dll" (Source As System.IntPtr, <MarshalAs(UnmanagedType.LPStr)> szName As StringBuilder, MaxLen As Integer) As Integer
    ...
    Declare Auto Function DTWAIN_GetCurrentTwainTriplet Lib "dtwain32d.dll" (ByRef pAppID As TW_IDENTITY, ByRef pSourceID As TW_IDENTITY, ByRef lpDG As Integer, ByRef lpDAT As Integer, ByRef lpMsg As Integer, ByRef lpMemRef As System.Int64) As Integer
    Declare Auto Function DTWAIN_GetCustomDSData Lib "dtwain32d.dll" (Source As System.IntPtr, Data As Byte(), dSize As UInteger, ByRef pActualSize As UInteger, nFlags As Integer) As System.IntPtr
    Declare Ansi Function DTWAIN_GetDSMFullName Lib "dtwain32d.dll" (DSMType As Integer, <MarshalAs(UnmanagedType.LPStr)> szDLLName As StringBuilder, nMaxLen As Integer, ByRef pWhichSearch As Integer) As Integer
    Declare Ansi Function DTWAIN_GetDSMFullNameA Lib "dtwain32d.dll" (DSMType As Integer, <MarshalAs(UnmanagedType.LPStr)> szDLLName As StringBuilder, nMaxLen As Integer, ByRef pWhichSearch As Integer) As Integer
    ...
    Declare Ansi Function DTWAIN_GetDeviceTimeDate Lib "dtwain32d.dll" (Source As System.IntPtr, <MarshalAs(UnmanagedType.LPStr)> szTimeDate As StringBuilder) As Integer
    Declare Ansi Function DTWAIN_GetDeviceTimeDateA Lib "dtwain32d.dll" (Source As System.IntPtr, <MarshalAs(UnmanagedType.LPStr)> szTimeDate As StringBuilder) As Integer
    ...
    Declare Auto Function DTWAIN_GetDoubleFeedDetectLength Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef Value As System.Double, bCurrent As Integer) As Integer
    ...
    Declare Ansi Function DTWAIN_GetErrorString Lib "dtwain32d.dll" (lError As Integer, <MarshalAs(UnmanagedType.LPStr)> lpszBuffer As StringBuilder, nMaxLen As Integer) As Integer
    Declare Ansi Function DTWAIN_GetErrorStringA Lib "dtwain32d.dll" (lError As Integer, <MarshalAs(UnmanagedType.LPStr)> lpszBuffer As StringBuilder, nLength As Integer) As Integer
    ...
    Declare Ansi Function DTWAIN_GetExtCapFromName Lib "dtwain32d.dll" (szName As String) As Integer
    Declare Ansi Function DTWAIN_GetExtCapFromNameA Lib "dtwain32d.dll" (szName As String) As Integer
    Declare Unicode Function DTWAIN_GetExtCapFromNameW Lib "dtwain32d.dll" (szName As String) As Integer
    ...
    Declare Auto Function DTWAIN_GetExtImageInfoDataEx Lib "dtwain32d.dll" (Source As System.IntPtr, nWhich As Integer) As System.IntPtr
    Declare Auto Function DTWAIN_GetExtImageInfoItem Lib "dtwain32d.dll" (Source As System.IntPtr, nWhich As Integer, ByRef InfoID As Integer, ByRef NumItems As Integer, ByRef Type As Integer) As Integer
    Declare Auto Function DTWAIN_GetExtImageInfoItemEx Lib "dtwain32d.dll" (Source As System.IntPtr, nWhich As Integer, ByRef InfoID As Integer, ByRef NumItems As Integer, ByRef Type As Integer, ByRef ReturnCode As Integer) As Integer
    Declare Ansi Function DTWAIN_GetExtNameFromCap Lib "dtwain32d.dll" (nValue As Integer, <MarshalAs(UnmanagedType.LPStr)> szValue As StringBuilder, nMaxLen As Integer) As Integer
    Declare Ansi Function DTWAIN_GetExtNameFromCapA Lib "dtwain32d.dll" (nValue As Integer, <MarshalAs(UnmanagedType.LPStr)> szValue As StringBuilder, nLength As Integer) As Integer
    ...
    Declare Auto Function DTWAIN_GetFeederWaitTime Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Declare Auto Function DTWAIN_GetFileCompressionType Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Declare Ansi Function DTWAIN_GetFileTypeExtensions Lib "dtwain32d.dll" (nType As Integer, <MarshalAs(UnmanagedType.LPStr)> lpszName As StringBuilder, nLength As Integer) As Integer
    Declare Ansi Function DTWAIN_GetFileTypeExtensionsA Lib "dtwain32d.dll" (nType As Integer, <MarshalAs(UnmanagedType.LPStr)> lpszName As StringBuilder, nLength As Integer) As Integer
    Declare Unicode Function DTWAIN_GetFileTypeExtensionsW Lib "dtwain32d.dll" (nType As Integer, <MarshalAs(UnmanagedType.LPWStr)> lpszName As StringBuilder, nLength As Integer) As Integer
    Declare Ansi Function DTWAIN_GetFileTypeName Lib "dtwain32d.dll" (nType As Integer, <MarshalAs(UnmanagedType.LPStr)> lpszName As StringBuilder, nLength As Integer) As Integer
    Declare Ansi Function DTWAIN_GetFileTypeNameA Lib "dtwain32d.dll" (nType As Integer, <MarshalAs(UnmanagedType.LPStr)> lpszName As StringBuilder, nLength As Integer) As Integer
    Declare Unicode Function DTWAIN_GetFileTypeNameW Lib "dtwain32d.dll" (nType As Integer, <MarshalAs(UnmanagedType.LPWStr)> lpszName As StringBuilder, nLength As Integer) As Integer
    Declare Ansi Function DTWAIN_GetHalftone Lib "dtwain32d.dll" (Source As System.IntPtr, <MarshalAs(UnmanagedType.LPStr)> lpHalftone As StringBuilder, TypeOfGet As Integer) As Integer
    Declare Ansi Function DTWAIN_GetHalftoneA Lib "dtwain32d.dll" (Source As System.IntPtr, <MarshalAs(UnmanagedType.LPStr)> lpHalftone As StringBuilder, TypeOfGet As Integer) As Integer
    Declare Unicode Function DTWAIN_GetHalftoneW Lib "dtwain32d.dll" (Source As System.IntPtr, <MarshalAs(UnmanagedType.LPWStr)> lpHalftone As StringBuilder, TypeOfGet As Integer) As Integer
    Declare Auto Function DTWAIN_GetHighlight Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef Highlight As System.Double) As Integer
    Declare Ansi Function DTWAIN_GetHighlightString Lib "dtwain32d.dll" (Source As System.IntPtr, <MarshalAs(UnmanagedType.LPStr)> Highlight As StringBuilder) As Integer
    Declare Ansi Function DTWAIN_GetHighlightStringA Lib "dtwain32d.dll" (Source As System.IntPtr, <MarshalAs(UnmanagedType.LPStr)> Highlight As StringBuilder) As Integer
    ...
    Declare Auto Function DTWAIN_GetJpegXRValues Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef pQuality As Integer, ByRef Progressive As Integer) As Integer
    ...
    Declare Ansi Function DTWAIN_GetLibraryPath Lib "dtwain32d.dll" (<MarshalAs(UnmanagedType.LPStr)> lpszVer As StringBuilder, nLength As Integer) As Integer
    Declare Ansi Function DTWAIN_GetLibraryPathA Lib "dtwain32d.dll" (<MarshalAs(UnmanagedType.LPStr)> lpszVer As StringBuilder, nLength As Integer) As Integer
    ...
    Declare Ansi Function DTWAIN_GetNameFromCap Lib "dtwain32d.dll" (nCapValue As Integer, <MarshalAs(UnmanagedType.LPStr)> szValue As StringBuilder, nMaxLen As Integer) As Integer
    Declare Ansi Function DTWAIN_GetNameFromCapA Lib "dtwain32d.dll" (nCapValue As Integer, <MarshalAs(UnmanagedType.LPStr)> szValue As StringBuilder, nLength As Integer) As Integer
    ...
    Declare Auto Function DTWAIN_GetOCRCapValues Lib "dtwain32d.dll" (Engine As System.IntPtr, OCRCapValue As Integer, TypeOfGet As Integer, ByRef CapValues As System.IntPtr) As Integer
    Declare Ansi Function DTWAIN_GetOCRErrorString Lib "dtwain32d.dll" (Engine As System.IntPtr, lError As Integer, <MarshalAs(UnmanagedType.LPStr)> lpszBuffer As StringBuilder, nMaxLen As Integer) As Integer
    Declare Ansi Function DTWAIN_GetOCRErrorStringA Lib "dtwain32d.dll" (Engine As System.IntPtr, lError As Integer, <MarshalAs(UnmanagedType.LPStr)> lpszBuffer As StringBuilder, nMaxLen As Integer) As Integer
    ...
    Declare Auto Function DTWAIN_GetOCRMajorMinorVersion Lib "dtwain32d.dll" (Engine As System.IntPtr, ByRef lpMajor As Integer, ByRef lpMinor As Integer) As Integer
    Declare Ansi Function DTWAIN_GetOCRManufacturer Lib "dtwain32d.dll" (Engine As System.IntPtr, <MarshalAs(UnmanagedType.LPStr)> szManufacturer As StringBuilder, nMaxLen As Integer) As Integer
    Declare Ansi Function DTWAIN_GetOCRManufacturerA Lib "dtwain32d.dll" (Engine As System.IntPtr, <MarshalAs(UnmanagedType.LPStr)> szManufacturer As StringBuilder, nLength As Integer) As Integer
    ...
    Declare Ansi Function DTWAIN_GetOCRProductFamily Lib "dtwain32d.dll" (Engine As System.IntPtr, <MarshalAs(UnmanagedType.LPStr)> szProductFamily As StringBuilder, nMaxLen As Integer) As Integer
    Declare Ansi Function DTWAIN_GetOCRProductFamilyA Lib "dtwain32d.dll" (Engine As System.IntPtr, <MarshalAs(UnmanagedType.LPStr)> szProductFamily As StringBuilder, nLength As Integer) As Integer
    ...
    Declare Ansi Function DTWAIN_GetOCRProductName Lib "dtwain32d.dll" (Engine As System.IntPtr, <MarshalAs(UnmanagedType.LPStr)> szProductName As StringBuilder, nMaxLen As Integer) As Integer
    Declare Ansi Function DTWAIN_GetOCRProductNameA Lib "dtwain32d.dll" (Engine As System.IntPtr, <MarshalAs(UnmanagedType.LPStr)> szProductName As StringBuilder, nLength As Integer) As Integer
    ...
    Declare Ansi Function DTWAIN_GetOCRText Lib "dtwain32d.dll" (Engine As System.IntPtr, nPageNo As Integer, <MarshalAs(UnmanagedType.LPStr)> Data As StringBuilder, dSize As Integer, ByRef pActualSize As Integer, nFlags As Integer) As System.IntPtr
    Declare Ansi Function DTWAIN_GetOCRTextA Lib "dtwain32d.dll" (Engine As System.IntPtr, nPageNo As Integer, <MarshalAs(UnmanagedType.LPStr)> Data As StringBuilder, dSize As Integer, ByRef pActualSize As Integer, nFlags As Integer) As System.IntPtr
    Declare Auto Function DTWAIN_GetOCRTextInfoFloat Lib "dtwain32d.dll" (OCRTextInfo As System.IntPtr, nCharPos As Integer, nWhichItem As Integer, ByRef pInfo As System.Double) As Integer
    Declare Auto Function DTWAIN_GetOCRTextInfoFloatEx Lib "dtwain32d.dll" (OCRTextInfo As System.IntPtr, nWhichItem As Integer, ByRef pInfo As System.Double, bufSize As Integer) As Integer
    ...
    Declare Ansi Function DTWAIN_GetOCRVersionInfo Lib "dtwain32d.dll" (Engine As System.IntPtr, <MarshalAs(UnmanagedType.LPStr)> buffer As StringBuilder, maxBufSize As Integer) As Integer
    Declare Ansi Function DTWAIN_GetOCRVersionInfoA Lib "dtwain32d.dll" (Engine As System.IntPtr, <MarshalAs(UnmanagedType.LPStr)> buffer As StringBuilder, nLength As Integer) As Integer
    ...
    Declare Auto Function DTWAIN_GetPDFTextElementFloat Lib "dtwain32d.dll" (TextElement As System.IntPtr, ByRef val1 As System.Double, ByRef val2 As System.Double, Flags As Integer) As Integer
    ...
    Declare Ansi Function DTWAIN_GetPDFTextElementString Lib "dtwain32d.dll" (TextElement As System.IntPtr, <MarshalAs(UnmanagedType.LPStr)> szData As StringBuilder, maxLen As Integer, Flags As Integer) As Integer
    Declare Ansi Function DTWAIN_GetPDFTextElementStringA Lib "dtwain32d.dll" (TextElement As System.IntPtr, <MarshalAs(UnmanagedType.LPStr)> szData As StringBuilder, maxLen As Integer, Flags As Integer) As Integer
    ...
    Declare Ansi Function DTWAIN_GetPDFType1FontName Lib "dtwain32d.dll" (FontVal As Integer, <MarshalAs(UnmanagedType.LPStr)> szFont As StringBuilder, nChars As Integer) As Integer
    Declare Ansi Function DTWAIN_GetPDFType1FontNameA Lib "dtwain32d.dll" (FontVal As Integer, <MarshalAs(UnmanagedType.LPStr)> szFont As StringBuilder, nChars As Integer) As Integer
    ...
    Declare Ansi Function DTWAIN_GetPaperSizeName Lib "dtwain32d.dll" (paperNumber As Integer, <MarshalAs(UnmanagedType.LPStr)> outName As StringBuilder, nSize As Integer) As Integer
    Declare Ansi Function DTWAIN_GetPaperSizeNameA Lib "dtwain32d.dll" (paperNumber As Integer, <MarshalAs(UnmanagedType.LPStr)> outName As StringBuilder, nSize As Integer) As Integer
    Declare Unicode Function DTWAIN_GetPaperSizeNameW Lib "dtwain32d.dll" (paperNumber As Integer, <MarshalAs(UnmanagedType.LPWStr)> outName As StringBuilder, nSize As Integer) As Integer
    ...
    Declare Ansi Function DTWAIN_GetPrinterSuffixString Lib "dtwain32d.dll" (Source As System.IntPtr, <MarshalAs(UnmanagedType.LPStr)> Suffix As StringBuilder, nMaxLen As Integer) As Integer
    Declare Ansi Function DTWAIN_GetPrinterSuffixStringA Lib "dtwain32d.dll" (Source As System.IntPtr, <MarshalAs(UnmanagedType.LPStr)> Suffix As StringBuilder, nLength As Integer) As Integer
    ...
    Declare Auto Function DTWAIN_GetResolution Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef Resolution As System.Double) As Integer
    Declare Ansi Function DTWAIN_GetResolutionString Lib "dtwain32d.dll" (Source As System.IntPtr, <MarshalAs(UnmanagedType.LPStr)> Resolution As StringBuilder) As Integer
    Declare Ansi Function DTWAIN_GetResolutionStringA Lib "dtwain32d.dll" (Source As System.IntPtr, <MarshalAs(UnmanagedType.LPStr)> Resolution As StringBuilder) As Integer
    ...
    Declare Ansi Function DTWAIN_GetResourceString Lib "dtwain32d.dll" (ResourceID As Integer, <MarshalAs(UnmanagedType.LPStr)> lpszBuffer As StringBuilder, nMaxLen As Integer) As Integer
    Declare Ansi Function DTWAIN_GetResourceStringA Lib "dtwain32d.dll" (ResourceID As Integer, <MarshalAs(UnmanagedType.LPStr)> lpszBuffer As StringBuilder, nMaxLen As Integer) As Integer
    Declare Unicode Function DTWAIN_GetResourceStringW Lib "dtwain32d.dll" (ResourceID As Integer, <MarshalAs(UnmanagedType.LPWStr)> lpszBuffer As StringBuilder, nMaxLen As Integer) As Integer
    Declare Auto Function DTWAIN_GetRotation Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef Rotation As System.Double) As Integer
    Declare Ansi Function DTWAIN_GetRotationString Lib "dtwain32d.dll" (Source As System.IntPtr, <MarshalAs(UnmanagedType.LPStr)> Rotation As StringBuilder) As Integer
    Declare Ansi Function DTWAIN_GetRotationStringA Lib "dtwain32d.dll" (Source As System.IntPtr, <MarshalAs(UnmanagedType.LPStr)> Rotation As StringBuilder) As Integer
    ...
    Declare Ansi Function DTWAIN_GetSaveFileName Lib "dtwain32d.dll" (Source As System.IntPtr, <MarshalAs(UnmanagedType.LPStr)> fName As StringBuilder, nMaxLen As Integer) As Integer
    Declare Ansi Function DTWAIN_GetSaveFileNameA Lib "dtwain32d.dll" (Source As System.IntPtr, <MarshalAs(UnmanagedType.LPStr)> fName As StringBuilder, nMaxLen As Integer) As Integer
    ...
    Declare Ansi Function DTWAIN_GetSessionDetails Lib "dtwain32d.dll" (<MarshalAs(UnmanagedType.LPStr)> szBuf As StringBuilder, nSize As Integer, indentFactor As Integer, bRefresh As Integer) As Integer
    Declare Ansi Function DTWAIN_GetSessionDetailsA Lib "dtwain32d.dll" (<MarshalAs(UnmanagedType.LPStr)> szBuf As StringBuilder, nSize As Integer, indentFactor As Integer, bRefresh As Integer) As Integer
    Declare Unicode Function DTWAIN_GetSessionDetailsW Lib "dtwain32d.dll" (<MarshalAs(UnmanagedType.LPWStr)> szBuf As StringBuilder, nSize As Integer, indentFactor As Integer, bRefresh As Integer) As Integer
    Declare Auto Function DTWAIN_GetShadow Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef Shadow As System.Double) As Integer
    Declare Ansi Function DTWAIN_GetShadowString Lib "dtwain32d.dll" (Source As System.IntPtr, <MarshalAs(UnmanagedType.LPStr)> Shadow As StringBuilder) As Integer
    Declare Ansi Function DTWAIN_GetShadowStringA Lib "dtwain32d.dll" (Source As System.IntPtr, <MarshalAs(UnmanagedType.LPStr)> Shadow As StringBuilder) As Integer
    ...
    Declare Ansi Function DTWAIN_GetShortVersionString Lib "dtwain32d.dll" (<MarshalAs(UnmanagedType.LPStr)> lpszVer As StringBuilder, nLength As Integer) As Integer
    Declare Ansi Function DTWAIN_GetShortVersionStringA Lib "dtwain32d.dll" (<MarshalAs(UnmanagedType.LPStr)> lpszVer As StringBuilder, nLength As Integer) As Integer
    ...
    Declare Ansi Function DTWAIN_GetSourceDetails Lib "dtwain32d.dll" (szSources As String, <MarshalAs(UnmanagedType.LPStr)> szBuf As StringBuilder, nSize As Integer, indentFactor As Integer, bRefresh As Integer) As Integer
    Declare Ansi Function DTWAIN_GetSourceDetailsA Lib "dtwain32d.dll" (szSources As String, <MarshalAs(UnmanagedType.LPStr)> szBuf As StringBuilder, nSize As Integer, indentFactor As Integer, bRefresh As Integer) As Integer
    Declare Unicode Function DTWAIN_GetSourceDetailsW Lib "dtwain32d.dll" (szSources As String, <MarshalAs(UnmanagedType.LPWStr)> szBuf As StringBuilder, nSize As Integer, indentFactor As Integer, bRefresh As Integer) As Integer
    Declare Auto Function DTWAIN_GetSourceID Lib "dtwain32d.dll" (Source As System.IntPtr) As System.IntPtr
    ...
    Declare Ansi Function DTWAIN_GetSourceManufacturer Lib "dtwain32d.dll" (Source As System.IntPtr, <MarshalAs(UnmanagedType.LPStr)> szProduct As StringBuilder, nMaxLen As Integer) As Integer
    Declare Ansi Function DTWAIN_GetSourceManufacturerA Lib "dtwain32d.dll" (Source As System.IntPtr, <MarshalAs(UnmanagedType.LPStr)> szProduct As StringBuilder, nLength As Integer) As Integer
    ...
    Declare Ansi Function DTWAIN_GetSourceProductFamily Lib "dtwain32d.dll" (Source As System.IntPtr, <MarshalAs(UnmanagedType.LPStr)> szProduct As StringBuilder, nMaxLen As Integer) As Integer
    Declare Ansi Function DTWAIN_GetSourceProductFamilyA Lib "dtwain32d.dll" (Source As System.IntPtr, <MarshalAs(UnmanagedType.LPStr)> szProduct As StringBuilder, nLength As Integer) As Integer
    ...
    Declare Ansi Function DTWAIN_GetSourceProductName Lib "dtwain32d.dll" (Source As System.IntPtr, <MarshalAs(UnmanagedType.LPStr)> szProduct As StringBuilder, nMaxLen As Integer) As Integer
    Declare Ansi Function DTWAIN_GetSourceProductNameA Lib "dtwain32d.dll" (Source As System.IntPtr, <MarshalAs(UnmanagedType.LPStr)> szProduct As StringBuilder, nLength As Integer) As Integer
    ...
    Declare Ansi Function DTWAIN_GetSourceVersionInfo Lib "dtwain32d.dll" (Source As System.IntPtr, <MarshalAs(UnmanagedType.LPStr)> szProduct As StringBuilder, nMaxLen As Integer) As Integer
    Declare Ansi Function DTWAIN_GetSourceVersionInfoA Lib "dtwain32d.dll" (Source As System.IntPtr, <MarshalAs(UnmanagedType.LPStr)> szProduct As StringBuilder, nLength As Integer) As Integer
    ...
    Declare Ansi Function DTWAIN_GetTempFileDirectory Lib "dtwain32d.dll" (<MarshalAs(UnmanagedType.LPStr)> szFilePath As StringBuilder, nMaxLen As Integer) As Integer
    Declare Ansi Function DTWAIN_GetTempFileDirectoryA Lib "dtwain32d.dll" (<MarshalAs(UnmanagedType.LPStr)> szFilePath As StringBuilder, nLength As Integer) As Integer
    ...
    Declare Auto Function DTWAIN_GetThreshold Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef Threshold As System.Double) As Integer
    Declare Ansi Function DTWAIN_GetThresholdString Lib "dtwain32d.dll" (Source As System.IntPtr, <MarshalAs(UnmanagedType.LPStr)> Threshold As StringBuilder) As Integer
    Declare Ansi Function DTWAIN_GetThresholdStringA Lib "dtwain32d.dll" (Source As System.IntPtr, <MarshalAs(UnmanagedType.LPStr)> Threshold As StringBuilder) As Integer
    ...
    Declare Ansi Function DTWAIN_GetTimeDate Lib "dtwain32d.dll" (Source As System.IntPtr, <MarshalAs(UnmanagedType.LPStr)> szTimeDate As StringBuilder) As Integer
    Declare Ansi Function DTWAIN_GetTimeDateA Lib "dtwain32d.dll" (Source As System.IntPtr, <MarshalAs(UnmanagedType.LPStr)> szTimeDate As StringBuilder) As Integer
    ...
    Declare Auto Function DTWAIN_GetTwainAppID Lib "dtwain32d.dll" () As System.IntPtr
    ...
    Declare Ansi Function DTWAIN_GetTwainAvailabilityEx Lib "dtwain32d.dll" (<MarshalAs(UnmanagedType.LPStr)> directories As StringBuilder, nMaxLen As Integer) As Integer
    Declare Ansi Function DTWAIN_GetTwainAvailabilityExA Lib "dtwain32d.dll" (<MarshalAs(UnmanagedType.LPStr)> szDirectories As StringBuilder, nLength As Integer) As Integer
    Declare Unicode Function DTWAIN_GetTwainAvailabilityExW Lib "dtwain32d.dll" (<MarshalAs(UnmanagedType.LPWStr)> szDirectories As StringBuilder, nLength As Integer) As Integer
    Declare Ansi Function DTWAIN_GetTwainCountryName Lib "dtwain32d.dll" (countryId As Integer, <MarshalAs(UnmanagedType.LPStr)> szName As StringBuilder) As Integer
    Declare Ansi Function DTWAIN_GetTwainCountryNameA Lib "dtwain32d.dll" (countryId As Integer, <MarshalAs(UnmanagedType.LPStr)> szName As StringBuilder) As Integer
    ...
    Declare Ansi Function DTWAIN_GetTwainCountryValue Lib "dtwain32d.dll" (country As String) As Integer
    Declare Ansi Function DTWAIN_GetTwainCountryValueA Lib "dtwain32d.dll" (country As String) As Integer
    Declare Unicode Function DTWAIN_GetTwainCountryValueW Lib "dtwain32d.dll" (country As String) As Integer
    Declare Auto Function DTWAIN_GetTwainHwnd Lib "dtwain32d.dll" () As System.IntPtr
    Declare Ansi Function DTWAIN_GetTwainIDFromName Lib "dtwain32d.dll" (lpszBuffer As String) As Integer
    Declare Ansi Function DTWAIN_GetTwainIDFromNameA Lib "dtwain32d.dll" (lpszBuffer As String) As Integer
    Declare Unicode Function DTWAIN_GetTwainIDFromNameW Lib "dtwain32d.dll" (lpszBuffer As String) As Integer
    Declare Ansi Function DTWAIN_GetTwainLanguageName Lib "dtwain32d.dll" (nameId As Integer, <MarshalAs(UnmanagedType.LPStr)> szName As StringBuilder) As Integer
    Declare Ansi Function DTWAIN_GetTwainLanguageNameA Lib "dtwain32d.dll" (lang As Integer, <MarshalAs(UnmanagedType.LPStr)> szName As StringBuilder) As Integer
    ...
    Declare Ansi Function DTWAIN_GetTwainLanguageValue Lib "dtwain32d.dll" (szName As String) As Integer
    Declare Ansi Function DTWAIN_GetTwainLanguageValueA Lib "dtwain32d.dll" (lang As String) As Integer
    Declare Unicode Function DTWAIN_GetTwainLanguageValueW Lib "dtwain32d.dll" (lang As String) As Integer
    Declare Auto Function DTWAIN_GetTwainMode Lib "dtwain32d.dll" () As Integer
    Declare Ansi Function DTWAIN_GetTwainNameFromConstant Lib "dtwain32d.dll" (lConstantType As Integer, lTwainConstant As Integer, <MarshalAs(UnmanagedType.LPStr)> lpszOut As StringBuilder, nSize As Integer) As Integer
    Declare Ansi Function DTWAIN_GetTwainNameFromConstantA Lib "dtwain32d.dll" (lConstantType As Integer, lTwainConstant As Integer, <MarshalAs(UnmanagedType.LPStr)> lpszOut As StringBuilder, nSize As Integer) As Integer
    Declare Unicode Function DTWAIN_GetTwainNameFromConstantW Lib "dtwain32d.dll" (lConstantType As Integer, lTwainConstant As Integer, <MarshalAs(UnmanagedType.LPWStr)> lpszOut As StringBuilder, nSize As Integer) As Integer
    Declare Ansi Function DTWAIN_GetTwainStringName Lib "dtwain32d.dll" (category As Integer, TwainID As Integer, <MarshalAs(UnmanagedType.LPStr)> lpszBuffer As StringBuilder, nMaxLen As Integer) As Integer
    Declare Ansi Function DTWAIN_GetTwainStringNameA Lib "dtwain32d.dll" (category As Integer, TwainID As Integer, <MarshalAs(UnmanagedType.LPStr)> lpszBuffer As StringBuilder, nMaxLen As Integer) As Integer
    Declare Unicode Function DTWAIN_GetTwainStringNameW Lib "dtwain32d.dll" (category As Integer, TwainID As Integer, <MarshalAs(UnmanagedType.LPWStr)> lpszBuffer As StringBuilder, nMaxLen As Integer) As Integer
    ...
    Declare Ansi Function DTWAIN_GetVersionCopyright Lib "dtwain32d.dll" (<MarshalAs(UnmanagedType.LPStr)> lpszApp As StringBuilder, nLength As Integer) As Integer
    Declare Ansi Function DTWAIN_GetVersionCopyrightA Lib "dtwain32d.dll" (<MarshalAs(UnmanagedType.LPStr)> lpszApp As StringBuilder, nLength As Integer) As Integer
    Declare Unicode Function DTWAIN_GetVersionCopyrightW Lib "dtwain32d.dll" (<MarshalAs(UnmanagedType.LPWStr)> lpszApp As StringBuilder, nLength As Integer) As Integer
    ...
    Declare Ansi Function DTWAIN_GetVersionInfo Lib "dtwain32d.dll" (<MarshalAs(UnmanagedType.LPStr)> lpszVer As StringBuilder, nLength As Integer) As Integer
    Declare Ansi Function DTWAIN_GetVersionInfoA Lib "dtwain32d.dll" (<MarshalAs(UnmanagedType.LPStr)> lpszVer As StringBuilder, nLength As Integer) As Integer
    ...
    Declare Ansi Function DTWAIN_GetVersionString Lib "dtwain32d.dll" (<MarshalAs(UnmanagedType.LPStr)> lpszVer As StringBuilder, nLength As Integer) As Integer
    Declare Ansi Function DTWAIN_GetVersionStringA Lib "dtwain32d.dll" (<MarshalAs(UnmanagedType.LPStr)> lpszVer As StringBuilder, nLength As Integer) As Integer
    ...
    Declare Ansi Function DTWAIN_GetWindowsVersionInfo Lib "dtwain32d.dll" (<MarshalAs(UnmanagedType.LPStr)> lpszBuffer As StringBuilder, nMaxLen As Integer) As Integer
    Declare Ansi Function DTWAIN_GetWindowsVersionInfoA Lib "dtwain32d.dll" (<MarshalAs(UnmanagedType.LPStr)> lpszBuffer As StringBuilder, nMaxLen As Integer) As Integer
    Declare Unicode Function DTWAIN_GetWindowsVersionInfoW Lib "dtwain32d.dll" (<MarshalAs(UnmanagedType.LPWStr)> lpszBuffer As StringBuilder, nMaxLen As Integer) As Integer
    Declare Auto Function DTWAIN_GetXResolution Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef Resolution As System.Double) As Integer
    Declare Ansi Function DTWAIN_GetXResolutionString Lib "dtwain32d.dll" (Source As System.IntPtr, <MarshalAs(UnmanagedType.LPStr)> Resolution As StringBuilder) As Integer
    Declare Ansi Function DTWAIN_GetXResolutionStringA Lib "dtwain32d.dll" (Source As System.IntPtr, <MarshalAs(UnmanagedType.LPStr)> Resolution As StringBuilder) As Integer
    ...
    Declare Auto Function DTWAIN_GetYResolution Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef Resolution As System.Double) As Integer
    Declare Ansi Function DTWAIN_GetYResolutionString Lib "dtwain32d.dll" (Source As System.IntPtr, <MarshalAs(UnmanagedType.LPStr)> Resolution As StringBuilder) As Integer
    Declare Ansi Function DTWAIN_GetYResolutionStringA Lib "dtwain32d.dll" (Source As System.IntPtr, <MarshalAs(UnmanagedType.LPStr)> Resolution As StringBuilder) As Integer
    ...
    Declare Ansi Function DTWAIN_InitImageFileAppend Lib "dtwain32d.dll" (szFile As String, fType As Integer) As Integer
    Declare Ansi Function DTWAIN_InitImageFileAppendA Lib "dtwain32d.dll" (szFile As String, fType As Integer) As Integer
    Declare Unicode Function DTWAIN_InitImageFileAppendW Lib "dtwain32d.dll" (szFile As String, fType As Integer) As Integer
    ...
    Declare Auto Function DTWAIN_IsAudioXferSupported Lib "dtwain32d.dll" (Source As System.IntPtr, supportVal As Integer) As Integer
    ...
    Declare Auto Function DTWAIN_IsDIBBlank Lib "dtwain32d.dll" (hDib As System.IntPtr, threshold As System.Double) As Integer
    Declare Ansi Function DTWAIN_IsDIBBlankString Lib "dtwain32d.dll" (hDib As System.IntPtr, threshold As String) As Integer
    Declare Ansi Function DTWAIN_IsDIBBlankStringA Lib "dtwain32d.dll" (hDib As System.IntPtr, threshold As String) As Integer
    Declare Unicode Function DTWAIN_IsDIBBlankStringW Lib "dtwain32d.dll" (hDib As System.IntPtr, threshold As String) As Integer
    ...
    Declare Auto Function DTWAIN_IsDoubleFeedDetectLengthSupported Lib "dtwain32d.dll" (Source As System.IntPtr, value As System.Double) As Integer
    ...
    Declare Auto Function DTWAIN_IsDoublePageCountOnDuplex Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    ...
    Declare Auto Function DTWAIN_IsIAFieldALastPageSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Declare Auto Function DTWAIN_IsIAFieldALevelSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Declare Auto Function DTWAIN_IsIAFieldAPrintFormatSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Declare Auto Function DTWAIN_IsIAFieldAValueSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Declare Auto Function DTWAIN_IsIAFieldBLastPageSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Declare Auto Function DTWAIN_IsIAFieldBLevelSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Declare Auto Function DTWAIN_IsIAFieldBPrintFormatSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Declare Auto Function DTWAIN_IsIAFieldBValueSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Declare Auto Function DTWAIN_IsIAFieldCLastPageSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Declare Auto Function DTWAIN_IsIAFieldCLevelSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Declare Auto Function DTWAIN_IsIAFieldCPrintFormatSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Declare Auto Function DTWAIN_IsIAFieldCValueSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Declare Auto Function DTWAIN_IsIAFieldDLastPageSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Declare Auto Function DTWAIN_IsIAFieldDLevelSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Declare Auto Function DTWAIN_IsIAFieldDPrintFormatSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Declare Auto Function DTWAIN_IsIAFieldDValueSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Declare Auto Function DTWAIN_IsIAFieldELastPageSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Declare Auto Function DTWAIN_IsIAFieldELevelSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Declare Auto Function DTWAIN_IsIAFieldEPrintFormatSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Declare Auto Function DTWAIN_IsIAFieldEValueSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    Declare Auto Function DTWAIN_IsImageAddressingSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    ...
    Declare Auto Function DTWAIN_IsMemFileXferSupported Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    ...
    Declare Auto Function DTWAIN_IsOpenSourcesOnSelect Lib "dtwain32d.dll" () As Integer
    ...
    Declare Auto Function DTWAIN_IsSourceAcquiringEx Lib "dtwain32d.dll" (Source As System.IntPtr, bUIOnly As Integer) As Integer
    ...
    Declare Ansi Function DTWAIN_IsTwainAvailableEx Lib "dtwain32d.dll" (<MarshalAs(UnmanagedType.LPStr)> directories As StringBuilder, nMaxLen As Integer) As Integer
    Declare Ansi Function DTWAIN_IsTwainAvailableExA Lib "dtwain32d.dll" (<MarshalAs(UnmanagedType.LPStr)> directories As StringBuilder, nMaxLen As Integer) As Integer
    Declare Unicode Function DTWAIN_IsTwainAvailableExW Lib "dtwain32d.dll" (<MarshalAs(UnmanagedType.LPWStr)> directories As StringBuilder, nMaxLen As Integer) As Integer
    ...
    Declare Ansi Function DTWAIN_LoadCustomStringResources Lib "dtwain32d.dll" (sLangDLL As String) As Integer
    Declare Ansi Function DTWAIN_LoadCustomStringResourcesA Lib "dtwain32d.dll" (sLangDLL As String) As Integer
    Declare Ansi Function DTWAIN_LoadCustomStringResourcesEx Lib "dtwain32d.dll" (sLangDLL As String, bClear As Integer) As Integer
    Declare Ansi Function DTWAIN_LoadCustomStringResourcesExA Lib "dtwain32d.dll" (sLangDLL As String, bClear As Integer) As Integer
    Declare Unicode Function DTWAIN_LoadCustomStringResourcesExW Lib "dtwain32d.dll" (sLangDLL As String, bClear As Integer) As Integer
    Declare Unicode Function DTWAIN_LoadCustomStringResourcesW Lib "dtwain32d.dll" (sLangDLL As String) As Integer
    ...
    Declare Ansi Function DTWAIN_LogMessage Lib "dtwain32d.dll" (message As String) As Integer
    Declare Ansi Function DTWAIN_LogMessageA Lib "dtwain32d.dll" (message As String) As Integer
    Declare Unicode Function DTWAIN_LogMessageW Lib "dtwain32d.dll" (message As String) As Integer
    ...
    Declare Auto Function DTWAIN_RangeExpandEx Lib "dtwain32d.dll" (Range As System.IntPtr) As System.IntPtr
    ...
    Declare Auto Function DTWAIN_RangeGetAllFloat Lib "dtwain32d.dll" (pArray As System.IntPtr, ByRef pVariantLow As System.Double, ByRef pVariantUp As System.Double, ByRef pVariantStep As System.Double, ByRef pVariantDefault As System.Double, ByRef pVariantCurrent As System.Double) As Integer
    Declare Ansi Function DTWAIN_RangeGetAllFloatString Lib "dtwain32d.dll" (pArray As System.IntPtr, <MarshalAs(UnmanagedType.LPStr)> dLow As StringBuilder, <MarshalAs(UnmanagedType.LPStr)> dUp As StringBuilder, <MarshalAs(UnmanagedType.LPStr)> dStep As StringBuilder, <MarshalAs(UnmanagedType.LPStr)> dDefault As StringBuilder, <MarshalAs(UnmanagedType.LPStr)> dCurrent As StringBuilder) As Integer
    ...
    Declare Auto Function DTWAIN_RangeGetExpValueFloat Lib "dtwain32d.dll" (pArray As System.IntPtr, lPos As Integer, ByRef pVal As System.Double) As Integer
    Declare Ansi Function DTWAIN_RangeGetExpValueFloatString Lib "dtwain32d.dll" (pArray As System.IntPtr, lPos As Integer, <MarshalAs(UnmanagedType.LPStr)> pVal As StringBuilder) As Integer
    Declare Ansi Function DTWAIN_RangeGetExpValueFloatStringA Lib "dtwain32d.dll" (pArray As System.IntPtr, lPos As Integer, <MarshalAs(UnmanagedType.LPStr)> pVal As StringBuilder) As Integer
    ...
    Declare Auto Function DTWAIN_RangeGetPosFloat Lib "dtwain32d.dll" (pArray As System.IntPtr, Val As System.Double, ByRef pPos As Integer) As Integer
    Declare Ansi Function DTWAIN_RangeGetPosFloatString Lib "dtwain32d.dll" (pArray As System.IntPtr, Val As String, ByRef pPos As Integer) As Integer
    Declare Ansi Function DTWAIN_RangeGetPosFloatStringA Lib "dtwain32d.dll" (pArray As System.IntPtr, Val As String, ByRef pPos As Integer) As Integer
    Declare Unicode Function DTWAIN_RangeGetPosFloatStringW Lib "dtwain32d.dll" (pArray As System.IntPtr, Val As String, ByRef pPos As Integer) As Integer
    ...
    Declare Auto Function DTWAIN_RangeGetValueFloat Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhich As Integer, ByRef pVal As System.Double) As Integer
    Declare Ansi Function DTWAIN_RangeGetValueFloatString Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhich As Integer, <MarshalAs(UnmanagedType.LPStr)> pVal As StringBuilder) As Integer
    Declare Ansi Function DTWAIN_RangeGetValueFloatStringA Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhich As Integer, <MarshalAs(UnmanagedType.LPStr)> dValue As StringBuilder) As Integer
    ...
    Declare Auto Function DTWAIN_RangeNearestValueFloat Lib "dtwain32d.dll" (pArray As System.IntPtr, dIn As System.Double, ByRef pOut As System.Double, RoundType As Integer) As Integer
    Declare Ansi Function DTWAIN_RangeNearestValueFloatString Lib "dtwain32d.dll" (pArray As System.IntPtr, dIn As String, <MarshalAs(UnmanagedType.LPStr)> pOut As StringBuilder, RoundType As Integer) As Integer
    Declare Ansi Function DTWAIN_RangeNearestValueFloatStringA Lib "dtwain32d.dll" (pArray As System.IntPtr, dIn As String, <MarshalAs(UnmanagedType.LPStr)> dOut As StringBuilder, RoundType As Integer) As Integer
    Declare Unicode Function DTWAIN_RangeNearestValueFloatStringW Lib "dtwain32d.dll" (pArray As System.IntPtr, dIn As String, <MarshalAs(UnmanagedType.LPWStr)> dOut As StringBuilder, RoundType As Integer) As Integer
    ...
    Declare Auto Function DTWAIN_RangeSetAllFloat Lib "dtwain32d.dll" (pArray As System.IntPtr, dLow As System.Double, dUp As System.Double, dStep As System.Double, dDefault As System.Double, dCurrent As System.Double) As Integer
    Declare Ansi Function DTWAIN_RangeSetAllFloatString Lib "dtwain32d.dll" (pArray As System.IntPtr, dLow As String, dUp As String, dStep As String, dDefault As String, dCurrent As String) As Integer
    Declare Ansi Function DTWAIN_RangeSetAllFloatStringA Lib "dtwain32d.dll" (pArray As System.IntPtr, dLow As String, dUp As String, dStep As String, dDefault As String, dCurrent As String) As Integer
    Declare Unicode Function DTWAIN_RangeSetAllFloatStringW Lib "dtwain32d.dll" (pArray As System.IntPtr, dLow As String, dUp As String, dStep As String, dDefault As String, dCurrent As String) As Integer
    ...
    Declare Auto Function DTWAIN_RangeSetValueFloat Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhich As Integer, Val As System.Double) As Integer
    Declare Ansi Function DTWAIN_RangeSetValueFloatString Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhich As Integer, Val As String) As Integer
    Declare Ansi Function DTWAIN_RangeSetValueFloatStringA Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhich As Integer, dValue As String) As Integer
    Declare Unicode Function DTWAIN_RangeSetValueFloatStringW Lib "dtwain32d.dll" (pArray As System.IntPtr, nWhich As Integer, dValue As String) As Integer
    ...
    Declare Ansi Function DTWAIN_SelectOCREngine2 Lib "dtwain32d.dll" (hWndParent As System.IntPtr, szTitle As String, xPos As Integer, yPos As Integer, nOptions As Integer) As System.IntPtr
    Declare Ansi Function DTWAIN_SelectOCREngine2A Lib "dtwain32d.dll" (hWndParent As System.IntPtr, szTitle As String, xPos As Integer, yPos As Integer, nOptions As Integer) As System.IntPtr
    Declare Ansi Function DTWAIN_SelectOCREngine2Ex Lib "dtwain32d.dll" (hWndParent As System.IntPtr, szTitle As String, xPos As Integer, yPos As Integer, szIncludeFilter As String, szExcludeFilter As String, szNameMapping As String, nOptions As Integer) As System.IntPtr
    Declare Ansi Function DTWAIN_SelectOCREngine2ExA Lib "dtwain32d.dll" (hWndParent As System.IntPtr, szTitle As String, xPos As Integer, yPos As Integer, szIncludeNames As String, szExcludeNames As String, szNameMapping As String, nOptions As Integer) As System.IntPtr
    Declare Unicode Function DTWAIN_SelectOCREngine2ExW Lib "dtwain32d.dll" (hWndParent As System.IntPtr, szTitle As String, xPos As Integer, yPos As Integer, szIncludeNames As String, szExcludeNames As String, szNameMapping As String, nOptions As Integer) As System.IntPtr
    Declare Unicode Function DTWAIN_SelectOCREngine2W Lib "dtwain32d.dll" (hWndParent As System.IntPtr, szTitle As String, xPos As Integer, yPos As Integer, nOptions As Integer) As System.IntPtr
    Declare Ansi Function DTWAIN_SelectOCREngineByName Lib "dtwain32d.dll" (lpszName As String) As System.IntPtr
    Declare Ansi Function DTWAIN_SelectOCREngineByNameA Lib "dtwain32d.dll" (lpszName As String) As System.IntPtr
    Declare Unicode Function DTWAIN_SelectOCREngineByNameW Lib "dtwain32d.dll" (lpszName As String) As System.IntPtr
    Declare Auto Function DTWAIN_SelectSource Lib "dtwain32d.dll" () As System.IntPtr
    Declare Ansi Function DTWAIN_SelectSource2 Lib "dtwain32d.dll" (hWndParent As System.IntPtr, szTitle As String, xPos As Integer, yPos As Integer, nOptions As Integer) As System.IntPtr
    Declare Ansi Function DTWAIN_SelectSource2A Lib "dtwain32d.dll" (hWndParent As System.IntPtr, szTitle As String, xPos As Integer, yPos As Integer, nOptions As Integer) As System.IntPtr
    Declare Ansi Function DTWAIN_SelectSource2Ex Lib "dtwain32d.dll" (hWndParent As System.IntPtr, szTitle As String, xPos As Integer, yPos As Integer, szIncludeFilter As String, szExcludeFilter As String, szNameMapping As String, nOptions As Integer) As System.IntPtr
    Declare Ansi Function DTWAIN_SelectSource2ExA Lib "dtwain32d.dll" (hWndParent As System.IntPtr, szTitle As String, xPos As Integer, yPos As Integer, szIncludeNames As String, szExcludeNames As String, szNameMapping As String, nOptions As Integer) As System.IntPtr
    Declare Unicode Function DTWAIN_SelectSource2ExW Lib "dtwain32d.dll" (hWndParent As System.IntPtr, szTitle As String, xPos As Integer, yPos As Integer, szIncludeNames As String, szExcludeNames As String, szNameMapping As String, nOptions As Integer) As System.IntPtr
    Declare Unicode Function DTWAIN_SelectSource2W Lib "dtwain32d.dll" (hWndParent As System.IntPtr, szTitle As String, xPos As Integer, yPos As Integer, nOptions As Integer) As System.IntPtr
    Declare Ansi Function DTWAIN_SelectSourceByName Lib "dtwain32d.dll" (lpszName As String) As System.IntPtr
    Declare Ansi Function DTWAIN_SelectSourceByNameA Lib "dtwain32d.dll" (lpszName As String) As System.IntPtr
    Declare Unicode Function DTWAIN_SelectSourceByNameW Lib "dtwain32d.dll" (lpszName As String) As System.IntPtr
    Declare Ansi Function DTWAIN_SelectSourceByNameWithOpen Lib "dtwain32d.dll" (lpszName As String, bOpen As Integer) As System.IntPtr
    Declare Ansi Function DTWAIN_SelectSourceByNameWithOpenA Lib "dtwain32d.dll" (lpszName As String, bOpen As Integer) As System.IntPtr
    Declare Unicode Function DTWAIN_SelectSourceByNameWithOpenW Lib "dtwain32d.dll" (lpszName As String, bOpen As Integer) As System.IntPtr
    ...
    Declare Auto Function DTWAIN_SetAcquireArea2 Lib "dtwain32d.dll" (Source As System.IntPtr, left As System.Double, top As System.Double, right As System.Double, bottom As System.Double, lUnit As Integer, Flags As Integer) As Integer
    Declare Ansi Function DTWAIN_SetAcquireArea2String Lib "dtwain32d.dll" (Source As System.IntPtr, left As String, top As String, right As String, bottom As String, lUnit As Integer, Flags As Integer) As Integer
    Declare Ansi Function DTWAIN_SetAcquireArea2StringA Lib "dtwain32d.dll" (Source As System.IntPtr, left As String, top As String, right As String, bottom As String, lUnit As Integer, Flags As Integer) As Integer
    Declare Unicode Function DTWAIN_SetAcquireArea2StringW Lib "dtwain32d.dll" (Source As System.IntPtr, left As String, top As String, right As String, bottom As String, lUnit As Integer, Flags As Integer) As Integer
    ...
    Declare Auto Function DTWAIN_SetAcquireImageScale Lib "dtwain32d.dll" (Source As System.IntPtr, xscale As System.Double, yscale As System.Double) As Integer
    Declare Ansi Function DTWAIN_SetAcquireImageScaleString Lib "dtwain32d.dll" (Source As System.IntPtr, xscale As String, yscale As String) As Integer
    Declare Ansi Function DTWAIN_SetAcquireImageScaleStringA Lib "dtwain32d.dll" (Source As System.IntPtr, xscale As String, yscale As String) As Integer
    Declare Unicode Function DTWAIN_SetAcquireImageScaleStringW Lib "dtwain32d.dll" (Source As System.IntPtr, xscale As String, yscale As String) As Integer
    ...
    Declare Ansi Function DTWAIN_SetAppInfo Lib "dtwain32d.dll" (szVerStr As String, szManu As String, szProdFam As String, szProdName As String) As Integer
    Declare Ansi Function DTWAIN_SetAppInfoA Lib "dtwain32d.dll" (szVerStr As String, szManu As String, szProdFam As String, szProdName As String) As Integer
    Declare Unicode Function DTWAIN_SetAppInfoW Lib "dtwain32d.dll" (szVerStr As String, szManu As String, szProdFam As String, szProdName As String) As Integer
    Declare Ansi Function DTWAIN_SetAuthor Lib "dtwain32d.dll" (Source As System.IntPtr, szAuthor As String) As Integer
    Declare Ansi Function DTWAIN_SetAuthorA Lib "dtwain32d.dll" (Source As System.IntPtr, szAuthor As String) As Integer
    Declare Unicode Function DTWAIN_SetAuthorW Lib "dtwain32d.dll" (Source As System.IntPtr, szAuthor As String) As Integer
    ...
    Declare Auto Function DTWAIN_SetBlankPageDetection Lib "dtwain32d.dll" (Source As System.IntPtr, threshold As System.Double, discard_option As Integer, bSet As Integer) As Integer
    Declare Auto Function DTWAIN_SetBlankPageDetectionEx Lib "dtwain32d.dll" (Source As System.IntPtr, threshold As System.Double, autodetect As Integer, detectOpts As Integer, bSet As Integer) As Integer
    Declare Ansi Function DTWAIN_SetBlankPageDetectionExString Lib "dtwain32d.dll" (Source As System.IntPtr, threshold As String, autodetect_option As Integer, detectOpts As Integer, bSet As Integer) As Integer
    Declare Ansi Function DTWAIN_SetBlankPageDetectionExStringA Lib "dtwain32d.dll" (Source As System.IntPtr, threshold As String, autodetect_option As Integer, detectOpts As Integer, bSet As Integer) As Integer
    Declare Unicode Function DTWAIN_SetBlankPageDetectionExStringW Lib "dtwain32d.dll" (Source As System.IntPtr, threshold As String, autodetect_option As Integer, detectOpts As Integer, bSet As Integer) As Integer
    Declare Ansi Function DTWAIN_SetBlankPageDetectionString Lib "dtwain32d.dll" (Source As System.IntPtr, threshold As String, autodetect_option As Integer, bSet As Integer) As Integer
    Declare Ansi Function DTWAIN_SetBlankPageDetectionStringA Lib "dtwain32d.dll" (Source As System.IntPtr, threshold As String, autodetect_option As Integer, bSet As Integer) As Integer
    Declare Unicode Function DTWAIN_SetBlankPageDetectionStringW Lib "dtwain32d.dll" (Source As System.IntPtr, threshold As String, autodetect_option As Integer, bSet As Integer) As Integer
    Declare Auto Function DTWAIN_SetBrightness Lib "dtwain32d.dll" (Source As System.IntPtr, Brightness As System.Double) As Integer
    Declare Ansi Function DTWAIN_SetBrightnessString Lib "dtwain32d.dll" (Source As System.IntPtr, Brightness As String) As Integer
    Declare Ansi Function DTWAIN_SetBrightnessStringA Lib "dtwain32d.dll" (Source As System.IntPtr, Contrast As String) As Integer
    Declare Unicode Function DTWAIN_SetBrightnessStringW Lib "dtwain32d.dll" (Source As System.IntPtr, Contrast As String) As Integer
    Declare Auto Function DTWAIN_SetBufferedTileMode Lib "dtwain32d.dll" (Source As System.IntPtr, bTileMode As Integer) As Integer
    Declare Auto Function DTWAIN_SetCallback Lib "dtwain32d.dll" (Fn As DTwainCallback, UserData As Integer) As DTwainCallback
    Declare Auto Function DTWAIN_SetCallback64 Lib "dtwain32d.dll" (Fn As DTwainCallback64, UserData As System.Int64) As DTwainCallback64
    Declare Ansi Function DTWAIN_SetCamera Lib "dtwain32d.dll" (Source As System.IntPtr, szCamera As String) As Integer
    Declare Ansi Function DTWAIN_SetCameraA Lib "dtwain32d.dll" (Source As System.IntPtr, szCamera As String) As Integer
    Declare Unicode Function DTWAIN_SetCameraW Lib "dtwain32d.dll" (Source As System.IntPtr, szCamera As String) As Integer
    ...
    Declare Ansi Function DTWAIN_SetCaption Lib "dtwain32d.dll" (Source As System.IntPtr, Caption As String) As Integer
    Declare Ansi Function DTWAIN_SetCaptionA Lib "dtwain32d.dll" (Source As System.IntPtr, Caption As String) As Integer
    Declare Unicode Function DTWAIN_SetCaptionW Lib "dtwain32d.dll" (Source As System.IntPtr, Caption As String) As Integer
    ...
    Declare Auto Function DTWAIN_SetContrast Lib "dtwain32d.dll" (Source As System.IntPtr, Contrast As System.Double) As Integer
    Declare Ansi Function DTWAIN_SetContrastString Lib "dtwain32d.dll" (Source As System.IntPtr, Contrast As String) As Integer
    Declare Ansi Function DTWAIN_SetContrastStringA Lib "dtwain32d.dll" (Source As System.IntPtr, Contrast As String) As Integer
    Declare Unicode Function DTWAIN_SetContrastStringW Lib "dtwain32d.dll" (Source As System.IntPtr, Contrast As String) As Integer
    ...
    Declare Auto Function DTWAIN_SetCustomDSData Lib "dtwain32d.dll" (Source As System.IntPtr, hData As System.IntPtr, <MarshalAs(UnmanagedType.LPArray, ArraySubType:=UnmanagedType.U8, SizeParamIndex:=3)> Data As Byte(), dSize As UInteger, nFlags As Integer) As Integer
    Declare Auto Function DTWAIN_SetDSMSearchOrder Lib "dtwain32d.dll" (SearchPath As Integer) As Integer
    Declare Ansi Function DTWAIN_SetDSMSearchOrderEx Lib "dtwain32d.dll" (SearchOrder As String, UserPath As String) As Integer
    Declare Ansi Function DTWAIN_SetDSMSearchOrderExA Lib "dtwain32d.dll" (SearchOrder As String, szUserPath As String) As Integer
    Declare Unicode Function DTWAIN_SetDSMSearchOrderExW Lib "dtwain32d.dll" (SearchOrder As String, szUserPath As String) As Integer
    ...
    Declare Ansi Function DTWAIN_SetDeviceTimeDate Lib "dtwain32d.dll" (Source As System.IntPtr, szTimeDate As String) As Integer
    Declare Ansi Function DTWAIN_SetDeviceTimeDateA Lib "dtwain32d.dll" (Source As System.IntPtr, szTimeDate As String) As Integer
    Declare Unicode Function DTWAIN_SetDeviceTimeDateW Lib "dtwain32d.dll" (Source As System.IntPtr, szTimeDate As String) As Integer
    Declare Auto Function DTWAIN_SetDoubleFeedDetectLength Lib "dtwain32d.dll" (Source As System.IntPtr, Value As System.Double) As Integer
    Declare Ansi Function DTWAIN_SetDoubleFeedDetectLengthString Lib "dtwain32d.dll" (Source As System.IntPtr, value As String) As Integer
    Declare Ansi Function DTWAIN_SetDoubleFeedDetectLengthStringA Lib "dtwain32d.dll" (Source As System.IntPtr, szLength As String) As Integer
    Declare Unicode Function DTWAIN_SetDoubleFeedDetectLengthStringW Lib "dtwain32d.dll" (Source As System.IntPtr, szLength As String) As Integer
    ...
    Declare Auto Function DTWAIN_SetDoublePageCountOnDuplex Lib "dtwain32d.dll" (Source As System.IntPtr, bDoubleCount As Integer) As Integer
    ...
    Declare Auto Function DTWAIN_SetErrorCallback Lib "dtwain32d.dll" (proc As DTwainErrorProc, UserData As Integer) As Integer
    Declare Auto Function DTWAIN_SetErrorCallback64 Lib "dtwain32d.dll" (proc As DTwainErrorProc64, UserData64 As System.Int64) As Integer
    ...
    Declare Auto Function DTWAIN_SetFeederWaitTime Lib "dtwain32d.dll" (Source As System.IntPtr, waitTime As Integer, flags As Integer) As Integer
    ...
    Declare Auto Function DTWAIN_SetFileCompressionType Lib "dtwain32d.dll" (Source As System.IntPtr, lCompression As Integer, bIsCustom As Integer) As Integer
    Declare Ansi Function DTWAIN_SetFileSavePos Lib "dtwain32d.dll" (hWndParent As System.IntPtr, szTitle As String, xPos As Integer, yPos As Integer, nFlags As Integer) As Integer
    Declare Ansi Function DTWAIN_SetFileSavePosA Lib "dtwain32d.dll" (hWndParent As System.IntPtr, szTitle As String, xPos As Integer, yPos As Integer, nFlags As Integer) As Integer
    Declare Unicode Function DTWAIN_SetFileSavePosW Lib "dtwain32d.dll" (hWndParent As System.IntPtr, szTitle As String, xPos As Integer, yPos As Integer, nFlags As Integer) As Integer
    ...
    Declare Ansi Function DTWAIN_SetHalftone Lib "dtwain32d.dll" (Source As System.IntPtr, lpHalftone As String) As Integer
    Declare Ansi Function DTWAIN_SetHalftoneA Lib "dtwain32d.dll" (Source As System.IntPtr, lpHalftone As String) As Integer
    Declare Unicode Function DTWAIN_SetHalftoneW Lib "dtwain32d.dll" (Source As System.IntPtr, lpHalftone As String) As Integer
    Declare Auto Function DTWAIN_SetHighlight Lib "dtwain32d.dll" (Source As System.IntPtr, Highlight As System.Double) As Integer
    Declare Ansi Function DTWAIN_SetHighlightString Lib "dtwain32d.dll" (Source As System.IntPtr, Highlight As String) As Integer
    Declare Ansi Function DTWAIN_SetHighlightStringA Lib "dtwain32d.dll" (Source As System.IntPtr, Highlight As String) As Integer
    Declare Unicode Function DTWAIN_SetHighlightStringW Lib "dtwain32d.dll" (Source As System.IntPtr, Highlight As String) As Integer
    ...
    Declare Auto Function DTWAIN_SetJpegXRValues Lib "dtwain32d.dll" (Source As System.IntPtr, Quality As Integer, Progressive As Integer) As Integer
    Declare Auto Function DTWAIN_SetLanguage Lib "dtwain32d.dll" (nLanguage As Integer) As Integer
    Declare Auto Function DTWAIN_SetLastError Lib "dtwain32d.dll" (nError As Integer) As Integer
    ...
    Declare Auto Function DTWAIN_SetLoggerCallback Lib "dtwain32d.dll" (logProc As DTwainLoggerProc, UserData As System.Int64) As Integer
    Declare Auto Function DTWAIN_SetLoggerCallbackA Lib "dtwain32d.dll" (logProc As DTwainLoggerProcA, UserData As System.Int64) As Integer
    Declare Auto Function DTWAIN_SetLoggerCallbackW Lib "dtwain32d.dll" (logProc As DTwainLoggerProcW, UserData As System.Int64) As Integer
    ...
    Declare Ansi Function DTWAIN_SetPDFAuthor Lib "dtwain32d.dll" (Source As System.IntPtr, lpAuthor As String) As Integer
    Declare Ansi Function DTWAIN_SetPDFAuthorA Lib "dtwain32d.dll" (Source As System.IntPtr, lpAuthor As String) As Integer
    Declare Unicode Function DTWAIN_SetPDFAuthorW Lib "dtwain32d.dll" (Source As System.IntPtr, lpAuthor As String) As Integer
    ...
    Declare Ansi Function DTWAIN_SetPDFCreator Lib "dtwain32d.dll" (Source As System.IntPtr, lpCreator As String) As Integer
    Declare Ansi Function DTWAIN_SetPDFCreatorA Lib "dtwain32d.dll" (Source As System.IntPtr, lpCreator As String) As Integer
    Declare Unicode Function DTWAIN_SetPDFCreatorW Lib "dtwain32d.dll" (Source As System.IntPtr, lpCreator As String) As Integer
    Declare Ansi Function DTWAIN_SetPDFEncryption Lib "dtwain32d.dll" (Source As System.IntPtr, bUseEncryption As Integer, lpszUser As String, lpszOwner As String, Permissions As UInteger, UseStrongEncryption As Integer) As Integer
    Declare Ansi Function DTWAIN_SetPDFEncryptionA Lib "dtwain32d.dll" (Source As System.IntPtr, bUseEncryption As Integer, lpszUser As String, lpszOwner As String, Permissions As UInteger, UseStrongEncryption As Integer) As Integer
    Declare Unicode Function DTWAIN_SetPDFEncryptionW Lib "dtwain32d.dll" (Source As System.IntPtr, bUseEncryption As Integer, lpszUser As String, lpszOwner As String, Permissions As UInteger, UseStrongEncryption As Integer) As Integer
    Declare Auto Function DTWAIN_SetPDFJpegQuality Lib "dtwain32d.dll" (Source As System.IntPtr, Quality As Integer) As Integer
    Declare Ansi Function DTWAIN_SetPDFKeywords Lib "dtwain32d.dll" (Source As System.IntPtr, lpKeyWords As String) As Integer
    Declare Ansi Function DTWAIN_SetPDFKeywordsA Lib "dtwain32d.dll" (Source As System.IntPtr, lpKeyWords As String) As Integer
    Declare Unicode Function DTWAIN_SetPDFKeywordsW Lib "dtwain32d.dll" (Source As System.IntPtr, lpKeyWords As String) As Integer
    ...
    Declare Auto Function DTWAIN_SetPDFPageScale Lib "dtwain32d.dll" (Source As System.IntPtr, nOptions As Integer, xScale As System.Double, yScale As System.Double) As Integer
    Declare Ansi Function DTWAIN_SetPDFPageScaleString Lib "dtwain32d.dll" (Source As System.IntPtr, nOptions As Integer, xScale As String, yScale As String) As Integer
    Declare Ansi Function DTWAIN_SetPDFPageScaleStringA Lib "dtwain32d.dll" (Source As System.IntPtr, nOptions As Integer, xScale As String, yScale As String) As Integer
    Declare Unicode Function DTWAIN_SetPDFPageScaleStringW Lib "dtwain32d.dll" (Source As System.IntPtr, nOptions As Integer, xScale As String, yScale As String) As Integer
    Declare Auto Function DTWAIN_SetPDFPageSize Lib "dtwain32d.dll" (Source As System.IntPtr, PageSize As Integer, CustomWidth As System.Double, CustomHeight As System.Double) As Integer
    Declare Ansi Function DTWAIN_SetPDFPageSizeString Lib "dtwain32d.dll" (Source As System.IntPtr, PageSize As Integer, CustomWidth As String, CustomHeight As String) As Integer
    Declare Ansi Function DTWAIN_SetPDFPageSizeStringA Lib "dtwain32d.dll" (Source As System.IntPtr, PageSize As Integer, CustomWidth As String, CustomHeight As String) As Integer
    Declare Unicode Function DTWAIN_SetPDFPageSizeStringW Lib "dtwain32d.dll" (Source As System.IntPtr, PageSize As Integer, CustomWidth As String, CustomHeight As String) As Integer
    Declare Auto Function DTWAIN_SetPDFPolarity Lib "dtwain32d.dll" (Source As System.IntPtr, Polarity As Integer) As Integer
    Declare Ansi Function DTWAIN_SetPDFProducer Lib "dtwain32d.dll" (Source As System.IntPtr, lpProducer As String) As Integer
    Declare Ansi Function DTWAIN_SetPDFProducerA Lib "dtwain32d.dll" (Source As System.IntPtr, lpProducer As String) As Integer
    Declare Unicode Function DTWAIN_SetPDFProducerW Lib "dtwain32d.dll" (Source As System.IntPtr, lpProducer As String) As Integer
    Declare Ansi Function DTWAIN_SetPDFSubject Lib "dtwain32d.dll" (Source As System.IntPtr, lpSubject As String) As Integer
    Declare Ansi Function DTWAIN_SetPDFSubjectA Lib "dtwain32d.dll" (Source As System.IntPtr, lpSubject As String) As Integer
    Declare Unicode Function DTWAIN_SetPDFSubjectW Lib "dtwain32d.dll" (Source As System.IntPtr, lpSubject As String) As Integer
    Declare Auto Function DTWAIN_SetPDFTextElementFloat Lib "dtwain32d.dll" (TextElement As System.IntPtr, val1 As System.Double, val2 As System.Double, Flags As Integer) As Integer
    ...
    Declare Ansi Function DTWAIN_SetPDFTextElementString Lib "dtwain32d.dll" (TextElement As System.IntPtr, val1 As String, Flags As Integer) As Integer
    Declare Ansi Function DTWAIN_SetPDFTextElementStringA Lib "dtwain32d.dll" (TextElement As System.IntPtr, szString As String, Flags As Integer) As Integer
    Declare Unicode Function DTWAIN_SetPDFTextElementStringW Lib "dtwain32d.dll" (TextElement As System.IntPtr, szString As String, Flags As Integer) As Integer
    Declare Ansi Function DTWAIN_SetPDFTitle Lib "dtwain32d.dll" (Source As System.IntPtr, lpTitle As String) As Integer
    Declare Ansi Function DTWAIN_SetPDFTitleA Lib "dtwain32d.dll" (Source As System.IntPtr, lpTitle As String) As Integer
    Declare Unicode Function DTWAIN_SetPDFTitleW Lib "dtwain32d.dll" (Source As System.IntPtr, lpTitle As String) As Integer
    ...
    Declare Ansi Function DTWAIN_SetPostScriptTitle Lib "dtwain32d.dll" (Source As System.IntPtr, szTitle As String) As Integer
    Declare Ansi Function DTWAIN_SetPostScriptTitleA Lib "dtwain32d.dll" (Source As System.IntPtr, szTitle As String) As Integer
    Declare Unicode Function DTWAIN_SetPostScriptTitleW Lib "dtwain32d.dll" (Source As System.IntPtr, szTitle As String) As Integer
    ...
    Declare Auto Function DTWAIN_SetPrinterEx Lib "dtwain32d.dll" (Source As System.IntPtr, Printer As Integer, bCurrent As Integer) As Integer
    ...
    Declare Ansi Function DTWAIN_SetPrinterSuffixString Lib "dtwain32d.dll" (Source As System.IntPtr, Suffix As String) As Integer
    Declare Ansi Function DTWAIN_SetPrinterSuffixStringA Lib "dtwain32d.dll" (Source As System.IntPtr, Suffix As String) As Integer
    Declare Unicode Function DTWAIN_SetPrinterSuffixStringW Lib "dtwain32d.dll" (Source As System.IntPtr, Suffix As String) As Integer
    Declare Auto Function DTWAIN_SetQueryCapSupport Lib "dtwain32d.dll" (bSet As Integer) As Integer
    Declare Auto Function DTWAIN_SetResolution Lib "dtwain32d.dll" (Source As System.IntPtr, Resolution As System.Double) As Integer
    Declare Ansi Function DTWAIN_SetResolutionString Lib "dtwain32d.dll" (Source As System.IntPtr, Resolution As String) As Integer
    Declare Ansi Function DTWAIN_SetResolutionStringA Lib "dtwain32d.dll" (Source As System.IntPtr, Resolution As String) As Integer
    Declare Unicode Function DTWAIN_SetResolutionStringW Lib "dtwain32d.dll" (Source As System.IntPtr, Resolution As String) As Integer
    Declare Ansi Function DTWAIN_SetResourcePath Lib "dtwain32d.dll" (ResourcePath As String) As Integer
    Declare Ansi Function DTWAIN_SetResourcePathA Lib "dtwain32d.dll" (ResourcePath As String) As Integer
    Declare Unicode Function DTWAIN_SetResourcePathW Lib "dtwain32d.dll" (ResourcePath As String) As Integer
    Declare Auto Function DTWAIN_SetRotation Lib "dtwain32d.dll" (Source As System.IntPtr, Rotation As System.Double) As Integer
    Declare Ansi Function DTWAIN_SetRotationString Lib "dtwain32d.dll" (Source As System.IntPtr, Rotation As String) As Integer
    Declare Ansi Function DTWAIN_SetRotationStringA Lib "dtwain32d.dll" (Source As System.IntPtr, Rotation As String) As Integer
    Declare Unicode Function DTWAIN_SetRotationStringW Lib "dtwain32d.dll" (Source As System.IntPtr, Rotation As String) As Integer
    Declare Ansi Function DTWAIN_SetSaveFileName Lib "dtwain32d.dll" (Source As System.IntPtr, fName As String) As Integer
    Declare Ansi Function DTWAIN_SetSaveFileNameA Lib "dtwain32d.dll" (Source As System.IntPtr, fName As String) As Integer
    Declare Unicode Function DTWAIN_SetSaveFileNameW Lib "dtwain32d.dll" (Source As System.IntPtr, fName As String) As Integer
    Declare Auto Function DTWAIN_SetShadow Lib "dtwain32d.dll" (Source As System.IntPtr, Shadow As System.Double) As Integer
    Declare Ansi Function DTWAIN_SetShadowString Lib "dtwain32d.dll" (Source As System.IntPtr, Shadow As String) As Integer
    Declare Ansi Function DTWAIN_SetShadowStringA Lib "dtwain32d.dll" (Source As System.IntPtr, Shadow As String) As Integer
    Declare Unicode Function DTWAIN_SetShadowStringW Lib "dtwain32d.dll" (Source As System.IntPtr, Shadow As String) As Integer
    Declare Auto Function DTWAIN_SetSourceUnit Lib "dtwain32d.dll" (Source As System.IntPtr, Unit As Integer) As Integer
    ...
    Declare Ansi Function DTWAIN_SetTempFileDirectory Lib "dtwain32d.dll" (szFilePath As String) As Integer
    Declare Ansi Function DTWAIN_SetTempFileDirectoryA Lib "dtwain32d.dll" (szFilePath As String) As Integer
    Declare Ansi Function DTWAIN_SetTempFileDirectoryEx Lib "dtwain32d.dll" (szFilePath As String, CreationFlags As Integer) As Integer
    Declare Ansi Function DTWAIN_SetTempFileDirectoryExA Lib "dtwain32d.dll" (szFilePath As String, CreationFlags As Integer) As Integer
    Declare Unicode Function DTWAIN_SetTempFileDirectoryExW Lib "dtwain32d.dll" (szFilePath As String, CreationFlags As Integer) As Integer
    Declare Unicode Function DTWAIN_SetTempFileDirectoryW Lib "dtwain32d.dll" (szFilePath As String) As Integer
    Declare Auto Function DTWAIN_SetThreshold Lib "dtwain32d.dll" (Source As System.IntPtr, Threshold As System.Double, bSetBithDepthReduction As Integer) As Integer
    Declare Ansi Function DTWAIN_SetThresholdString Lib "dtwain32d.dll" (Source As System.IntPtr, Threshold As String, bSetBitDepthReduction As Integer) As Integer
    Declare Ansi Function DTWAIN_SetThresholdStringA Lib "dtwain32d.dll" (Source As System.IntPtr, Threshold As String, bSetBitDepthReduction As Integer) As Integer
    Declare Unicode Function DTWAIN_SetThresholdStringW Lib "dtwain32d.dll" (Source As System.IntPtr, Threshold As String, bSetBitDepthReduction As Integer) As Integer
    Declare Auto Function DTWAIN_SetTwainDSM Lib "dtwain32d.dll" (DSMType As Integer) As Integer
    Declare Ansi Function DTWAIN_SetTwainLog Lib "dtwain32d.dll" (LogFlags As UInteger, lpszLogFile As String) As Integer
    Declare Ansi Function DTWAIN_SetTwainLogA Lib "dtwain32d.dll" (LogFlags As UInteger, lpszLogFile As String) As Integer
    Declare Unicode Function DTWAIN_SetTwainLogW Lib "dtwain32d.dll" (LogFlags As UInteger, lpszLogFile As String) As Integer
    ...
    Declare Auto Function DTWAIN_SetXResolution Lib "dtwain32d.dll" (Source As System.IntPtr, xResolution As System.Double) As Integer
    Declare Ansi Function DTWAIN_SetXResolutionString Lib "dtwain32d.dll" (Source As System.IntPtr, Resolution As String) As Integer
    Declare Ansi Function DTWAIN_SetXResolutionStringA Lib "dtwain32d.dll" (Source As System.IntPtr, Resolution As String) As Integer
    Declare Unicode Function DTWAIN_SetXResolutionStringW Lib "dtwain32d.dll" (Source As System.IntPtr, Resolution As String) As Integer
    Declare Auto Function DTWAIN_SetYResolution Lib "dtwain32d.dll" (Source As System.IntPtr, yResolution As System.Double) As Integer
    Declare Ansi Function DTWAIN_SetYResolutionString Lib "dtwain32d.dll" (Source As System.IntPtr, Resolution As String) As Integer
    Declare Ansi Function DTWAIN_SetYResolutionStringA Lib "dtwain32d.dll" (Source As System.IntPtr, Resolution As String) As Integer
    Declare Unicode Function DTWAIN_SetYResolutionStringW Lib "dtwain32d.dll" (Source As System.IntPtr, Resolution As String) As Integer
    ...
    Declare Ansi Function DTWAIN_StartTwainSession Lib "dtwain32d.dll" (hWndMsg As System.IntPtr, lpszDLLName As String) As Integer
    Declare Ansi Function DTWAIN_StartTwainSessionA Lib "dtwain32d.dll" (hWndMsg As System.IntPtr, lpszDLLName As String) As Integer
    Declare Unicode Function DTWAIN_StartTwainSessionW Lib "dtwain32d.dll" (hWndMsg As System.IntPtr, lpszDLLName As String) As Integer
    ...
    Declare Ansi Function DTWAIN_SysInitializeEx Lib "dtwain32d.dll" (szINIPath As String) As System.IntPtr
    Declare Ansi Function DTWAIN_SysInitializeEx2 Lib "dtwain32d.dll" (szINIPath As String, szImageDLLPath As String, szLangResourcePath As String) As System.IntPtr
    Declare Ansi Function DTWAIN_SysInitializeEx2A Lib "dtwain32d.dll" (szINIPath As String, szImageDLLPath As String, szLangResourcePath As String) As System.IntPtr
    Declare Unicode Function DTWAIN_SysInitializeEx2W Lib "dtwain32d.dll" (szINIPath As String, szImageDLLPath As String, szLangResourcePath As String) As System.IntPtr
    Declare Ansi Function DTWAIN_SysInitializeExA Lib "dtwain32d.dll" (szINIPath As String) As System.IntPtr
    Declare Unicode Function DTWAIN_SysInitializeExW Lib "dtwain32d.dll" (szINIPath As String) As System.IntPtr
    Declare Auto Function DTWAIN_SysInitializeLib Lib "dtwain32d.dll" (hInstance As System.IntPtr) As System.IntPtr
    Declare Ansi Function DTWAIN_SysInitializeLibEx Lib "dtwain32d.dll" (hInstance As System.IntPtr, szINIPath As String) As System.IntPtr
    Declare Ansi Function DTWAIN_SysInitializeLibEx2 Lib "dtwain32d.dll" (hInstance As System.IntPtr, szINIPath As String, szImageDLLPath As String, szLangResourcePath As String) As System.IntPtr
    Declare Ansi Function DTWAIN_SysInitializeLibEx2A Lib "dtwain32d.dll" (hInstance As System.IntPtr, szINIPath As String, szImageDLLPath As String, szLangResourcePath As String) As System.IntPtr
    Declare Unicode Function DTWAIN_SysInitializeLibEx2W Lib "dtwain32d.dll" (hInstance As System.IntPtr, szINIPath As String, szImageDLLPath As String, szLangResourcePath As String) As System.IntPtr
    Declare Ansi Function DTWAIN_SysInitializeLibExA Lib "dtwain32d.dll" (hInstance As System.IntPtr, szINIPath As String) As System.IntPtr
    Declare Unicode Function DTWAIN_SysInitializeLibExW Lib "dtwain32d.dll" (hInstance As System.IntPtr, szINIPath As String) As System.IntPtr
