...
namespace dynarithmic
{
    namespace twain
    {
        ...
        {
            public:
                static void apply(twain_source_base& ts, pages_options& po)
                {
                ...
                static void apply(twain_source_base& ts, jobcontrol_options& jc)
                {
                    auto& ci = ts.get_capability_interface();
                ...
                static void apply(twain_source_base& ts, paperhandling_options& po)
                {
                    auto& ci = ts.get_capability_interface();
                ...
                static void apply(twain_source_base& ts, imagetype_options& io)
                {
                    auto& ci = ts.get_capability_interface();
                ...
                static void apply(twain_source_base& ts, file_transfer_options_ex& fo)
                {
                ...
                static void apply(twain_source_base& ts, compression_options& co)
                {
                    auto& ci = ts.get_capability_interface();
                ...
                static void apply(twain_source_base& ts, userinterface_options& ui)
                {
                    auto& ci = ts.get_capability_interface();
                ...
                static void apply(twain_source_base& ts, language_options& lo)
                {
                    auto& ci = ts.get_capability_interface();
                ...
                static void apply(twain_source_base& ts, deviceparams_options& dp)
                {
                    auto& ci = ts.get_capability_interface();
                ...
                static void apply(twain_source_base& ts, powermonitor_options& po)
                {
                ...
                static void apply(twain_source_base& ts, doublefeed_options& df)
                {
                    auto& ci = ts.get_capability_interface();
                ...
                static void apply(twain_source_base& ts, autoadjust_options& ao)
                {
                    auto& ci = ts.get_capability_interface();
                ...
                static void apply(twain_source_base& ts, barcodedetection_options& bo)
                {
                    auto& ci = ts.get_capability_interface();
                ...
                static void apply(twain_source_base& ts, patchcode_options& pc)
                {
                    auto& ci = ts.get_capability_interface();
                ...
                static void apply(twain_source_base& ts, autocapture_options& ac)
                {
                    auto& ci = ts.get_capability_interface();
                ...
                static void apply(twain_source_base& ts, imageinformation_options& io)
                {
                    auto& ci = ts.get_capability_interface();
                ...
                static void apply(twain_source_base& ts, imageparameter_options& io)
                {
                    auto& ci = ts.get_capability_interface();
                ...
                static void apply(twain_source_base& ts, audiblealarms_options& aa)
                {
                    auto& ci = ts.get_capability_interface();
                ...
                static void apply(twain_source_base& ts, deviceevent_options& dopt)
                {
                    auto& ci = ts.get_capability_interface();
                    ci.set_cap_values< CAP_DEVICEEVENT_>(dopt.m_vDeviceEvents);
                }

                static void apply(twain_source_base& ts, resolution_options& ro)
                {
                    auto& ci = ts.get_capability_interface();
                ...
                static void apply(twain_source_base& ts, color_options& co)
                {
                    auto& ci = ts.get_capability_interface();
                ...
                static void apply(twain_source_base& ts, capnegotiation_options& co)
                {
                ...
                static void apply(twain_source_base& ts, micr_options& mo)
                {
                    auto& ci = ts.get_capability_interface();
                    ci.set_cap_values< CAP_MICRENABLED_>({ mo.m_bMicrEnabled });
                }

                static void apply(twain_source_base& ts, imprinter_options& io)
                {
                    auto& ci = ts.get_capability_interface();
                ...
                static void apply(twain_source_base& ts, autoscanning_options& ao)
                {
                    auto& ci = ts.get_capability_interface();
                    ao.set_autoscan({ ao.m_bAutoScan });
                    ao.set_cameraenabled({ ao.m_bCameraEnabled });
