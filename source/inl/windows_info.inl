...
CTL_StringType dynarithmic::GetWinVersion()
{
        ...
        switch (osvi.EmulatedPlatform)
        {
            ...
            case COSVersion::Windows9x:
            {
                if (os.IsWindows95(&osvi, FALSE))
                    ...
                    sBuf << _T("Windows Millennium Edition");
                else
                    sBuf << _T("Windows \?\?");
                sText << sBuf.str();
                break;
            ...
            case COSVersion::WindowsNT:
            {
                ...
                else if (os.IsWindows8Point1OrWindowsServer2012R2(&osvi, FALSE))
                {
                    if (os.IsWindows8Point1(&osvi, FALSE))
                    {
                        if (os.IsThinPC(&osvi))
                            ...
                            sText << _T("Windows 8.1 (Pro for Education)"); //NOLINT(clang-analyzer-security.insecureAPI.strcpy)
                        else if (os.IsProfessional(&osvi))
                ...
                else if (os.IsWindows11(&osvi, FALSE))
                {
                    ...
                    if (os.IsWindows11Version21H2(&osvi, FALSE))
                        ...
                        sText << _T(", (version 26H2)"); //NOLINT(clang-analyzer-security.insecureAPI.strcpy)
  ...
  //lets not bother displaying any info on this on CE
        ...
        case COSVersion::ReactOS:
        {
            sText << _T("ReactOS"); //NOLINT(clang-analyzer-security.insecureAPI.strcpy)
            break;
        }
        case COSVersion::WindowsCE:
        {
        ...
        case COSVersion::WindowsNT:
        {
            ...
            else if (os.IsWindowsXPOrWindowsServer2003(&osvi, TRUE))
            {
                ...
                if (os.IsWindowsServer2003Datacenter(&osvi, TRUE) || os.IsWindowsServer2003R2Datacenter(&osvi, TRUE))
                    sText << _T(", (Datacenter Edition)"); //NOLINT(clang-analyzer-security.insecureAPI.strcpy)
                else if (os.IsWindowsServer2003Enterprise(&osvi, TRUE) || os.IsWindowsServer2003R2Enterprise(&osvi, TRUE))
                    sText << _T(", (Enterprise Edition)"); //NOLINT(clang-analyzer-security.insecureAPI.strcpy)
            ...
            else if (os.IsWindows11(&osvi, TRUE))
            {
                ...
                if (os.IsWindows11Version21H2(&osvi, TRUE))
                    ...
                    sText <<  _T(", (version 22H2)"); //NOLINT(clang-analyzer-security.iecureAPI.strcpy)
        ...
        if (os.IsEssentialBusinessServerSecurity(&osvi))
            sText << _T(", (Windows Essential Business Server Security)"); //NOLINT(clang-analyzer-security.insecureAPI.strcpy)
        if (os.IsEssentialBusinessServerManagementSvc(&osvi))
            sText << _T(", (Windows Essential Business Server Svc)"); //NOLINT(clang-analyzer-security.insecureAPI.strcpy)
        if (os.IsEssentialBusinessServerAdditional(&osvi))
            sText << _T(", (Windows Essential Business Server Additional)"); //NOLINT(clang-analyzer-security.insecureAPI.strcpy)
        if (os.IsEssentialBusinessServerAdditionalSvc(&osvi))
            sText << _T(", (Windows Essential Business Server Additional Svc)"); //NOLINT(clang-analyzer-security.insecureAPI.strcpy)
        ...
        if (os.IsServerForSBSolutions(&osvi))
            sText << _T(", (Server for SB Solutions)"); //NOLINT(clang-analyzer-security.insecureAPI.strcpy)
        if (os.IsServerSolutions(&osvi))
            sText << _T(", (Server Solutions)"); //NOLINT(clang-analyzer-security.insecureAPI.strcpy)
        ...
        if (os.IsWindows10Team(&osvi))      
            sText << _T(", (Windows 10 Team)"); //NOLINT(clang-analyzer-security.insecureAPI.strcpy)
        ...
        if (os.IsIoTEnterpriseSK(&osvi))
            sText << _T(", (IoT Enterprise LTSC Subscription)"); //NOLINT(clang-analyzer-security.insecureAPI.strcpy)
        else if (os.IsIoTEnterpriseK(&osvi))
            sText << _T(", (IoT Enterprise Subscription)"); //NOLINT(clang-analyzer-security.insecureAPI.strcpy)
        else if (os.IsIoTEnterpriseEvaluation(&osvi))
            sText << _T(", (IoT Enterprise Evaluation)"); //NOLINT(clang-analyzer-security.insecureAPI.strcpy)
        ...
        if (os.IsValidation(&osvi))
            sText << _T(", (Validation)"); //NOLINT(clang-analyzer-security.insecureAPI.strcpy)
        ...
        if (os.IsXBoxOneHostOS(&osvi))
            sText << _T(", (XBox One Host OS)"); //NOLINT(clang-analyzer-security.insecureAPI.strcpy)
        if (os.IsXBoxSeriesXSHostOS(&osvi))
            sText << _T(", (XBox Series X/S Host OS)"); //NOLINT(clang-analyzer-security.insecureAPI.strcpy)
        ...
        if (os.IsAzureServerAgentBridge(&osvi))
            sText << _T(", (Azure Server Agent Bridge)"); //NOLINT(clang-analyzer-security.insecureAPI.strcpy)
        if (os.IsAzureServerNanoHost(&osvi))
            sText << _T(", (Azure Server Nano Host)"); //NOLINT(clang-analyzer-security.insecureAPI.strcpy)
        ...
        if (os.IsDatacenterWSServerCoreAzureEdition(&osvi))
            sText << _T(", (Datacenter WS Server Core Azure Edition)"); //NOLINT(clang-analyzer-security.insecureAPI.strcpy)
        ...
        if (os.IsWindows11SE(&osvi))
            sText << _T(", (Windows 11 SE)"); //NOLINT(clang-analyzer-security.insecureAPI.strcpy)
