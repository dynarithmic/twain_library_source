...
/* The changes to the AES code are done per Dynarithmic Software's requirements.
   See AES_256_CBC.h for original author and MIT license */
...
void AES256_ECB::AES_EncryptInit(AES_CTX_256_ECB* ctx, const unsigned char* key, const unsigned char* iv /*= nullptr*/)
{
...
void AES256_ECB::AES_Encrypt(AES_CTX_256_ECB* ctx, const unsigned char in_data[AES_BLOCK_SIZE], unsigned char out_data[AES_BLOCK_SIZE])
{
...
void AES256_ECB::AES_CTX_Free(AES_CTX_256_ECB* ctx)
{
