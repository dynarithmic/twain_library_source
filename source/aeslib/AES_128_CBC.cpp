...
/* The changes to the AES code are done per Dynarithmic Software's requirements.  
   See AES_128_CBC.h for original author and MIT license */
...
#if 0
void AES128::AES_DecryptInit(AES_CTX* ctx, const unsigned char* key, const unsigned char* iv)
{
...
#endif
#if 0
void AES128::AES_Decrypt(AES_CTX* ctx, const unsigned char in_data[AES_BLOCK_SIZE], unsigned char out_data[AES_BLOCK_SIZE])
{
...
void AES128::AES_EncryptInit(AES_CTX* ctx, const unsigned char* key, const unsigned char* iv)
{
...
void AES128::AES_Encrypt(AES_CTX* ctx, const unsigned char in_data[AES_BLOCK_SIZE], unsigned char out_data[AES_BLOCK_SIZE])
{
    unsigned int s0, s1, s2, s3, t0, t1, t2, t3;
