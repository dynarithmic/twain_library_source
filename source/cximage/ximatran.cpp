		...
		for(int32_t y=0; y<newy; y++){
			...
			for(int32_t x=0; x<newx; x++){
				...
				for(int32_t m=-1; m<3; m++) {
					...
					for(int32_t n=-1; n<3; n++) {
						...
						if (head.biClrUsed){
							...
							iDst2  = info.pImage + yy*info.dwEffWidth + xx*3;
							rgb.rgbBlue = *iDst2++;
							rgb.rgbGreen= *iDst2++;
							rgb.rgbRed  = *iDst2;
						}
				...
				if (head.biClrUsed)
					...
					iDst2 = newImage.info.pImage + y*newImage.info.dwEffWidth + x*3;
					*iDst2++ = (uint8_t)bb;
					*iDst2++ = (uint8_t)gg;
					*iDst2   = (uint8_t)rr;
				}
			...
			for(int32_t y=0; y<newy; y++){
				...
				for(int32_t x=0; x<newx; x++){
					...
					if (head.biClrUsed){
						...
						uint8_t* iDst3;
						iDst3 = info.pImage + ifY*info.dwEffWidth + ifX*3;
						rgb1.rgbBlue = *iDst3++;	rgb1.rgbGreen= *iDst3++;	rgb1.rgbRed =*iDst3;
						iDst3 = info.pImage + ifY*info.dwEffWidth + ifX1*3;
						rgb2.rgbBlue = *iDst3++;	rgb2.rgbGreen= *iDst3++;	rgb2.rgbRed =*iDst3;
						iDst3 = info.pImage + ifY1*info.dwEffWidth + ifX*3;
						rgb3.rgbBlue = *iDst3++;	rgb3.rgbGreen= *iDst3++;	rgb3.rgbRed =*iDst3;
						iDst3 = info.pImage + ifY1*info.dwEffWidth + ifX1*3;
						rgb4.rgbBlue = *iDst3++;	rgb4.rgbGreen= *iDst3++;	rgb4.rgbRed =*iDst3;
					}
