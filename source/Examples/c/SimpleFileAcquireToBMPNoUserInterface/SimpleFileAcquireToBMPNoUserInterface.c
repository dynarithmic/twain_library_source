...
int SimpleFileAcquireToBMPNoUserInterface()
{
    /* Initialize DTWAIN */
    ...
    strcat(outputDir, "SimpleFileAcquireToBMPNoUserInterface.bmp");
    ...
    fileError = DTWAIN_AcquireFileA(theSource, /* The TWAIN Data Source that was selected */
                                    ...
                                    FALSE,   /* Do not show the user interface */
...
int main()
{
    SimpleFileAcquireToBMPNoUserInterface();
}
