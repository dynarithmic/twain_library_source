...
class fipImageUtility
{
    public:
        static BOOL copyFromHandle(fipImage& im, HANDLE hMem, bool isHandle = true);
        static HANDLE copyToHandle(const fipImage& im);
};
...
public:
    ...
    */
    ...
    @return Returns TRUE if successful, returns FALSE otherwise
    */
    BOOL copyFromHandle(HANDLE hMem, bool isHandle=true);
