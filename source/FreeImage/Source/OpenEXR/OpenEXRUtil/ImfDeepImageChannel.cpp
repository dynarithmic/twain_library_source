...
template <>
PixelType
TypedDeepImageChannel<IMATH_INTERNAL_NAMESPACE::half>::pixelType () const
{
    return HALF;
}
...
template class IMFUTIL_EXPORT_TEMPLATE_INSTANCE TypedDeepImageChannel<IMATH_INTERNAL_NAMESPACE::half>;
