...
namespace
{
    ...
    DTWAIN_BOOL DTWAIN_SetDeviceCapByString(DTWAIN_SOURCE Source, LPCTSTR strVal, SetByStringFn fn)
    {
        ...
        DTWAIN_FLOAT value = CharTraits<CharType>::ToDouble(strVal, 0.0);
...
namespace
{
    ...
    struct SetSupportFn2 : public SetSupportFn1<T>
    {
        ...
        bool operator()()
        {
            return SetSupportArray(this->theSource, this->theValue, this->theCap);
        }
    };

    template <typename T, typename FnToCall>
    T FunctionCaller(FnToCall fn)
    {
        try
        {
            T bRet{};
    ...
    DTWAIN_BOOL SetCapability(SetterFn fn)
    {
        return FunctionCaller<DTWAIN_BOOL>(fn);
    }

    DTWAIN_BOOL GetCapabilityByString(GetDeviceCapsByStringFn fn)
    {
        return FunctionCaller<DTWAIN_BOOL>(fn);
    }

    bool IsEnabledImpl(DTWAIN_SOURCE Source, TW_UINT16 Cap)
    {
        return FunctionCaller<bool>(IsEnabledImplFn(Source, Cap));
    }

    template <typename T>
    bool IsSupportedImpl(DTWAIN_SOURCE Source, TW_UINT16 Cap, bool anySupport, T SupportVal)
    {
    ...
    DTWAIN_BOOL SetCapabilityByString(SetFn fn)
    {
        return FunctionCaller<DTWAIN_BOOL>(fn);
    }

    bool GetStringCapability(DTWAIN_SOURCE Source, TW_UINT16 Cap, LPSTR value, LONG nLen, GetCapValuesFn fn)
    {
        DTWAIN_ARRAY ArrayValues = nullptr;
    ...
    bool GetStringCapabilityGeneric(DTWAIN_SOURCE Source, LPTSTR value, LONG Cap, LONG NumChars)
    {
        ...
        CopyInfoToCString(stringconversion::Convert_Ansi_To_Native(valueTemp, valueTemp.size()), value, NumChars);
        return retVal;
    }
}

#define EXPORT_ENUM_CAP_VALUES(FuncName, Cap) \
    extern "C" LONG DLLENTRY_DEF FuncName(DTWAIN_SOURCE Source, LPDTWAIN_ARRAY pArray, DTWAIN_BOOL bExpandIfRange) \
    {\
...
#define EXPORT_ENUM_CAP_VALUES_NOEXPAND(FuncName, Cap) \
    extern "C" LONG DLLENTRY_DEF FuncName(DTWAIN_SOURCE Source, LPDTWAIN_ARRAY pArray) \
    { \
...
#define EXPORT_ENUM_CAP_VALUES_EX(FuncName, Cap) \
    extern "C" DTWAIN_ARRAY DLLENTRY_DEF FuncName(DTWAIN_SOURCE Source, DTWAIN_BOOL bExpandIfRange) \
    {\
...
#define EXPORT_ENUM_CAP_VALUES_NOEXPAND_EX(FuncName, Cap) \
    extern "C" DTWAIN_ARRAY DLLENTRY_DEF FuncName(DTWAIN_SOURCE Source) \
    { \
...
#define EXPORT_SET_CAP_VALUE(FuncName, Cap, CapDataType, CapFn) \
    extern "C" DTWAIN_BOOL  DLLENTRY_DEF FuncName(DTWAIN_SOURCE Source, CapDataType value) \
    {\
...
#define EXPORT_SET_CAP_VALUE_PARM3_2(FuncName, Cap1, Cap2, CapDataType1, CapDataType2, value2, CapFn) \
    extern "C" DTWAIN_BOOL  DLLENTRY_DEF FuncName(DTWAIN_SOURCE Source, CapDataType1 value, DTWAIN_BOOL condType ) \
    {\
...
#define EXPORT_SET_CAP_VALUE_2(FuncName, Cap1, Cap2, CapDataType1, CapDataType2, CapFn) \
    extern "C" DTWAIN_BOOL  DLLENTRY_DEF FuncName(DTWAIN_SOURCE Source, CapDataType1 value) \
    {\
        LOG_FUNC_ENTRY_PARAMS((Source, value)) \
        CapFn theFn, theFn2;\
...
#define EXPORT_GET_CAP_VALUE(FuncName, Cap, CapDataType, CapFn) \
    extern "C" DTWAIN_BOOL DLLENTRY_DEF FuncName(DTWAIN_SOURCE Source, CapDataType::value_type* value)\
    {\
       LOG_FUNC_ENTRY_PARAMS((Source, value)) \
...
#define EXPORT_GET_CAP_VALUE_ARRAY(FuncName, Cap) \
    extern "C" DTWAIN_BOOL DLLENTRY_DEF FuncName(DTWAIN_SOURCE Source, LPDTWAIN_ARRAY value)\
    {\
       LOG_FUNC_ENTRY_PARAMS((Source, value)) \
       auto bRet = DTWAIN_GetCapValues(Source, Cap, DTWAIN_CAPGET, value); \
       LOG_FUNC_EXIT_DEREFERENCE_POINTERS((value)) \
       LOG_FUNC_EXIT_NONAME_PARAMS(bRet); \
       CATCH_BLOCK(false) \
    }
...
#define EXPORT_GET_CAP_VALUE_CONVERTED(FuncName, Cap, CapDataType, CapFn) \
    extern "C" DTWAIN_BOOL DLLENTRY_DEF FuncName(DTWAIN_SOURCE Source, CapDataType::value_converted_type* value)\
    {\
       LOG_FUNC_ENTRY_PARAMS((Source, value)) \
       auto bRet = GetCapability<CapDataType>(Source, Cap, reinterpret_cast<CapDataType::value_type*>(value), CapFn); \
       LOG_FUNC_EXIT_DEREFERENCE_POINTERS((value)) \
       LOG_FUNC_EXIT_NONAME_PARAMS(bRet.first); \
       CATCH_BLOCK(false) \
    }
...
#define EXPORT_GET_CAP_VALUE_RETURNVAL(FuncName, Cap, CapDataType, errorRetValue, CapFn) \
    extern "C" CapDataType::value_type DLLENTRY_DEF FuncName(DTWAIN_SOURCE Source)\
    {\
       LOG_FUNC_ENTRY_PARAMS((Source)) \
...
#define EXPORT_GET_CAP_VALUE_RETURNVAL_CONVERTED(FuncName, Cap, CapDataType, errorRetValue, CapFn) \
    extern "C" CapDataType::value_converted_type DLLENTRY_DEF FuncName(DTWAIN_SOURCE Source)\
    {\
       LOG_FUNC_ENTRY_PARAMS((Source)) \
       CapDataType::value_type value = {}; \
       auto bRet = GetCapability<CapDataType>(Source, Cap, &value, CapFn); \
...
#define EXPORT_GET_CAP_VALUE_OPT_CURRENT_RETURN(FuncName, FuncNameToCall, Cap, CapDataType, ErrorValue) \
    extern "C" CapDataType::value_type DLLENTRY_DEF FuncName(DTWAIN_SOURCE Source, DTWAIN_BOOL bCurrent)\
    {\
...
#define EXPORT_GET_CAP_VALUE_OPT_CURRENT(FuncName, Cap, CapDataType) \
    extern "C" DTWAIN_BOOL DLLENTRY_DEF FuncName(DTWAIN_SOURCE Source, CapDataType::value_type* value, DTWAIN_BOOL bCurrent)\
    {\
...
#define EXPORT_GET_CAP_VALUE_OPT_CURRENT_CONVERT(FuncName, Cap, CapDataType) \
    extern "C" DTWAIN_BOOL DLLENTRY_DEF FuncName(DTWAIN_SOURCE Source, CapDataType::value_converted_type* value, DTWAIN_BOOL bCurrent)\
    {\
        LOG_FUNC_ENTRY_PARAMS((Source, value, bCurrent)) \
        std::pair <bool, int> bRet = {}; \
        if ( bCurrent ) \
            bRet = GetCapability<CapDataType>(Source, Cap, reinterpret_cast<CapDataType::value_type*>(value), GetCurrentCapValues); \
        else \
            bRet = GetCapability<CapDataType>(Source, Cap, reinterpret_cast<CapDataType::value_type*>(value), GetDefaultCapValues); \
       LOG_FUNC_EXIT_DEREFERENCE_POINTERS((value)) \
       LOG_FUNC_EXIT_NONAME_PARAMS(bRet.first); \
       CATCH_BLOCK(false) \
    }
...
#define EXPORT_SET_CAP_VALUE_OPT_CURRENT(FuncName, Cap, CapDataType, CapFn) \
    extern "C" DTWAIN_BOOL DLLENTRY_DEF FuncName(DTWAIN_SOURCE Source, CapDataType value, DTWAIN_BOOL bCurrent)\
    {\
       LOG_FUNC_ENTRY_PARAMS((Source, value, bCurrent)) \
...
#define EXPORT_GET_CAP_VALUE_STRING(FuncName) \
    extern "C" DTWAIN_BOOL DLLENTRY_DEF FuncName##String(DTWAIN_SOURCE Source, LPTSTR value)\
    {\
       LOG_FUNC_ENTRY_PARAMS((Source, value)) \
...
#define EXPORT_SET_CAP_VALUE_STRING(FuncName) \
    extern "C" DTWAIN_BOOL DLLENTRY_DEF FuncName##String(DTWAIN_SOURCE Source, LPCTSTR value)\
   {\
       LOG_FUNC_ENTRY_PARAMS((Source, value)) \
...
#define EXPORT_SET_CAP_VALUE_STRING_2(FuncName) \
    extern "C" DTWAIN_BOOL DLLENTRY_DEF FuncName##String(DTWAIN_SOURCE Source, LPCTSTR value, DTWAIN_BOOL condition)\
    {\
...
#define EXPORT_GET_CAP_VALUE_DWORD(FuncName, Cap) EXPORT_GET_CAP_VALUE_CONVERTED(FuncName, Cap, CTL_ArrayFactory::tagged_array_long, GetCurrentCapValues)
#define EXPORT_GET_CAP_VALUE_A(FuncName, Cap) EXPORT_GET_CAP_VALUE_ARRAY(FuncName, Cap)
...
#define EXPORT_GET_CAP_VALUE_S(FuncName, Cap, NumChars) \
    extern "C" DTWAIN_BOOL DLLENTRY_DEF FuncName(DTWAIN_SOURCE Source, LPTSTR value)\
    {\
        LOG_FUNC_ENTRY_PARAMS((Source, value)) \
...
#define EXPORT_GET_VALUE_OPT_MAXLENGTH_S(FuncName, Cap) \
    extern "C" DTWAIN_BOOL DLLENTRY_DEF FuncName(DTWAIN_SOURCE Source, LPTSTR value, LONG MaxLen)\
    {\
...
#define EXPORT_GET_CAP_VALUE_OPT_CURRENT_DWORD(FuncName, Cap) EXPORT_GET_CAP_VALUE_OPT_CURRENT_CONVERT(FuncName, Cap, CTL_ArrayFactory::tagged_array_long)
...
#define EXPORT_GET_CAP_VALUE_OPT_CURRENT_S(FuncName, Cap, NumChars) \
    extern "C" DTWAIN_BOOL DLLENTRY_DEF FuncName(DTWAIN_SOURCE Source, LPTSTR value, DTWAIN_LONG GetType)\
    {\
...
#define EXPORT_SET_CAP_VALUE_DWORD(FuncName, Cap) EXPORT_SET_CAP_VALUE(FuncName, Cap, DWORD, SetSupportFn1<DWORD>)
...
#define EXPORT_IS_CAP_SUPPORTED_I(FuncName, Cap) \
    extern "C" DTWAIN_BOOL DLLENTRY_DEF FuncName(DTWAIN_SOURCE Source, LONG CapValue)\
    { \
...
#define EXPORT_IS_CAP_SUPPORTED_D(FuncName, Cap) \
    extern "C" DTWAIN_BOOL DLLENTRY_DEF FuncName(DTWAIN_SOURCE Source, DTWAIN_FLOAT CapValue)\
    {\
       LOG_FUNC_ENTRY_PARAMS((Source, CapValue)) \
...
#define EXPORT_IS_CAP_SUPPORTED_I_1(FuncName, Cap) \
    extern "C" DTWAIN_BOOL DLLENTRY_DEF FuncName(DTWAIN_SOURCE Source)\
    { \
       LOG_FUNC_ENTRY_PARAMS((Source)) \
...
EXPORT_IS_CAP_SUPPORTED_I(DTWAIN_IsPatchcodeSupported, ICAP_SUPPORTEDPATCHCODETYPES)
EXPORT_IS_CAP_SUPPORTED_I(DTWAIN_IsBarcodeSupported, ICAP_SUPPORTEDBARCODETYPES)
...
EXPORT_IS_CAP_ENABLED(DTWAIN_IsPatchcodeDetectionEnabled, ICAP_PATCHCODEDETECTIONENABLED)
EXPORT_IS_CAP_ENABLED(DTWAIN_IsBarcodeDetectionEnabled, ICAP_BARCODEDETECTIONENABLED)
...
EXPORT_GET_CAP_VALUE_OPT_CURRENT_RETURN_I(DTWAIN_GetCompressionTypeEx, DTWAIN_GetCompressionType, ICAP_COMPRESSION, -1)
...
EXPORT_GET_CAP_VALUE_DWORD(DTWAIN_GetMaxBuffers, CAP_MAXBATCHBUFFERS)
EXPORT_GET_CAP_VALUE_RETURNVAL_DWORD(DTWAIN_GetMaxBuffersEx, CAP_MAXBATCHBUFFERS, 0)
EXPORT_GET_CAP_VALUE_OPT_CURRENT_I(DTWAIN_GetPaperSize, ICAP_SUPPORTEDSIZES)
EXPORT_GET_CAP_VALUE_OPT_CURRENT_DWORD(DTWAIN_GetPatchcodeMaxPriorities, ICAP_PATCHCODEMAXSEARCHPRIORITIES)
EXPORT_GET_CAP_VALUE_OPT_CURRENT_DWORD(DTWAIN_GetBarcodeMaxPriorities, ICAP_BARCODEMAXSEARCHPRIORITIES)
EXPORT_GET_CAP_VALUE_OPT_CURRENT_DWORD(DTWAIN_GetPatchcodeMaxRetries, ICAP_PATCHCODEMAXRETRIES)
EXPORT_GET_CAP_VALUE_OPT_CURRENT_DWORD(DTWAIN_GetBarcodeMaxRetries, ICAP_BARCODEMAXRETRIES)
EXPORT_GET_CAP_VALUE_A(DTWAIN_GetPatchcodePriorities, ICAP_PATCHCODESEARCHPRIORITIES)
EXPORT_GET_CAP_VALUE_A(DTWAIN_GetBarcodePriorities, ICAP_BARCODESEARCHPRIORITIES)
EXPORT_GET_CAP_VALUE_OPT_CURRENT_I(DTWAIN_GetPatchcodeSearchMode, ICAP_PATCHCODESEARCHMODE)
EXPORT_GET_CAP_VALUE_OPT_CURRENT_I(DTWAIN_GetBarcodeSearchMode, ICAP_BARCODESEARCHMODE)
EXPORT_GET_CAP_VALUE_OPT_CURRENT_DWORD(DTWAIN_GetPatchcodeTimeOut, ICAP_PATCHCODETIMEOUT)
EXPORT_GET_CAP_VALUE_OPT_CURRENT_DWORD(DTWAIN_GetBarcodeTimeOut, ICAP_BARCODETIMEOUT)
...
EXPORT_GET_CAP_VALUE_DWORD(DTWAIN_GetPrinterStartNumber, CAP_PRINTERINDEX)
EXPORT_GET_CAP_VALUE_RETURNVAL_DWORD(DTWAIN_GetPrinterStartNumberEx, CAP_PRINTERINDEX, std::numeric_limits<DWORD>::max())
...
EXPORT_GET_CAP_VALUE_RETURNVAL_D(DTWAIN_GetBrightnessEx, ICAP_BRIGHTNESS, std::numeric_limits<DTWAIN_FLOAT>::min())
EXPORT_GET_CAP_VALUE_RETURNVAL_D(DTWAIN_GetContrastEx, ICAP_CONTRAST, std::numeric_limits<DTWAIN_FLOAT>::min())
...
EXPORT_SET_CAP_VALUE_I(DTWAIN_EnablePatchcodeDetection, ICAP_PATCHCODEDETECTIONENABLED)
EXPORT_SET_CAP_VALUE_I(DTWAIN_EnableBarcodeDetection, ICAP_BARCODEDETECTIONENABLED)
...
EXPORT_SET_CAP_VALUE_DWORD(DTWAIN_SetMaxBuffers, CAP_MAXBATCHBUFFERS)
...
EXPORT_SET_CAP_VALUE_DWORD(DTWAIN_SetPatchcodeMaxPriorities, ICAP_PATCHCODEMAXSEARCHPRIORITIES)
EXPORT_SET_CAP_VALUE_DWORD(DTWAIN_SetBarcodeMaxPriorities, ICAP_BARCODEMAXSEARCHPRIORITIES)
EXPORT_SET_CAP_VALUE_DWORD(DTWAIN_SetPatchcodeMaxRetries,  ICAP_PATCHCODEMAXRETRIES)
EXPORT_SET_CAP_VALUE_DWORD(DTWAIN_SetBarcodeMaxRetries, ICAP_BARCODEMAXRETRIES)
EXPORT_SET_CAP_VALUE_A(DTWAIN_SetPatchcodePriorities, ICAP_PATCHCODESEARCHPRIORITIES)
EXPORT_SET_CAP_VALUE_A(DTWAIN_SetBarcodePriorities, ICAP_BARCODESEARCHPRIORITIES)
EXPORT_SET_CAP_VALUE_I(DTWAIN_SetPatchcodeSearchMode, ICAP_PATCHCODESEARCHMODE)
EXPORT_SET_CAP_VALUE_I(DTWAIN_SetBarcodeSearchMode, ICAP_BARCODESEARCHMODE)
EXPORT_SET_CAP_VALUE_DWORD(DTWAIN_SetPatchcodeTimeOut, ICAP_PATCHCODETIMEOUT)
EXPORT_SET_CAP_VALUE_DWORD(DTWAIN_SetBarcodeTimeOut, ICAP_BARCODETIMEOUT)
EXPORT_SET_CAP_VALUE_I(DTWAIN_SetPixelFlavor, ICAP_PIXELFLAVOR)
EXPORT_SET_CAP_VALUE_DWORD(DTWAIN_SetPrinterStartNumber, CAP_PRINTERINDEX)
...
EXPORT_ENUM_CAP_VALUES_NOEXPAND(DTWAIN_EnumPatchcodeCodes, ICAP_SUPPORTEDPATCHCODETYPES)
EXPORT_ENUM_CAP_VALUES_NOEXPAND(DTWAIN_EnumBarcodeCodes, ICAP_SUPPORTEDBARCODETYPES)
EXPORT_ENUM_CAP_VALUES_NOEXPAND(DTWAIN_EnumPatchcodeMaxPriorities, ICAP_PATCHCODEMAXSEARCHPRIORITIES)
EXPORT_ENUM_CAP_VALUES_NOEXPAND(DTWAIN_EnumBarcodeMaxPriorities, ICAP_BARCODEMAXSEARCHPRIORITIES)
EXPORT_ENUM_CAP_VALUES_NOEXPAND(DTWAIN_EnumPatchcodePriorities, ICAP_PATCHCODESEARCHPRIORITIES)
EXPORT_ENUM_CAP_VALUES_NOEXPAND(DTWAIN_EnumBarcodePriorities, ICAP_BARCODESEARCHPRIORITIES)
EXPORT_ENUM_CAP_VALUES_NOEXPAND(DTWAIN_EnumPatchcodeSearchModes, ICAP_PATCHCODESEARCHMODE)
EXPORT_ENUM_CAP_VALUES_NOEXPAND(DTWAIN_EnumBarcodeSearchModes, ICAP_BARCODESEARCHMODE)
EXPORT_ENUM_CAP_VALUES_NOEXPAND(DTWAIN_EnumPaperSizes, ICAP_SUPPORTEDSIZES)
EXPORT_ENUM_CAP_VALUES_NOEXPAND(DTWAIN_EnumPatchcodeMaxRetries, ICAP_PATCHCODEMAXRETRIES)
EXPORT_ENUM_CAP_VALUES_NOEXPAND(DTWAIN_EnumBarcodeMaxRetries, ICAP_BARCODEMAXRETRIES)
EXPORT_ENUM_CAP_VALUES_NOEXPAND(DTWAIN_EnumPatchcodeTimeOutValues, ICAP_PATCHCODETIMEOUT)
EXPORT_ENUM_CAP_VALUES_NOEXPAND(DTWAIN_EnumBarcodeTimeOutValues, ICAP_BARCODETIMEOUT)
...
EXPORT_ENUM_CAP_VALUES_NOEXPAND_EX(DTWAIN_EnumBitDepthsEx, ICAP_BITDEPTH)
EXPORT_ENUM_CAP_VALUES_NOEXPAND_EX(DTWAIN_EnumPixelTypesEx, ICAP_PIXELTYPE)
...
EXPORT_ENUM_CAP_VALUES_NOEXPAND_EX(DTWAIN_EnumPatchcodeCodesEx, ICAP_SUPPORTEDPATCHCODETYPES)
EXPORT_ENUM_CAP_VALUES_NOEXPAND_EX(DTWAIN_EnumBarcodeCodesEx, ICAP_SUPPORTEDBARCODETYPES)
EXPORT_ENUM_CAP_VALUES_NOEXPAND_EX(DTWAIN_EnumPatchcodeMaxPrioritiesEx, ICAP_PATCHCODEMAXSEARCHPRIORITIES)
EXPORT_ENUM_CAP_VALUES_NOEXPAND_EX(DTWAIN_EnumBarcodeMaxPrioritiesEx, ICAP_BARCODEMAXSEARCHPRIORITIES)
EXPORT_ENUM_CAP_VALUES_NOEXPAND_EX(DTWAIN_EnumPatchcodePrioritiesEx, ICAP_PATCHCODESEARCHPRIORITIES)
EXPORT_ENUM_CAP_VALUES_NOEXPAND_EX(DTWAIN_EnumBarcodePrioritiesEx, ICAP_BARCODESEARCHPRIORITIES)
EXPORT_ENUM_CAP_VALUES_NOEXPAND_EX(DTWAIN_EnumPatchcodeSearchModesEx, ICAP_PATCHCODESEARCHMODE)
EXPORT_ENUM_CAP_VALUES_NOEXPAND_EX(DTWAIN_EnumBarcodeSearchModesEx, ICAP_BARCODESEARCHMODE)
EXPORT_ENUM_CAP_VALUES_NOEXPAND_EX(DTWAIN_EnumPatchcodeMaxRetriesEx, ICAP_PATCHCODEMAXRETRIES)
EXPORT_ENUM_CAP_VALUES_NOEXPAND_EX(DTWAIN_EnumBarcodeMaxRetriesEx, ICAP_BARCODEMAXRETRIES)
EXPORT_ENUM_CAP_VALUES_NOEXPAND_EX(DTWAIN_EnumPatchcodeTimeOutValuesEx, ICAP_PATCHCODETIMEOUT)
EXPORT_ENUM_CAP_VALUES_NOEXPAND_EX(DTWAIN_EnumBarcodeTimeOutValuesEx, ICAP_BARCODETIMEOUT)
