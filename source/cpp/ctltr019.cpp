...
#include "ctltr019.h"
    ...
    #include "ctltr019.inl"
    template  CTL_CapabilitySetEnumTriplet<int>;
    template  CTL_CapabilitySetEnumTriplet<long>;
    template  CTL_CapabilitySetEnumTriplet<unsigned int>;
