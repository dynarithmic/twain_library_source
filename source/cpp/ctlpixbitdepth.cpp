...
DTWAIN_BOOL DTWAIN_SetPixelTypeHelper(DTWAIN_SOURCE Source, LONG PixelType, LONG BitDepth, DTWAIN_BOOL bSetCurrent)
{
    ...
    const DTWAIN_BOOL bRet = DTWAIN_SetCapValuesEx2(Source, ICAP_PIXELTYPE, SetType, DTWAIN_CONTDEFAULT, DTWAIN_DEFAULT, Array );
    if ( bRet )
    {
...
DTWAIN_BOOL DLLENTRY_DEF DTWAIN_SetBitDepth(DTWAIN_SOURCE Source, LONG BitDepth, DTWAIN_BOOL bSetCurrent)
{
    ...
    {
        vIn[0] = BitDepth;
        bRet = DTWAIN_SetCapValuesEx2(Source, ICAP_BITDEPTH, SetType, DTWAIN_CONTDEFAULT, DTWAIN_DEFAULT, Array);
        if ( !bRet )
        {
