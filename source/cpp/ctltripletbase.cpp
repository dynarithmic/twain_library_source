...
namespace dynarithmic
{
    ...
    bool CTL_TwainTriplet::IsMessageGetType() const
    {
        return IsMSGGetType(GetMSG());
    }

    bool CTL_TwainTriplet::IsMessageSetType() const
    {
        return IsMSGSetType(GetMSG());
    }

    bool CTL_TwainTriplet::IsMessageResetType() const
    {
        return IsMSGResetType(GetMSG());
    }

    bool CTL_TwainTriplet::IsMessageSetOrResetType() const
    {
