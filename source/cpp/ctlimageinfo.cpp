                                                ...
                                                LPLONG Compression)
{
    ...
    if (retVal)
    {
        dynarithmic::basicstringutils::SafeStrcpy(XResolution, dynarithmic::basicstringutils::TrimDouble<CTL_StringType>(tempX).c_str(), 255);
        dynarithmic::basicstringutils::SafeStrcpy(YResolution, dynarithmic::basicstringutils::TrimDouble<CTL_StringType>(tempY).c_str(), 255);
    }
