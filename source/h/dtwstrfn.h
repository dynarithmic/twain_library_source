...
LONG        DLLENTRY_DEF DTWAIN_GetSessionDetailsW(LPWSTR szBuf, LONG nSize);
LONG        DLLENTRY_DEF DTWAIN_GetSessionDetailsA(LPSTR szBuf, LONG nSize);
...
LONG        DLLENTRY_DEF DTWAIN_GetSessionDetails(DTWAIN_CHARPTRTYPE szBuf, LONG nSize);
#endif
