...
#define DTWAIN_PDF_ALLOWALL          0xFFFFFFFCU
#define DTWAIN_PDF_ALLOWANYMOD    (DTWAIN_PDF_ALLOWMOD | DTWAIN_PDF_ALLOWFILLIN | DTWAIN_PDF_ALLOWMODANNOTATIONS | DTWAIN_PDF_ALLOWASSEMBLY)
#define DTWAIN_PDF_ALLOWANYPRINTING (DTWAIN_PDF_ALLOWPRINTING | DTWAIN_PDF_ALLOWDEGRADEDPRINTING)
...
#define DTWAIN_CONSTANT_LAST     (DTWAIN_CONSTANT_DTWAINCONT_TWAINCONT + 1) 
