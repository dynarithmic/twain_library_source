...
#define DTWAIN_MINOR_VERSION           10
#define DTWAIN_PATCHLEVEL_VERSION      1

#define DTWAIN_TEXTRESOURCE_MIN_MAJOR_VERSION           5
#define DTWAIN_TEXTRESOURCE_MIN_MINOR_VERSION           10
#define DTWAIN_TEXTRESOURCE_MIN_PATCHLEVEL_VERSION      1

#define DTWAIN_STRINGER_2_(x) #x
#define DTWAIN_STRINGER_(x) DTWAIN_STRINGER_2_(x)

#define DTWAIN_BUILDNUMBER_VERSION 3
#define DTWAIN_BUILDVERSION DTWAIN_STRINGER_(DTWAIN_BUILDNUMBER_VERSION)

#define DTWAIN_VERINFO_BASEVERSION          DTWAIN_STRINGER_(DTWAIN_MAJOR_VERSION) "." DTWAIN_STRINGER_(DTWAIN_MINOR_VERSION)
#define DTWAIN_VERINFO_FILEVERSION          DTWAIN_VERINFO_BASEVERSION "." DTWAIN_STRINGER_(DTWAIN_PATCHLEVEL_VERSION) "." DTWAIN_BUILDVERSION
...
#define DTWAIN_TEXTRESOURCE_PATCHLEVEL_VERSION   DTWAIN_STRINGER_2_(DTWAIN_TEXTRESOURCE_MIN_PATCHLEVEL_VERSION)
    ...
    #define  DTWAIN_DEBUG_COMPILE_MSG " (Release)"
        ...
        #pragma message ( "Building DTWAIN Version " DTWAIN_VERINFO_FILEVERSION DTWAIN_DEBUG_COMPILE_MSG)
    #else
        #pragma message ( "Compiling using DTWAIN Version " DTWAIN_VERINFO_FILEVERSION DTWAIN_DEBUG_COMPILE_MSG)
    #endif
#endif
    ...
    #define DTWAIN_BASE_NAME "dtwain"
        ...
        #define DTWAIN_OSPLATFORMEX " 32-Bit "
    #endif
