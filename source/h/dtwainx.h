...
LONG           DLLENTRY_DEF      DTWAIN_GetSourceUnitEx(DTWAIN_SOURCE Source);
...
DTWAIN_FLOAT         DLLENTRY_DEF    DTWAIN_GetContrastEx(DTWAIN_SOURCE Source);
...
DTWAIN_FLOAT         DLLENTRY_DEF    DTWAIN_GetBrightnessEx(DTWAIN_SOURCE Source);
...
LONG        DLLENTRY_DEF DTWAIN_GetCompressionTypeEx(DTWAIN_SOURCE Source, DTWAIN_BOOL bCurrent);
...
LONG        DLLENTRY_DEF DTWAIN_GetPrinterEx(DTWAIN_SOURCE Source, DTWAIN_BOOL bCurrent);
...
DTWAIN_BOOL DLLENTRY_DEF DTWAIN_SetPrinterStartNumber(DTWAIN_SOURCE Source, DWORD nStart);
...
DTWAIN_BOOL DLLENTRY_DEF DTWAIN_GetPrinterStartNumber(DTWAIN_SOURCE Source, LPDWORD nStart);
DWORD       DLLENTRY_DEF DTWAIN_GetPrinterStartNumberEx(DTWAIN_SOURCE Source); 
DTWAIN_BOOL DLLENTRY_DEF DTWAIN_GetPrinterStringMode(DTWAIN_SOURCE Source, LPLONG PrinterMode, DTWAIN_BOOL bCurrent);
LONG        DLLENTRY_DEF DTWAIN_GetPrinterStringModeEx(DTWAIN_SOURCE Source, DTWAIN_BOOL bCurrent);
DTWAIN_BOOL DLLENTRY_DEF DTWAIN_GetPrinterStrings(DTWAIN_SOURCE Source, LPDTWAIN_ARRAY ArrayString );
DTWAIN_ARRAY DLLENTRY_DEF DTWAIN_GetPrinterStringsEx(DTWAIN_SOURCE Source);
...
LONG        DLLENTRY_DEF DTWAIN_GetOrientationEx(DTWAIN_SOURCE Source, DTWAIN_BOOL bCurrent); 
...
LONG        DLLENTRY_DEF DTWAIN_GetJobControlEx(DTWAIN_SOURCE Source, DTWAIN_BOOL bGetCurrent);
...
DTWAIN_BOOL DLLENTRY_DEF DTWAIN_GetLightPathEx(DTWAIN_SOURCE Source);
...
/* CAP_MAXBATCHBUFFERS */
DTWAIN_BOOL DLLENTRY_DEF DTWAIN_SetMaxBuffers(DTWAIN_SOURCE Source, DWORD MaxBuf );
...
DTWAIN_BOOL DLLENTRY_DEF DTWAIN_GetMaxBuffers(DTWAIN_SOURCE Source, LPDWORD pMaxBuf);
DWORD       DLLENTRY_DEF DTWAIN_GetMaxBuffersEx(DTWAIN_SOURCE Source);
...
DTWAIN_FLOAT DLLENTRY_DEF DTWAIN_GetRotationEx(DTWAIN_SOURCE Source);
...
DTWAIN_BOOL DLLENTRY_DEF DTWAIN_IsPatchcodeSupported(DTWAIN_SOURCE Source, LONG PatchCode);
DTWAIN_BOOL DLLENTRY_DEF DTWAIN_IsPatchcodeDetectionEnabled(DTWAIN_SOURCE Source);
DTWAIN_BOOL DLLENTRY_DEF DTWAIN_EnablePatchcodeDetection(DTWAIN_SOURCE Source, DTWAIN_BOOL bEnable);
DTWAIN_BOOL DLLENTRY_DEF DTWAIN_SetPatchcodeMaxRetries(DTWAIN_SOURCE Source, DWORD nMaxRetries);
DTWAIN_BOOL DLLENTRY_DEF DTWAIN_GetPatchcodeMaxRetries(DTWAIN_SOURCE Source, LPDWORD pMaxRetries, DTWAIN_BOOL bCurrent);
DTWAIN_BOOL DLLENTRY_DEF DTWAIN_EnumPatchcodeMaxRetries(DTWAIN_SOURCE Source,LPDTWAIN_ARRAY pArray);
DTWAIN_ARRAY DLLENTRY_DEF DTWAIN_EnumPatchcodeMaxRetriesEx(DTWAIN_SOURCE Source);
DTWAIN_BOOL DLLENTRY_DEF DTWAIN_SetPatchcodeMaxPriorities(DTWAIN_SOURCE Source, DWORD nMaxSearchPriorities);
DTWAIN_BOOL DLLENTRY_DEF DTWAIN_GetPatchcodeMaxPriorities(DTWAIN_SOURCE Source, LPDWORD pMaxPriorities, DTWAIN_BOOL bCurrent);
DTWAIN_BOOL DLLENTRY_DEF DTWAIN_EnumPatchcodeMaxPriorities(DTWAIN_SOURCE Source, LPDTWAIN_ARRAY pArray);
DTWAIN_ARRAY DLLENTRY_DEF DTWAIN_EnumPatchcodeMaxPrioritiesEx(DTWAIN_SOURCE Source);
DTWAIN_BOOL DLLENTRY_DEF DTWAIN_SetPatchcodeSearchMode(DTWAIN_SOURCE Source, LONG nSearchMode);
DTWAIN_BOOL DLLENTRY_DEF DTWAIN_GetPatchcodeSearchMode(DTWAIN_SOURCE Source, LPLONG pSearchMode, DTWAIN_BOOL bCurrent);
DTWAIN_BOOL DLLENTRY_DEF DTWAIN_EnumPatchcodeSearchModes(DTWAIN_SOURCE Source, LPDTWAIN_ARRAY pArray);
DTWAIN_ARRAY DLLENTRY_DEF DTWAIN_EnumPatchcodeSearchModesEx(DTWAIN_SOURCE Source);
DTWAIN_BOOL DLLENTRY_DEF DTWAIN_SetPatchcodeTimeOut(DTWAIN_SOURCE Source, DWORD TimeOutValue);
DTWAIN_BOOL DLLENTRY_DEF DTWAIN_GetPatchcodeTimeOut(DTWAIN_SOURCE Source, LPDWORD pTimeOut, DTWAIN_BOOL bCurrent);
DTWAIN_BOOL DLLENTRY_DEF DTWAIN_EnumPatchcodeTimeOutValues(DTWAIN_SOURCE Source, LPDTWAIN_ARRAY pArray);
DTWAIN_ARRAY DLLENTRY_DEF DTWAIN_EnumPatchcodeTimeOutValuesEx(DTWAIN_SOURCE Source);
DTWAIN_BOOL DLLENTRY_DEF DTWAIN_SetPatchcodePriorities(DTWAIN_SOURCE Source, DTWAIN_ARRAY SearchPriorities);
DTWAIN_BOOL DLLENTRY_DEF DTWAIN_GetPatchcodePriorities(DTWAIN_SOURCE Source, LPDTWAIN_ARRAY SearchPriorities);
DTWAIN_BOOL DLLENTRY_DEF DTWAIN_EnumPatchcodePriorities(DTWAIN_SOURCE Source, LPDTWAIN_ARRAY pArray);
DTWAIN_ARRAY DLLENTRY_DEF DTWAIN_EnumPatchcodePrioritiesEx(DTWAIN_SOURCE Source);
DTWAIN_BOOL DLLENTRY_DEF DTWAIN_EnumPatchcodeCodes(DTWAIN_SOURCE Source, LPDTWAIN_ARRAY PCodes);
DTWAIN_ARRAY DLLENTRY_DEF DTWAIN_EnumPatchcodeCodesEx(DTWAIN_SOURCE Source);

/* Bar codes */
DTWAIN_BOOL DLLENTRY_DEF DTWAIN_IsBarcodeCapsSupported(DTWAIN_SOURCE Source);
DTWAIN_BOOL DLLENTRY_DEF DTWAIN_IsBarcodeSupported(DTWAIN_SOURCE Source, LONG BarCode);
DTWAIN_BOOL DLLENTRY_DEF DTWAIN_IsBarcodeDetectionEnabled(DTWAIN_SOURCE Source);
DTWAIN_BOOL DLLENTRY_DEF DTWAIN_EnableBarcodeDetection(DTWAIN_SOURCE Source, DTWAIN_BOOL bEnable);
DTWAIN_BOOL DLLENTRY_DEF DTWAIN_SetBarcodeMaxRetries(DTWAIN_SOURCE Source, DWORD nMaxRetries);
DTWAIN_BOOL DLLENTRY_DEF DTWAIN_GetBarcodeMaxRetries(DTWAIN_SOURCE Source, LPDWORD pMaxRetries, DTWAIN_BOOL bCurrent);
DTWAIN_BOOL DLLENTRY_DEF DTWAIN_EnumBarcodeMaxRetries(DTWAIN_SOURCE Source, LPDTWAIN_ARRAY pArray);
DTWAIN_ARRAY DLLENTRY_DEF DTWAIN_EnumBarcodeMaxRetriesEx(DTWAIN_SOURCE Source);
DTWAIN_BOOL DLLENTRY_DEF DTWAIN_SetBarcodeMaxPriorities(DTWAIN_SOURCE Source, DWORD nMaxSearchRetries);
DTWAIN_BOOL DLLENTRY_DEF DTWAIN_GetBarcodeMaxPriorities(DTWAIN_SOURCE Source, LPDWORD pMaxPriorities, DTWAIN_BOOL bCurrent);
DTWAIN_BOOL DLLENTRY_DEF DTWAIN_EnumBarcodeMaxPriorities(DTWAIN_SOURCE Source, LPDTWAIN_ARRAY pArray);
DTWAIN_ARRAY DLLENTRY_DEF DTWAIN_EnumBarcodeMaxPrioritiesEx(DTWAIN_SOURCE Source);
DTWAIN_BOOL DLLENTRY_DEF DTWAIN_SetBarcodeSearchMode(DTWAIN_SOURCE Source, LONG nSearchMode);
DTWAIN_BOOL DLLENTRY_DEF DTWAIN_GetBarcodeSearchMode(DTWAIN_SOURCE Source, LPLONG pSearchMode, DTWAIN_BOOL bCurrent);
DTWAIN_BOOL DLLENTRY_DEF DTWAIN_EnumBarcodeSearchModes(DTWAIN_SOURCE Source, LPDTWAIN_ARRAY pArray);
DTWAIN_ARRAY DLLENTRY_DEF DTWAIN_EnumBarcodeSearchModesEx(DTWAIN_SOURCE Source);
DTWAIN_BOOL DLLENTRY_DEF DTWAIN_SetBarcodeTimeOut(DTWAIN_SOURCE Source, DWORD TimeOutValue);
DTWAIN_BOOL DLLENTRY_DEF DTWAIN_GetBarcodeTimeOut(DTWAIN_SOURCE Source, LPDWORD pTimeOut, DTWAIN_BOOL bCurrent);
DTWAIN_BOOL DLLENTRY_DEF DTWAIN_EnumBarcodeTimeOutValues(DTWAIN_SOURCE Source, LPDTWAIN_ARRAY pArray);
DTWAIN_ARRAY DLLENTRY_DEF DTWAIN_EnumBarcodeTimeOutValuesEx(DTWAIN_SOURCE Source);
DTWAIN_BOOL DLLENTRY_DEF DTWAIN_SetBarcodePriorities(DTWAIN_SOURCE Source, DTWAIN_ARRAY SearchPriorities);
DTWAIN_BOOL DLLENTRY_DEF DTWAIN_GetBarcodePriorities(DTWAIN_SOURCE Source, LPDTWAIN_ARRAY SearchPriorities);
DTWAIN_BOOL DLLENTRY_DEF DTWAIN_EnumBarcodePriorities(DTWAIN_SOURCE Source, LPDTWAIN_ARRAY pArray);
DTWAIN_ARRAY DLLENTRY_DEF DTWAIN_EnumBarcodePrioritiesEx(DTWAIN_SOURCE Source);
DTWAIN_BOOL DLLENTRY_DEF DTWAIN_EnumBarcodeCodes(DTWAIN_SOURCE Source, LPDTWAIN_ARRAY PCodes);
DTWAIN_ARRAY DLLENTRY_DEF DTWAIN_EnumBarcodeCodesEx(DTWAIN_SOURCE Source);
