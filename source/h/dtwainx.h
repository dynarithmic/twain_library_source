...
LONG        DLLENTRY_DEF DTWAIN_GetPrinterStartNumberEx(DTWAIN_SOURCE Source); 
...
DTWAIN_BOOL DLLENTRY_DEF DTWAIN_SetPatchcodeMaxRetries(DTWAIN_SOURCE Source, LONG nMaxRetries);
DTWAIN_BOOL DLLENTRY_DEF DTWAIN_GetPatchcodeMaxRetries(DTWAIN_SOURCE Source, LPLONG pMaxRetries, DTWAIN_BOOL bCurrent);
...
DTWAIN_BOOL DLLENTRY_DEF DTWAIN_SetPatchcodeMaxPriorities(DTWAIN_SOURCE Source, LONG nMaxSearchRetries);
DTWAIN_BOOL DLLENTRY_DEF DTWAIN_GetPatchcodeMaxPriorities(DTWAIN_SOURCE Source, LPLONG pMaxPriorities, DTWAIN_BOOL bCurrent);
...
DTWAIN_BOOL DLLENTRY_DEF DTWAIN_SetPatchcodeTimeOut(DTWAIN_SOURCE Source, LONG TimeOutValue);
DTWAIN_BOOL DLLENTRY_DEF DTWAIN_GetPatchcodeTimeOut(DTWAIN_SOURCE Source, LPLONG pTimeOut, DTWAIN_BOOL bCurrent);
...
DTWAIN_BOOL DLLENTRY_DEF DTWAIN_SetBarcodeMaxRetries(DTWAIN_SOURCE Source, LONG nMaxRetries);
DTWAIN_BOOL DLLENTRY_DEF DTWAIN_GetBarcodeMaxRetries(DTWAIN_SOURCE Source, LPLONG pMaxRetries, DTWAIN_BOOL bCurrent);
...
DTWAIN_BOOL DLLENTRY_DEF DTWAIN_SetBarcodeMaxPriorities(DTWAIN_SOURCE Source, LONG nMaxSearchRetries);
DTWAIN_BOOL DLLENTRY_DEF DTWAIN_GetBarcodeMaxPriorities(DTWAIN_SOURCE Source, LPLONG pMaxPriorities, DTWAIN_BOOL bCurrent);
...
DTWAIN_BOOL DLLENTRY_DEF DTWAIN_SetBarcodeTimeOut(DTWAIN_SOURCE Source, LONG TimeOutValue);
DTWAIN_BOOL DLLENTRY_DEF DTWAIN_GetBarcodeTimeOut(DTWAIN_SOURCE Source, LPLONG pTimeOut, DTWAIN_BOOL bCurrent);
