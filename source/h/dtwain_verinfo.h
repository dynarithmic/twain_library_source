...
#include "dtwain_version.h"
    ...
    #define DTWAIN_BUILD_CALLSTACKNAME  " [Logging+]\0"
#else
    #define DTWAIN_BUILD_CALLSTACKNAME  
#endif
...
#define DTWAIN_VERINFO_PRODUCTVERSION       DTWAIN_VERINFO_FILEVERSION " Build " DTWAIN_BUILDVERSION DTWAIN_BUILD_CALLSTACKNAME "\0"
#endif
