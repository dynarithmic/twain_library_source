...
#define DTWAIN_VERINFO_SPECIALBUILD         DTWAIN_BUILD_COMPILER "\0"
#define DTWAIN_VERINFO_PRIVATEBUILD         "Build " DTWAIN_BUILDVERSION "\0"

#define DTWAIN_NUMERIC_FILE_VERSION         DTWAIN_MAJOR_VERSION, DTWAIN_MINOR_VERSION, DTWAIN_PATCHLEVEL_VERSION, DTWAIN_BUILDNUMBER_VERSION
#define DTWAIN_NUMERIC_PRODUCT_VERSION      DTWAIN_NUMERIC_FILE_VERSION
#define DTWAIN_VERINFO_LEGALCOPYRIGHT_HTML  "Copyright &#169; 2020-2026"
