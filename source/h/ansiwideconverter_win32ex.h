 ...
 */
#ifndef ANSIWIDECONVERTER_WIN32EX_H
#define ANSIWIDECONVERTER_WIN32EX_H
...
namespace dynarithmic
{
    ...
    inline std::string WideToANSI(std::wstring_view wstr)
    {
        return static_cast<LPCSTR>(ConvertW2A(wstr.data()));
    }

    inline std::wstring ANSIToWide(std::string_view str)
    {
        return static_cast<LPCWSTR>(ConvertA2W(str.data()));
    }

    inline std::string WideToANSI(std::wstring_view wstr, size_t len)
    {
        return static_cast<LPCSTR>(ConvertW2A(wstr.data(), len));
    }

    inline std::wstring ANSIToWide(std::string_view str, size_t len)
    {
