...
namespace dynarithmic
{
    ...
    class TiffSessionWriter
    {
        ...
        private:
            ...
            bool SetCommonTags(const PageTagInfo& tagInfo) const;
            bool SetCompressionTags(const PageTagInfo& tagInfo) const;
            bool SetPaletteTags(uint16_t bitsPerSample) const;
