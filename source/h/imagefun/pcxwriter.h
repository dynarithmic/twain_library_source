...
namespace dynarithmic
{
    ...
    class PcxSessionWriter
    {
        public:
            ...
            bool Close();
            static std::optional<PreparedPcxDibPage> MakePreparedPcxDibPage(const DibPageView& view);
        ...
        private:
            ...
            bool Write256Palette(const PreparedPcxDibPage& page) const;
    ...
    class DTWAINPcxDcxOutput
    {
        public:
            ...
            bool OnNextPage(const PreparedPcxDibPage& page) const;
            bool OnLastPage();
