...
2) An installation of the [Boost](http://www.boost.org/) library (version 1.80 or above, until version 1.87).  There is an issue using version 1.88 and above, which will be remedied in version 5.6.4 and above of the DTWAIN source code.
