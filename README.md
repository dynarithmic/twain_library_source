...
* Start Visual Studio, and open one of the DTWAIN solution.  The DTWAIN solution files are found in the [source](https://github.com/dynarithmic/twain_library_development/tree/master/source) directory.  Open **dtwain_5_vs2015.sln** or **dtwain_5_vs2017.sln**, depending on whether you are using Visual Studio 2015 or 2017, respectively. 
