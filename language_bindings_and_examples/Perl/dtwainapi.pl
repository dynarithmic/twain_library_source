...
my $DTWAIN_RotateDIB = new Win32::API($dtwain_dllName, 'DTWAIN_RotateDIB', 'PD', 'P');
my $DTWAIN_RotateDIBString = new Win32::API($dtwain_dllName, 'DTWAIN_RotateDIBString', 'PP', 'P');
my $DTWAIN_RotateDIBStringA = new Win32::API($dtwain_dllName, 'DTWAIN_RotateDIBStringA', 'PP', 'P');
my $DTWAIN_RotateDIBStringW = new Win32::API($dtwain_dllName, 'DTWAIN_RotateDIBStringW', 'PP', 'P');
