...
Class DTWAINAPI
    ...
    Public Declare Ansi Function DTWAIN_GetCurrentCustomResourceName Lib "dtwain32d.dll" (<MarshalAs(UnmanagedType.LPStr)> lpszOut As StringBuilder, nMaxLen As Integer) As Integer
    ...
    Public Declare Function DTWAIN_GetImageLayoutInfo Lib "dtwain32d.dll" (Source As System.IntPtr, lGetType As Integer, ByRef DocumentNumber As Integer, ByRef PageNumber As Integer, ByRef FrameNumber As Integer) As Integer
    ...
    Public Declare Function DTWAIN_GetLastCapEnumIndices Lib "dtwain32d.dll" (Source As System.IntPtr, ByRef pCurrentIndex As Integer, ByRef pDefaultIndex As Integer) As Integer
    Public Declare Function DTWAIN_GetLastError Lib "dtwain32d.dll" () As Integer
    Public Declare Function DTWAIN_GetLastTwainError Lib "dtwain32d.dll" (ByRef rcError As UInteger, ByRef ccError As UInteger) As Integer
    ...
    Public Declare Function DTWAIN_GetPendingXferCount Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    ...
    Public Declare Function DTWAIN_GetSaveFileType Lib "dtwain32d.dll" (Source As System.IntPtr) As Integer
    ...
    Public Declare Function DTWAIN_SetSaveFileType Lib "dtwain32d.dll" (Source As System.IntPtr, FileType As Integer) As Integer
