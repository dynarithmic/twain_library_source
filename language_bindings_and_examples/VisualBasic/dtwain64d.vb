...
Class DTWAINAPI
    ...
    Public Declare Function DTWAIN_AcquireAudioNative Lib "dtwain64d.dll" (Source As System.IntPtr, nMaxAudioClips As Integer, bShowUI As Integer, bCloseSource As Integer, ByRef pStatus As Integer) As System.IntPtr
    Public Declare Function DTWAIN_AcquireAudioNativeEx Lib "dtwain64d.dll" (Source As System.IntPtr, nMaxAudioClips As Integer, bShowUI As Integer, bCloseSource As Integer, Acquisitions As System.IntPtr, ByRef pStatus As Integer) As Integer
    Public Declare Function DTWAIN_AcquireBuffered Lib "dtwain64d.dll" (Source As System.IntPtr, PixelType As Integer, nMaxPages As Integer, bShowUI As Integer, bCloseSource As Integer, ByRef pStatus As Integer) As System.IntPtr
    Public Declare Function DTWAIN_AcquireBufferedEx Lib "dtwain64d.dll" (Source As System.IntPtr, PixelType As Integer, nMaxPages As Integer, bShowUI As Integer, bCloseSource As Integer, Acquisitions As System.IntPtr, ByRef pStatus As Integer) As Integer
    ...
    Public Declare Function DTWAIN_AcquireFileEx Lib "dtwain64d.dll" (Source As System.IntPtr, aFileNames As System.IntPtr, lFileType As Integer, lFileFlags As Integer, PixelType As Integer, lMaxPages As Integer, bShowUI As Integer, bCloseSource As Integer, ByRef pStatus As Integer) As Integer
    ...
    Public Declare Function DTWAIN_AllocateMemoryEx Lib "dtwain64d.dll" (memSize As UInteger) As System.IntPtr
    Public Declare Function DTWAIN_AppHandlesExceptions Lib "dtwain64d.dll" (bSet As Integer) As Integer
    Public Declare Function DTWAIN_ArrayANSIStringToFloat Lib "dtwain64d.dll" (StringArray As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_ArrayAdd Lib "dtwain64d.dll" (pArray As System.IntPtr, pVariant As System.IntPtr) As Integer
    ...
    Public Declare Function DTWAIN_ArrayAddFloat Lib "dtwain64d.dll" (pArray As System.IntPtr, Val As System.Double) As Integer
    Public Declare Function DTWAIN_ArrayAddFloatN Lib "dtwain64d.dll" (pArray As System.IntPtr, Val As System.Double, num As Integer) As Integer
    ...
    Public Declare Function DTWAIN_ArrayAddFrame Lib "dtwain64d.dll" (pArray As System.IntPtr, frame As System.IntPtr) As Integer
    Public Declare Function DTWAIN_ArrayAddFrameN Lib "dtwain64d.dll" (pArray As System.IntPtr, frame As System.IntPtr, num As Integer) As Integer
    Public Declare Function DTWAIN_ArrayAddLong Lib "dtwain64d.dll" (pArray As System.IntPtr, Val As Integer) As Integer
    Public Declare Function DTWAIN_ArrayAddLong64 Lib "dtwain64d.dll" (pArray As System.IntPtr, Val As System.Int64) As Integer
    Public Declare Function DTWAIN_ArrayAddLong64N Lib "dtwain64d.dll" (pArray As System.IntPtr, Val As System.Int64, num As Integer) As Integer
    Public Declare Function DTWAIN_ArrayAddLongN Lib "dtwain64d.dll" (pArray As System.IntPtr, Val As Integer, num As Integer) As Integer
    Public Declare Function DTWAIN_ArrayAddN Lib "dtwain64d.dll" (pArray As System.IntPtr, pVariant As System.IntPtr, num As Integer) As Integer
    ...
    Public Declare Function DTWAIN_ArrayConvertFix32ToFloat Lib "dtwain64d.dll" (Fix32Array As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_ArrayConvertFloatToFix32 Lib "dtwain64d.dll" (FloatArray As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_ArrayCopy Lib "dtwain64d.dll" (Source As System.IntPtr, Dest As System.IntPtr) As Integer
    Public Declare Function DTWAIN_ArrayCreate Lib "dtwain64d.dll" (nEnumType As Integer, nInitialSize As Integer) As System.IntPtr
    Public Declare Function DTWAIN_ArrayCreateCopy Lib "dtwain64d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_ArrayCreateFromANSIStrings Lib "dtwain64d.dll" (<[In], MarshalAs(UnmanagedType.LPArray, ArraySubType:=UnmanagedType.LPStr)> pCArray() As String, nSize As Integer) As System.IntPtr
    Public Declare Function DTWAIN_ArrayCreateFromCap Lib "dtwain64d.dll" (Source As System.IntPtr, lCapType As Integer, lSize As Integer) As System.IntPtr
    Public Declare Function DTWAIN_ArrayCreateFromFloats Lib "dtwain64d.dll" (<[In]> pCArray() As System.Double, nSize As Integer) As System.IntPtr
    Public Declare Function DTWAIN_ArrayCreateFromLong64s Lib "dtwain64d.dll" (<[In]> pCArray() As System.Int64, nSize As Integer) As System.IntPtr
    Public Declare Function DTWAIN_ArrayCreateFromLongs Lib "dtwain64d.dll" (<[In]> pCArray() As Integer, nSize As Integer) As System.IntPtr
    Public Declare Function DTWAIN_ArrayCreateFromStrings Lib "dtwain64d.dll" (<[In], MarshalAs(UnmanagedType.LPArray, ArraySubType:=UnmanagedType.LPTStr)> pCArray() As String, nSize As Integer) As System.IntPtr
    Public Declare Function DTWAIN_ArrayCreateFromType Lib "dtwain64d.dll" (Source As System.IntPtr, lType As Integer, lSize As Integer) As System.IntPtr
    Public Declare Function DTWAIN_ArrayCreateFromWideStrings Lib "dtwain64d.dll" (<[In], MarshalAs(UnmanagedType.LPArray, ArraySubType:=UnmanagedType.LPWStr)> pCArray() As String, nSize As Integer) As System.IntPtr
    Public Declare Function DTWAIN_ArrayDestroy Lib "dtwain64d.dll" (pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_ArrayDestroyAll Lib "dtwain64d.dll" () As Integer
    Public Declare Function DTWAIN_ArrayDestroyFrames Lib "dtwain64d.dll" (FrameArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_ArrayDumpToLog Lib "dtwain64d.dll" (pArray As System.IntPtr, bAsUnsigned As Integer) As Integer
    Public Declare Function DTWAIN_ArrayFind Lib "dtwain64d.dll" (pArray As System.IntPtr, pVariant As System.IntPtr) As Integer
    ...
    Public Declare Function DTWAIN_ArrayFindFloat Lib "dtwain64d.dll" (pArray As System.IntPtr, Val As System.Double, Tolerance As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_ArrayFindLong Lib "dtwain64d.dll" (pArray As System.IntPtr, Val As Integer) As Integer
    Public Declare Function DTWAIN_ArrayFindLong64 Lib "dtwain64d.dll" (pArray As System.IntPtr, Val As System.Int64) As Integer
    ...
    Public Declare Function DTWAIN_ArrayFix32GetAt Lib "dtwain64d.dll" (aFix32 As System.IntPtr, lPos As Integer, ByRef Whole As Integer, ByRef Frac As Integer) As Integer
    Public Declare Function DTWAIN_ArrayFix32SetAt Lib "dtwain64d.dll" (aFix32 As System.IntPtr, lPos As Integer, Whole As Integer, Frac As Integer) As Integer
    Public Declare Function DTWAIN_ArrayFloatToANSIString Lib "dtwain64d.dll" (FloatArray As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_ArrayFloatToString Lib "dtwain64d.dll" (FloatArray As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_ArrayFloatToWideString Lib "dtwain64d.dll" (FloatArray As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_ArrayGetAt Lib "dtwain64d.dll" (pArray As System.IntPtr, nWhere As Integer, pVariant As System.IntPtr) As Integer
    ...
    Public Declare Function DTWAIN_ArrayGetAtANSIStringPtr Lib "dtwain64d.dll" (pArray As System.IntPtr, nWhere As Integer) As System.IntPtr
    Public Declare Function DTWAIN_ArrayGetAtFloat Lib "dtwain64d.dll" (pArray As System.IntPtr, nWhere As Integer, ByRef pVal As System.Double) As Integer
    Public Declare Function DTWAIN_ArrayGetAtFloatEx Lib "dtwain64d.dll" (pArray As System.IntPtr, nWhere As Integer) As System.Double
    ...
    Public Declare Function DTWAIN_ArrayGetAtFrame Lib "dtwain64d.dll" (FrameArray As System.IntPtr, nWhere As Integer, ByRef pleft As System.Double, ByRef ptop As System.Double, ByRef pright As System.Double, ByRef pbottom As System.Double) As Integer
    Public Declare Function DTWAIN_ArrayGetAtFrameEx Lib "dtwain64d.dll" (FrameArray As System.IntPtr, nWhere As Integer, Frame As System.IntPtr) As Integer
    ...
    Public Declare Function DTWAIN_ArrayGetAtLong Lib "dtwain64d.dll" (pArray As System.IntPtr, nWhere As Integer, ByRef pVal As Integer) As Integer
    Public Declare Function DTWAIN_ArrayGetAtLong64 Lib "dtwain64d.dll" (pArray As System.IntPtr, nWhere As Integer, ByRef pVal As System.Int64) As Integer
    Public Declare Function DTWAIN_ArrayGetAtLong64Ex Lib "dtwain64d.dll" (pArray As System.IntPtr, nWhere As Integer) As System.Int64
    Public Declare Function DTWAIN_ArrayGetAtLongEx Lib "dtwain64d.dll" (pArray As System.IntPtr, nWhere As Integer) As Integer
    Public Declare Function DTWAIN_ArrayGetAtSource Lib "dtwain64d.dll" (pArray As System.IntPtr, nWhere As Integer, ByRef ppSource As System.IntPtr) As Integer
    Public Declare Function DTWAIN_ArrayGetAtSourceEx Lib "dtwain64d.dll" (pArray As System.IntPtr, nWhere As Integer) As System.IntPtr
    ...
    Public Declare Function DTWAIN_ArrayGetAtStringPtr Lib "dtwain64d.dll" (pArray As System.IntPtr, nWhere As Integer) As System.IntPtr
    ...
    Public Declare Function DTWAIN_ArrayGetAtWideStringPtr Lib "dtwain64d.dll" (pArray As System.IntPtr, nWhere As Integer) As System.IntPtr
    Public Declare Function DTWAIN_ArrayGetBuffer Lib "dtwain64d.dll" (pArray As System.IntPtr, nPos As Integer) As System.IntPtr
    Public Declare Function DTWAIN_ArrayGetCapValues Lib "dtwain64d.dll" (Source As System.IntPtr, lCap As Integer, lGetType As Integer) As System.IntPtr
    Public Declare Function DTWAIN_ArrayGetCapValuesEx Lib "dtwain64d.dll" (Source As System.IntPtr, lCap As Integer, lGetType As Integer, lContainerType As Integer) As System.IntPtr
    Public Declare Function DTWAIN_ArrayGetCapValuesEx2 Lib "dtwain64d.dll" (Source As System.IntPtr, lCap As Integer, lGetType As Integer, lContainerType As Integer, nDataType As Integer) As System.IntPtr
    Public Declare Function DTWAIN_ArrayGetCount Lib "dtwain64d.dll" (pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_ArrayGetMaxStringLength Lib "dtwain64d.dll" (a As System.IntPtr) As Integer
    ...
    Public Declare Function DTWAIN_ArrayInsertAtFloat Lib "dtwain64d.dll" (pArray As System.IntPtr, nWhere As Integer, pVal As System.Double) As Integer
    Public Declare Function DTWAIN_ArrayInsertAtFloatN Lib "dtwain64d.dll" (pArray As System.IntPtr, nWhere As Integer, Val As System.Double, num As Integer) As Integer
    ...
    Public Declare Function DTWAIN_ArrayInsertAtFrame Lib "dtwain64d.dll" (pArray As System.IntPtr, nWhere As Integer, frame As System.IntPtr) As Integer
    Public Declare Function DTWAIN_ArrayInsertAtFrameN Lib "dtwain64d.dll" (pArray As System.IntPtr, nWhere As Integer, frame As System.IntPtr, num As Integer) As Integer
    Public Declare Function DTWAIN_ArrayInsertAtLong Lib "dtwain64d.dll" (pArray As System.IntPtr, nWhere As Integer, pVal As Integer) As Integer
    Public Declare Function DTWAIN_ArrayInsertAtLong64 Lib "dtwain64d.dll" (pArray As System.IntPtr, nWhere As Integer, Val As System.Int64) As Integer
    Public Declare Function DTWAIN_ArrayInsertAtLong64N Lib "dtwain64d.dll" (pArray As System.IntPtr, nWhere As Integer, Val As System.Int64, num As Integer) As Integer
    Public Declare Function DTWAIN_ArrayInsertAtLongN Lib "dtwain64d.dll" (pArray As System.IntPtr, nWhere As Integer, pVal As Integer, num As Integer) As Integer
    Public Declare Function DTWAIN_ArrayInsertAtN Lib "dtwain64d.dll" (pArray As System.IntPtr, nWhere As Integer, pVariant As System.IntPtr, num As Integer) As Integer
    ...
    Public Declare Function DTWAIN_ArrayIsValid Lib "dtwain64d.dll" (theArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_ArrayRemoveAll Lib "dtwain64d.dll" (pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_ArrayRemoveAt Lib "dtwain64d.dll" (pArray As System.IntPtr, nWhere As Integer) As Integer
    Public Declare Function DTWAIN_ArrayRemoveAtN Lib "dtwain64d.dll" (pArray As System.IntPtr, nWhere As Integer, num As Integer) As Integer
    Public Declare Function DTWAIN_ArrayResize Lib "dtwain64d.dll" (pArray As System.IntPtr, NewSize As Integer) As Integer
    Public Declare Function DTWAIN_ArraySetAt Lib "dtwain64d.dll" (pArray As System.IntPtr, lPos As Integer, pVariant As System.IntPtr) As Integer
    ...
    Public Declare Function DTWAIN_ArraySetAtFloat Lib "dtwain64d.dll" (pArray As System.IntPtr, nWhere As Integer, pVal As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_ArraySetAtFrame Lib "dtwain64d.dll" (FrameArray As System.IntPtr, nWhere As Integer, left As System.Double, top As System.Double, right As System.Double, bottom As System.Double) As Integer
    Public Declare Function DTWAIN_ArraySetAtFrameEx Lib "dtwain64d.dll" (FrameArray As System.IntPtr, nWhere As Integer, Frame As System.IntPtr) As Integer
    ...
    Public Declare Function DTWAIN_ArraySetAtLong Lib "dtwain64d.dll" (pArray As System.IntPtr, nWhere As Integer, pVal As Integer) As Integer
    Public Declare Function DTWAIN_ArraySetAtLong64 Lib "dtwain64d.dll" (pArray As System.IntPtr, nWhere As Integer, Val As System.Int64) As Integer
    ...
    Public Declare Function DTWAIN_ArrayStringToFloat Lib "dtwain64d.dll" (StringArray As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_ArrayWideStringToFloat Lib "dtwain64d.dll" (StringArray As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_CallCallback Lib "dtwain64d.dll" (wParam As Integer, lParam As Integer, UserData As Integer) As Integer
    Public Declare Function DTWAIN_CallCallback64 Lib "dtwain64d.dll" (wParam As Integer, lParam As Integer, UserData As System.Int64) As Integer
    Public Declare Function DTWAIN_CallDSMProc Lib "dtwain64d.dll" (AppID As System.IntPtr, SourceId As System.IntPtr, lDG As Integer, lDAT As Integer, lMSG As Integer, pData As System.IntPtr) As Integer
    Public Declare Function DTWAIN_CheckDLLVersion Lib "dtwain64d.dll" (lMajor As Integer, lMinor As Integer, lPatchLevel As Integer, lBuildNumber As Integer, MatchType As Integer) As Integer
    Public Declare Function DTWAIN_CheckHandles Lib "dtwain64d.dll" (bCheck As Integer) As Integer
    Public Declare Function DTWAIN_ClearBuffers Lib "dtwain64d.dll" (Source As System.IntPtr, ClearBuffer As Integer) As Integer
    Public Declare Function DTWAIN_ClearErrorBuffer Lib "dtwain64d.dll" () As Integer
    Public Declare Function DTWAIN_ClearPDFTextElements Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_ClearPage Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_CloseSource Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_CloseSourceUI Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_ConvertDIBToBitmap Lib "dtwain64d.dll" (hDib As System.IntPtr, hPalette As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_ConvertDIBToFullBitmap Lib "dtwain64d.dll" (hDib As System.IntPtr, isBMP As Integer) As System.IntPtr
    ...
    Public Declare Function DTWAIN_CreateAcquisitionArray Lib "dtwain64d.dll" () As System.IntPtr
    Public Declare Function DTWAIN_CreatePDFTextElement Lib "dtwain64d.dll" () As System.IntPtr
    Public Declare Function DTWAIN_CreatePDFTextElementCopy Lib "dtwain64d.dll" (TextElement As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_DeleteDIB Lib "dtwain64d.dll" (hDib As System.IntPtr) As Integer
    Public Declare Function DTWAIN_DestroyAcquisitionArray Lib "dtwain64d.dll" (aAcq As System.IntPtr, bDestroyData As Integer) As Integer
    Public Declare Function DTWAIN_DestroyPDFTextElement Lib "dtwain64d.dll" (TextElement As System.IntPtr) As Integer
    Public Declare Function DTWAIN_DisableAppWindow Lib "dtwain64d.dll" (hWnd As System.IntPtr, bDisable As Integer) As Integer
    Public Declare Function DTWAIN_EnableAutoBorderDetect Lib "dtwain64d.dll" (Source As System.IntPtr, bEnable As Integer) As Integer
    Public Declare Function DTWAIN_EnableAutoBright Lib "dtwain64d.dll" (Source As System.IntPtr, bSet As Integer) As Integer
    Public Declare Function DTWAIN_EnableAutoDeskew Lib "dtwain64d.dll" (Source As System.IntPtr, bEnable As Integer) As Integer
    Public Declare Function DTWAIN_EnableAutoFeed Lib "dtwain64d.dll" (Source As System.IntPtr, bSet As Integer) As Integer
    Public Declare Function DTWAIN_EnableAutoRotate Lib "dtwain64d.dll" (Source As System.IntPtr, bSet As Integer) As Integer
    Public Declare Function DTWAIN_EnableAutoScan Lib "dtwain64d.dll" (Source As System.IntPtr, bEnable As Integer) As Integer
    Public Declare Function DTWAIN_EnableAutomaticSenseMedium Lib "dtwain64d.dll" (Source As System.IntPtr, bSet As Integer) As Integer
    ...
    Public Declare Function DTWAIN_EnableGetMessageLoop Lib "dtwain64d.dll" (Source As System.IntPtr, bSet As Integer) As Integer
    ...
    Public Declare Function DTWAIN_EnableMsgNotify Lib "dtwain64d.dll" (bSet As Integer) As Integer
    Public Declare Function DTWAIN_EnablePatchcodeDetection Lib "dtwain64d.dll" (Source As System.IntPtr, bEnable As Integer) As Integer
    Public Declare Function DTWAIN_EnablePeekMessageLoop Lib "dtwain64d.dll" (Source As System.IntPtr, bSet As Integer) As Integer
    Public Declare Function DTWAIN_EnablePrinter Lib "dtwain64d.dll" (Source As System.IntPtr, bEnable As Integer) As Integer
    Public Declare Function DTWAIN_EnableThumbnail Lib "dtwain64d.dll" (Source As System.IntPtr, bEnable As Integer) As Integer
    Public Declare Function DTWAIN_EnableTripletsNotify Lib "dtwain64d.dll" (bSet As Integer) As Integer
    Public Declare Function DTWAIN_EndThread Lib "dtwain64d.dll" (DLLHandle As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EndTwainSession Lib "dtwain64d.dll" () As Integer
    Public Declare Function DTWAIN_EnumAlarmVolumes Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr, expandIfRange As Integer) As Integer
    Public Declare Function DTWAIN_EnumAlarmVolumesEx Lib "dtwain64d.dll" (Source As System.IntPtr, expandIfRange As Integer) As System.IntPtr
    Public Declare Function DTWAIN_EnumAlarms Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumAlarmsEx Lib "dtwain64d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumAudioXferMechs Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumAudioXferMechsEx Lib "dtwain64d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumAutoFeedValues Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumAutoFeedValuesEx Lib "dtwain64d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumAutomaticCaptures Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr, bExpandIfRange As Integer) As Integer
    Public Declare Function DTWAIN_EnumAutomaticCapturesEx Lib "dtwain64d.dll" (Source As System.IntPtr, bExpandIfRange As Integer) As System.IntPtr
    Public Declare Function DTWAIN_EnumAutomaticSenseMedium Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumAutomaticSenseMediumEx Lib "dtwain64d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumBarcodeCodes Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef PCodes As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumBarcodeCodesEx Lib "dtwain64d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumBarcodeMaxPriorities Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumBarcodeMaxPrioritiesEx Lib "dtwain64d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumBarcodeMaxRetries Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumBarcodeMaxRetriesEx Lib "dtwain64d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumBarcodePriorities Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumBarcodePrioritiesEx Lib "dtwain64d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumBarcodeSearchModes Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumBarcodeSearchModesEx Lib "dtwain64d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumBarcodeTimeOutValues Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumBarcodeTimeOutValuesEx Lib "dtwain64d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumBitDepths Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumBitDepthsEx Lib "dtwain64d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumBitDepthsEx2 Lib "dtwain64d.dll" (Source As System.IntPtr, PixelType As Integer) As System.IntPtr
    Public Declare Function DTWAIN_EnumBottomCameras Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef Cameras As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumBottomCamerasEx Lib "dtwain64d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumBrightnessValues Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr, bExpandIfRange As Integer) As Integer
    Public Declare Function DTWAIN_EnumBrightnessValuesEx Lib "dtwain64d.dll" (Source As System.IntPtr, bExpandIfRange As Integer) As System.IntPtr
    ...
    Public Declare Function DTWAIN_EnumContrastValues Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr, bExpandIfRange As Integer) As Integer
    Public Declare Function DTWAIN_EnumContrastValuesEx Lib "dtwain64d.dll" (Source As System.IntPtr, bExpandIfRange As Integer) As System.IntPtr
    Public Declare Function DTWAIN_EnumCustomCaps Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumCustomCapsEx Lib "dtwain64d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumDoubleFeedDetectLengths Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr, bExpandIfRange As Integer) As Integer
    Public Declare Function DTWAIN_EnumDoubleFeedDetectLengthsEx Lib "dtwain64d.dll" (Source As System.IntPtr, bExpandIfRange As Integer) As System.IntPtr
    Public Declare Function DTWAIN_EnumDoubleFeedDetectValues Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumDoubleFeedDetectValuesEx Lib "dtwain64d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumExtImageInfoTypes Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumExtImageInfoTypesEx Lib "dtwain64d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumExtendedCaps Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumExtendedCapsEx Lib "dtwain64d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumExtendedCapsEx2 Lib "dtwain64d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumFileTypeBitsPerPixel Lib "dtwain64d.dll" (FileType As Integer, ByRef Array As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumFileXferFormats Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumFileXferFormatsEx Lib "dtwain64d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumHalftones Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumHalftonesEx Lib "dtwain64d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumHighlightValues Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr, bExpandIfRange As Integer) As Integer
    Public Declare Function DTWAIN_EnumHighlightValuesEx Lib "dtwain64d.dll" (Source As System.IntPtr, bExpandIfRange As Integer) As System.IntPtr
    Public Declare Function DTWAIN_EnumJobControls Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumJobControlsEx Lib "dtwain64d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumLightPaths Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef LightPath As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumLightPathsEx Lib "dtwain64d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumLightSources Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef LightSources As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumLightSourcesEx Lib "dtwain64d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumMaxBuffers Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef pMaxBufs As System.IntPtr, bExpandRange As Integer) As Integer
    Public Declare Function DTWAIN_EnumMaxBuffersEx Lib "dtwain64d.dll" (Source As System.IntPtr, bExpandRange As Integer) As System.IntPtr
    Public Declare Function DTWAIN_EnumNoiseFilters Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumNoiseFiltersEx Lib "dtwain64d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumOCRInterfaces Lib "dtwain64d.dll" (ByRef OCRInterfaces As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumOCRInterfacesEx Lib "dtwain64d.dll" () As System.IntPtr
    Public Declare Function DTWAIN_EnumOCRSupportedCaps Lib "dtwain64d.dll" (Engine As System.IntPtr, ByRef SupportedCaps As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumOrientations Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumOrientationsEx Lib "dtwain64d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumOverscanValues Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumOverscanValuesEx Lib "dtwain64d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumPaperSizes Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumPaperSizesEx Lib "dtwain64d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumPatchcodeCodes Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef PCodes As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumPatchcodeCodesEx Lib "dtwain64d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumPatchcodeMaxPriorities Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumPatchcodeMaxPrioritiesEx Lib "dtwain64d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumPatchcodeMaxRetries Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumPatchcodeMaxRetriesEx Lib "dtwain64d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumPatchcodePriorities Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumPatchcodePrioritiesEx Lib "dtwain64d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumPatchcodeSearchModes Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumPatchcodeSearchModesEx Lib "dtwain64d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumPatchcodeTimeOutValues Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumPatchcodeTimeOutValuesEx Lib "dtwain64d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumPixelTypes Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumPixelTypesEx Lib "dtwain64d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumPrinterStringModes Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumPrinterStringModesEx Lib "dtwain64d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumResolutionValues Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr, bExpandIfRange As Integer) As Integer
    Public Declare Function DTWAIN_EnumResolutionValuesEx Lib "dtwain64d.dll" (Source As System.IntPtr, bExpandIfRange As Integer) As System.IntPtr
    Public Declare Function DTWAIN_EnumShadowValues Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr, bExpandIfRange As Integer) As Integer
    Public Declare Function DTWAIN_EnumShadowValuesEx Lib "dtwain64d.dll" (Source As System.IntPtr, bExpandIfRange As Integer) As System.IntPtr
    Public Declare Function DTWAIN_EnumSourceUnits Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef lpArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumSourceUnitsEx Lib "dtwain64d.dll" (Source As System.IntPtr) As System.IntPtr
    ...
    Public Declare Function DTWAIN_EnumSupportedFileTypes Lib "dtwain64d.dll" () As System.IntPtr
    Public Declare Function DTWAIN_EnumSupportedMultiPageFileTypes Lib "dtwain64d.dll" () As System.IntPtr
    Public Declare Function DTWAIN_EnumSupportedSinglePageFileTypes Lib "dtwain64d.dll" () As System.IntPtr
    Public Declare Function DTWAIN_EnumThresholdValues Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr, bExpandIfRange As Integer) As Integer
    Public Declare Function DTWAIN_EnumThresholdValuesEx Lib "dtwain64d.dll" (Source As System.IntPtr, bExpandIfRange As Integer) As System.IntPtr
    Public Declare Function DTWAIN_EnumTopCameras Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef Cameras As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumTopCamerasEx Lib "dtwain64d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumTwainPrinters Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef lpAvailPrinters As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumTwainPrintersEx Lib "dtwain64d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumXResolutionValues Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr, bExpandIfRange As Integer) As Integer
    Public Declare Function DTWAIN_EnumXResolutionValuesEx Lib "dtwain64d.dll" (Source As System.IntPtr, bExpandIfRange As Integer) As System.IntPtr
    Public Declare Function DTWAIN_EnumYResolutionValues Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr, bExpandIfRange As Integer) As Integer
    Public Declare Function DTWAIN_EnumYResolutionValuesEx Lib "dtwain64d.dll" (Source As System.IntPtr, bExpandIfRange As Integer) As System.IntPtr
    ...
    Public Declare Function DTWAIN_FeedPage Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_FlipBitmap Lib "dtwain64d.dll" (hDib As System.IntPtr) As Integer
    Public Declare Function DTWAIN_FlushAcquiredPages Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_FrameCreate Lib "dtwain64d.dll" (Left As System.Double, Top As System.Double, Right As System.Double, Bottom As System.Double) As System.IntPtr
    ...
    Public Declare Function DTWAIN_FrameDestroy Lib "dtwain64d.dll" (Frame As System.IntPtr) As Integer
    Public Declare Function DTWAIN_FrameGetAll Lib "dtwain64d.dll" (Frame As System.IntPtr, ByRef Left As System.Double, ByRef Top As System.Double, ByRef Right As System.Double, ByRef Bottom As System.Double) As Integer
    Public Declare Ansi Function DTWAIN_FrameGetAllString Lib "dtwain64d.dll" (Frame As System.IntPtr, <MarshalAs(UnmanagedType.LPStr)> Left As StringBuilder, <MarshalAs(UnmanagedType.LPStr)> Top As StringBuilder, <MarshalAs(UnmanagedType.LPStr)> Right As StringBuilder, <MarshalAs(UnmanagedType.LPStr)> Bottom As StringBuilder) As Integer
    Public Declare Function DTWAIN_FrameGetValue Lib "dtwain64d.dll" (Frame As System.IntPtr, nWhich As Integer, ByRef Value As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_FrameIsValid Lib "dtwain64d.dll" (Frame As System.IntPtr) As Integer
    Public Declare Function DTWAIN_FrameSetAll Lib "dtwain64d.dll" (Frame As System.IntPtr, Left As System.Double, Top As System.Double, Right As System.Double, Bottom As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_FrameSetValue Lib "dtwain64d.dll" (Frame As System.IntPtr, nWhich As Integer, Value As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_FreeExtImageInfo Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_FreeMemory Lib "dtwain64d.dll" (h As System.IntPtr) As Integer
    Public Declare Function DTWAIN_FreeMemoryEx Lib "dtwain64d.dll" (h As System.IntPtr) As Integer
    Public Declare Function DTWAIN_GetAPIHandleStatus Lib "dtwain64d.dll" (pHandle As System.IntPtr) As Integer
    Public Declare Function DTWAIN_GetAcquireArea Lib "dtwain64d.dll" (Source As System.IntPtr, lGetType As Integer, ByRef FloatEnum As System.IntPtr) As Integer
    Public Declare Function DTWAIN_GetAcquireArea2 Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef left As System.Double, ByRef top As System.Double, ByRef right As System.Double, ByRef bottom As System.Double, ByRef lpUnit As Integer) As Integer
    ...
    Public Declare Function DTWAIN_GetAcquireAreaEx Lib "dtwain64d.dll" (Source As System.IntPtr, lGetType As Integer) As System.IntPtr
    Public Declare Function DTWAIN_GetAcquireMetrics Lib "dtwain64d.dll" (source As System.IntPtr, ByRef ImageCount As Integer, ByRef SheetCount As Integer) As Integer
    Public Declare Function DTWAIN_GetAcquireStripBuffer Lib "dtwain64d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_GetAcquireStripData Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef lpCompression As Integer, ByRef lpBytesPerRow As UInteger, ByRef lpColumns As UInteger, ByRef lpRows As UInteger, ByRef XOffset As UInteger, ByRef YOffset As UInteger, ByRef lpBytesWritten As UInteger) As Integer
    ...
    Public Declare Ansi Function DTWAIN_GetAllSessionInfo Lib "dtwain64d.dll" (<MarshalAs(UnmanagedType.LPTStr)> lpszOut As StringBuilder, indentFactor As Integer, nMaxLen As Integer) As Integer
    Public Declare Function DTWAIN_GetAllSourceDibs Lib "dtwain64d.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Ansi Function DTWAIN_GetAllSourceInfo Lib "dtwain64d.dll" (Source As System.IntPtr, <MarshalAs(UnmanagedType.LPStr)> lpszOut As StringBuilder, indentFactor As Integer, nSize As Integer) As Integer
    ...
    Public Declare Function DTWAIN_GetBarcodeMaxPriorities Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef pMaxPriorities As UInteger, bCurrent As Integer) As Integer
    Public Declare Function DTWAIN_GetBarcodeMaxRetries Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef pMaxRetries As UInteger, bCurrent As Integer) As Integer
    Public Declare Function DTWAIN_GetBarcodePriorities Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef SearchPriorities As System.IntPtr) As Integer
    Public Declare Function DTWAIN_GetBarcodeSearchMode Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef pSearchMode As Integer, bCurrent As Integer) As Integer
    Public Declare Function DTWAIN_GetBarcodeTimeOut Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef pTimeOut As UInteger, bCurrent As Integer) As Integer
    ...
    Public Declare Function DTWAIN_GetCallback64 Lib "dtwain64d.dll" () As DTwainCallback64
    Public Declare Function DTWAIN_GetCapArrayType Lib "dtwain64d.dll" (Source As System.IntPtr, nCap As Integer) As Integer
    Public Declare Function DTWAIN_GetCapContainer Lib "dtwain64d.dll" (Source As System.IntPtr, nCap As Integer, lCapType As Integer) As Integer
    Public Declare Function DTWAIN_GetCapContainerEx Lib "dtwain64d.dll" (nCap As Integer, bSetContainer As Integer, ByRef ConTypes As System.IntPtr) As Integer
    ...
    Public Declare Function DTWAIN_GetCapValuesEx Lib "dtwain64d.dll" (Source As System.IntPtr, lCap As Integer, lGetType As Integer, lContainerType As Integer, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_GetCapValuesEx2 Lib "dtwain64d.dll" (Source As System.IntPtr, lCap As Integer, lGetType As Integer, lContainerType As Integer, nDataType As Integer, ByRef pArray As System.IntPtr) As Integer
    ...
    Public Declare Function DTWAIN_GetCompressionSize Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef lBytes As UInteger) As Integer
    ...
    Public Declare Function DTWAIN_GetCurrentTwainTriplet Lib "dtwain64d.dll" (ByRef pAppID As TW_IDENTITY, ByRef pSourceID As TW_IDENTITY, ByRef lpDG As Integer, ByRef lpDAT As Integer, ByRef lpMsg As Integer, ByRef lpMemRef As System.Int64) As Integer
    ...
    Public Declare Function DTWAIN_GetDeviceEvent Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef lpEvent As UInteger) As Integer
    Public Declare Function DTWAIN_GetDeviceEventEx Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef lpEvent As UInteger, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_GetDeviceEventInfo Lib "dtwain64d.dll" (Source As System.IntPtr, nWhichInfo As Integer, pValue As System.IntPtr) As Integer
    Public Declare Function DTWAIN_GetDeviceNotifications Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef DevEvents As Integer) As Integer
    ...
    Public Declare Function DTWAIN_GetDoubleFeedDetectLength Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef Value As System.Double, bCurrent As Integer) As Integer
    Public Declare Function DTWAIN_GetDoubleFeedDetectValues Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_GetDuplexType Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef lpDupType As Integer) As Integer
    Public Declare Function DTWAIN_GetDuplexTypeEx Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_GetErrorBuffer Lib "dtwain64d.dll" (ByRef ArrayBuffer As System.IntPtr) As Integer
    Public Declare Function DTWAIN_GetErrorBufferThreshold Lib "dtwain64d.dll" () As UInteger
    Public Declare Function DTWAIN_GetErrorCallback Lib "dtwain64d.dll" () As DTwainErrorProc
    ...
    Public Declare Function DTWAIN_GetExtImageInfoItemEx Lib "dtwain64d.dll" (Source As System.IntPtr, nWhich As Integer, ByRef InfoID As Integer, ByRef NumItems As Integer, ByRef Type As Integer, ByRef ReturnCode As Integer) As Integer
    ...
    Public Declare Function DTWAIN_GetFeederAlignment Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef lpAlignment As Integer) As Integer
    Public Declare Function DTWAIN_GetFeederFuncs Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_GetFeederOrder Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef lpOrder As Integer) As Integer
    Public Declare Function DTWAIN_GetFeederWaitTime Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_GetFileCompressionType Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_GetFileSavePageCount Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    ...
    Public Declare Function DTWAIN_GetHighlight Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef Highlight As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_GetMaxBuffersEx Lib "dtwain64d.dll" (Source As System.IntPtr) As UInteger
    Public Declare Function DTWAIN_GetMaxPagesToAcquire Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_GetMaxRetryAttempts Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    ...
    Public Declare Function DTWAIN_GetNoiseFilter Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef lpNoiseFilter As Integer) As Integer
    Public Declare Function DTWAIN_GetNumAcquiredImages Lib "dtwain64d.dll" (aAcq As System.IntPtr, nWhich As Integer) As Integer
    Public Declare Function DTWAIN_GetNumAcquisitions Lib "dtwain64d.dll" (aAcq As System.IntPtr) As Integer
    Public Declare Function DTWAIN_GetOCRCapValues Lib "dtwain64d.dll" (Engine As System.IntPtr, OCRCapValue As Integer, TypeOfGet As Integer, ByRef CapValues As System.IntPtr) As Integer
    ...
    Public Declare Function DTWAIN_GetOCRLastError Lib "dtwain64d.dll" (Engine As System.IntPtr) As Integer
    Public Declare Function DTWAIN_GetOCRMajorMinorVersion Lib "dtwain64d.dll" (Engine As System.IntPtr, ByRef lpMajor As Integer, ByRef lpMinor As Integer) As Integer
    ...
    Public Declare Function DTWAIN_GetOCRTextInfoFloat Lib "dtwain64d.dll" (OCRTextInfo As System.IntPtr, nCharPos As Integer, nWhichItem As Integer, ByRef pInfo As System.Double) As Integer
    Public Declare Function DTWAIN_GetOCRTextInfoFloatEx Lib "dtwain64d.dll" (OCRTextInfo As System.IntPtr, nWhichItem As Integer, ByRef pInfo As System.Double, bufSize As Integer) As Integer
    Public Declare Function DTWAIN_GetOCRTextInfoHandle Lib "dtwain64d.dll" (Engine As System.IntPtr, nPageNo As Integer) As System.IntPtr
    Public Declare Function DTWAIN_GetOCRTextInfoLong Lib "dtwain64d.dll" (OCRTextInfo As System.IntPtr, nCharPos As Integer, nWhichItem As Integer, ByRef pInfo As Integer) As Integer
    ...
    Public Declare Function DTWAIN_GetPaperSize Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef lpPaperSize As Integer, bCurrent As Integer) As Integer
    ...
    Public Declare Function DTWAIN_GetPatchcodeMaxPriorities Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef pMaxPriorities As UInteger, bCurrent As Integer) As Integer
    Public Declare Function DTWAIN_GetPatchcodeMaxRetries Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef pMaxRetries As UInteger, bCurrent As Integer) As Integer
    ...
    Public Declare Function DTWAIN_GetPrinterStartNumber Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef nStart As UInteger) As Integer
    Public Declare Function DTWAIN_GetPrinterStartNumberEx Lib "dtwain64d.dll" (Source As System.IntPtr) As UInteger
    ...
    Public Declare Function DTWAIN_GetSourceAcquisitions Lib "dtwain64d.dll" (Source As System.IntPtr) As System.IntPtr
    ...
    Public Declare Function DTWAIN_GetSourceID Lib "dtwain64d.dll" (Source As System.IntPtr) As System.IntPtr
    ...
    Public Declare Function DTWAIN_GetTwainAppID Lib "dtwain64d.dll" () As System.IntPtr
    Public Declare Function DTWAIN_GetTwainAvailability Lib "dtwain64d.dll" () As Integer
    ...
    Public Declare Function DTWAIN_GetTwainHwnd Lib "dtwain64d.dll" () As System.IntPtr
    ...
    Public Declare Function DTWAIN_GetVersionEx2 Lib "dtwain64d.dll" (ByRef lMajor As Integer, ByRef lMinor As Integer, ByRef lVersionType As Integer, ByRef lPatchLevel As Integer, ByRef lBuildNumber As Integer) As Integer
    ...
    Public Declare Function DTWAIN_GetXResolution Lib "dtwain64d.dll" (Source As System.IntPtr, ByRef Resolution As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_IsAutoBorderDetectEnabled Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsAutoBorderDetectSupported Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsAutoBrightEnabled Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsAutoBrightSupported Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsAutoDeskewEnabled Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsAutoDeskewSupported Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsAutoFeedEnabled Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsAutoFeedSupported Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsAutoRotateEnabled Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsAutoRotateSupported Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsAutoScanEnabled Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsAutomaticSenseMediumEnabled Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsAutomaticSenseMediumSupported Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsBarcodeCapsSupported Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsBarcodeDetectionEnabled Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsBarcodeSupported Lib "dtwain64d.dll" (Source As System.IntPtr, BarCode As Integer) As Integer
    Public Declare Function DTWAIN_IsBlankPageDetectionOn Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsBufferedTileModeOn Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsBufferedTileModeSupported Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsCapSupported Lib "dtwain64d.dll" (Source As System.IntPtr, lCapability As Integer) As Integer
    Public Declare Function DTWAIN_IsCompressionSupported Lib "dtwain64d.dll" (Source As System.IntPtr, Compression As Integer) As Integer
    Public Declare Function DTWAIN_IsCustomDSDataSupported Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsDIBBlank Lib "dtwain64d.dll" (hDib As System.IntPtr, threshold As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_IsDeviceEventSupported Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsDeviceOnLine Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsDoubleFeedDetectLengthSupported Lib "dtwain64d.dll" (Source As System.IntPtr, value As System.Double) As Integer
    Public Declare Function DTWAIN_IsDoubleFeedDetectSupported Lib "dtwain64d.dll" (Source As System.IntPtr, SupportVal As Integer) As Integer
    Public Declare Function DTWAIN_IsDoublePageCountOnDuplex Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsDuplexEnabled Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsDuplexSupported Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsExtImageInfoSupported Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsFeederEnabled Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsFeederLoaded Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsFeederSensitive Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    ...
    Public Declare Function DTWAIN_IsGetMessageLoopEnabled Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    ...
    Public Declare Function DTWAIN_IsIAFieldAValueSupported Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsIAFieldBLastPageSupported Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsIAFieldBLevelSupported Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsIAFieldBPrintFormatSupported Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsIAFieldBValueSupported Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsIAFieldCLastPageSupported Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsIAFieldCLevelSupported Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsIAFieldCPrintFormatSupported Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsIAFieldCValueSupported Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsIAFieldDLastPageSupported Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsIAFieldDLevelSupported Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsIAFieldDPrintFormatSupported Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsIAFieldDValueSupported Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsIAFieldELastPageSupported Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsIAFieldELevelSupported Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsIAFieldEPrintFormatSupported Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsIAFieldEValueSupported Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsImageAddressingSupported Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsIndicatorEnabled Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsIndicatorSupported Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsInitialized Lib "dtwain64d.dll" () As Integer
    Public Declare Function DTWAIN_IsJobControlSupported Lib "dtwain64d.dll" (Source As System.IntPtr, JobControl As Integer) As Integer
    Public Declare Function DTWAIN_IsLampEnabled Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsLampSupported Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsLightPathSupported Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsLightSourceSupported Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsMaxBuffersSupported Lib "dtwain64d.dll" (Source As System.IntPtr, MaxBuf As Integer) As Integer
    Public Declare Function DTWAIN_IsMemFileXferSupported Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsMsgNotifyEnabled Lib "dtwain64d.dll" () As Integer
    Public Declare Function DTWAIN_IsNotifyTripletsEnabled Lib "dtwain64d.dll" () As Integer
    Public Declare Function DTWAIN_IsOCREngineActivated Lib "dtwain64d.dll" (OCREngine As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsOpenSourcesOnSelect Lib "dtwain64d.dll" () As Integer
    Public Declare Function DTWAIN_IsOrientationSupported Lib "dtwain64d.dll" (Source As System.IntPtr, Orientation As Integer) As Integer
    Public Declare Function DTWAIN_IsOverscanSupported Lib "dtwain64d.dll" (Source As System.IntPtr, SupportValue As Integer) As Integer
    Public Declare Function DTWAIN_IsPaperDetectable Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsPaperSizeSupported Lib "dtwain64d.dll" (Source As System.IntPtr, PaperSize As Integer) As Integer
    Public Declare Function DTWAIN_IsPatchcodeCapsSupported Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsPatchcodeDetectionEnabled Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsPatchcodeSupported Lib "dtwain64d.dll" (Source As System.IntPtr, PatchCode As Integer) As Integer
    Public Declare Function DTWAIN_IsPeekMessageLoopEnabled Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsPixelTypeSupported Lib "dtwain64d.dll" (Source As System.IntPtr, PixelType As Integer) As Integer
    Public Declare Function DTWAIN_IsPrinterEnabled Lib "dtwain64d.dll" (Source As System.IntPtr, Printer As Integer) As Integer
    Public Declare Function DTWAIN_IsPrinterSupported Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsRotationSupported Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsSessionEnabled Lib "dtwain64d.dll" () As Integer
    Public Declare Function DTWAIN_IsSkipImageInfoError Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsSourceAcquiring Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsSourceAcquiringEx Lib "dtwain64d.dll" (Source As System.IntPtr, bUIOnly As Integer) As Integer
    Public Declare Function DTWAIN_IsSourceInUIOnlyMode Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsSourceOpen Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsSourceSelected Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsSourceValid Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsThumbnailEnabled Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsThumbnailSupported Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsTwainAvailable Lib "dtwain64d.dll" () As Integer
    ...
    Public Declare Function DTWAIN_IsTwainMsg Lib "dtwain64d.dll" (ByRef pMsg As WinMsg) As Integer
    Public Declare Function DTWAIN_IsUIControllable Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsUIEnabled Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsUIOnlySupported Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    ...
    Public Declare Function DTWAIN_LoadLanguageResource Lib "dtwain64d.dll" (nLanguage As Integer) As Integer
    Public Declare Function DTWAIN_LockMemory Lib "dtwain64d.dll" (h As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_LockMemoryEx Lib "dtwain64d.dll" (h As System.IntPtr) As System.IntPtr
    Public Declare Ansi Function DTWAIN_LogMessage Lib "dtwain64d.dll" (message As String) As Integer
    Public Declare Function DTWAIN_MakeRGB Lib "dtwain64d.dll" (red As Integer, green As Integer, blue As Integer) As Integer
    Public Declare Function DTWAIN_OpenSource Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_OpenSourcesOnSelect Lib "dtwain64d.dll" (bSet As Integer) As Integer
    Public Declare Function DTWAIN_RangeCreate Lib "dtwain64d.dll" (nEnumType As Integer) As System.IntPtr
    Public Declare Function DTWAIN_RangeCreateFromCap Lib "dtwain64d.dll" (Source As System.IntPtr, lCapType As Integer) As System.IntPtr
    Public Declare Function DTWAIN_RangeDestroy Lib "dtwain64d.dll" (pSource As System.IntPtr) As Integer
    Public Declare Function DTWAIN_RangeExpand Lib "dtwain64d.dll" (pSource As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_RangeExpandEx Lib "dtwain64d.dll" (Range As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_RangeGetAll Lib "dtwain64d.dll" (pArray As System.IntPtr, pVariantLow As System.IntPtr, pVariantUp As System.IntPtr, pVariantStep As System.IntPtr, pVariantDefault As System.IntPtr, pVariantCurrent As System.IntPtr) As Integer
    Public Declare Function DTWAIN_RangeGetAllFloat Lib "dtwain64d.dll" (pArray As System.IntPtr, ByRef pVariantLow As System.Double, ByRef pVariantUp As System.Double, ByRef pVariantStep As System.Double, ByRef pVariantDefault As System.Double, ByRef pVariantCurrent As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_RangeGetAllLong Lib "dtwain64d.dll" (pArray As System.IntPtr, ByRef pVariantLow As Integer, ByRef pVariantUp As Integer, ByRef pVariantStep As Integer, ByRef pVariantDefault As Integer, ByRef pVariantCurrent As Integer) As Integer
    Public Declare Function DTWAIN_RangeGetCount Lib "dtwain64d.dll" (pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_RangeGetExpValue Lib "dtwain64d.dll" (pArray As System.IntPtr, lPos As Integer, pVariant As System.IntPtr) As Integer
    Public Declare Function DTWAIN_RangeGetExpValueFloat Lib "dtwain64d.dll" (pArray As System.IntPtr, lPos As Integer, ByRef pVal As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_RangeGetExpValueLong Lib "dtwain64d.dll" (pArray As System.IntPtr, lPos As Integer, ByRef pVal As Integer) As Integer
    Public Declare Function DTWAIN_RangeGetNearestValue Lib "dtwain64d.dll" (pArray As System.IntPtr, pVariantIn As System.IntPtr, pVariantOut As System.IntPtr, RoundType As Integer) As Integer
    Public Declare Function DTWAIN_RangeGetNearestValueFloat Lib "dtwain64d.dll" (pArray As System.IntPtr, dIn As System.Double, ByRef pOut As System.Double, RoundType As Integer) As Integer
    ...
    Public Declare Function DTWAIN_RangeGetNearestValueLong Lib "dtwain64d.dll" (pArray As System.IntPtr, lIn As Integer, ByRef pOut As Integer, RoundType As Integer) As Integer
    Public Declare Function DTWAIN_RangeGetPos Lib "dtwain64d.dll" (pArray As System.IntPtr, pVariant As System.IntPtr, ByRef pPos As Integer) As Integer
    Public Declare Function DTWAIN_RangeGetPosFloat Lib "dtwain64d.dll" (pArray As System.IntPtr, Val As System.Double, ByRef pPos As Integer) As Integer
    ...
    Public Declare Function DTWAIN_RangeGetPosLong Lib "dtwain64d.dll" (pArray As System.IntPtr, Value As Integer, ByRef pPos As Integer) As Integer
    Public Declare Function DTWAIN_RangeGetValue Lib "dtwain64d.dll" (pArray As System.IntPtr, nWhich As Integer, pVariant As System.IntPtr) As Integer
    Public Declare Function DTWAIN_RangeGetValueFloat Lib "dtwain64d.dll" (pArray As System.IntPtr, nWhich As Integer, ByRef pVal As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_RangeGetValueLong Lib "dtwain64d.dll" (pArray As System.IntPtr, nWhich As Integer, ByRef pVal As Integer) As Integer
    Public Declare Function DTWAIN_RangeIsValid Lib "dtwain64d.dll" (Range As System.IntPtr, ByRef pStatus As Integer) As Integer
    Public Declare Function DTWAIN_RangeSetAll Lib "dtwain64d.dll" (pArray As System.IntPtr, pVariantLow As System.IntPtr, pVariantUp As System.IntPtr, pVariantStep As System.IntPtr, pVariantDefault As System.IntPtr, pVariantCurrent As System.IntPtr) As Integer
    Public Declare Function DTWAIN_RangeSetAllFloat Lib "dtwain64d.dll" (pArray As System.IntPtr, dLow As System.Double, dUp As System.Double, dStep As System.Double, dDefault As System.Double, dCurrent As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_RangeSetAllLong Lib "dtwain64d.dll" (pArray As System.IntPtr, lLow As Integer, lUp As Integer, lStep As Integer, lDefault As Integer, lCurrent As Integer) As Integer
    Public Declare Function DTWAIN_RangeSetValue Lib "dtwain64d.dll" (pArray As System.IntPtr, nWhich As Integer, pVal As System.IntPtr) As Integer
    Public Declare Function DTWAIN_RangeSetValueFloat Lib "dtwain64d.dll" (pArray As System.IntPtr, nWhich As Integer, Val As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_RangeSetValueLong Lib "dtwain64d.dll" (pArray As System.IntPtr, nWhich As Integer, Val As Integer) As Integer
    ...
    Public Declare Function DTWAIN_RotateImage Lib "dtwain64d.dll" (hDib As System.IntPtr, rotationAngle As System.Double) As System.IntPtr
    Public Declare Ansi Function DTWAIN_RotateImageString Lib "dtwain64d.dll" (hDib As System.IntPtr, rotationAngle As String) As System.IntPtr
    ...
    Public Declare Function DTWAIN_SelectOCREngine Lib "dtwain64d.dll" () As System.IntPtr
    ...
    Public Declare Function DTWAIN_SelectSource Lib "dtwain64d.dll" () As System.IntPtr
    ...
    Public Declare Function DTWAIN_SelectSourceWithOpen Lib "dtwain64d.dll" (bOpen As Integer) As System.IntPtr
    Public Declare Function DTWAIN_SetAcquireArea Lib "dtwain64d.dll" (Source As System.IntPtr, lSetType As Integer, FloatEnum As System.IntPtr, ActualEnum As System.IntPtr) As Integer
    Public Declare Function DTWAIN_SetAcquireArea2 Lib "dtwain64d.dll" (Source As System.IntPtr, left As System.Double, top As System.Double, right As System.Double, bottom As System.Double, lUnit As Integer, Flags As Integer) As Integer
    ...
    Public Declare Function DTWAIN_SetAcquireImageNegative Lib "dtwain64d.dll" (Source As System.IntPtr, IsNegative As Integer) As Integer
    Public Declare Function DTWAIN_SetAcquireImageScale Lib "dtwain64d.dll" (Source As System.IntPtr, xscale As System.Double, yscale As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_SetAcquireStripBuffer Lib "dtwain64d.dll" (Source As System.IntPtr, hMem As System.IntPtr) As Integer
    Public Declare Function DTWAIN_SetAcquireStripSize Lib "dtwain64d.dll" (Source As System.IntPtr, StripSize As UInteger) As Integer
    Public Declare Function DTWAIN_SetAlarmVolume Lib "dtwain64d.dll" (Source As System.IntPtr, Volume As Integer) As Integer
    Public Declare Function DTWAIN_SetAlarms Lib "dtwain64d.dll" (Source As System.IntPtr, Alarms As System.IntPtr) As Integer
    Public Declare Function DTWAIN_SetAllCapsToDefault Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    ...
    Public Declare Function DTWAIN_SetAvailablePrinters Lib "dtwain64d.dll" (Source As System.IntPtr, lpAvailPrinters As Integer) As Integer
    Public Declare Function DTWAIN_SetAvailablePrintersArray Lib "dtwain64d.dll" (Source As System.IntPtr, AvailPrinters As System.IntPtr) As Integer
    Public Declare Function DTWAIN_SetBarcodeMaxPriorities Lib "dtwain64d.dll" (Source As System.IntPtr, nMaxPriorities As UInteger) As Integer
    Public Declare Function DTWAIN_SetBarcodeMaxRetries Lib "dtwain64d.dll" (Source As System.IntPtr, nMaxRetries As UInteger) As Integer
    Public Declare Function DTWAIN_SetBarcodePriorities Lib "dtwain64d.dll" (Source As System.IntPtr, SearchPriorities As System.IntPtr) As Integer
    Public Declare Function DTWAIN_SetBarcodeSearchMode Lib "dtwain64d.dll" (Source As System.IntPtr, nSearchMode As Integer) As Integer
    Public Declare Function DTWAIN_SetBarcodeTimeOut Lib "dtwain64d.dll" (Source As System.IntPtr, TimeOutValue As UInteger) As Integer
    Public Declare Function DTWAIN_SetBitDepth Lib "dtwain64d.dll" (Source As System.IntPtr, BitDepth As Integer, bSetCurrent As Integer) As Integer
    Public Declare Function DTWAIN_SetBlankPageDetection Lib "dtwain64d.dll" (Source As System.IntPtr, threshold As System.Double, discard_option As Integer, bSet As Integer) As Integer
    Public Declare Function DTWAIN_SetBlankPageDetectionEx Lib "dtwain64d.dll" (Source As System.IntPtr, threshold As System.Double, autodetect As Integer, detectOpts As Integer, bSet As Integer) As Integer
    ...
    Public Declare Function DTWAIN_SetBrightness Lib "dtwain64d.dll" (Source As System.IntPtr, Brightness As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_SetBufferedTileMode Lib "dtwain64d.dll" (Source As System.IntPtr, bTileMode As Integer) As Integer
    Public Declare Function DTWAIN_SetCallback Lib "dtwain64d.dll" (Fn As DTwainCallback, UserData As Integer) As DTwainCallback
    Public Declare Function DTWAIN_SetCallback64 Lib "dtwain64d.dll" (Fn As DTwainCallback64, UserData As System.Int64) As DTwainCallback64
    Public Declare Ansi Function DTWAIN_SetCamera Lib "dtwain64d.dll" (Source As System.IntPtr, szCamera As String) As Integer
    Public Declare Function DTWAIN_SetCapValues Lib "dtwain64d.dll" (Source As System.IntPtr, lCap As Integer, lSetType As Integer, pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_SetCapValuesEx Lib "dtwain64d.dll" (Source As System.IntPtr, lCap As Integer, lSetType As Integer, lContainerType As Integer, pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_SetCapValuesEx2 Lib "dtwain64d.dll" (Source As System.IntPtr, lCap As Integer, lSetType As Integer, lContainerType As Integer, nDataType As Integer, pArray As System.IntPtr) As Integer
    Public Declare Ansi Function DTWAIN_SetCaption Lib "dtwain64d.dll" (Source As System.IntPtr, Caption As String) As Integer
    Public Declare Function DTWAIN_SetCompressionType Lib "dtwain64d.dll" (Source As System.IntPtr, lCompression As Integer, bSetCurrent As Integer) As Integer
    Public Declare Function DTWAIN_SetContrast Lib "dtwain64d.dll" (Source As System.IntPtr, Contrast As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_SetCountry Lib "dtwain64d.dll" (nCountry As Integer) As Integer
    Public Declare Function DTWAIN_SetCurrentRetryCount Lib "dtwain64d.dll" (Source As System.IntPtr, nCount As Integer) As Integer
    Public Declare Function DTWAIN_SetCustomDSData Lib "dtwain64d.dll" (Source As System.IntPtr, hData As System.IntPtr, <MarshalAs(UnmanagedType.LPArray, ArraySubType:=UnmanagedType.U8, SizeParamIndex:=3)> Data As Byte(), dSize As UInteger, nFlags As Integer) As Integer
    Public Declare Function DTWAIN_SetDSMSearchOrder Lib "dtwain64d.dll" (SearchPath As Integer) As Integer
    ...
    Public Declare Function DTWAIN_SetDefaultSource Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_SetDeviceNotifications Lib "dtwain64d.dll" (Source As System.IntPtr, DevEvents As Integer) As Integer
    ...
    Public Declare Function DTWAIN_SetDoubleFeedDetectLength Lib "dtwain64d.dll" (Source As System.IntPtr, Value As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_SetDoubleFeedDetectValues Lib "dtwain64d.dll" (Source As System.IntPtr, prray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_SetDoublePageCountOnDuplex Lib "dtwain64d.dll" (Source As System.IntPtr, bDoubleCount As Integer) As Integer
    Public Declare Function DTWAIN_SetEOJDetectValue Lib "dtwain64d.dll" (Source As System.IntPtr, nValue As Integer) As Integer
    Public Declare Function DTWAIN_SetErrorBufferThreshold Lib "dtwain64d.dll" (nErrors As UInteger) As Integer
    Public Declare Function DTWAIN_SetErrorCallback Lib "dtwain64d.dll" (proc As DTwainErrorProc, UserData As Integer) As Integer
    Public Declare Function DTWAIN_SetErrorCallback64 Lib "dtwain64d.dll" (proc As DTwainErrorProc64, UserData64 As System.Int64) As Integer
    Public Declare Function DTWAIN_SetFeederAlignment Lib "dtwain64d.dll" (Source As System.IntPtr, lpAlignment As Integer) As Integer
    Public Declare Function DTWAIN_SetFeederOrder Lib "dtwain64d.dll" (Source As System.IntPtr, lOrder As Integer) As Integer
    Public Declare Function DTWAIN_SetFeederWaitTime Lib "dtwain64d.dll" (Source As System.IntPtr, waitTime As Integer, flags As Integer) As Integer
    Public Declare Function DTWAIN_SetFileAutoIncrement Lib "dtwain64d.dll" (Source As System.IntPtr, Increment As Integer, bResetOnAcquire As Integer, bSet As Integer) As Integer
    Public Declare Function DTWAIN_SetFileCompressionType Lib "dtwain64d.dll" (Source As System.IntPtr, lCompression As Integer, bIsCustom As Integer) As Integer
    ...
    Public Declare Function DTWAIN_SetFileXferFormat Lib "dtwain64d.dll" (Source As System.IntPtr, lFileType As Integer, bSetCurrent As Integer) As Integer
    ...
    Public Declare Function DTWAIN_SetHighlight Lib "dtwain64d.dll" (Source As System.IntPtr, Highlight As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_SetJobControl Lib "dtwain64d.dll" (Source As System.IntPtr, JobControl As Integer, bSetCurrent As Integer) As Integer
    Public Declare Function DTWAIN_SetJpegValues Lib "dtwain64d.dll" (Source As System.IntPtr, Quality As Integer, Progressive As Integer) As Integer
    Public Declare Function DTWAIN_SetJpegXRValues Lib "dtwain64d.dll" (Source As System.IntPtr, Quality As Integer, Progressive As Integer) As Integer
    Public Declare Function DTWAIN_SetLanguage Lib "dtwain64d.dll" (nLanguage As Integer) As Integer
    Public Declare Function DTWAIN_SetLastError Lib "dtwain64d.dll" (nError As Integer) As Integer
    Public Declare Function DTWAIN_SetLightPath Lib "dtwain64d.dll" (Source As System.IntPtr, LightPath As Integer) As Integer
    ...
    Public Declare Function DTWAIN_SetMaxRetryAttempts Lib "dtwain64d.dll" (Source As System.IntPtr, nAttempts As Integer) As Integer
    Public Declare Function DTWAIN_SetMultipageScanMode Lib "dtwain64d.dll" (Source As System.IntPtr, ScanType As Integer) As Integer
    Public Declare Function DTWAIN_SetNoiseFilter Lib "dtwain64d.dll" (Source As System.IntPtr, NoiseFilter As Integer) As Integer
    Public Declare Function DTWAIN_SetOCRCapValues Lib "dtwain64d.dll" (Engine As System.IntPtr, OCRCapValue As Integer, SetType As Integer, CapValues As System.IntPtr) As Integer
    Public Declare Function DTWAIN_SetOrientation Lib "dtwain64d.dll" (Source As System.IntPtr, Orient As Integer, bSetCurrent As Integer) As Integer
    Public Declare Function DTWAIN_SetOverscan Lib "dtwain64d.dll" (Source As System.IntPtr, Value As Integer, bSetCurrent As Integer) As Integer
    Public Declare Function DTWAIN_SetPDFAESEncryption Lib "dtwain64d.dll" (Source As System.IntPtr, nWhichEncryption As Integer, bUseAES As Integer) As Integer
    Public Declare Function DTWAIN_SetPDFASCIICompression Lib "dtwain64d.dll" (Source As System.IntPtr, bSet As Integer) As Integer
    Public Declare Ansi Function DTWAIN_SetPDFAuthor Lib "dtwain64d.dll" (Source As System.IntPtr, lpAuthor As String) As Integer
    Public Declare Function DTWAIN_SetPDFCompression Lib "dtwain64d.dll" (Source As System.IntPtr, bCompression As Integer) As Integer
    ...
    Public Declare Function DTWAIN_SetPDFJpegQuality Lib "dtwain64d.dll" (Source As System.IntPtr, Quality As Integer) As Integer
    ...
    Public Declare Function DTWAIN_SetPDFOCRConversion Lib "dtwain64d.dll" (Engine As System.IntPtr, PageType As Integer, FileType As Integer, PixelType As Integer, BitDepth As Integer, Options As Integer) As Integer
    Public Declare Function DTWAIN_SetPDFOCRMode Lib "dtwain64d.dll" (Source As System.IntPtr, bSet As Integer) As Integer
    Public Declare Function DTWAIN_SetPDFOrientation Lib "dtwain64d.dll" (Source As System.IntPtr, lPOrientation As Integer) As Integer
    Public Declare Function DTWAIN_SetPDFPageScale Lib "dtwain64d.dll" (Source As System.IntPtr, nOptions As Integer, xScale As System.Double, yScale As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_SetPDFPageSize Lib "dtwain64d.dll" (Source As System.IntPtr, PageSize As Integer, CustomWidth As System.Double, CustomHeight As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_SetPDFPolarity Lib "dtwain64d.dll" (Source As System.IntPtr, Polarity As Integer) As Integer
    ...
    Public Declare Function DTWAIN_SetPDFTextElementFloat Lib "dtwain64d.dll" (TextElement As System.IntPtr, val1 As System.Double, val2 As System.Double, Flags As Integer) As Integer
    ...
    Public Declare Function DTWAIN_SetPDFTextElementLong Lib "dtwain64d.dll" (TextElement As System.IntPtr, val1 As Integer, val2 As Integer, Flags As Integer) As Integer
    ...
    Public Declare Function DTWAIN_SetPaperSize Lib "dtwain64d.dll" (Source As System.IntPtr, PaperSize As Integer, bSetCurrent As Integer) As Integer
    Public Declare Function DTWAIN_SetPatchcodeMaxPriorities Lib "dtwain64d.dll" (Source As System.IntPtr, nMaxSearchRetries As UInteger) As Integer
    Public Declare Function DTWAIN_SetPatchcodeMaxRetries Lib "dtwain64d.dll" (Source As System.IntPtr, nMaxRetries As UInteger) As Integer
    Public Declare Function DTWAIN_SetPatchcodePriorities Lib "dtwain64d.dll" (Source As System.IntPtr, SearchPriorities As System.IntPtr) As Integer
    Public Declare Function DTWAIN_SetPatchcodeSearchMode Lib "dtwain64d.dll" (Source As System.IntPtr, nSearchMode As Integer) As Integer
    Public Declare Function DTWAIN_SetPatchcodeTimeOut Lib "dtwain64d.dll" (Source As System.IntPtr, TimeOutValue As UInteger) As Integer
    Public Declare Function DTWAIN_SetPixelFlavor Lib "dtwain64d.dll" (Source As System.IntPtr, PixelFlavor As Integer) As Integer
    Public Declare Function DTWAIN_SetPixelType Lib "dtwain64d.dll" (Source As System.IntPtr, PixelType As Integer, BitDepth As Integer, bSetCurrent As Integer) As Integer
    ...
    Public Declare Function DTWAIN_SetPostScriptType Lib "dtwain64d.dll" (Source As System.IntPtr, PSType As Integer) As Integer
    Public Declare Function DTWAIN_SetPrinter Lib "dtwain64d.dll" (Source As System.IntPtr, Printer As Integer, bCurrent As Integer) As Integer
    Public Declare Function DTWAIN_SetPrinterEx Lib "dtwain64d.dll" (Source As System.IntPtr, Printer As Integer, bCurrent As Integer) As Integer
    Public Declare Function DTWAIN_SetPrinterStartNumber Lib "dtwain64d.dll" (Source As System.IntPtr, nStart As UInteger) As Integer
    ...
    Public Declare Function DTWAIN_SetTIFFCompressType Lib "dtwain64d.dll" (Source As System.IntPtr, Setting As Integer) As Integer
    Public Declare Function DTWAIN_SetTIFFInvert Lib "dtwain64d.dll" (Source As System.IntPtr, Setting As Integer) As Integer
    ...
    Public Declare Function DTWAIN_SetThreshold Lib "dtwain64d.dll" (Source As System.IntPtr, Threshold As System.Double, bSetBithDepthReduction As Integer) As Integer
    ...
    Public Declare Function DTWAIN_SetYResolution Lib "dtwain64d.dll" (Source As System.IntPtr, yResolution As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_ShowUIOnly Lib "dtwain64d.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_ShutdownOCREngine Lib "dtwain64d.dll" (OCREngine As System.IntPtr) As Integer
    Public Declare Function DTWAIN_SkipImageInfoError Lib "dtwain64d.dll" (Source As System.IntPtr, bSkip As Integer) As Integer
    Public Declare Function DTWAIN_StartThread Lib "dtwain64d.dll" (DLLHandle As System.IntPtr) As Integer
    ...
    Public Declare Function DTWAIN_SysInitializeLib Lib "dtwain64d.dll" (hInstance As System.IntPtr) As System.IntPtr
    ...
    Public Declare Function DTWAIN_UnlockMemory Lib "dtwain64d.dll" (h As System.IntPtr) As Integer
    Public Declare Function DTWAIN_UnlockMemoryEx Lib "dtwain64d.dll" (h As System.IntPtr) As Integer
    Public Declare Function DTWAIN_UpdateCurrentAcquiredImage Lib "dtwain64d.dll" (Source As System.IntPtr, hNewDib As System.IntPtr) As Integer
    Public Declare Function DTWAIN_UseMultipleThreads Lib "dtwain64d.dll" (bSet As Integer) As Integer
