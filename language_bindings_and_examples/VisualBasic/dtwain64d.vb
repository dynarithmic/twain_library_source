...
Class DTWAINAPI
    ...
    Public Declare Function DTWAIN_GetErrorBufferThreshold Lib "dtwain64d.dll" () As Integer
    ...
    Public Declare Function DTWAIN_SetErrorBufferThreshold Lib "dtwain64d.dll" (nErrors As Integer) As Integer
