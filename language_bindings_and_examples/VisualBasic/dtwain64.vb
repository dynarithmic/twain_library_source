...
Class DTWAINAPI
    ...
    Public Declare Function DTWAIN_AcquireAudioNative Lib "dtwain64.dll" (Source As System.IntPtr, nMaxAudioClips As Integer, bShowUI As Integer, bCloseSource As Integer, ByRef pStatus As Integer) As System.IntPtr
    Public Declare Function DTWAIN_AcquireAudioNativeEx Lib "dtwain64.dll" (Source As System.IntPtr, nMaxAudioClips As Integer, bShowUI As Integer, bCloseSource As Integer, Acquisitions As System.IntPtr, ByRef pStatus As Integer) As Integer
    Public Declare Function DTWAIN_AcquireBuffered Lib "dtwain64.dll" (Source As System.IntPtr, PixelType As Integer, nMaxPages As Integer, bShowUI As Integer, bCloseSource As Integer, ByRef pStatus As Integer) As System.IntPtr
    Public Declare Function DTWAIN_AcquireBufferedEx Lib "dtwain64.dll" (Source As System.IntPtr, PixelType As Integer, nMaxPages As Integer, bShowUI As Integer, bCloseSource As Integer, Acquisitions As System.IntPtr, ByRef pStatus As Integer) As Integer
    ...
    Public Declare Function DTWAIN_AcquireFileEx Lib "dtwain64.dll" (Source As System.IntPtr, aFileNames As System.IntPtr, lFileType As Integer, lFileFlags As Integer, PixelType As Integer, lMaxPages As Integer, bShowUI As Integer, bCloseSource As Integer, ByRef pStatus As Integer) As Integer
    Public Declare Function DTWAIN_AcquireNative Lib "dtwain64.dll" (Source As System.IntPtr, PixelType As Integer, nMaxPages As Integer, bShowUI As Integer, bCloseSource As Integer, ByRef pStatus As Integer) As System.IntPtr
    Public Declare Function DTWAIN_AcquireNativeEx Lib "dtwain64.dll" (Source As System.IntPtr, PixelType As Integer, nMaxPages As Integer, bShowUI As Integer, bCloseSource As Integer, Acquisitions As System.IntPtr, ByRef pStatus As Integer) As Integer
    Public Declare Function DTWAIN_AcquireToClipboard Lib "dtwain64.dll" (Source As System.IntPtr, PixelType As Integer, nMaxPages As Integer, nTransferMode As Integer, bDiscardDibs As Integer, bShowUI As Integer, bCloseSource As Integer, ByRef pStatus As Integer) As System.IntPtr
    ...
    Public Declare Function DTWAIN_AddPDFTextElement Lib "dtwain64.dll" (Source As System.IntPtr, TextElement As System.IntPtr) As Integer
    ...
    Public Declare Function DTWAIN_AllocateMemory Lib "dtwain64.dll" (memSize As UInteger) As System.IntPtr
    Public Declare Function DTWAIN_AllocateMemory64 Lib "dtwain64.dll" (memSize As System.UInt64) As System.IntPtr
    Public Declare Function DTWAIN_AllocateMemoryEx Lib "dtwain64.dll" (memSize As UInteger) As System.IntPtr
    Public Declare Function DTWAIN_AppHandlesExceptions Lib "dtwain64.dll" (bSet As Integer) As Integer
    Public Declare Function DTWAIN_ArrayANSIStringToFloat Lib "dtwain64.dll" (StringArray As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_ArrayAdd Lib "dtwain64.dll" (pArray As System.IntPtr, pVariant As System.IntPtr) As Integer
    ...
    Public Declare Function DTWAIN_ArrayAddFloat Lib "dtwain64.dll" (pArray As System.IntPtr, Val As System.Double) As Integer
    Public Declare Function DTWAIN_ArrayAddFloatN Lib "dtwain64.dll" (pArray As System.IntPtr, Val As System.Double, num As Integer) As Integer
    ...
    Public Declare Function DTWAIN_ArrayAddFrame Lib "dtwain64.dll" (pArray As System.IntPtr, frame As System.IntPtr) As Integer
    Public Declare Function DTWAIN_ArrayAddFrameN Lib "dtwain64.dll" (pArray As System.IntPtr, frame As System.IntPtr, num As Integer) As Integer
    Public Declare Function DTWAIN_ArrayAddLong Lib "dtwain64.dll" (pArray As System.IntPtr, Val As Integer) As Integer
    Public Declare Function DTWAIN_ArrayAddLong64 Lib "dtwain64.dll" (pArray As System.IntPtr, Val As System.Int64) As Integer
    Public Declare Function DTWAIN_ArrayAddLong64N Lib "dtwain64.dll" (pArray As System.IntPtr, Val As System.Int64, num As Integer) As Integer
    Public Declare Function DTWAIN_ArrayAddLongN Lib "dtwain64.dll" (pArray As System.IntPtr, Val As Integer, num As Integer) As Integer
    Public Declare Function DTWAIN_ArrayAddN Lib "dtwain64.dll" (pArray As System.IntPtr, pVariant As System.IntPtr, num As Integer) As Integer
    ...
    Public Declare Function DTWAIN_ArrayConvertFix32ToFloat Lib "dtwain64.dll" (Fix32Array As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_ArrayConvertFloatToFix32 Lib "dtwain64.dll" (FloatArray As System.IntPtr) As System.IntPtr
    ...
    Public Declare Function DTWAIN_ArrayCreateFromType Lib "dtwain64.dll" (Source As System.IntPtr, lType As Integer, lSize As Integer) As System.IntPtr
    ...
    Public Declare Function DTWAIN_ArrayFindLong Lib "dtwain64.dll" (pArray As System.IntPtr, Val As Integer) As Integer
    Public Declare Function DTWAIN_ArrayFindLong64 Lib "dtwain64.dll" (pArray As System.IntPtr, Val As System.Int64) As Integer
    ...
    Public Declare Function DTWAIN_ArrayFix32GetAt Lib "dtwain64.dll" (aFix32 As System.IntPtr, lPos As Integer, ByRef Whole As Integer, ByRef Frac As Integer) As Integer
    Public Declare Function DTWAIN_ArrayFix32SetAt Lib "dtwain64.dll" (aFix32 As System.IntPtr, lPos As Integer, Whole As Integer, Frac As Integer) As Integer
    Public Declare Function DTWAIN_ArrayFloatToANSIString Lib "dtwain64.dll" (FloatArray As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_ArrayFloatToString Lib "dtwain64.dll" (FloatArray As System.IntPtr) As System.IntPtr
    ...
    Public Declare Function DTWAIN_ArrayGetAtFrame Lib "dtwain64.dll" (FrameArray As System.IntPtr, nWhere As Integer, ByRef pleft As System.Double, ByRef ptop As System.Double, ByRef pright As System.Double, ByRef pbottom As System.Double) As Integer
    Public Declare Function DTWAIN_ArrayGetAtFrameEx Lib "dtwain64.dll" (FrameArray As System.IntPtr, nWhere As Integer, Frame As System.IntPtr) As Integer
    ...
    Public Declare Function DTWAIN_ArrayGetAtLong Lib "dtwain64.dll" (pArray As System.IntPtr, nWhere As Integer, ByRef pVal As Integer) As Integer
    Public Declare Function DTWAIN_ArrayGetAtLong64 Lib "dtwain64.dll" (pArray As System.IntPtr, nWhere As Integer, ByRef pVal As System.Int64) As Integer
    Public Declare Function DTWAIN_ArrayGetAtLong64Ex Lib "dtwain64.dll" (pArray As System.IntPtr, nWhere As Integer) As System.Int64
    Public Declare Function DTWAIN_ArrayGetAtLongEx Lib "dtwain64.dll" (pArray As System.IntPtr, nWhere As Integer) As Integer
    ...
    Public Declare Function DTWAIN_ArrayGetCapValuesEx2 Lib "dtwain64.dll" (Source As System.IntPtr, lCap As Integer, lGetType As Integer, lContainerType As Integer, nDataType As Integer) As System.IntPtr
    Public Declare Function DTWAIN_ArrayGetCount Lib "dtwain64.dll" (pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_ArrayGetMaxStringLength Lib "dtwain64.dll" (a As System.IntPtr) As Integer
    Public Declare Function DTWAIN_ArrayGetSourceAt Lib "dtwain64.dll" (pArray As System.IntPtr, nWhere As Integer, ByRef ppSource As System.IntPtr) As Integer
    Public Declare Function DTWAIN_ArrayGetStringLength Lib "dtwain64.dll" (a As System.IntPtr, nWhichString As Integer) As Integer
    Public Declare Function DTWAIN_ArrayGetType Lib "dtwain64.dll" (pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_ArrayInsertAt Lib "dtwain64.dll" (pArray As System.IntPtr, nWhere As Integer, pVariant As System.IntPtr) As Integer
    ...
    Public Declare Function DTWAIN_ArrayInsertAtFloat Lib "dtwain64.dll" (pArray As System.IntPtr, nWhere As Integer, pVal As System.Double) As Integer
    Public Declare Function DTWAIN_ArrayInsertAtFloatN Lib "dtwain64.dll" (pArray As System.IntPtr, nWhere As Integer, Val As System.Double, num As Integer) As Integer
    ...
    Public Declare Function DTWAIN_ArrayInsertAtFrame Lib "dtwain64.dll" (pArray As System.IntPtr, nWhere As Integer, frame As System.IntPtr) As Integer
    Public Declare Function DTWAIN_ArrayInsertAtFrameN Lib "dtwain64.dll" (pArray As System.IntPtr, nWhere As Integer, frame As System.IntPtr, num As Integer) As Integer
    Public Declare Function DTWAIN_ArrayInsertAtLong Lib "dtwain64.dll" (pArray As System.IntPtr, nWhere As Integer, pVal As Integer) As Integer
    Public Declare Function DTWAIN_ArrayInsertAtLong64 Lib "dtwain64.dll" (pArray As System.IntPtr, nWhere As Integer, Val As System.Int64) As Integer
    Public Declare Function DTWAIN_ArrayInsertAtLong64N Lib "dtwain64.dll" (pArray As System.IntPtr, nWhere As Integer, Val As System.Int64, num As Integer) As Integer
    Public Declare Function DTWAIN_ArrayInsertAtLongN Lib "dtwain64.dll" (pArray As System.IntPtr, nWhere As Integer, pVal As Integer, num As Integer) As Integer
    Public Declare Function DTWAIN_ArrayInsertAtN Lib "dtwain64.dll" (pArray As System.IntPtr, nWhere As Integer, pVariant As System.IntPtr, num As Integer) As Integer
    ...
    Public Declare Function DTWAIN_ArrayResize Lib "dtwain64.dll" (pArray As System.IntPtr, NewSize As Integer) As Integer
    Public Declare Function DTWAIN_ArraySetAt Lib "dtwain64.dll" (pArray As System.IntPtr, lPos As Integer, pVariant As System.IntPtr) As Integer
    ...
    Public Declare Function DTWAIN_ArraySetAtFloat Lib "dtwain64.dll" (pArray As System.IntPtr, nWhere As Integer, pVal As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_ArraySetAtFrame Lib "dtwain64.dll" (FrameArray As System.IntPtr, nWhere As Integer, left As System.Double, top As System.Double, right As System.Double, bottom As System.Double) As Integer
    Public Declare Function DTWAIN_ArraySetAtFrameEx Lib "dtwain64.dll" (FrameArray As System.IntPtr, nWhere As Integer, Frame As System.IntPtr) As Integer
    ...
    Public Declare Function DTWAIN_ArraySetAtLong Lib "dtwain64.dll" (pArray As System.IntPtr, nWhere As Integer, pVal As Integer) As Integer
    Public Declare Function DTWAIN_ArraySetAtLong64 Lib "dtwain64.dll" (pArray As System.IntPtr, nWhere As Integer, Val As System.Int64) As Integer
    ...
    Public Declare Function DTWAIN_ArrayStringToFloat Lib "dtwain64.dll" (StringArray As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_ArrayWideStringToFloat Lib "dtwain64.dll" (StringArray As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_CallCallback Lib "dtwain64.dll" (wParam As Integer, lParam As Integer, UserData As Integer) As Integer
    Public Declare Function DTWAIN_CallCallback64 Lib "dtwain64.dll" (wParam As Integer, lParam As Integer, UserData As System.Int64) As Integer
    Public Declare Function DTWAIN_CallDSMProc Lib "dtwain64.dll" (AppID As System.IntPtr, SourceId As System.IntPtr, lDG As Integer, lDAT As Integer, lMSG As Integer, pData As System.IntPtr) As Integer
    Public Declare Function DTWAIN_CheckDLLVersion Lib "dtwain64.dll" (lMajor As Integer, lMinor As Integer, lPatchLevel As Integer, lBuildNumber As Integer, MatchType As Integer) As Integer
    Public Declare Function DTWAIN_CheckHandles Lib "dtwain64.dll" (bCheck As Integer) As Integer
    Public Declare Function DTWAIN_ClearBuffers Lib "dtwain64.dll" (Source As System.IntPtr, ClearBuffer As Integer) As Integer
    Public Declare Function DTWAIN_ClearErrorBuffer Lib "dtwain64.dll" () As Integer
    Public Declare Function DTWAIN_ClearPDFTextElements Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_ClearPage Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_CloseSource Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_CloseSourceUI Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_ConvertDIBToBitmap Lib "dtwain64.dll" (hDib As System.IntPtr, hPalette As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_ConvertDIBToFullBitmap Lib "dtwain64.dll" (hDib As System.IntPtr, isBMP As Integer) As System.IntPtr
    ...
    Public Declare Function DTWAIN_CreateAcquisitionArray Lib "dtwain64.dll" () As System.IntPtr
    Public Declare Function DTWAIN_CreatePDFTextElement Lib "dtwain64.dll" () As System.IntPtr
    Public Declare Function DTWAIN_CreatePDFTextElementCopy Lib "dtwain64.dll" (TextElement As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_DeleteDIB Lib "dtwain64.dll" (hDib As System.IntPtr) As Integer
    Public Declare Function DTWAIN_DestroyAcquisitionArray Lib "dtwain64.dll" (aAcq As System.IntPtr, bDestroyData As Integer) As Integer
    Public Declare Function DTWAIN_DestroyPDFTextElement Lib "dtwain64.dll" (TextElement As System.IntPtr) As Integer
    Public Declare Function DTWAIN_DisableAppWindow Lib "dtwain64.dll" (hWnd As System.IntPtr, bDisable As Integer) As Integer
    Public Declare Function DTWAIN_EnableAutoBorderDetect Lib "dtwain64.dll" (Source As System.IntPtr, bEnable As Integer) As Integer
    Public Declare Function DTWAIN_EnableAutoBright Lib "dtwain64.dll" (Source As System.IntPtr, bSet As Integer) As Integer
    Public Declare Function DTWAIN_EnableAutoDeskew Lib "dtwain64.dll" (Source As System.IntPtr, bEnable As Integer) As Integer
    Public Declare Function DTWAIN_EnableAutoFeed Lib "dtwain64.dll" (Source As System.IntPtr, bSet As Integer) As Integer
    Public Declare Function DTWAIN_EnableAutoRotate Lib "dtwain64.dll" (Source As System.IntPtr, bSet As Integer) As Integer
    Public Declare Function DTWAIN_EnableAutoScan Lib "dtwain64.dll" (Source As System.IntPtr, bEnable As Integer) As Integer
    Public Declare Function DTWAIN_EnableAutomaticSenseMedium Lib "dtwain64.dll" (Source As System.IntPtr, bSet As Integer) As Integer
    Public Declare Function DTWAIN_EnableBarcodeDetection Lib "dtwain64.dll" (Source As System.IntPtr, bEnable As Integer) As Integer
    Public Declare Function DTWAIN_EnableDuplex Lib "dtwain64.dll" (Source As System.IntPtr, bEnable As Integer) As Integer
    Public Declare Function DTWAIN_EnableFeeder Lib "dtwain64.dll" (Source As System.IntPtr, bSet As Integer) As Integer
    Public Declare Function DTWAIN_EnableGetMessageLoop Lib "dtwain64.dll" (Source As System.IntPtr, bSet As Integer) As Integer
    Public Declare Function DTWAIN_EnableGetMessageLoopDetection Lib "dtwain64.dll" (bEnable As Integer) As Integer
    Public Declare Function DTWAIN_EnableIndicator Lib "dtwain64.dll" (Source As System.IntPtr, bEnable As Integer) As Integer
    Public Declare Function DTWAIN_EnableJobFileHandling Lib "dtwain64.dll" (Source As System.IntPtr, bSet As Integer) As Integer
    Public Declare Function DTWAIN_EnableLamp Lib "dtwain64.dll" (Source As System.IntPtr, bEnable As Integer) As Integer
    Public Declare Function DTWAIN_EnableMsgNotify Lib "dtwain64.dll" (bSet As Integer) As Integer
    Public Declare Function DTWAIN_EnablePatchcodeDetection Lib "dtwain64.dll" (Source As System.IntPtr, bEnable As Integer) As Integer
    Public Declare Function DTWAIN_EnablePeekMessageLoop Lib "dtwain64.dll" (Source As System.IntPtr, bSet As Integer) As Integer
    Public Declare Function DTWAIN_EnablePrinter Lib "dtwain64.dll" (Source As System.IntPtr, bEnable As Integer) As Integer
    Public Declare Function DTWAIN_EnableThumbnail Lib "dtwain64.dll" (Source As System.IntPtr, bEnable As Integer) As Integer
    Public Declare Function DTWAIN_EnableTripletsNotify Lib "dtwain64.dll" (bSet As Integer) As Integer
    Public Declare Function DTWAIN_EndThread Lib "dtwain64.dll" (DLLHandle As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EndTwainSession Lib "dtwain64.dll" () As Integer
    Public Declare Function DTWAIN_EnumAlarmVolumes Lib "dtwain64.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr, expandIfRange As Integer) As Integer
    Public Declare Function DTWAIN_EnumAlarmVolumesEx Lib "dtwain64.dll" (Source As System.IntPtr, expandIfRange As Integer) As System.IntPtr
    Public Declare Function DTWAIN_EnumAlarms Lib "dtwain64.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumAlarmsEx Lib "dtwain64.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumAudioXferMechs Lib "dtwain64.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumAudioXferMechsEx Lib "dtwain64.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumAutoFeedValues Lib "dtwain64.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumAutoFeedValuesEx Lib "dtwain64.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumAutomaticCaptures Lib "dtwain64.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr, bExpandIfRange As Integer) As Integer
    Public Declare Function DTWAIN_EnumAutomaticCapturesEx Lib "dtwain64.dll" (Source As System.IntPtr, bExpandIfRange As Integer) As System.IntPtr
    ...
    Public Declare Function DTWAIN_EnumBarcodeCodes Lib "dtwain64.dll" (Source As System.IntPtr, ByRef PCodes As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumBarcodeCodesEx Lib "dtwain64.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumBarcodeMaxPriorities Lib "dtwain64.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumBarcodeMaxPrioritiesEx Lib "dtwain64.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumBarcodeMaxRetries Lib "dtwain64.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumBarcodeMaxRetriesEx Lib "dtwain64.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumBarcodePriorities Lib "dtwain64.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumBarcodePrioritiesEx Lib "dtwain64.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumBarcodeSearchModes Lib "dtwain64.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumBarcodeSearchModesEx Lib "dtwain64.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumBarcodeTimeOutValues Lib "dtwain64.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumBarcodeTimeOutValuesEx Lib "dtwain64.dll" (Source As System.IntPtr) As System.IntPtr
    ...
    Public Declare Function DTWAIN_EnumDoubleFeedDetectValuesEx Lib "dtwain64.dll" (Source As System.IntPtr) As System.IntPtr
    ...
    Public Declare Function DTWAIN_EnumFileXferFormatsEx Lib "dtwain64.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumHalftones Lib "dtwain64.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumHalftonesEx Lib "dtwain64.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumHighlightValues Lib "dtwain64.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr, bExpandIfRange As Integer) As Integer
    Public Declare Function DTWAIN_EnumHighlightValuesEx Lib "dtwain64.dll" (Source As System.IntPtr, bExpandIfRange As Integer) As System.IntPtr
    Public Declare Function DTWAIN_EnumJobControls Lib "dtwain64.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumJobControlsEx Lib "dtwain64.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumLightPaths Lib "dtwain64.dll" (Source As System.IntPtr, ByRef LightPath As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumLightPathsEx Lib "dtwain64.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumLightSources Lib "dtwain64.dll" (Source As System.IntPtr, ByRef LightSources As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumLightSourcesEx Lib "dtwain64.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumMaxBuffers Lib "dtwain64.dll" (Source As System.IntPtr, ByRef pMaxBufs As System.IntPtr, bExpandRange As Integer) As Integer
    Public Declare Function DTWAIN_EnumMaxBuffersEx Lib "dtwain64.dll" (Source As System.IntPtr, bExpandRange As Integer) As System.IntPtr
    ...
    Public Declare Function DTWAIN_EnumOverscanValues Lib "dtwain64.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumOverscanValuesEx Lib "dtwain64.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumPaperSizes Lib "dtwain64.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumPaperSizesEx Lib "dtwain64.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumPatchcodeCodes Lib "dtwain64.dll" (Source As System.IntPtr, ByRef PCodes As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumPatchcodeCodesEx Lib "dtwain64.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumPatchcodeMaxPriorities Lib "dtwain64.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumPatchcodeMaxPrioritiesEx Lib "dtwain64.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumPatchcodeMaxRetries Lib "dtwain64.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumPatchcodeMaxRetriesEx Lib "dtwain64.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumPatchcodePriorities Lib "dtwain64.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumPatchcodePrioritiesEx Lib "dtwain64.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumPatchcodeSearchModes Lib "dtwain64.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumPatchcodeSearchModesEx Lib "dtwain64.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumPatchcodeTimeOutValues Lib "dtwain64.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumPatchcodeTimeOutValuesEx Lib "dtwain64.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumPixelTypes Lib "dtwain64.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumPixelTypesEx Lib "dtwain64.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumPrinterStringModes Lib "dtwain64.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumPrinterStringModesEx Lib "dtwain64.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumResolutionValues Lib "dtwain64.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr, bExpandIfRange As Integer) As Integer
    Public Declare Function DTWAIN_EnumResolutionValuesEx Lib "dtwain64.dll" (Source As System.IntPtr, bExpandIfRange As Integer) As System.IntPtr
    Public Declare Function DTWAIN_EnumShadowValues Lib "dtwain64.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr, bExpandIfRange As Integer) As Integer
    Public Declare Function DTWAIN_EnumShadowValuesEx Lib "dtwain64.dll" (Source As System.IntPtr, bExpandIfRange As Integer) As System.IntPtr
    Public Declare Function DTWAIN_EnumSourceUnits Lib "dtwain64.dll" (Source As System.IntPtr, ByRef lpArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumSourceUnitsEx Lib "dtwain64.dll" (Source As System.IntPtr) As System.IntPtr
    ...
    Public Declare Function DTWAIN_EnumSupportedFileTypes Lib "dtwain64.dll" () As System.IntPtr
    Public Declare Function DTWAIN_EnumSupportedMultiPageFileTypes Lib "dtwain64.dll" () As System.IntPtr
    Public Declare Function DTWAIN_EnumSupportedSinglePageFileTypes Lib "dtwain64.dll" () As System.IntPtr
    Public Declare Function DTWAIN_EnumThresholdValues Lib "dtwain64.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr, bExpandIfRange As Integer) As Integer
    Public Declare Function DTWAIN_EnumThresholdValuesEx Lib "dtwain64.dll" (Source As System.IntPtr, bExpandIfRange As Integer) As System.IntPtr
    Public Declare Function DTWAIN_EnumTopCameras Lib "dtwain64.dll" (Source As System.IntPtr, ByRef Cameras As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumTopCamerasEx Lib "dtwain64.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumTwainPrinters Lib "dtwain64.dll" (Source As System.IntPtr, ByRef lpAvailPrinters As System.IntPtr) As Integer
    Public Declare Function DTWAIN_EnumTwainPrintersEx Lib "dtwain64.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_EnumXResolutionValues Lib "dtwain64.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr, bExpandIfRange As Integer) As Integer
    Public Declare Function DTWAIN_EnumXResolutionValuesEx Lib "dtwain64.dll" (Source As System.IntPtr, bExpandIfRange As Integer) As System.IntPtr
    Public Declare Function DTWAIN_EnumYResolutionValues Lib "dtwain64.dll" (Source As System.IntPtr, ByRef pArray As System.IntPtr, bExpandIfRange As Integer) As Integer
    Public Declare Function DTWAIN_EnumYResolutionValuesEx Lib "dtwain64.dll" (Source As System.IntPtr, bExpandIfRange As Integer) As System.IntPtr
    ...
    Public Declare Function DTWAIN_FeedPage Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_FlipBitmap Lib "dtwain64.dll" (hDib As System.IntPtr) As Integer
    Public Declare Function DTWAIN_FlushAcquiredPages Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_FrameCreate Lib "dtwain64.dll" (Left As System.Double, Top As System.Double, Right As System.Double, Bottom As System.Double) As System.IntPtr
    ...
    Public Declare Function DTWAIN_FrameDestroy Lib "dtwain64.dll" (Frame As System.IntPtr) As Integer
    Public Declare Function DTWAIN_FrameGetAll Lib "dtwain64.dll" (Frame As System.IntPtr, ByRef Left As System.Double, ByRef Top As System.Double, ByRef Right As System.Double, ByRef Bottom As System.Double) As Integer
    Public Declare Ansi Function DTWAIN_FrameGetAllString Lib "dtwain64.dll" (Frame As System.IntPtr, <MarshalAs(UnmanagedType.LPStr)> Left As StringBuilder, <MarshalAs(UnmanagedType.LPStr)> Top As StringBuilder, <MarshalAs(UnmanagedType.LPStr)> Right As StringBuilder, <MarshalAs(UnmanagedType.LPStr)> Bottom As StringBuilder) As Integer
    Public Declare Function DTWAIN_FrameGetValue Lib "dtwain64.dll" (Frame As System.IntPtr, nWhich As Integer, ByRef Value As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_FrameIsValid Lib "dtwain64.dll" (Frame As System.IntPtr) As Integer
    Public Declare Function DTWAIN_FrameSetAll Lib "dtwain64.dll" (Frame As System.IntPtr, Left As System.Double, Top As System.Double, Right As System.Double, Bottom As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_FrameSetValue Lib "dtwain64.dll" (Frame As System.IntPtr, nWhich As Integer, Value As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_FreeExtImageInfo Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_FreeMemory Lib "dtwain64.dll" (h As System.IntPtr) As Integer
    Public Declare Function DTWAIN_FreeMemoryEx Lib "dtwain64.dll" (h As System.IntPtr) As Integer
    Public Declare Function DTWAIN_GetAPIHandleStatus Lib "dtwain64.dll" (pHandle As System.IntPtr) As Integer
    Public Declare Function DTWAIN_GetAcquireArea Lib "dtwain64.dll" (Source As System.IntPtr, lGetType As Integer, ByRef FloatEnum As System.IntPtr) As Integer
    Public Declare Function DTWAIN_GetAcquireArea2 Lib "dtwain64.dll" (Source As System.IntPtr, ByRef left As System.Double, ByRef top As System.Double, ByRef right As System.Double, ByRef bottom As System.Double, ByRef lpUnit As Integer) As Integer
    ...
    Public Declare Function DTWAIN_GetAcquireAreaEx Lib "dtwain64.dll" (Source As System.IntPtr, lGetType As Integer) As System.IntPtr
    Public Declare Function DTWAIN_GetAcquireMetrics Lib "dtwain64.dll" (source As System.IntPtr, ByRef ImageCount As Integer, ByRef SheetCount As Integer) As Integer
    Public Declare Function DTWAIN_GetAcquireStripBuffer Lib "dtwain64.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_GetAcquireStripData Lib "dtwain64.dll" (Source As System.IntPtr, ByRef lpCompression As Integer, ByRef lpBytesPerRow As UInteger, ByRef lpColumns As UInteger, ByRef lpRows As UInteger, ByRef XOffset As UInteger, ByRef YOffset As UInteger, ByRef lpBytesWritten As UInteger) As Integer
    Public Declare Function DTWAIN_GetAcquireStripSizes Lib "dtwain64.dll" (Source As System.IntPtr, ByRef lpMin As UInteger, ByRef lpMax As UInteger, ByRef lpPreferred As UInteger) As Integer
    Public Declare Function DTWAIN_GetAcquiredImage Lib "dtwain64.dll" (aAcq As System.IntPtr, nWhichAcq As Integer, nWhichDib As Integer) As System.IntPtr
    Public Declare Function DTWAIN_GetAcquiredImageArray Lib "dtwain64.dll" (aAcq As System.IntPtr, nWhichAcq As Integer) As System.IntPtr
    Public Declare Function DTWAIN_GetAcquisitionArray Lib "dtwain64.dll" (Source As System.IntPtr) As System.IntPtr
    ...
    Public Declare Ansi Function DTWAIN_GetAllSessionInfo Lib "dtwain64.dll" (<MarshalAs(UnmanagedType.LPTStr)> lpszOut As StringBuilder, indentFactor As Integer, nMaxLen As Integer) As Integer
    ...
    Public Declare Function DTWAIN_GetBitDepthEx Lib "dtwain64.dll" (Source As System.IntPtr, bCurrent As Integer) As Integer
    Public Declare Function DTWAIN_GetBlankPageAutoDetection Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_GetBrightness Lib "dtwain64.dll" (Source As System.IntPtr, ByRef Brightness As System.Double) As Integer
    Public Declare Function DTWAIN_GetBrightnessEx Lib "dtwain64.dll" (Source As System.IntPtr) As System.Double
    ...
    Public Declare Function DTWAIN_GetBufferedTransferInfo Lib "dtwain64.dll" (Source As System.IntPtr, ByRef Compression As UInteger, ByRef BytesPerRow As UInteger, ByRef Columns As UInteger, ByRef Rows As UInteger, ByRef XOffset As UInteger, ByRef YOffset As UInteger, ByRef Flags As UInteger, ByRef BytesWritten As UInteger, ByRef MemoryLength As UInteger) As System.IntPtr
    Public Declare Function DTWAIN_GetCallback Lib "dtwain64.dll" () As DTwainCallback
    Public Declare Function DTWAIN_GetCallback64 Lib "dtwain64.dll" () As DTwainCallback64
    Public Declare Function DTWAIN_GetCapArrayType Lib "dtwain64.dll" (Source As System.IntPtr, nCap As Integer) As Integer
    Public Declare Function DTWAIN_GetCapContainer Lib "dtwain64.dll" (Source As System.IntPtr, nCap As Integer, lCapType As Integer) As Integer
    Public Declare Function DTWAIN_GetCapContainerEx Lib "dtwain64.dll" (nCap As Integer, bSetContainer As Integer, ByRef ConTypes As System.IntPtr) As Integer
    ...
    Public Declare Function DTWAIN_GetContrast Lib "dtwain64.dll" (Source As System.IntPtr, ByRef Contrast As System.Double) As Integer
    Public Declare Function DTWAIN_GetContrastEx Lib "dtwain64.dll" (Source As System.IntPtr) As System.Double
    ...
    Public Declare Function DTWAIN_GetCountry Lib "dtwain64.dll" () As Integer
    Public Declare Function DTWAIN_GetCurrentAcquiredImage Lib "dtwain64.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Ansi Function DTWAIN_GetCurrentCustomResourceName Lib "dtwain64.dll" (<MarshalAs(UnmanagedType.LPStr)> lpszOut As StringBuilder, nMaxLen As Integer) As Integer
    ...
    Public Declare Function DTWAIN_GetCurrentPageNum Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_GetCurrentRetryCount Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_GetCurrentTwainTriplet Lib "dtwain64.dll" (ByRef pAppID As TW_IDENTITY, ByRef pSourceID As TW_IDENTITY, ByRef lpDG As Integer, ByRef lpDAT As Integer, ByRef lpMsg As Integer, ByRef lpMemRef As System.Int64) As Integer
    Public Declare Function DTWAIN_GetCustomDSData Lib "dtwain64.dll" (Source As System.IntPtr, Data As Byte(), dSize As UInteger, ByRef pActualSize As UInteger, nFlags As Integer) As System.IntPtr
    ...
    Public Declare Function DTWAIN_GetExtImageInfo Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_GetExtImageInfoData Lib "dtwain64.dll" (Source As System.IntPtr, nWhich As Integer, ByRef Data As System.IntPtr) As Integer
    Public Declare Function DTWAIN_GetExtImageInfoDataEx Lib "dtwain64.dll" (Source As System.IntPtr, nWhich As Integer) As System.IntPtr
    Public Declare Function DTWAIN_GetExtImageInfoItem Lib "dtwain64.dll" (Source As System.IntPtr, nWhich As Integer, ByRef InfoID As Integer, ByRef NumItems As Integer, ByRef Type As Integer) As Integer
    Public Declare Function DTWAIN_GetExtImageInfoItemEx Lib "dtwain64.dll" (Source As System.IntPtr, nWhich As Integer, ByRef InfoID As Integer, ByRef NumItems As Integer, ByRef Type As Integer, ByRef ReturnCode As Integer) As Integer
    ...
    Public Declare Function DTWAIN_GetFeederAlignment Lib "dtwain64.dll" (Source As System.IntPtr, ByRef lpAlignment As Integer) As Integer
    Public Declare Function DTWAIN_GetFeederFuncs Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_GetFeederOrder Lib "dtwain64.dll" (Source As System.IntPtr, ByRef lpOrder As Integer) As Integer
    Public Declare Function DTWAIN_GetFeederWaitTime Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_GetFileCompressionType Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_GetFileSavePageCount Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    ...
    Public Declare Function DTWAIN_GetHighlight Lib "dtwain64.dll" (Source As System.IntPtr, ByRef Highlight As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_GetImageLayoutInfo Lib "dtwain64.dll" (Source As System.IntPtr, lGetType As Integer, ByRef DocumentNumber As Integer, ByRef PageNumber As Integer, ByRef FrameNumber As Integer) As Integer
    Public Declare Function DTWAIN_GetJobControl Lib "dtwain64.dll" (Source As System.IntPtr, ByRef pJobControl As Integer, bCurrent As Integer) As Integer
    Public Declare Function DTWAIN_GetJobControlEx Lib "dtwain64.dll" (Source As System.IntPtr, bGetCurrent As Integer) As Integer
    Public Declare Function DTWAIN_GetJpegValues Lib "dtwain64.dll" (Source As System.IntPtr, ByRef pQuality As Integer, ByRef Progressive As Integer) As Integer
    Public Declare Function DTWAIN_GetJpegXRValues Lib "dtwain64.dll" (Source As System.IntPtr, ByRef pQuality As Integer, ByRef Progressive As Integer) As Integer
    Public Declare Function DTWAIN_GetLanguage Lib "dtwain64.dll" () As Integer
    Public Declare Function DTWAIN_GetLastCapEnumIndices Lib "dtwain64.dll" (Source As System.IntPtr, ByRef pCurrentIndex As Integer, ByRef pDefaultIndex As Integer) As Integer
    Public Declare Function DTWAIN_GetLastError Lib "dtwain64.dll" () As Integer
    Public Declare Function DTWAIN_GetLastTwainError Lib "dtwain64.dll" (ByRef rcError As UInteger, ByRef ccError As UInteger) As Integer
    ...
    Public Declare Function DTWAIN_GetLightPath Lib "dtwain64.dll" (Source As System.IntPtr, ByRef lpLightPath As Integer) As Integer
    Public Declare Function DTWAIN_GetLightPathEx Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_GetLightSource Lib "dtwain64.dll" (Source As System.IntPtr, ByRef LightSource As Integer) As Integer
    Public Declare Function DTWAIN_GetLightSources Lib "dtwain64.dll" (Source As System.IntPtr, ByRef LightSources As System.IntPtr) As Integer
    Public Declare Function DTWAIN_GetLightSourcesEx Lib "dtwain64.dll" (Source As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_GetLoggerCallback Lib "dtwain64.dll" () As DTwainLoggerProc
    Public Declare Function DTWAIN_GetMajorMinorVersion Lib "dtwain64.dll" (ByRef nMajor As UInteger, ByRef nMinor As UInteger) As Integer
    ...
    Public Declare Function DTWAIN_GetNoiseFilter Lib "dtwain64.dll" (Source As System.IntPtr, ByRef lpNoiseFilter As Integer) As Integer
    Public Declare Function DTWAIN_GetNumAcquiredImages Lib "dtwain64.dll" (aAcq As System.IntPtr, nWhich As Integer) As Integer
    Public Declare Function DTWAIN_GetNumAcquisitions Lib "dtwain64.dll" (aAcq As System.IntPtr) As Integer
    Public Declare Function DTWAIN_GetOCRCapValues Lib "dtwain64.dll" (Engine As System.IntPtr, OCRCapValue As Integer, TypeOfGet As Integer, ByRef CapValues As System.IntPtr) As Integer
    ...
    Public Declare Function DTWAIN_GetOCRLastError Lib "dtwain64.dll" (Engine As System.IntPtr) As Integer
    Public Declare Function DTWAIN_GetOCRMajorMinorVersion Lib "dtwain64.dll" (Engine As System.IntPtr, ByRef lpMajor As Integer, ByRef lpMinor As Integer) As Integer
    ...
    Public Declare Function DTWAIN_GetOCRTextInfoFloat Lib "dtwain64.dll" (OCRTextInfo As System.IntPtr, nCharPos As Integer, nWhichItem As Integer, ByRef pInfo As System.Double) As Integer
    Public Declare Function DTWAIN_GetOCRTextInfoFloatEx Lib "dtwain64.dll" (OCRTextInfo As System.IntPtr, nWhichItem As Integer, ByRef pInfo As System.Double, bufSize As Integer) As Integer
    Public Declare Function DTWAIN_GetOCRTextInfoHandle Lib "dtwain64.dll" (Engine As System.IntPtr, nPageNo As Integer) As System.IntPtr
    Public Declare Function DTWAIN_GetOCRTextInfoLong Lib "dtwain64.dll" (OCRTextInfo As System.IntPtr, nCharPos As Integer, nWhichItem As Integer, ByRef pInfo As Integer) As Integer
    Public Declare Function DTWAIN_GetOCRTextInfoLongEx Lib "dtwain64.dll" (OCRTextInfo As System.IntPtr, nWhichItem As Integer, ByRef pInfo As Integer, bufSize As Integer) As Integer
    ...
    Public Declare Function DTWAIN_GetOrientation Lib "dtwain64.dll" (Source As System.IntPtr, ByRef lpOrient As Integer, bCurrent As Integer) As Integer
    Public Declare Function DTWAIN_GetOrientationEx Lib "dtwain64.dll" (Source As System.IntPtr, bCurrent As Integer) As Integer
    Public Declare Function DTWAIN_GetOverscan Lib "dtwain64.dll" (Source As System.IntPtr, ByRef lpOverscan As Integer, bCurrent As Integer) As Integer
    Public Declare Function DTWAIN_GetPDFTextElementFloat Lib "dtwain64.dll" (TextElement As System.IntPtr, ByRef val1 As System.Double, ByRef val2 As System.Double, Flags As Integer) As Integer
    Public Declare Function DTWAIN_GetPDFTextElementLong Lib "dtwain64.dll" (TextElement As System.IntPtr, ByRef val1 As Integer, ByRef val2 As Integer, Flags As Integer) As Integer
    ...
    Public Declare Function DTWAIN_GetPendingXferCount Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    ...
    Public Declare Function DTWAIN_GetPrinterStringsEx Lib "dtwain64.dll" (Source As System.IntPtr) As System.IntPtr
    ...
    Public Declare Function DTWAIN_GetRegisteredMsg Lib "dtwain64.dll" () As Integer
    Public Declare Function DTWAIN_GetResolution Lib "dtwain64.dll" (Source As System.IntPtr, ByRef Resolution As System.Double) As Integer
    Public Declare Function DTWAIN_GetResolutionEx Lib "dtwain64.dll" (Source As System.IntPtr) As System.Double
    ...
    Public Declare Function DTWAIN_GetRotation Lib "dtwain64.dll" (Source As System.IntPtr, ByRef Rotation As System.Double) As Integer
    Public Declare Function DTWAIN_GetRotationEx Lib "dtwain64.dll" (Source As System.IntPtr) As System.Double
    ...
    Public Declare Function DTWAIN_GetSaveFileType Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    ...
    Public Declare Function DTWAIN_GetShadow Lib "dtwain64.dll" (Source As System.IntPtr, ByRef Shadow As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_GetSourceAcquisitions Lib "dtwain64.dll" (Source As System.IntPtr) As System.IntPtr
    ...
    Public Declare Function DTWAIN_GetSourceID Lib "dtwain64.dll" (Source As System.IntPtr) As System.IntPtr
    ...
    Public Declare Function DTWAIN_GetSourceUnit Lib "dtwain64.dll" (Source As System.IntPtr, ByRef lpUnit As Integer) As Integer
    Public Declare Function DTWAIN_GetSourceUnitEx Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    ...
    Public Declare Function DTWAIN_GetSourceVersionNumber Lib "dtwain64.dll" (Source As System.IntPtr, ByRef pMajor As Integer, ByRef pMinor As Integer) As Integer
    ...
    Public Declare Function DTWAIN_GetThreshold Lib "dtwain64.dll" (Source As System.IntPtr, ByRef Threshold As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_GetVersionEx Lib "dtwain64.dll" (ByRef lMajor As Integer, ByRef lMinor As Integer, ByRef lVersionType As Integer, ByRef lPatchLevel As Integer) As Integer
    Public Declare Function DTWAIN_GetVersionEx2 Lib "dtwain64.dll" (ByRef lMajor As Integer, ByRef lMinor As Integer, ByRef lVersionType As Integer, ByRef lPatchLevel As Integer, ByRef lBuildNumber As Integer) As Integer
    ...
    Public Declare Function DTWAIN_GetXResolution Lib "dtwain64.dll" (Source As System.IntPtr, ByRef Resolution As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_GetYResolution Lib "dtwain64.dll" (Source As System.IntPtr, ByRef Resolution As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_InitExtImageInfo Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_InitOCRInterface Lib "dtwain64.dll" () As Integer
    Public Declare Function DTWAIN_IsAcquiring Lib "dtwain64.dll" () As Integer
    Public Declare Function DTWAIN_IsAudioXferSupported Lib "dtwain64.dll" (Source As System.IntPtr, supportVal As Integer) As Integer
    Public Declare Function DTWAIN_IsAutoBorderDetectEnabled Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsAutoBorderDetectSupported Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsAutoBrightEnabled Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsAutoBrightSupported Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsAutoDeskewEnabled Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsAutoDeskewSupported Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsAutoFeedEnabled Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsAutoFeedSupported Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsAutoRotateEnabled Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsAutoRotateSupported Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsAutoScanEnabled Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsAutomaticSenseMediumEnabled Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsAutomaticSenseMediumSupported Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsBarcodeCapsSupported Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsBarcodeDetectionEnabled Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsBarcodeSupported Lib "dtwain64.dll" (Source As System.IntPtr, BarCode As Integer) As Integer
    Public Declare Function DTWAIN_IsBlankPageDetectionOn Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsBufferedTileModeOn Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsBufferedTileModeSupported Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsCapSupported Lib "dtwain64.dll" (Source As System.IntPtr, lCapability As Integer) As Integer
    Public Declare Function DTWAIN_IsCompressionSupported Lib "dtwain64.dll" (Source As System.IntPtr, Compression As Integer) As Integer
    Public Declare Function DTWAIN_IsCustomDSDataSupported Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsDIBBlank Lib "dtwain64.dll" (hDib As System.IntPtr, threshold As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_IsDeviceEventSupported Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsDeviceOnLine Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsDoubleFeedDetectLengthSupported Lib "dtwain64.dll" (Source As System.IntPtr, value As System.Double) As Integer
    Public Declare Function DTWAIN_IsDoubleFeedDetectSupported Lib "dtwain64.dll" (Source As System.IntPtr, SupportVal As Integer) As Integer
    Public Declare Function DTWAIN_IsDoublePageCountOnDuplex Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsDuplexEnabled Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsDuplexSupported Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsExtImageInfoSupported Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsFeederEnabled Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsFeederLoaded Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsFeederSensitive Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsFeederSupported Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsFileSystemSupported Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsFileXferSupported Lib "dtwain64.dll" (Source As System.IntPtr, lFileType As Integer) As Integer
    Public Declare Function DTWAIN_IsGetMessageLoopDetectionOn Lib "dtwain64.dll" () As Integer
    Public Declare Function DTWAIN_IsGetMessageLoopEnabled Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsIAFieldALastPageSupported Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsIAFieldALevelSupported Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsIAFieldAPrintFormatSupported Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsIAFieldAValueSupported Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsIAFieldBLastPageSupported Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsIAFieldBLevelSupported Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsIAFieldBPrintFormatSupported Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsIAFieldBValueSupported Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsIAFieldCLastPageSupported Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsIAFieldCLevelSupported Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsIAFieldCPrintFormatSupported Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsIAFieldCValueSupported Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsIAFieldDLastPageSupported Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsIAFieldDLevelSupported Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsIAFieldDPrintFormatSupported Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsIAFieldDValueSupported Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsIAFieldELastPageSupported Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsIAFieldELevelSupported Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsIAFieldEPrintFormatSupported Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsIAFieldEValueSupported Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsImageAddressingSupported Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsIndicatorEnabled Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsIndicatorSupported Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsInitialized Lib "dtwain64.dll" () As Integer
    Public Declare Function DTWAIN_IsJobControlSupported Lib "dtwain64.dll" (Source As System.IntPtr, JobControl As Integer) As Integer
    Public Declare Function DTWAIN_IsLampEnabled Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsLampSupported Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsLightPathSupported Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsLightSourceSupported Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsMaxBuffersSupported Lib "dtwain64.dll" (Source As System.IntPtr, MaxBuf As Integer) As Integer
    Public Declare Function DTWAIN_IsMemFileXferSupported Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsMsgNotifyEnabled Lib "dtwain64.dll" () As Integer
    Public Declare Function DTWAIN_IsNotifyTripletsEnabled Lib "dtwain64.dll" () As Integer
    Public Declare Function DTWAIN_IsOCREngineActivated Lib "dtwain64.dll" (OCREngine As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsOpenSourcesOnSelect Lib "dtwain64.dll" () As Integer
    Public Declare Function DTWAIN_IsOrientationSupported Lib "dtwain64.dll" (Source As System.IntPtr, Orientation As Integer) As Integer
    Public Declare Function DTWAIN_IsOverscanSupported Lib "dtwain64.dll" (Source As System.IntPtr, SupportValue As Integer) As Integer
    Public Declare Function DTWAIN_IsPaperDetectable Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsPaperSizeSupported Lib "dtwain64.dll" (Source As System.IntPtr, PaperSize As Integer) As Integer
    Public Declare Function DTWAIN_IsPatchcodeCapsSupported Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsPatchcodeDetectionEnabled Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsPatchcodeSupported Lib "dtwain64.dll" (Source As System.IntPtr, PatchCode As Integer) As Integer
    Public Declare Function DTWAIN_IsPeekMessageLoopEnabled Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsPixelTypeSupported Lib "dtwain64.dll" (Source As System.IntPtr, PixelType As Integer) As Integer
    Public Declare Function DTWAIN_IsPrinterEnabled Lib "dtwain64.dll" (Source As System.IntPtr, Printer As Integer) As Integer
    Public Declare Function DTWAIN_IsPrinterSupported Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsRotationSupported Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsSessionEnabled Lib "dtwain64.dll" () As Integer
    Public Declare Function DTWAIN_IsSkipImageInfoError Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsSourceAcquiring Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsSourceAcquiringEx Lib "dtwain64.dll" (Source As System.IntPtr, bUIOnly As Integer) As Integer
    Public Declare Function DTWAIN_IsSourceInUIOnlyMode Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsSourceOpen Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsSourceSelected Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsSourceValid Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsThumbnailEnabled Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsThumbnailSupported Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsTwainAvailable Lib "dtwain64.dll" () As Integer
    ...
    Public Declare Function DTWAIN_IsTwainMsg Lib "dtwain64.dll" (ByRef pMsg As WinMsg) As Integer
    Public Declare Function DTWAIN_IsUIControllable Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsUIEnabled Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_IsUIOnlySupported Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    ...
    Public Declare Function DTWAIN_LoadLanguageResource Lib "dtwain64.dll" (nLanguage As Integer) As Integer
    Public Declare Function DTWAIN_LockMemory Lib "dtwain64.dll" (h As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_LockMemoryEx Lib "dtwain64.dll" (h As System.IntPtr) As System.IntPtr
    Public Declare Ansi Function DTWAIN_LogMessage Lib "dtwain64.dll" (message As String) As Integer
    Public Declare Function DTWAIN_MakeRGB Lib "dtwain64.dll" (red As Integer, green As Integer, blue As Integer) As Integer
    Public Declare Function DTWAIN_OpenSource Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_OpenSourcesOnSelect Lib "dtwain64.dll" (bSet As Integer) As Integer
    Public Declare Function DTWAIN_RangeCreate Lib "dtwain64.dll" (nEnumType As Integer) As System.IntPtr
    Public Declare Function DTWAIN_RangeCreateFromCap Lib "dtwain64.dll" (Source As System.IntPtr, lCapType As Integer) As System.IntPtr
    Public Declare Function DTWAIN_RangeDestroy Lib "dtwain64.dll" (pSource As System.IntPtr) As Integer
    Public Declare Function DTWAIN_RangeExpand Lib "dtwain64.dll" (pSource As System.IntPtr, ByRef pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_RangeExpandEx Lib "dtwain64.dll" (Range As System.IntPtr) As System.IntPtr
    Public Declare Function DTWAIN_RangeGetAll Lib "dtwain64.dll" (pArray As System.IntPtr, pVariantLow As System.IntPtr, pVariantUp As System.IntPtr, pVariantStep As System.IntPtr, pVariantDefault As System.IntPtr, pVariantCurrent As System.IntPtr) As Integer
    Public Declare Function DTWAIN_RangeGetAllFloat Lib "dtwain64.dll" (pArray As System.IntPtr, ByRef pVariantLow As System.Double, ByRef pVariantUp As System.Double, ByRef pVariantStep As System.Double, ByRef pVariantDefault As System.Double, ByRef pVariantCurrent As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_RangeGetAllLong Lib "dtwain64.dll" (pArray As System.IntPtr, ByRef pVariantLow As Integer, ByRef pVariantUp As Integer, ByRef pVariantStep As Integer, ByRef pVariantDefault As Integer, ByRef pVariantCurrent As Integer) As Integer
    Public Declare Function DTWAIN_RangeGetCount Lib "dtwain64.dll" (pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_RangeGetExpValue Lib "dtwain64.dll" (pArray As System.IntPtr, lPos As Integer, pVariant As System.IntPtr) As Integer
    Public Declare Function DTWAIN_RangeGetExpValueFloat Lib "dtwain64.dll" (pArray As System.IntPtr, lPos As Integer, ByRef pVal As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_RangeGetExpValueLong Lib "dtwain64.dll" (pArray As System.IntPtr, lPos As Integer, ByRef pVal As Integer) As Integer
    Public Declare Function DTWAIN_RangeGetNearestValue Lib "dtwain64.dll" (pArray As System.IntPtr, pVariantIn As System.IntPtr, pVariantOut As System.IntPtr, RoundType As Integer) As Integer
    Public Declare Function DTWAIN_RangeGetNearestValueFloat Lib "dtwain64.dll" (pArray As System.IntPtr, dIn As System.Double, ByRef pOut As System.Double, RoundType As Integer) As Integer
    ...
    Public Declare Function DTWAIN_RangeGetNearestValueLong Lib "dtwain64.dll" (pArray As System.IntPtr, lIn As Integer, ByRef pOut As Integer, RoundType As Integer) As Integer
    Public Declare Function DTWAIN_RangeGetPos Lib "dtwain64.dll" (pArray As System.IntPtr, pVariant As System.IntPtr, ByRef pPos As Integer) As Integer
    Public Declare Function DTWAIN_RangeGetPosFloat Lib "dtwain64.dll" (pArray As System.IntPtr, Val As System.Double, ByRef pPos As Integer) As Integer
    ...
    Public Declare Function DTWAIN_RangeGetPosLong Lib "dtwain64.dll" (pArray As System.IntPtr, Value As Integer, ByRef pPos As Integer) As Integer
    Public Declare Function DTWAIN_RangeGetValue Lib "dtwain64.dll" (pArray As System.IntPtr, nWhich As Integer, pVariant As System.IntPtr) As Integer
    Public Declare Function DTWAIN_RangeGetValueFloat Lib "dtwain64.dll" (pArray As System.IntPtr, nWhich As Integer, ByRef pVal As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_RangeGetValueLong Lib "dtwain64.dll" (pArray As System.IntPtr, nWhich As Integer, ByRef pVal As Integer) As Integer
    Public Declare Function DTWAIN_RangeIsValid Lib "dtwain64.dll" (Range As System.IntPtr, ByRef pStatus As Integer) As Integer
    Public Declare Function DTWAIN_RangeSetAll Lib "dtwain64.dll" (pArray As System.IntPtr, pVariantLow As System.IntPtr, pVariantUp As System.IntPtr, pVariantStep As System.IntPtr, pVariantDefault As System.IntPtr, pVariantCurrent As System.IntPtr) As Integer
    Public Declare Function DTWAIN_RangeSetAllFloat Lib "dtwain64.dll" (pArray As System.IntPtr, dLow As System.Double, dUp As System.Double, dStep As System.Double, dDefault As System.Double, dCurrent As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_RangeSetAllLong Lib "dtwain64.dll" (pArray As System.IntPtr, lLow As Integer, lUp As Integer, lStep As Integer, lDefault As Integer, lCurrent As Integer) As Integer
    Public Declare Function DTWAIN_RangeSetValue Lib "dtwain64.dll" (pArray As System.IntPtr, nWhich As Integer, pVal As System.IntPtr) As Integer
    Public Declare Function DTWAIN_RangeSetValueFloat Lib "dtwain64.dll" (pArray As System.IntPtr, nWhich As Integer, Val As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_RangeSetValueLong Lib "dtwain64.dll" (pArray As System.IntPtr, nWhich As Integer, Val As Integer) As Integer
    ...
    Public Declare Function DTWAIN_RotateImage Lib "dtwain64.dll" (hDib As System.IntPtr, rotationAngle As System.Double) As System.IntPtr
    Public Declare Ansi Function DTWAIN_RotateImageString Lib "dtwain64.dll" (hDib As System.IntPtr, rotationAngle As String) As System.IntPtr
    ...
    Public Declare Function DTWAIN_SelectOCREngine Lib "dtwain64.dll" () As System.IntPtr
    ...
    Public Declare Function DTWAIN_SelectSource Lib "dtwain64.dll" () As System.IntPtr
    ...
    Public Declare Function DTWAIN_SelectSourceWithOpen Lib "dtwain64.dll" (bOpen As Integer) As System.IntPtr
    Public Declare Function DTWAIN_SetAcquireArea Lib "dtwain64.dll" (Source As System.IntPtr, lSetType As Integer, FloatEnum As System.IntPtr, ActualEnum As System.IntPtr) As Integer
    Public Declare Function DTWAIN_SetAcquireArea2 Lib "dtwain64.dll" (Source As System.IntPtr, left As System.Double, top As System.Double, right As System.Double, bottom As System.Double, lUnit As Integer, Flags As Integer) As Integer
    ...
    Public Declare Function DTWAIN_SetAcquireImageNegative Lib "dtwain64.dll" (Source As System.IntPtr, IsNegative As Integer) As Integer
    Public Declare Function DTWAIN_SetAcquireImageScale Lib "dtwain64.dll" (Source As System.IntPtr, xscale As System.Double, yscale As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_SetAcquireStripBuffer Lib "dtwain64.dll" (Source As System.IntPtr, hMem As System.IntPtr) As Integer
    Public Declare Function DTWAIN_SetAcquireStripSize Lib "dtwain64.dll" (Source As System.IntPtr, StripSize As UInteger) As Integer
    Public Declare Function DTWAIN_SetAlarmVolume Lib "dtwain64.dll" (Source As System.IntPtr, Volume As Integer) As Integer
    Public Declare Function DTWAIN_SetAlarms Lib "dtwain64.dll" (Source As System.IntPtr, Alarms As System.IntPtr) As Integer
    Public Declare Function DTWAIN_SetAllCapsToDefault Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    ...
    Public Declare Function DTWAIN_SetBrightness Lib "dtwain64.dll" (Source As System.IntPtr, Brightness As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_SetBufferedTileMode Lib "dtwain64.dll" (Source As System.IntPtr, bTileMode As Integer) As Integer
    Public Declare Function DTWAIN_SetCallback Lib "dtwain64.dll" (Fn As DTwainCallback, UserData As Integer) As DTwainCallback
    Public Declare Function DTWAIN_SetCallback64 Lib "dtwain64.dll" (Fn As DTwainCallback64, UserData As System.Int64) As DTwainCallback64
    Public Declare Ansi Function DTWAIN_SetCamera Lib "dtwain64.dll" (Source As System.IntPtr, szCamera As String) As Integer
    Public Declare Function DTWAIN_SetCapValues Lib "dtwain64.dll" (Source As System.IntPtr, lCap As Integer, lSetType As Integer, pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_SetCapValuesEx Lib "dtwain64.dll" (Source As System.IntPtr, lCap As Integer, lSetType As Integer, lContainerType As Integer, pArray As System.IntPtr) As Integer
    Public Declare Function DTWAIN_SetCapValuesEx2 Lib "dtwain64.dll" (Source As System.IntPtr, lCap As Integer, lSetType As Integer, lContainerType As Integer, nDataType As Integer, pArray As System.IntPtr) As Integer
    Public Declare Ansi Function DTWAIN_SetCaption Lib "dtwain64.dll" (Source As System.IntPtr, Caption As String) As Integer
    Public Declare Function DTWAIN_SetCompressionType Lib "dtwain64.dll" (Source As System.IntPtr, lCompression As Integer, bSetCurrent As Integer) As Integer
    Public Declare Function DTWAIN_SetContrast Lib "dtwain64.dll" (Source As System.IntPtr, Contrast As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_SetCountry Lib "dtwain64.dll" (nCountry As Integer) As Integer
    Public Declare Function DTWAIN_SetCurrentRetryCount Lib "dtwain64.dll" (Source As System.IntPtr, nCount As Integer) As Integer
    Public Declare Function DTWAIN_SetCustomDSData Lib "dtwain64.dll" (Source As System.IntPtr, hData As System.IntPtr, <MarshalAs(UnmanagedType.LPArray, ArraySubType:=UnmanagedType.U8, SizeParamIndex:=3)> Data As Byte(), dSize As UInteger, nFlags As Integer) As Integer
    Public Declare Function DTWAIN_SetDSMSearchOrder Lib "dtwain64.dll" (SearchPath As Integer) As Integer
    ...
    Public Declare Function DTWAIN_SetDefaultSource Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_SetDeviceNotifications Lib "dtwain64.dll" (Source As System.IntPtr, DevEvents As Integer) As Integer
    ...
    Public Declare Function DTWAIN_SetDoubleFeedDetectLength Lib "dtwain64.dll" (Source As System.IntPtr, Value As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_SetFeederOrder Lib "dtwain64.dll" (Source As System.IntPtr, lOrder As Integer) As Integer
    Public Declare Function DTWAIN_SetFeederWaitTime Lib "dtwain64.dll" (Source As System.IntPtr, waitTime As Integer, flags As Integer) As Integer
    Public Declare Function DTWAIN_SetFileAutoIncrement Lib "dtwain64.dll" (Source As System.IntPtr, Increment As Integer, bResetOnAcquire As Integer, bSet As Integer) As Integer
    Public Declare Function DTWAIN_SetFileCompressionType Lib "dtwain64.dll" (Source As System.IntPtr, lCompression As Integer, bIsCustom As Integer) As Integer
    ...
    Public Declare Function DTWAIN_SetFileXferFormat Lib "dtwain64.dll" (Source As System.IntPtr, lFileType As Integer, bSetCurrent As Integer) As Integer
    Public Declare Ansi Function DTWAIN_SetHalftone Lib "dtwain64.dll" (Source As System.IntPtr, lpHalftone As String) As Integer
    Public Declare Function DTWAIN_SetHighlight Lib "dtwain64.dll" (Source As System.IntPtr, Highlight As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_SetJobControl Lib "dtwain64.dll" (Source As System.IntPtr, JobControl As Integer, bSetCurrent As Integer) As Integer
    Public Declare Function DTWAIN_SetJpegValues Lib "dtwain64.dll" (Source As System.IntPtr, Quality As Integer, Progressive As Integer) As Integer
    Public Declare Function DTWAIN_SetJpegXRValues Lib "dtwain64.dll" (Source As System.IntPtr, Quality As Integer, Progressive As Integer) As Integer
    Public Declare Function DTWAIN_SetLanguage Lib "dtwain64.dll" (nLanguage As Integer) As Integer
    Public Declare Function DTWAIN_SetLastError Lib "dtwain64.dll" (nError As Integer) As Integer
    Public Declare Function DTWAIN_SetLightPath Lib "dtwain64.dll" (Source As System.IntPtr, LightPath As Integer) As Integer
    ...
    Public Declare Function DTWAIN_SetMajorMinorVersion Lib "dtwain64.dll" (nMajor As UInteger, nMinor As UInteger) As Integer
    ...
    Public Declare Function DTWAIN_SetOCRCapValues Lib "dtwain64.dll" (Engine As System.IntPtr, OCRCapValue As Integer, SetType As Integer, CapValues As System.IntPtr) As Integer
    Public Declare Function DTWAIN_SetOrientation Lib "dtwain64.dll" (Source As System.IntPtr, Orient As Integer, bSetCurrent As Integer) As Integer
    Public Declare Function DTWAIN_SetOverscan Lib "dtwain64.dll" (Source As System.IntPtr, Value As Integer, bSetCurrent As Integer) As Integer
    Public Declare Function DTWAIN_SetPDFAESEncryption Lib "dtwain64.dll" (Source As System.IntPtr, nWhichEncryption As Integer, bUseAES As Integer) As Integer
    Public Declare Function DTWAIN_SetPDFASCIICompression Lib "dtwain64.dll" (Source As System.IntPtr, bSet As Integer) As Integer
    Public Declare Ansi Function DTWAIN_SetPDFAuthor Lib "dtwain64.dll" (Source As System.IntPtr, lpAuthor As String) As Integer
    Public Declare Function DTWAIN_SetPDFCompression Lib "dtwain64.dll" (Source As System.IntPtr, bCompression As Integer) As Integer
    ...
    Public Declare Function DTWAIN_SetPDFJpegQuality Lib "dtwain64.dll" (Source As System.IntPtr, Quality As Integer) As Integer
    ...
    Public Declare Function DTWAIN_SetPDFOCRConversion Lib "dtwain64.dll" (Engine As System.IntPtr, PageType As Integer, FileType As Integer, PixelType As Integer, BitDepth As Integer, Options As Integer) As Integer
    Public Declare Function DTWAIN_SetPDFOCRMode Lib "dtwain64.dll" (Source As System.IntPtr, bSet As Integer) As Integer
    Public Declare Function DTWAIN_SetPDFOrientation Lib "dtwain64.dll" (Source As System.IntPtr, lPOrientation As Integer) As Integer
    Public Declare Function DTWAIN_SetPDFPageScale Lib "dtwain64.dll" (Source As System.IntPtr, nOptions As Integer, xScale As System.Double, yScale As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_SetPDFPageSize Lib "dtwain64.dll" (Source As System.IntPtr, PageSize As Integer, CustomWidth As System.Double, CustomHeight As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_SetPDFPolarity Lib "dtwain64.dll" (Source As System.IntPtr, Polarity As Integer) As Integer
    ...
    Public Declare Function DTWAIN_SetPDFTextElementFloat Lib "dtwain64.dll" (TextElement As System.IntPtr, val1 As System.Double, val2 As System.Double, Flags As Integer) As Integer
    ...
    Public Declare Function DTWAIN_SetPDFTextElementLong Lib "dtwain64.dll" (TextElement As System.IntPtr, val1 As Integer, val2 As Integer, Flags As Integer) As Integer
    ...
    Public Declare Function DTWAIN_SetResolution Lib "dtwain64.dll" (Source As System.IntPtr, Resolution As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_SetRotation Lib "dtwain64.dll" (Source As System.IntPtr, Rotation As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_SetSaveFileType Lib "dtwain64.dll" (Source As System.IntPtr, FileType As Integer) As Integer
    Public Declare Function DTWAIN_SetShadow Lib "dtwain64.dll" (Source As System.IntPtr, Shadow As System.Double) As Integer
    Public Declare Ansi Function DTWAIN_SetShadowString Lib "dtwain64.dll" (Source As System.IntPtr, Shadow As String) As Integer
    Public Declare Function DTWAIN_SetSourceUnit Lib "dtwain64.dll" (Source As System.IntPtr, Unit As Integer) As Integer
    Public Declare Function DTWAIN_SetTIFFCompressType Lib "dtwain64.dll" (Source As System.IntPtr, Setting As Integer) As Integer
    Public Declare Function DTWAIN_SetTIFFInvert Lib "dtwain64.dll" (Source As System.IntPtr, Setting As Integer) As Integer
    ...
    Public Declare Function DTWAIN_SetThreshold Lib "dtwain64.dll" (Source As System.IntPtr, Threshold As System.Double, bSetBithDepthReduction As Integer) As Integer
    ...
    Public Declare Function DTWAIN_SetTwainDSM Lib "dtwain64.dll" (DSMType As Integer) As Integer
    Public Declare Ansi Function DTWAIN_SetTwainLog Lib "dtwain64.dll" (LogFlags As UInteger, lpszLogFile As String) As Integer
    Public Declare Function DTWAIN_SetTwainMode Lib "dtwain64.dll" (lAcquireMode As Integer) As Integer
    Public Declare Function DTWAIN_SetUpdateDibProc Lib "dtwain64.dll" (DibProc As DTwainDIBUpdateProc) As DTwainDIBUpdateProc
    Public Declare Function DTWAIN_SetXResolution Lib "dtwain64.dll" (Source As System.IntPtr, xResolution As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_SetYResolution Lib "dtwain64.dll" (Source As System.IntPtr, yResolution As System.Double) As Integer
    ...
    Public Declare Function DTWAIN_ShowUIOnly Lib "dtwain64.dll" (Source As System.IntPtr) As Integer
    Public Declare Function DTWAIN_ShutdownOCREngine Lib "dtwain64.dll" (OCREngine As System.IntPtr) As Integer
    Public Declare Function DTWAIN_SkipImageInfoError Lib "dtwain64.dll" (Source As System.IntPtr, bSkip As Integer) As Integer
    Public Declare Function DTWAIN_StartThread Lib "dtwain64.dll" (DLLHandle As System.IntPtr) As Integer
    ...
    Public Declare Function DTWAIN_SysDestroy Lib "dtwain64.dll" () As Integer
    ...
    Public Declare Function DTWAIN_UnlockMemory Lib "dtwain64.dll" (h As System.IntPtr) As Integer
    Public Declare Function DTWAIN_UnlockMemoryEx Lib "dtwain64.dll" (h As System.IntPtr) As Integer
    Public Declare Function DTWAIN_UpdateCurrentAcquiredImage Lib "dtwain64.dll" (Source As System.IntPtr, hNewDib As System.IntPtr) As Integer
    Public Declare Function DTWAIN_UseMultipleThreads Lib "dtwain64.dll" (bSet As Integer) As Integer
