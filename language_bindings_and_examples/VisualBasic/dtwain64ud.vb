...
Class DTWAINAPI
    ...
    Declare Auto Function DTWAIN_ArrayGetAtFrame Lib "dtwain64ud.dll" (FrameArray As System.IntPtr, nWhere As Integer, ByRef pleft As Double, ByRef ptop As Double, ByRef pright As Double, ByRef pbottom As Double) As Integer
    Declare Auto Function DTWAIN_ArraySetAtFrame Lib "dtwain64ud.dll" (FrameArray As System.IntPtr, nWhere As Integer, left As Double, top As Double, right As Double, bottom As Double) As Integer
    Declare Auto Function DTWAIN_ArrayGetAtFrameEx Lib "dtwain64ud.dll" (FrameArray As System.IntPtr, nWhere As Integer, FrameArray As System.IntPtr) As Integer
    Declare Auto Function DTWAIN_ArraySetAtFrameEx Lib "dtwain64ud.dll" (FrameArray As System.IntPtr, nWhere As Integer, FrameArray As System.IntPtr) As Integer
End Class
