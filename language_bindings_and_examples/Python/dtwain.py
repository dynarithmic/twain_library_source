...
def setup_windll(theDLL):
     ...
     theDLL.DTWAIN_AcquireNative.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_AcquireToClipboard.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_ArrayConvertFix32ToFloat.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_ArrayConvertFloatToFix32.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_ArrayCreateCopy.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_ArrayCreateFromCap.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_ArrayCreateFromLong64s.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_ArrayCreateFromLongs.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_ArrayCreateFromReals.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_ArrayCreateFromStrings.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_ArrayCreate.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_ArrayInit.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_CreateAcquisitionArray.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_EnumAlarmsEx.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_EnumAlarmVolumesEx.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_EnumAudioXferMechsEx.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_EnumAutoFeedValuesEx.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_EnumAutomaticCapturesEx.restype = ct.POINTER(ct.c_void_p)
     ...
     theDLL.DTWAIN_EnumDoubleFeedDetectLengthsEx.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_EnumDoubleFeedDetectValuesEx.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_EnumExtendedCapsEx2.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_EnumFileXferFormatsEx.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_EnumHalftonesEx.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_EnumHighlightValuesEx.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_EnumJobControlsEx.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_EnumLightPathsEx.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_EnumLightSourcesEx.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_EnumMaxBuffersEx.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_EnumNoiseFiltersEx.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_EnumOrientationsEx.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_EnumOverscanValuesEx.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_EnumPaperSizesEx.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_EnumPatchCodesEx.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_EnumPatchMaxPrioritiesEx.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_EnumPatchMaxRetriesEx.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_EnumPatchPrioritiesEx.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_EnumPatchSearchModesEx.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_EnumPatchTimeOutValuesEx.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_EnumPrinterStringModesEx.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_EnumResolutionValuesEx.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_EnumShadowValuesEx.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_EnumSourcesEx.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_EnumSourceUnitsEx.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_EnumSupportedCapsEx2.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_EnumThresholdValuesEx.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_EnumTwainPrintersArrayEx.restype = ct.POINTER(ct.c_void_p)
     ...
     theDLL.DTWAIN_SetCallback64.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_SetUpdateDibProc.restype = ct.POINTER(ct.c_void_p)
     ...
     theDLL.DTWAIN_SysInitializeEx2W.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_SysInitializeExA.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_SysInitializeEx.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_SysInitializeExW.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_SysInitialize.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_SysInitializeLibEx2A.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_SysInitializeLibEx2.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_SysInitializeLibEx2W.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_SysInitializeLibExA.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_SysInitializeLibEx.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_SysInitializeLibExW.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_SysInitializeLib.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_SysInitializeNoBlocking.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_GetSourceID.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_GetTwainAppID.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_GetLoggerCallback.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_GetLoggerCallbackA.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_GetLoggerCallbackW.restype = ct.POINTER(ct.c_void_p)
     ...
     theDLL.DTWAIN_SelectSource2ExW.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_SelectSource2.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_SelectSource2W.restype = ct.POINTER(ct.c_void_p)
     ...
     theDLL.DTWAIN_ConvertToAPIStringW.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_GetBufferedTransferInfo.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_AllocateMemory64.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_AllocateMemoryEx.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_AllocateMemory.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_ConvertDIBToBitmap.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_GetAcquiredImage.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_GetAcquireStripBuffer.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_GetCurrentAcquiredImage.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_GetCustomDSData.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_GetOCRTextA.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_GetOCRText.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_GetOCRTextW.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_GetTwainHwnd.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_ArrayGetAtANSIStringPtr.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_ArrayGetAtStringPtr.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_ArrayGetAtWideStringPtr.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_ArrayGetBuffer.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_GetSourceIDEx.restype = ct.POINTER(ct.c_void_p)
     theDLL.DTWAIN_GetTwainAppIDEx.restype = ct.POINTER(ct.c_void_p)