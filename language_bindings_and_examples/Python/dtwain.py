...
def setup_unicode(theDLL):
     ...
     theDLL.DTWAIN_ArrayInit.restype = ct.c_void_pct.c_void
     ...
     theDLL.DTWAIN_ClearErrorBuffer.restype = ct.c_longct.c_void
     ...
     theDLL.DTWAIN_CreateAcquisitionArray.restype = ct.c_void_pct.c_void
     ...
     theDLL.DTWAIN_EndTwainSession.restype = ct.c_longct.c_void
     ...
     theDLL.DTWAIN_EnumSourcesEx.restype = ct.c_void_pct.c_void
     ...
     theDLL.DTWAIN_EnumSupportedFileTypes.restype = ct.c_void_pct.c_void
     theDLL.DTWAIN_EnumSupportedMultiPageFileTypes.restype = ct.c_void_pct.c_void
     theDLL.DTWAIN_EnumSupportedSinglePageFileTypes.restype = ct.c_void_pct.c_void
     ...
     theDLL.DTWAIN_GetCallback.restype = theDLL.SETCALLBACK_TYPEct.c_void
     theDLL.DTWAIN_GetCallback64.restype = theDLL.SETCALLBACK64_TYPEct.c_void
     ...
     theDLL.DTWAIN_GetCountry.restype = ct.c_longct.c_void
     ...
     theDLL.DTWAIN_GetDSMSearchOrder.restype = ct.c_longct.c_void
     theDLL.DTWAIN_GetDTWAINHandle.restype = ct.c_void_pct.c_void
     ...
     theDLL.DTWAIN_GetErrorBufferThreshold.restype = ct.c_longct.c_void
     theDLL.DTWAIN_GetErrorCallback.restype = theDLL.SETERRORPROC_TYPEct.c_void
     theDLL.DTWAIN_GetErrorCallback64.restype = theDLL.SETERRORPROC64_TYPEct.c_void
     ...
     theDLL.DTWAIN_GetLoggerCallback.restype = theDLL.SETLOGGERPROC_TYPEct.c_void
     theDLL.DTWAIN_GetLoggerCallbackA.restype = theDLL.SETLOGGERPROCA_TYPEct.c_void
     theDLL.DTWAIN_GetLoggerCallbackW.restype = theDLL.SETLOGGERPROCW_TYPEct.c_void
     ...
     theDLL.DTWAIN_GetRegisteredMsg.restype = ct.c_longct.c_void
     ...
     theDLL.DTWAIN_GetStaticLibVersion.restype = ct.c_longct.c_void
     ...
     theDLL.DTWAIN_GetTwainAppID.restype = ct.c_void_pct.c_void
     theDLL.DTWAIN_GetTwainAppIDEx.restype = ct.c_void_p
     theDLL.DTWAIN_GetTwainAvailability.restype = ct.c_longct.c_void
     ...
     theDLL.DTWAIN_GetTwainHwnd.restype = ct.c_void_pct.c_void
     ...
     theDLL.DTWAIN_GetTwainMode.restype = ct.c_longct.c_void
     ...
     theDLL.DTWAIN_GetTwainTimeout.restype = ct.c_longct.c_void
     ...
     theDLL.DTWAIN_InitOCRInterface.restype = ct.c_longct.c_void
     theDLL.DTWAIN_IsAcquiring.restype = ct.c_longct.c_void
     ...
     theDLL.DTWAIN_IsInitialized.restype = ct.c_longct.c_void
     theDLL.DTWAIN_IsJPEGSupported.restype = ct.c_longct.c_void
     ...
     theDLL.DTWAIN_IsMsgNotifyEnabled.restype = ct.c_longct.c_void
     theDLL.DTWAIN_IsNotifyTripletsEnabled.restype = ct.c_longct.c_void
     theDLL.DTWAIN_IsOCREngineActivated.restype = ct.c_long
     theDLL.DTWAIN_IsOpenSourcesOnSelect.restype = ct.c_longct.c_void
     theDLL.DTWAIN_IsOrientationSupported.restype = ct.c_long
     theDLL.DTWAIN_IsOverscanSupported.restype = ct.c_long
     theDLL.DTWAIN_IsPDFSupported.restype = ct.c_longct.c_void
     theDLL.DTWAIN_IsPNGSupported.restype = ct.c_longct.c_void
     ...
     theDLL.DTWAIN_IsSessionEnabled.restype = ct.c_longct.c_void
     ...
     theDLL.DTWAIN_IsTIFFSupported.restype = ct.c_longct.c_void
     theDLL.DTWAIN_IsThumbnailEnabled.restype = ct.c_long
     theDLL.DTWAIN_IsThumbnailSupported.restype = ct.c_long
     theDLL.DTWAIN_IsTwainAvailable.restype = ct.c_longct.c_void
     ...
     theDLL.DTWAIN_SelectDefaultOCREngine.restype = ct.c_void_pct.c_void
     theDLL.DTWAIN_SelectDefaultSource.restype = ct.c_void_pct.c_void
     theDLL.DTWAIN_SelectDefaultSourceWithOpen.restype = ct.c_void_p
     theDLL.DTWAIN_SelectOCREngine.restype = ct.c_void_pct.c_void
     ...
     theDLL.DTWAIN_SelectSource.restype = ct.c_void_pct.c_void
     ...
     theDLL.DTWAIN_SysDestroy.restype = ct.c_longct.c_void
     theDLL.DTWAIN_SysInitialize.restype = ct.c_void_pct.c_void
     ...
     theDLL.DTWAIN_SysInitializeNoBlocking.restype = ct.c_void_pct.c_void
     ...
     theDLL.DTWAIN_AddPDFText.argtypes = [ct.c_void_p, ct.c_wchar_p, ct.c_long, ct.c_long, ct.c_wchar_p, ct.c_double, ct.c_long, ct.c_long, ct.c_double, ct.c_double, ct.c_double, ct.c_long, ct.c_ulong]
     theDLL.DTWAIN_AddPDFTextA.argtypes = [ct.c_void_p, ct.c_char_p, ct.c_long, ct.c_long, ct.c_char_p, ct.c_double, ct.c_long, ct.c_long, ct.c_double, ct.c_double, ct.c_double, ct.c_long, ct.c_ulong]
     theDLL.DTWAIN_AddPDFTextEx.argtypes = [ct.c_void_p, ct.c_void_p, ct.c_ulong]
     theDLL.DTWAIN_AddPDFTextW.argtypes = [ct.c_void_p, ct.c_wchar_p, ct.c_long, ct.c_long, ct.c_wchar_p, ct.c_double, ct.c_long, ct.c_long, ct.c_double, ct.c_double, ct.c_double, ct.c_long, ct.c_ulong]
...
def setup_ansi(theDLL):
     ...
     theDLL.DTWAIN_AcquireToClipboard.argtypes = [ct.c_void_p, ct.c_long, ct.c_long, ct.c_long, ct.c_long, ct.c_long, ct.c_long, ct.POINTER(ct.c_long)]
     theDLL.DTWAIN_AddExtImageInfoQuery.argtypes = [ct.c_void_p, ct.c_long]
     theDLL.DTWAIN_AddPDFText.argtypes = [ct.c_void_p, ct.c_char_p, ct.c_long, ct.c_long, ct.c_char_p, ct.c_double, ct.c_long, ct.c_long, ct.c_double, ct.c_double, ct.c_double, ct.c_long, ct.c_ulong]
     theDLL.DTWAIN_AddPDFTextA.argtypes = [ct.c_void_p, ct.c_char_p, ct.c_long, ct.c_long, ct.c_char_p, ct.c_double, ct.c_long, ct.c_long, ct.c_double, ct.c_double, ct.c_double, ct.c_long, ct.c_ulong]
     theDLL.DTWAIN_AddPDFTextEx.argtypes = [ct.c_void_p, ct.c_void_p, ct.c_ulong]
     theDLL.DTWAIN_AddPDFTextW.argtypes = [ct.c_void_p, ct.c_wchar_p, ct.c_long, ct.c_long, ct.c_wchar_p, ct.c_double, ct.c_long, ct.c_long, ct.c_double, ct.c_double, ct.c_double, ct.c_long, ct.c_ulong]
     theDLL.DTWAIN_AllocateMemory.argtypes = [ct.c_ulong]
